dnl $Id: support-rpath.m4,v 1.14 2001/11/21 23:21:26 gunney Exp $
...
AC_ARG_ENABLE(rpath,
[  --enable-rpath=SYNTAX	Use the given syntax for rpath flags
...
if test "$enable_rpath" = yes; then
  ...
  You can override this by using --enable-rpath-syntax=SYNTAX])
      fi
    ;;
    *)
      BTNG_LIBS_FIND_RPATH(btng_rpath_beginning)
