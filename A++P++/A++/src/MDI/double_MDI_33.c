...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_Cos_Array \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         Result[Address_Result] = cos(Lhs[Address_Lhs]);
                      /* for (nd=1;nd<MAXDIMS;nd++)*/
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) Result[Address_Result] = cos(Lhs[Address_Lhs]);
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer [i3]) Result [i0] = cos(Lhs [i1]);
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_Cos_Array_Accumulate_To_Operand \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         Lhs[Address_Lhs] = cos(Lhs[Address_Lhs]);
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
                         if (APP_DEBUG > 10)
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) Lhs[Address_Lhs] = cos(Lhs[Address_Lhs]);
                      /* for (nd=1;nd<MAXDIMS;nd++)*/
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer[i3]) Lhs [i1] = cos(Lhs [i1]);
                    i3 += Stride_Mask_I; 
                  }
               Offset_Lhs += Sclstride_Lhs[second];
               Offset_Mask += Sclstride_Mask[second];
