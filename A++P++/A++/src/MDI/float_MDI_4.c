...
#define  FLOATARRAY
/* Array_To_Array_Operation_Call_Function(f_Fmod,Modulo,fmod,float,float) */
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_f_Fmod_Array_Modulo_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Fmod_Array_Modulo_Scalar \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_f_Fmod_Scalar_Modulo_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Fmod_Scalar_Modulo_Array_Accumulate_To_Operand \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Fmod_Array_Modulo_Array_Accumulate_To_Operand \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Fmod_Array_Modulo_Scalar_Accumulate_To_Operand \n");
#endif
