...
/*
   ...
   Previous definition: define(MDI_ceil,(int) (f+1))
...
#ifndef INTARRAY
/* Unary_Array_Operation(f_Ceil,ceil,float) */
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Ceil_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Ceil_Array_Accumulate_To_Operand \n");
#endif
