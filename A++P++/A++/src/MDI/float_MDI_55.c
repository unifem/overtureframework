...
#define  FLOATARRAY
/* define(MDI_sign,(f < float) ? -f : f) */
/* Bug fix (5/19/94) sign function was not working properly! */ 
/* define(MDI_sign,(f < 0) ? -float : float) */
/* 
   ...
   define(MDI_sign,((f)<0 && (float)>=0) || ((f)>=0 && (float)<0) ? -(float) : (float) )
 */
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_f_Sign_Array_Of_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Sign_Array_Of_Scalar \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_f_Sign_Scalar_Of_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Sign_Scalar_Of_Array_Accumulate_To_Operand \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Sign_Array_Of_Array_Accumulate_To_Operand \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Sign_Array_Of_Scalar_Accumulate_To_Operand \n");
#endif
