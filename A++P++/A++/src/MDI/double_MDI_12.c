...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_d_Add_Array_Plus_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_Add_Array_Plus_Scalar \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_Add_Scalar_Plus_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_Add_Scalar_Plus_Array_Accumulate_To_Operand \n");
#endif
