...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Sum_Array_Along_Axis \n");
#endif
...
#  pragma _CRI novector
            ...
            /* ... arrays are only 2d or less ... */
               ...
               printf ("Sorry, Indirect addressing not implemented in MDI_f_Sum_Array_Along_Axis! \n");
               exit(1);
/* iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii*/
             }
            else
...
#  pragma _CRI novector
               ...
               printf ("Sorry, Indirect addressing (with where mask) not implemented in MDI_f_Sum_Array_Along_Axis! \n");
               exit(1);
/* iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii*/
             }
            else
            ...
            /* Macro_Where_Loop_Structure_Bases_NOT_Equal_Strides_NOT_Equal_Result_Lhs(Result [i0] = +(Lhs [i1])) */
               printf ("Sorry, Direct addressing (with where mask) not implemented in MDI_f_Sum_Array_Along_Axis! \n");
               exit(1);
             }
        }
   }
