...
void MDI_i_Array_convertTo_doubleArray_Array_Accumulate_To_Operand 
          ( double *Lhs , int *Rhs , int *Mask_Array_Pointer ,
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_i_Array_convertTo_doubleArray_Array_Accumulate_To_Operand \n");
#endif
...
void MDI_i_Array_convertTo_doubleArray_Scalar_Accumulate_To_Operand
          ( double *Lhs , int x , int *Mask_Array_Pointer ,
            array_domain *Lhs_Descriptor , 
            array_domain *Mask_Descriptor )
   {
     /*--------------------------------------------------------*/
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_Array_convertTo_doubleArray_Scalar_Accumulate_To_Operand \n");
#endif
