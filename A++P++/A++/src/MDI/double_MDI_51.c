...
/*
   ...
   Previous definition: define(MDI_ceil,(int) (d+1))
   define CNX_CEIL(L) ((L)>0 && (L)-(int)(L)>0) ? (int)((L)+1) : (int)(L)
   Result [i1] = CNX_CEIL(Lhs [i1]);
   define(MDI_ceil,((L)>0 && (L)-(int)(L)>0) ? (int)((L)+1) : (int)(L))
 */



#ifndef INTARRAY
/* Unary_Array_Operation(d_Ceil,ceil,double) */
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_Ceil_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_Ceil_Array_Accumulate_To_Operand \n");
#endif
