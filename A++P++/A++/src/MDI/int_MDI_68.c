...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_i_BIT_RSHIFT_Array_BitwiseRShift_Array \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         Result[Address_Result] = Lhs[Address_Lhs] >> Rhs[Address_Rhs];
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) Result[Address_Result] = Lhs[Address_Lhs] >> Rhs[Address_Rhs];
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer[i3]) Result[i0] = Lhs[i1] >> Rhs[i2];
...
void MDI_i_BIT_RSHIFT_Array_BitwiseRShift_Scalar
          ( int *Result , int *Lhs , int x ,
            ...
            array_domain *Mask_Descriptor )
   {
  /* Note that special cases can be made for when j=k or i=j=k etc.
     this might improve the performance.  Additionally the following 
     loop can be written in C or FORTRAN for vectorization on the Cray if required.
   */
     /*--------------------------------------------------------*/
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_RSHIFT_Array_BitwiseRShift_Scalar \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         Result[Address_Result] = Lhs[Address_Lhs] >> x;
                      /* for (nd=1;nd<MAXDIMS;nd++)*/
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) Result[Address_Result] = Lhs[Address_Lhs] >> x;
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer [i3]) Result[i0] = Lhs[i1] >> x;
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_RSHIFT_Scalar_BitwiseRShift_Array \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         Result[Address_Result] = x >> Lhs[Address_Lhs];
                      /* for (nd=1;nd<MAXDIMS;nd++)*/
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) Result[Address_Result] = x >> Lhs[Address_Lhs];
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer [i3]) Result[i0] = x >> Lhs[i1];
...
/* We change the name from Rhs to Lhs to reuse existing macros! */
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_RSHIFT_Scalar_BitwiseRShift_Array_Accumulate_To_Operand \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         Lhs[Address_Lhs] = x >> Lhs[Address_Lhs];
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
                         if (APP_DEBUG > 10)
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) Lhs[Address_Lhs] = x >> Lhs[Address_Lhs];
                      /* for (nd=1;nd<MAXDIMS;nd++)*/
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer[i3]) Lhs [i1] = x >> Lhs [i1];
                    i3 += Stride_Mask_I; 
                  }
               Offset_Lhs += Sclstride_Lhs[second];
               Offset_Mask += Sclstride_Mask[second];
...
void MDI_i_BIT_RSHIFT_Array_BitwiseRShift_Array_Accumulate_To_Operand 
          ( int *Lhs , int *Rhs , int *Mask_Array_Pointer ,
            array_domain *Lhs_Descriptor , 
            array_domain *Rhs_Descriptor , 
            array_domain *Mask_Descriptor )
   {
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_i_BIT_RSHIFT_Array_BitwiseRShift_Array_Accumulate_To_Operand \n");
#endif
     ...
     if (APP_DEBUG)
        {
          ...
          for (nd=0;nd<MAXDIMS;nd++)
		     ...
		     IT IS 20% SLOWER TO USE MEMCPY! */
                  /* memcpy ( Lhs , Rhs , Block_Size_Lhs_L*sizeof(int) ); */
...
void MDI_i_BIT_RSHIFT_Array_BitwiseRShift_Scalar_Accumulate_To_Operand
          ( int *Lhs , int x , int *Mask_Array_Pointer ,
            array_domain *Lhs_Descriptor , 
            array_domain *Mask_Descriptor )
   {
     /*--------------------------------------------------------*/
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_RSHIFT_Array_BitwiseRShift_Scalar_Accumulate_To_Operand \n");
#endif
