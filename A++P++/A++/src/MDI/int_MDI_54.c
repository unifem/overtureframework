...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_i_Max_Array_And_Array \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         Result[Address_Result] = (Lhs[Address_Lhs] < Rhs[Address_Rhs]) ? Rhs[Address_Rhs] : Lhs[Address_Lhs];
     ...
     for (i1=0; i1 < Array_Size; i1++)
        {
          ...
          Result[i1] = (Lhs[i1] < Rhs[i1]) ? Rhs[i1] : Lhs[i1];
        }
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    Result[i0] = (Lhs[i1] < Rhs[i2]) ? Rhs[i2] : Lhs[i1];
                    i2 += Stride_Rhs_I; 
                    i0 += Stride_Result_I; 
                  }
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) Result[Address_Result] = (Lhs[Address_Lhs] < Rhs[Address_Rhs]) ? Rhs[Address_Rhs] : Lhs[Address_Lhs];
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer[i3]) Result[i0] = (Lhs[i1] < Rhs[i2]) ? Rhs[i2] : Lhs[i1];
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_Max_Array_And_Scalar \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         Result[Address_Result] = (Lhs[Address_Lhs] < x) ? x : Lhs[Address_Lhs];
                      /* for (nd=1;nd<MAXDIMS;nd++)*/
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) Result[Address_Result] = (Lhs[Address_Lhs] < x) ? x : Lhs[Address_Lhs];
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer [i3]) Result[i0] = (Lhs[i1] < x) ? x : Lhs[i1];
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_i_Max_Scalar_And_Array \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         Result[Address_Result] = (x < Lhs[Address_Lhs]) ? Lhs[Address_Lhs] : x;
                      /* for (nd=1;nd<MAXDIMS;nd++)*/
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) Result[Address_Result] = (x < Lhs[Address_Lhs]) ? Lhs[Address_Lhs] : x;
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer [i3]) Result[i0] = (x < Lhs[i1]) ? Lhs[i1] : x;
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_Max_Scalar_And_Array_Accumulate_To_Operand \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         Lhs[Address_Lhs] = (x < Lhs[Address_Lhs]) ? Lhs[Address_Lhs] : x;
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
                         if (APP_DEBUG > 10)
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) Lhs[Address_Lhs] = (x < Lhs[Address_Lhs]) ? Lhs[Address_Lhs] : x;
                      /* for (nd=1;nd<MAXDIMS;nd++)*/
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer[i3]) Lhs[i1] = (x < Lhs[i1]) ? Lhs[i1] : x;
                    i3 += Stride_Mask_I; 
                  }
               Offset_Lhs += Sclstride_Lhs[second];
               Offset_Mask += Sclstride_Mask[second];
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_Max_Array_And_Array_Accumulate_To_Operand \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         Lhs[Address_Lhs] = (Lhs[Address_Lhs] < Rhs[Address_Rhs]) ? Rhs[Address_Rhs] : Lhs[Address_Lhs];
                      /* for (nd=1;nd<MAXDIMS;nd++)*/
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
     ...
     for (i1=0; i1 < Array_Size; i1++)
        {
          ...
          Lhs[i1] = (Lhs[i1] < Rhs[i1]) ? Rhs[i1] : Lhs[i1];
        }
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    Lhs[i1] = (Lhs[i1] < Rhs[i2]) ? Rhs[i2] : Lhs[i1];
                    i2 += Stride_Rhs_I; 
                  }
               Offset_Lhs += Sclstride_Lhs[second];
               Offset_Rhs += Sclstride_Rhs[second];
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) Lhs[Address_Lhs] = (Lhs[Address_Lhs] < Rhs[Address_Rhs]) ? Rhs[Address_Rhs] : Lhs[Address_Lhs];
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer [i3]) Lhs[i1] = (Lhs[i1] < Rhs[i2]) ? Rhs[i2] : Lhs[i1];
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_Max_Array_And_Scalar_Accumulate_To_Operand \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         Lhs[Address_Lhs] = (Lhs[Address_Lhs] < x) ? x : Lhs[Address_Lhs];
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
                         if (APP_DEBUG > 10)
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) Lhs[Address_Lhs] = (Lhs[Address_Lhs] < x) ? x : Lhs[Address_Lhs];
                      /* for (nd=1;nd<MAXDIMS;nd++)*/
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer[i3]) Lhs[i1] = (Lhs[i1] < x) ? x : Lhs[i1];
                    i3 += Stride_Mask_I; 
                  }
               Offset_Lhs += Sclstride_Lhs[second];
               Offset_Mask += Sclstride_Mask[second];
