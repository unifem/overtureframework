...
// *wdh* 100924 void Expression_Tree_Node_Type::Catagorize_Operators ( char* String_Var , int Operation_Code_2 )
void Expression_Tree_Node_Type::Catagorize_Operators ( const char* String_Var , int Operation_Code_2 )
   {
