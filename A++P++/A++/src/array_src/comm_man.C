...
// *wdh* 100924 char*  Communication_Manager::MainProcessorGroupName          = MAIN_PROCESSOR_GROUP_NAME;
char*  Communication_Manager::MainProcessorGroupName          = (char*)MAIN_PROCESSOR_GROUP_NAME;
...
// *wdh* 100924 char* Global_PARTI_P_plus_plus_Interface_Name_Of_Main_Processor_Group = MAIN_PROCESSOR_GROUP_NAME;
const char* Global_PARTI_P_plus_plus_Interface_Name_Of_Main_Processor_Group = MAIN_PROCESSOR_GROUP_NAME;
