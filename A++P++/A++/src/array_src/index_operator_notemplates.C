    ...
    Index_Pointer_List ) const
{
   ...
   // Start of macro defining common part of all operator()
     ...
     if (APP_DEBUG > FILE_LEVEL_DEBUG)
        {
          printf ("Inside of doubleArray::operator(Internal_Index*)! -- Array_ID = %d getRawDataReferenceCount() = %d \n",
    ...
    Index_Pointer_List ) const
{
   ...
   // Start of macro defining common part of all operator()
     ...
     if (APP_DEBUG > FILE_LEVEL_DEBUG)
        {
          printf ("Inside of floatArray::operator(Internal_Index*)! -- Array_ID = %d getRawDataReferenceCount() = %d \n",
                   Array_ID(),getRawDataReferenceCount() );
        }
    ...
    Index_Pointer_List ) const
{
   ...
   // Start of macro defining common part of all operator()
     ...
     if (APP_DEBUG > FILE_LEVEL_DEBUG)
        {
          printf ("Inside of intArray::operator(Internal_Index*)! -- Array_ID = %d getRawDataReferenceCount() = %d \n",
                   Array_ID(),getRawDataReferenceCount() );
        }
