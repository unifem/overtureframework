...
// *wdh* 100924 void print ( char* str, const intArray & X )
void print ( const char* str, const intArray & X )
   {
     MACRO_PRINT_INFO(X)
   }

// *wdh* 100924 void print ( char* str, const floatArray & X )
void print ( const char* str, const floatArray & X )
   {
     MACRO_PRINT_INFO(X)
   }

// *wdh* 100924 void print ( char* str, const doubleArray & X )
void print ( const char* str, const doubleArray & X )
   {
     MACRO_PRINT_INFO(X)
   }
