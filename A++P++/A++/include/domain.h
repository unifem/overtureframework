...
// *wdh* 090222 -- define a new type to use for Size[] 
typedef int64_t DOMAIN_SIZE_Type;
...
// IBM xlC requires a declaration in the same scope where the function
// is used (declaration in any class as a friend function is not enough).
...
class Array_Domain_Type
  ...
  // friend class Partitioning_Type;
     ...
     /* A lot of other things will be added here, but it should be a minimal set! */
        DOMAIN_SIZE_Type Size          [MAX_ARRAY_DIMENSION];
...
// if defined(USE_EXPRESSION_TEMPLATES)
     ...
     // to make the subscript computation as simple as possible.
        DOMAIN_SIZE_Type ExpressionTemplateOffset;
     ...
     */
        inline DOMAIN_SIZE_Type offset(int i) const APP_RESTRICT_MACRO
           { return i * Stride[0]; }
        inline DOMAIN_SIZE_Type offset0(int i) const APP_RESTRICT_MACRO
           { return Base[0] + i * Stride[0]; }
        inline DOMAIN_SIZE_Type indirectOffset_1D ( int i ) const APP_RESTRICT_MACRO
           { return offset(computeSubscript(0,i)); }

#if (MAX_ARRAY_DIMENSION >= 2)
        inline DOMAIN_SIZE_Type offset(int i, int j) const APP_RESTRICT_MACRO
           { return i * Stride[0] + j * Stride[1] * Size[0]; }
        inline DOMAIN_SIZE_Type offset0(int i, int j) const APP_RESTRICT_MACRO
        // { return Base[0] + i * Stride[0] + (Base[1] + j * Stride[1]) * Size[0]; }
           { return i * Stride[0] + j * Stride[1] * Size[0] + (Base[0] + Base[1] * Size[0]); }
        inline DOMAIN_SIZE_Type indirectOffset_2D ( int i ) const APP_RESTRICT_MACRO
           { return offset(computeSubscript(0,i), computeSubscript(1,i)); }
#endif
#if (MAX_ARRAY_DIMENSION >= 3)
        inline DOMAIN_SIZE_Type offset(int i, int j, int k) const APP_RESTRICT_MACRO
           { return i * Stride[0] + j * Stride[1] * Size[0] + k * Stride[2] * Size[1]; }
        inline DOMAIN_SIZE_Type offset0(int i, int j, int k) const APP_RESTRICT_MACRO
        // { return Base[0] + i * Stride[0] + (Base[1] + j * Stride[1]) * Size[0] + 
        //         (Base[2] + k * Stride[2]) * Size[1]; }
           { return i * Stride[0] + j * Stride[1] * Size[0] +
                    k * Stride[2] * Size[1] + (Base[0] + Base[1] * Size[0] + Base[2] * Size[1]); }
        inline DOMAIN_SIZE_Type indirectOffset_3D ( int i ) const APP_RESTRICT_MACRO
           { return offset(computeSubscript(0,i), computeSubscript(1,i),
                           computeSubscript(2,i)); }
#endif
#if (MAX_ARRAY_DIMENSION >= 4)
        inline DOMAIN_SIZE_Type offset(int i, int j, int k, int l) const APP_RESTRICT_MACRO
           { return i * Stride[0]           + j * Stride[1] * Size[0] + 
                    k * Stride[2] * Size[1] + l * Stride[3] * Size[2]; }
        inline DOMAIN_SIZE_Type offset0(int i, int j, int k, int l) const APP_RESTRICT_MACRO
        // { return Base[0] + i * Stride[0] + (Base[1] + j * Stride[1]) * Size[0] + 
        //         (Base[2] + k * Stride[2]) * Size[1] + (Base[3] + l * Stride[3]) * Size[2]; }
           { return i * Stride[0] + j * Stride[1] * Size[0] + 
                    k * Stride[2] * Size[1] + l * Stride[3] * Size[2] + 
                    (Base[0] + Base[1] * Size[0] + Base[2] * Size[1] + Base[3] * Size[2]); }
        inline DOMAIN_SIZE_Type indirectOffset_4D ( int i ) const APP_RESTRICT_MACRO
           { return offset(computeSubscript(0,i), computeSubscript(1,i),
                           computeSubscript(2,i), computeSubscript(3,i)); }
#endif
#if (MAX_ARRAY_DIMENSION >= 5)
        inline DOMAIN_SIZE_Type offset(int i, int j, int k, int l, int m) const APP_RESTRICT_MACRO
           { return offset(i,j,k,l) + m * Stride[4] * Size[3]; }
        inline DOMAIN_SIZE_Type offset0(int i, int j, int k, int l, int m) const APP_RESTRICT_MACRO
        // { return offset0(i,j,k,l) + (Base[4] + m * Stride[4]) * Size[3]; }
           { return offset0(i,j,k,l) + m * Stride[4] * Size[3] + Base[4] * Size[3]; }
        inline DOMAIN_SIZE_Type indirectOffset_5D ( int i ) const APP_RESTRICT_MACRO
           { return offset(computeSubscript(0,i), computeSubscript(1,i),
                           computeSubscript(2,i), computeSubscript(3,i),
                           computeSubscript(4,i)); }
#endif
#if (MAX_ARRAY_DIMENSION >= 6)
        inline DOMAIN_SIZE_Type offset(int i, int j, int k, int l, int m, int n) const APP_RESTRICT_MACRO
           { return offset(i,j,k,l,m) + n * Stride[5] * Size[4]; }
        inline DOMAIN_SIZE_Type offset0(int i, int j, int k, int l, int m, int n) const APP_RESTRICT_MACRO
        // { return offset0(i,j,k,l,m) + (Base[5] + n * Stride[5]) * Size[4]; }
           { return offset0(i,j,k,l,m) + n * Stride[5] * Size[4] + Base[5] * Size[4]; }
        inline DOMAIN_SIZE_Type indirectOffset_6D ( int i ) const APP_RESTRICT_MACRO
           { return offset(computeSubscript(0,i), computeSubscript(1,i),
                           computeSubscript(2,i), computeSubscript(3,i),
                           computeSubscript(4,i), computeSubscript(5,i)); }
#endif
#if (MAX_ARRAY_DIMENSION >= 7)
        inline DOMAIN_SIZE_Type offset(int i, int j, int k, int l, int m, int n, int o) const APP_RESTRICT_MACRO
           { return offset(i,j,k,l,m,n) + o * Stride[6] * Size[5]; }
        inline DOMAIN_SIZE_Type offset0(int i, int j, int k, int l, int m, int n, int o) const APP_RESTRICT_MACRO
        // { return offset0(i,j,k,l,m,n) + (Base[6] + o * Stride[6]) * Size[5]; }
           { return offset0(i,j,k,l,m,n) + o * Stride[6] * Size[5] + Base[6] * Size[5]; }
        inline DOMAIN_SIZE_Type indirectOffset_7D ( int i ) const APP_RESTRICT_MACRO
           { return offset(computeSubscript(0,i), computeSubscript(1,i),
                           computeSubscript(2,i), computeSubscript(3,i),
                           computeSubscript(4,i), computeSubscript(5,i),
        ...
        inline DOMAIN_SIZE_Type offset(int i, int j, int k, int l, int m, int n, int o, int p) const APP_RESTRICT_MACRO
           { return offset(i,j,k,l,m,n,o) + p * Stride[7] * Size[6]; }
        inline DOMAIN_SIZE_Type offset0(int i, int j, int k, int l, int m, int n, int o, int p) const APP_RESTRICT_MACRO
        // { return offset0(i,j,k,l,m,n,o) + (Base[7] + p * Stride[7]) * Size[6]; }
           { return offset0(i,j,k,l,m,n,o) + p * Stride[7] * Size[6] + Base[7] * Size[6]; }
        inline DOMAIN_SIZE_Type indirectOffset_8D ( int i ) const APP_RESTRICT_MACRO
           { return offset(computeSubscript(0,i), computeSubscript(1,i),
                           computeSubscript(2,i), computeSubscript(3,i),
                           computeSubscript(4,i), computeSubscript(5,i),
