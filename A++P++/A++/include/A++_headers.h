...
typedef int bool;
#else
// *wdh* BOOL_IS_BROKEN is not defined here 
#ifdef __sun
#ifndef _BOOL
typedef int bool;
#endif
...
// This is a simpler test and it avoids warnings generated 
// from the expanded form of the macro with ROSE
#define APP_ASSERT(f) \
     if(!(f)) \
          APP_Assertion_Support (__FILE__,__LINE__)
#endif
#if 0
// Bugfix (2/18/2001) Old macro
#define APP_ASSERT(f) \
     if(f)            \
          (void)NULL;       \
     else             \
