...
// IBM xlC requires that friend functions be declared in the scope where they are 
// used (declaration as a friend function in a class definition is not enough).
char* APP_version();

#if defined(PPP)
// IBM xlC requires a forward declaration here even 
// though it is declared a a friend function in the class
// P++ support for reduction operations
void Reduction_Operation ( int Input_Function, double & x );
void Reduction_Operation ( int Input_Function, float & x );
void Reduction_Operation ( int Input_Function, int & x );
#endif
...
// elif defined(APP)
    ...
    //! This function is called in lazy_operand.C!
        doubleArray ( const double* Array_Data_Pointer,
	   Array_Descriptor_Type<double,MAX_ARRAY_DIMENSION>* Array_Descriptor_Pointer,
           Operand_Storage* Array_Storage_Pointer );
#endif
#endif
...
// elif defined(APP)
    ...
    //! This function is called in lazy_operand.C!
        floatArray ( const float* Array_Data_Pointer,
	   Array_Descriptor_Type<float,MAX_ARRAY_DIMENSION>* Array_Descriptor_Pointer,
           Operand_Storage* Array_Storage_Pointer );
#endif
#endif
...
// elif defined(APP)
    ...
    //! This function is called in lazy_operand.C!
        intArray ( const int* Array_Data_Pointer,
	   Array_Descriptor_Type<int,MAX_ARRAY_DIMENSION>* Array_Descriptor_Pointer,
           Operand_Storage* Array_Storage_Pointer );
#endif
#endif
