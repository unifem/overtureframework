...
// I don't think we need these shape access functions! WE DO!
  ...
  inline bool InArray<double>::usesIndirectAddressing() const APP_RESTRICT_MACRO
     {
#if COMPILE_DEBUG_STATEMENTS
  ...
  inline bool InArray<double>::containsArrayID ( int lhs_id ) const APP_RESTRICT_MACRO
     {
...
// We don't need these functions!
  inline bool doubleArray::usesIndirectAddressing() const
     {
       printf ("Inside of doubleArray::usesIndirectAddressing() \n");
       return FALSE;
     }

  inline bool doubleArray::containsArrayID ( int lhs_id ) const
     {
...
// I don't think we need these shape access functions! WE DO!
  ...
  inline bool InArray<float>::usesIndirectAddressing() const APP_RESTRICT_MACRO
     {
#if COMPILE_DEBUG_STATEMENTS
  ...
  inline bool InArray<float>::containsArrayID ( int lhs_id ) const APP_RESTRICT_MACRO
     {
    // Used to check for loop dependence
#if COMPILE_DEBUG_STATEMENTS
    // APP_ASSERT (floatArrayPointer != NULL);
...
#if 0
// We don't need these functions!
  inline bool floatArray::usesIndirectAddressing() const
     {
       printf ("Inside of floatArray::usesIndirectAddressing() \n");
       return FALSE;
     }

  inline bool floatArray::containsArrayID ( int lhs_id ) const
     {
    // Used to check for loop dependence Array member function always returns FALSE.
    // This function MUST return false since it makes nosense for the Lhs to
    // have a loop dependence on the lhs this function is only used when there is no
...
// I don't think we need these shape access functions! WE DO!
  ...
  inline bool InArray<int>::usesIndirectAddressing() const APP_RESTRICT_MACRO
     {
#if COMPILE_DEBUG_STATEMENTS
  ...
  inline bool InArray<int>::containsArrayID ( int lhs_id ) const APP_RESTRICT_MACRO
     {
    // Used to check for loop dependence
#if COMPILE_DEBUG_STATEMENTS
    // APP_ASSERT (intArrayPointer != NULL);
...
#if 0
// We don't need these functions!
  inline bool intArray::usesIndirectAddressing() const
     {
       printf ("Inside of intArray::usesIndirectAddressing() \n");
       return FALSE;
     }

  inline bool intArray::containsArrayID ( int lhs_id ) const
     {
    // Used to check for loop dependence Array member function always returns FALSE.
    // This function MUST return false since it makes nosense for the Lhs to
    // have a loop dependence on the lhs this function is only used when there is no
          ...
          // The NULL Array has dimension of ZERO.  Operations on such arrays have no effect.
             ...
             if (Where_Statement_Support::Where_Statement_Mask == NULL)
               ...
               // printf ("Rhs. usesIndirectAddressing() = %s \n",Rhs. usesIndirectAddressing() ? "TRUE" : "FALSE");
                  ...
                  bool Lhs_usesIndirectAddressing = usesIndirectAddressing();
                  bool Rhs_usesIndirectAddressing = Rhs. usesIndirectAddressing();
          ...
          // The NULL Array has dimension of ZERO.  Operations on such arrays have no effect.
             ...
             if (Where_Statement_Support::Where_Statement_Mask == NULL)
               ...
               // printf ("X.usesIndirectAddressing() = %s \n",X.usesIndirectAddressing() ? "TRUE" : "FALSE");
                  ...
                  bool Lhs_usesIndirectAddressing = X.usesIndirectAddressing();
                  bool Rhs_usesIndirectAddressing = X.usesIndirectAddressing();
               // Allow for extra operand (useful for the replace function)
                  bool Extra_Operand = FALSE;
