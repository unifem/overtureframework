...
/*
  (DQ (1/2/2002): This should not be required since PARTI_ENABLE_MP_INTERFACE_MPI
  is defined in port.h (at base of this header files)
...
/* wdh* add void to make a strict prototype */
void remove_exch_scheds(void);
/* wdh* add void to make a strict prototype */
void remove_subarray_scheds(void);
...
/* DQ (1/2/2002): Trying to use PARTI_ENABLE_MP_INTERFACE_MPI macro only in port.h for simplicity. */
#if 0
