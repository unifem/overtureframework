...
main(int argc, char** argv)
  ...
  // Bugfix (12/10/2000) Must trap out case of serialArray being a NullArray 
  // object since this will trigger a scalar out of bounds error
     if (lpr.isNullArray() == FALSE)
        {
