...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_i_BIT_OR_Array_BitwiseOR_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_OR_Array_BitwiseOR_Scalar \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_OR_Scalar_BitwiseOR_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_OR_Scalar_BitwiseOR_Array_Accumulate_To_Operand \n");
#endif
