...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_i_BIT_XOR_Array_BitwiseXOR_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_XOR_Array_BitwiseXOR_Scalar \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_XOR_Scalar_BitwiseXOR_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_XOR_Scalar_BitwiseXOR_Array_Accumulate_To_Operand \n");
#endif
