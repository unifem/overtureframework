...
/*
   ...
   Previous definition: define(MDI_ceil,(int) (i+1))
...
#ifndef INTARRAY
/* Unary_Array_Operation(i_Ceil,ceil,int) */
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_Ceil_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_Ceil_Array_Accumulate_To_Operand \n");
#endif
