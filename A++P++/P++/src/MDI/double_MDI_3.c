...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_If_Array_Use_Array \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Lhs[Address_Lhs]) Result[Address_Result] = Rhs[Address_Rhs];
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) if (Lhs[Address_Lhs]) Result[Address_Result] = Rhs[Address_Rhs];
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer[i3]) if (Lhs[i1]) Result [i0] = Rhs[i2];
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_If_Array_Use_Scalar \n");
#endif
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Lhs[Address_Lhs]) Result[Address_Result] = x;
                      /* for (nd=1;nd<MAXDIMS;nd++)*/
                         for (nd=0;nd<MAXDIMS;nd++)
                            {
#if MDI_DEBUG
                    ...
                    for (nd=1;nd<MAXDIMS;nd++)
                       {
                         ...
                         if (Mask_Array_Pointer[Address_Mask]) if (Lhs[Address_Lhs]) Result[Address_Result] = x;
               ...
               for (i1  = Lo_Lhs_I; i1 <= Hi_Lhs_I; i1 += Stride_Lhs_I)
                  {
                    ...
                    if (Mask_Array_Pointer [i3]) if (Lhs[i1]) Result [i0] = x;
...
void MDI_d_If_Scalar_Use_Array
          ( double *Result , double *Rhs , int x ,
            ...
            array_domain *Mask_Descriptor )
   {
  /* We can simplify this case by just doing the assignment directly! 
     This function is exactly like an if conditional for Array = Array 
     it is provide to fulfill the symetry on the replace operator.
   */

#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_d_If_Scalar_Use_Array \n");
#endif

     if (x)
          MDI_d_Assign_Array_Equals_Array_Accumulate_To_Operand
               ( Result , Rhs , Mask_Array_Pointer , 
                 Descriptor , Rhs_Descriptor , Mask_Descriptor );
   }
