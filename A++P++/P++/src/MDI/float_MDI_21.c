...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_f_GT_Array_GT_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_GT_Array_GT_Scalar \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_GT_Scalar_GT_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_GT_Scalar_GT_Array_Accumulate_To_Operand \n");
#endif
