...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_d_EQ_Array_EQ_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_EQ_Array_EQ_Scalar \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_EQ_Scalar_EQ_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_EQ_Scalar_EQ_Array_Accumulate_To_Operand \n");
#endif
