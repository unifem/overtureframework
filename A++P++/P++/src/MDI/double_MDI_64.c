...
void MDI_d_Array_convertTo_floatArray_Array_Accumulate_To_Operand 
          ( float *Lhs , double *Rhs , int *Mask_Array_Pointer ,
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_d_Array_convertTo_floatArray_Array_Accumulate_To_Operand \n");
#endif
...
void MDI_d_Array_convertTo_floatArray_Scalar_Accumulate_To_Operand
          ( float *Lhs , double x , int *Mask_Array_Pointer ,
            array_domain *Lhs_Descriptor , 
            array_domain *Mask_Descriptor )
   {
     /*--------------------------------------------------------*/
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_Array_convertTo_floatArray_Scalar_Accumulate_To_Operand \n");
#endif
