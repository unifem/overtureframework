...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_d_GTEQ_Array_GTEQ_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_GTEQ_Array_GTEQ_Scalar \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_GTEQ_Scalar_GTEQ_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_GTEQ_Scalar_GTEQ_Array_Accumulate_To_Operand \n");
#endif
