...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_i_BIT_AND_Array_BitwiseAND_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_AND_Array_BitwiseAND_Scalar \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_AND_Scalar_BitwiseAND_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_BIT_AND_Scalar_BitwiseAND_Array_Accumulate_To_Operand \n");
#endif
