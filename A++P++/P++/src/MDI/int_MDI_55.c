...
/* 
   ...
   define(MDI_sign,((i)<0 && (int)>=0) || ((i)>=0 && (int)<0) ? -(int) : (int) )
 */
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_i_Sign_Array_Of_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_Sign_Array_Of_Scalar \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_i_Sign_Scalar_Of_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_Sign_Scalar_Of_Array_Accumulate_To_Operand \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_Sign_Array_Of_Array_Accumulate_To_Operand \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_Sign_Array_Of_Scalar_Accumulate_To_Operand \n");
#endif
