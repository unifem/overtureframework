...
/*
   ...
   Previous definition: define(MDI_floor,(int) d)
...
#ifndef INTARRAY
/* Unary_Array_Operation(d_Floor,floor,double) */
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_Floor_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_d_Floor_Array_Accumulate_To_Operand \n");
#endif
