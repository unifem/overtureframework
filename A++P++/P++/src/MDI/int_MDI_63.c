...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
        printf ("Inside of MDI_i_Array_convertTo_intArray_Array_Accumulate_To_Operand \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_i_Array_convertTo_intArray_Scalar_Accumulate_To_Operand \n");
#endif
