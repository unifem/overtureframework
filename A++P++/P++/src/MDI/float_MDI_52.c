...
/*
   ...
   Previous definition: define(MDI_floor,(int) f)
...
#ifndef INTARRAY
/* Unary_Array_Operation(f_Floor,floor,float) */
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Floor_Array \n");
#endif
...
#if MDI_DEBUG
     if (APP_DEBUG > 0)
          printf ("Inside of MDI_f_Floor_Array_Accumulate_To_Operand \n");
#endif
