...
/* Array_Descriptors_for_Index_Operators(,Serial) */

doubleSerialArray doubleSerialArray::operator() () const
{
#if COMPILE_DEBUG_STATEMENTS
   if (APP_DEBUG > FILE_LEVEL_DEBUG)
      printf ("Inside of doubleSerialArray::operator()! \n");
#endif
   ...
   printf ("ERROR: doubleSerialArray::operator()() not supported in P++ yet! \n");
   APP_ABORT();
   return *this;
#else
...
// SerialArray_Descriptor_Type<double,MAX_ARRAY_DIMENSION>* Vectorized_Descriptor_Pointer = 
//    SerialArray_Descriptor_Type<double,MAX_ARRAY_DIMENSION>::Vectorizing_Descriptor (Array_Descriptor);
   SerialArray_Domain_Type* Vectorized_Domain_Pointer = 
      SerialArray_Domain_Type::Vectorizing_Domain (Array_Descriptor.Array_Domain);
     
   return doubleSerialArray ( New_Data_Pointer , Vectorized_Domain_Pointer );
#endif
}
...
doubleSerialArray doubleSerialArray::operator() 
    ...
    Index_Pointer_List ) const
{
   ...
   // Start of macro defining common part of all operator()
     ...
     if (APP_DEBUG > FILE_LEVEL_DEBUG)
        {
          printf ("Inside of doubleSerialArray::operator(Internal_Index*)! -- Array_ID = %d getRawDataReferenceCount() = %d \n",
                   Array_ID(),getRawDataReferenceCount() );
        }

     Test_Consistency ("In doubleSerialArray::operator() (Internal_Index*)");
#endif
  ...
  // and deallocation from the heap.
     ...
     return doubleSerialArray ( View, Array_Descriptor.Array_Domain, Index_Pointer_List );
  ...
  // Increment the reference count for the array data!
     ...
     Delete_Lhs_If_Temporary (*this);
     return doubleSerialArray ( Array_Descriptor.Array_Data , Array_Descriptor.Array_Domain, Index_Pointer_List );
...
//---------------------------------------------------------------
doubleSerialArray doubleSerialArray::operator() ( const Internal_Index & I ) const
{
   ...
   ( const Internal_Index & I , const Internal_Index & J ) const
{
   ...
   if (APP_DEBUG > FILE_LEVEL_DEBUG)
      printf 
	 ("Inside of doubleSerialArray::operator(Internal_Index,Internal_Index)! -- Array_ID = %d getRawDataReferenceCount() = %d \n",
          Array_ID(),getRawDataReferenceCount() );

   Test_Consistency ("In doubleSerialArray::operator() (Internal_Index,Internal_Index)");
#endif
     ...
     const Internal_Index & K ) const
{
   ...
   if (APP_DEBUG > FILE_LEVEL_DEBUG)
      printf 
	 ("Inside of doubleSerialArray::operator(Internal_Index,Internal_Index,Internal_Index)! -- Array_ID = %d getRawDataReferenceCount() = %d \n",
          Array_ID(),getRawDataReferenceCount() );

   Test_Consistency ("In doubleSerialArray::operator() (Internal_Index,Internal_Index,Internal_Index)");
#endif
     ...
     const Internal_Index & K , const Internal_Index & L ) const
{
   ...
   if (APP_DEBUG > FILE_LEVEL_DEBUG)
      printf 
	 ("Inside of doubleSerialArray::operator(Internal_Index,Internal_Index,Internal_Index,Internal_Index)! -- Array_ID = %d  getRawDataReferenceCount() = %d \n",
          Array_ID(),getRawDataReferenceCount() );

   Test_Consistency ("In doubleSerialArray::operator() (Internal_Index,Internal_Index,Internal_Index,Internal_Index)");
#endif
...
// ****************************************************************
// Index operators for intSerialArray objects (this provides indirect addressing and will
// be supported in the parallel P++ using work from Joel Saltz).  Maybe or maybe not!
// ****************************************************************

//---------------------------------------------------------------
doubleSerialArray doubleSerialArray::operator() ( const Internal_Indirect_Addressing_Index & I ) const
{
  ...
  // Set the remaining higher dimensional pointers to NULL
  ...
  // return doubleSerialArray ( View , Parallel_Descriptor );
     return doubleSerialArray ( View , Array_Descriptor.Array_Domain, Indirect_Index_Pointer_List);
#else
  ...
  // return doubleSerialArray ( Array_Descriptor.Array_Data ,  
  //      new SerialArray_Descriptor_Type<double,MAX_ARRAY_DIMENSION> (Array_Descriptor, Indirect_Index_Pointer_List) );
  // return doubleSerialArray ( Array_Descriptor.Array_Data ,  
  //      new SerialArray_Domain_Type (Array_Descriptor.Array_Domain, Indirect_Index_Pointer_List) );
   return doubleSerialArray ( Array_Descriptor.Array_Data, Array_Descriptor.Array_Domain, Indirect_Index_Pointer_List );
#endif
;
}
//---------------------------------------------------------------
...
#if MAX_ARRAY_DIMENSION >=2
doubleSerialArray doubleSerialArray::operator() ( const Internal_Indirect_Addressing_Index & I , 
...
floatSerialArray floatSerialArray::operator() () const
{
#if COMPILE_DEBUG_STATEMENTS
   if (APP_DEBUG > FILE_LEVEL_DEBUG)
      printf ("Inside of floatSerialArray::operator()! \n");
#endif
   ...
   // a 1D array and so this step would be complicated (and inefficient as well). 
   // More thought about this function is required before implementation for P++. 
   printf ("ERROR: floatSerialArray::operator()() not supported in P++ yet! \n");
   APP_ABORT();
   return *this;
#else
...
// SerialArray_Descriptor_Type<float,MAX_ARRAY_DIMENSION>* Vectorized_Descriptor_Pointer = 
//    SerialArray_Descriptor_Type<float,MAX_ARRAY_DIMENSION>::Vectorizing_Descriptor (Array_Descriptor);
   SerialArray_Domain_Type* Vectorized_Domain_Pointer = 
      SerialArray_Domain_Type::Vectorizing_Domain (Array_Descriptor.Array_Domain);
     
   return floatSerialArray ( New_Data_Pointer , Vectorized_Domain_Pointer );
#endif
}
...
// This function takes an array of pointers to Internal_Index objects
floatSerialArray floatSerialArray::operator() 
   (const Index_Pointer_Array_MAX_ARRAY_DIMENSION_Type 
    Index_Pointer_List ) const
{
   int i = 0;
   // Start of macro defining common part of all operator()
     ...
     if (APP_DEBUG > FILE_LEVEL_DEBUG)
        {
          printf ("Inside of floatSerialArray::operator(Internal_Index*)! -- Array_ID = %d getRawDataReferenceCount() = %d \n",
                   Array_ID(),getRawDataReferenceCount() );
        }

     Test_Consistency ("In floatSerialArray::operator() (Internal_Index*)");
#endif
  ...
  // and deallocation from the heap.
     ...
     return floatSerialArray ( View, Array_Descriptor.Array_Domain, Index_Pointer_List );
  ...
  // Increment the reference count for the array data!
     ...
     Delete_Lhs_If_Temporary (*this);
     return floatSerialArray ( Array_Descriptor.Array_Data , Array_Descriptor.Array_Domain, Index_Pointer_List );
...
//---------------------------------------------------------------
floatSerialArray floatSerialArray::operator() ( const Internal_Index & I ) const
{
// For the expression template version we want to avoid building a
// descriptor object and then passing it to an array object constructor
// and recopied within that constructor.  So the operator() should be 
   ...
   ( const Internal_Index & I , const Internal_Index & J ) const
{
   ...
   if (APP_DEBUG > FILE_LEVEL_DEBUG)
      printf 
	 ("Inside of floatSerialArray::operator(Internal_Index,Internal_Index)! -- Array_ID = %d getRawDataReferenceCount() = %d \n",
          Array_ID(),getRawDataReferenceCount() );

   Test_Consistency ("In floatSerialArray::operator() (Internal_Index,Internal_Index)");
#endif
     ...
     const Internal_Index & K ) const
{
   ...
   if (APP_DEBUG > FILE_LEVEL_DEBUG)
      printf 
	 ("Inside of floatSerialArray::operator(Internal_Index,Internal_Index,Internal_Index)! -- Array_ID = %d getRawDataReferenceCount() = %d \n",
          Array_ID(),getRawDataReferenceCount() );

   Test_Consistency ("In floatSerialArray::operator() (Internal_Index,Internal_Index,Internal_Index)");
#endif
     ...
     const Internal_Index & K , const Internal_Index & L ) const
{
   ...
   if (APP_DEBUG > FILE_LEVEL_DEBUG)
      printf 
	 ("Inside of floatSerialArray::operator(Internal_Index,Internal_Index,Internal_Index,Internal_Index)! -- Array_ID = %d  getRawDataReferenceCount() = %d \n",
          Array_ID(),getRawDataReferenceCount() );

   Test_Consistency ("In floatSerialArray::operator() (Internal_Index,Internal_Index,Internal_Index,Internal_Index)");
#endif
...
//---------------------------------------------------------------
floatSerialArray floatSerialArray::operator() ( const Internal_Indirect_Addressing_Index & I ) const
{
   ...
   */
     ...
     Delete_Lhs_If_Temporary (*this);
  // WARNING: Parallel_Descriptor constructed twice
  // return floatSerialArray ( View , Parallel_Descriptor );
     return floatSerialArray ( View , Array_Descriptor.Array_Domain, Indirect_Index_Pointer_List);
#else
  // Bugfix (8/31/95) this fixes a memory leak in P++ this line should only
  // be executed in A++ and the Serial_A++ classes.  It was previously executed in 
  // P++ as well.  
  ...
  // printf ("Delete_Lhs_If_Temporary in operator()(intArray) \n");
     Delete_Lhs_If_Temporary (*this);
  // printf ("DONE: Delete_Lhs_If_Temporary in operator()(intArray) \n");
  // return floatSerialArray ( Array_Descriptor.Array_Data ,  
  //      new SerialArray_Descriptor_Type<float,MAX_ARRAY_DIMENSION> (Array_Descriptor, Indirect_Index_Pointer_List) );
  // return floatSerialArray ( Array_Descriptor.Array_Data ,  
  //      new SerialArray_Domain_Type (Array_Descriptor.Array_Domain, Indirect_Index_Pointer_List) );
   return floatSerialArray ( Array_Descriptor.Array_Data, Array_Descriptor.Array_Domain, Indirect_Index_Pointer_List );
#endif
;
}
//---------------------------------------------------------------
...
#if MAX_ARRAY_DIMENSION >=2
floatSerialArray floatSerialArray::operator() ( const Internal_Indirect_Addressing_Index & I , 
                                  const Internal_Indirect_Addressing_Index & J ) const
{
...
intSerialArray intSerialArray::operator() () const
{
#if COMPILE_DEBUG_STATEMENTS
   if (APP_DEBUG > FILE_LEVEL_DEBUG)
      printf ("Inside of intSerialArray::operator()! \n");
#endif
   ...
   // a 1D array and so this step would be complicated (and inefficient as well). 
   // More thought about this function is required before implementation for P++. 
   printf ("ERROR: intSerialArray::operator()() not supported in P++ yet! \n");
   APP_ABORT();
   return *this;
#else
...
// SerialArray_Descriptor_Type<int,MAX_ARRAY_DIMENSION>* Vectorized_Descriptor_Pointer = 
//    SerialArray_Descriptor_Type<int,MAX_ARRAY_DIMENSION>::Vectorizing_Descriptor (Array_Descriptor);
   SerialArray_Domain_Type* Vectorized_Domain_Pointer = 
      SerialArray_Domain_Type::Vectorizing_Domain (Array_Descriptor.Array_Domain);
     
   return intSerialArray ( New_Data_Pointer , Vectorized_Domain_Pointer );
#endif
}
...
// This function takes an array of pointers to Internal_Index objects
intSerialArray intSerialArray::operator() 
   (const Index_Pointer_Array_MAX_ARRAY_DIMENSION_Type 
    Index_Pointer_List ) const
{
   int i = 0;
   // Start of macro defining common part of all operator()
     ...
     if (APP_DEBUG > FILE_LEVEL_DEBUG)
        {
          printf ("Inside of intSerialArray::operator(Internal_Index*)! -- Array_ID = %d getRawDataReferenceCount() = %d \n",
                   Array_ID(),getRawDataReferenceCount() );
        }

     Test_Consistency ("In intSerialArray::operator() (Internal_Index*)");
#endif
  ...
  // and deallocation from the heap.
     ...
     return intSerialArray ( View, Array_Descriptor.Array_Domain, Index_Pointer_List );
  ...
  // Increment the reference count for the array data!
     ...
     Delete_Lhs_If_Temporary (*this);
     return intSerialArray ( Array_Descriptor.Array_Data , Array_Descriptor.Array_Domain, Index_Pointer_List );
...
//---------------------------------------------------------------
intSerialArray intSerialArray::operator() ( const Internal_Index & I ) const
{
// For the expression template version we want to avoid building a
// descriptor object and then passing it to an array object constructor
// and recopied within that constructor.  So the operator() should be 
   ...
   ( const Internal_Index & I , const Internal_Index & J ) const
{
   ...
   if (APP_DEBUG > FILE_LEVEL_DEBUG)
      printf 
	 ("Inside of intSerialArray::operator(Internal_Index,Internal_Index)! -- Array_ID = %d getRawDataReferenceCount() = %d \n",
          Array_ID(),getRawDataReferenceCount() );

   Test_Consistency ("In intSerialArray::operator() (Internal_Index,Internal_Index)");
#endif
     ...
     const Internal_Index & K ) const
{
   ...
   if (APP_DEBUG > FILE_LEVEL_DEBUG)
      printf 
	 ("Inside of intSerialArray::operator(Internal_Index,Internal_Index,Internal_Index)! -- Array_ID = %d getRawDataReferenceCount() = %d \n",
          Array_ID(),getRawDataReferenceCount() );

   Test_Consistency ("In intSerialArray::operator() (Internal_Index,Internal_Index,Internal_Index)");
#endif
     ...
     const Internal_Index & K , const Internal_Index & L ) const
{
   ...
   if (APP_DEBUG > FILE_LEVEL_DEBUG)
      printf 
	 ("Inside of intSerialArray::operator(Internal_Index,Internal_Index,Internal_Index,Internal_Index)! -- Array_ID = %d  getRawDataReferenceCount() = %d \n",
          Array_ID(),getRawDataReferenceCount() );

   Test_Consistency ("In intSerialArray::operator() (Internal_Index,Internal_Index,Internal_Index,Internal_Index)");
#endif
...
//---------------------------------------------------------------
intSerialArray intSerialArray::operator() ( const Internal_Indirect_Addressing_Index & I ) const
{
   ...
   */
     ...
     Delete_Lhs_If_Temporary (*this);
  // WARNING: Parallel_Descriptor constructed twice
  // return intSerialArray ( View , Parallel_Descriptor );
     return intSerialArray ( View , Array_Descriptor.Array_Domain, Indirect_Index_Pointer_List);
#else
  // Bugfix (8/31/95) this fixes a memory leak in P++ this line should only
  // be executed in A++ and the Serial_A++ classes.  It was previously executed in 
  // P++ as well.  
  ...
  // printf ("Delete_Lhs_If_Temporary in operator()(intArray) \n");
     Delete_Lhs_If_Temporary (*this);
  // printf ("DONE: Delete_Lhs_If_Temporary in operator()(intArray) \n");
  // return intSerialArray ( Array_Descriptor.Array_Data ,  
  //      new SerialArray_Descriptor_Type<int,MAX_ARRAY_DIMENSION> (Array_Descriptor, Indirect_Index_Pointer_List) );
  // return intSerialArray ( Array_Descriptor.Array_Data ,  
  //      new SerialArray_Domain_Type (Array_Descriptor.Array_Domain, Indirect_Index_Pointer_List) );
   return intSerialArray ( Array_Descriptor.Array_Data, Array_Descriptor.Array_Domain, Indirect_Index_Pointer_List );
#endif
;
}
//---------------------------------------------------------------
...
#if MAX_ARRAY_DIMENSION >=2
intSerialArray intSerialArray::operator() ( const Internal_Indirect_Addressing_Index & I , 
                                  const Internal_Indirect_Addressing_Index & J ) const
{
