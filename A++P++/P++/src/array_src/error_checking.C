...
void SerialArray_Descriptor_Type::Error_Checking_For_Index_Operators (
  ...
  // if the user specifies runtime bounds checking!
     ...
     if (APP_DEBUG > 0)
          printf ("Inside of SerialArray_Descriptor_Type::Error_Checking_For_Index_Operators \n");
#endif
...
#if COMPILE_DEBUG_STATEMENTS
     if (APP_DEBUG > 3)
          printf ("Leaving SerialArray_Descriptor_Type::Error_Checking_For_Index_Operators! \n");
#endif
   }
...
void SerialArray_Descriptor_Type::Error_Checking_For_Index_Operators (
...
#if COMPILE_DEBUG_STATEMENTS
     if (APP_DEBUG > 0)
          printf ("Inside of SerialArray_Descriptor_Type::Error_Checking_For_Index_Operators(Indirect_Index_List) \n");
#endif
 ...
 // Optionally turn off the bounds checking since it adds to the output when debugging!
  ...
  // The fix is to use *Parm0_int instead of *Parm0_int+Data_Base[0] along all axes.
     ...
     for (i=0; i < MAX_ARRAY_DIMENSION; i++)
          if (intArrayList[i] != NULL)
               intArrayList[i]->Test_Consistency("SerialArray_Descriptor_Type::Error_Checking_For_Index_Operators (intArrayList[i])");
#endif
...
void SerialArray_Descriptor_Type::Error_Checking_For_Scalar_Index_Operators ( 
