...
bool doubleSerialArray_Data_Hash_Table::USE_HASH_TABLE_FOR_ARRAY_DATA_STORAGE = FALSE;
int doubleSerialArray_Data_Hash_Table::Hash_Table_Hits   = 0;
int doubleSerialArray_Data_Hash_Table::Hash_Table_Misses = 0;

doubleSerialArray_Data_Hash_Table::~doubleSerialArray_Data_Hash_Table()
   {
   }
...
doubleSerialArray_Data_Hash_Table::doubleSerialArray_Data_Hash_Table()
   {
     if (APP_DEBUG > 0)
          printf ("Initialize the doubleSerialArray_Data_hash table! \n");
...
double* doubleSerialArray_Data_Hash_Table::Get_Primative_Array ( int Size )
   {
     int Key                        = Size;
...
void doubleSerialArray_Data_Hash_Table::Put_Primative_Array_Into_Storage ( double* Memory_To_Store, int Size )
   {
     int Key = Size;
     int Hash_Table_Key = Key % Number_Of_Buckets;
     int Index = -1;
...
bool floatSerialArray_Data_Hash_Table::USE_HASH_TABLE_FOR_ARRAY_DATA_STORAGE = FALSE;
int floatSerialArray_Data_Hash_Table::Hash_Table_Hits   = 0;
int floatSerialArray_Data_Hash_Table::Hash_Table_Misses = 0;

floatSerialArray_Data_Hash_Table::~floatSerialArray_Data_Hash_Table()
   {
   }
...
floatSerialArray_Data_Hash_Table::floatSerialArray_Data_Hash_Table()
   {
     if (APP_DEBUG > 0)
          printf ("Initialize the floatSerialArray_Data_hash table! \n");
...
float* floatSerialArray_Data_Hash_Table::Get_Primative_Array ( int Size )
   {
     int Key                        = Size;
     int Hash_Table_Key             = Key % Number_Of_Buckets;
     int Index                      = -1;
...
void floatSerialArray_Data_Hash_Table::Put_Primative_Array_Into_Storage ( float* Memory_To_Store, int Size )
   {
     int Key = Size;
     int Hash_Table_Key = Key % Number_Of_Buckets;
     int Index = -1;
...
bool intSerialArray_Data_Hash_Table::USE_HASH_TABLE_FOR_ARRAY_DATA_STORAGE = FALSE;
int intSerialArray_Data_Hash_Table::Hash_Table_Hits   = 0;
int intSerialArray_Data_Hash_Table::Hash_Table_Misses = 0;

intSerialArray_Data_Hash_Table::~intSerialArray_Data_Hash_Table()
   {
   }
...
intSerialArray_Data_Hash_Table::intSerialArray_Data_Hash_Table()
   {
     if (APP_DEBUG > 0)
          printf ("Initialize the intSerialArray_Data_hash table! \n");
...
int* intSerialArray_Data_Hash_Table::Get_Primative_Array ( int Size )
   {
     int Key                        = Size;
     int Hash_Table_Key             = Key % Number_Of_Buckets;
     int Index                      = -1;
...
void intSerialArray_Data_Hash_Table::Put_Primative_Array_Into_Storage ( int* Memory_To_Store, int Size )
   {
     int Key = Size;
     int Hash_Table_Key = Key % Number_Of_Buckets;
     int Index = -1;
