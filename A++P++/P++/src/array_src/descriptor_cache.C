...
SerialArray_Descriptor_Type** SerialArray_Descriptor_Type::Descriptor_0D_Cache             = NULL;
Descriptor_1D_Cache_Type* SerialArray_Descriptor_Type::Descriptor_1D_Cache             = NULL;
Descriptor_2D_Cache_Type* SerialArray_Descriptor_Type::Descriptor_2D_Cache             = NULL;

// Will be supported later!
// SerialArray_Descriptor_Type*********** SerialArray_Descriptor_Type::Descriptor_3D_Cache    = NULL;
// SerialArray_Descriptor_Type************** SerialArray_Descriptor_Type::Descriptor_4D_Cache = NULL;

// typedef SerialArray_Descriptor_Type*    Size_Pointers_Type        [SIZE_2D_HASH_TABLE_LENGTH]
...
void SerialArray_Descriptor_Type::Put_Descriptor_Into_Cache ( SerialArray_Descriptor_Type* & X )
   {
     int i = 0;
     int j = 0;
     SerialArray_Descriptor_Type* Temp = NULL;

#if COMPILE_DEBUG_STATEMENTS
     if (APP_DEBUG > 1)
          printf ("Inside of SerialArray_Descriptor_Type::Put_Descriptor_Into_Cache(X) \n");
#endif
          ...
          if (X->Constant_Data_Base)
            ...
            // are required).
               if (Descriptor_0D_Cache == NULL)
                  {
                 // Descriptor_0D_Cache = new (SerialArray_Descriptor_Type**) [DATA_BASE_HASH_TABLE_LENGTH];
                    Descriptor_0D_Cache = (SerialArray_Descriptor_Type**) malloc ( DATA_BASE_HASH_TABLE_LENGTH * sizeof (SerialArray_Descriptor_Type**) );
               ...
               if ( X->Constant_Data_Base && X->Constant_Unit_Stride && X->Stride[0] == 1)
                  {
                    ...
                    if (Descriptor_1D_Cache == NULL)
                       {
                      // Descriptor_1D_Cache = new (SerialArray_Descriptor_Type*****) [DATA_BASE_HASH_TABLE_LENGTH];
                    ...
                    if ( (*Descriptor_1D_Cache)[Data_Base_Key] == NULL) 
                       {
                      // Descriptor_1D_Cache[Data_Base_Key] = new (SerialArray_Descriptor_Type****) [ACCESS_BASE_HASH_TABLE_LENGTH];
                    ...
                    if ( (*(*Descriptor_1D_Cache)[Data_Base_Key])[Access_Base_Key] == NULL) 
                       {
                      // Descriptor_1D_Cache[Data_Base_Key][Access_Base_Key] = new (SerialArray_Descriptor_Type***) [ACCESS_BOUND_HASH_TABLE_LENGTH];
                    ...
                    if ( (*(*(*Descriptor_1D_Cache)[Data_Base_Key])[Access_Base_Key])[Access_Bound_Key] == NULL) 
                       {
                      // Descriptor_1D_Cache[Data_Base_Key][Access_Base_Key][Access_Bound_Key] = new (SerialArray_Descriptor_Type**) [SIZE_HASH_TABLE_LENGTH];
                    ...
                    if (APP_DEBUG > 1)
                       {
                         ...
                         if (Descriptor_2D_Cache == NULL)
                            {
                           // Descriptor_2D_Cache = new (SerialArray_Descriptor_Type*) [DATA_BASE_HASH_TABLE_LENGTH];
                         ...
                         if ( (*Descriptor_2D_Cache)[Data_Base_Key] == NULL) 
                           ...
                           //      new (SerialArray_Descriptor_Type*) [ACCESS_BASE_2D_HASH_TABLE_LENGTH][ACCESS_BASE_2D_HASH_TABLE_LENGTH];
                         ...
                         if ( (*(*Descriptor_2D_Cache)[Data_Base_Key])[Access_Base_I_Key][Access_Base_J_Key] == NULL)
                           ...
                           //      new (SerialArray_Descriptor_Type*) [ACCESS_BOUND_2D_HASH_TABLE_LENGTH][ACCESS_BOUND_2D_HASH_TABLE_LENGTH];
                         ...
                         if ( (*(*(*Descriptor_2D_Cache)[Data_Base_Key])[Access_Base_I_Key][Access_Base_J_Key])[Access_Bound_I_Key][Access_Bound_J_Key] == NULL)
                            {
                           // printf ("Stage 3 \n");
                           // Descriptor_2D_Cache[Data_Base_Key][Access_Base_I_Key][Access_Base_J_Key][Access_Bound_I_Key][Access_Bound_J_Key] = new (SerialArray_Descriptor_Type*) [SIZE_2D_HASH_TABLE_LENGTH][SIZE_2D_HASH_TABLE_LENGTH];
...
SerialArray_Descriptor_Type *SerialArray_Descriptor_Type::Get_Descriptor_From_Cache ()
   {
     SerialArray_Descriptor_Type *Return_Descriptor = NULL;

#if COMPILE_DEBUG_STATEMENTS
     if (APP_DEBUG > 3)
          printf ("Inside of SerialArray_Descriptor_Type::Get_Descriptor_From_Cache() \n");
#endif
...
#endif
          Return_Descriptor = new SerialArray_Descriptor_Type ();
        }
...
SerialArray_Descriptor_Type *SerialArray_Descriptor_Type::Get_Descriptor_From_Cache ( const Internal_Index & I )
   {
     SerialArray_Descriptor_Type *Return_Descriptor = NULL;
  ...
  // Store descriptor in chain of lists (Data_Base, Access_Base, Length)
     ...
     APP_ABORT();
  // if (Return_Descriptor == NULL)
  //      Return_Descriptor = new SerialArray_Descriptor_Type ( *this , I );

     return Return_Descriptor;
   }

SerialArray_Descriptor_Type *SerialArray_Descriptor_Type::Get_Descriptor_From_Cache ( const Internal_Index & I , const Internal_Index & J )
   {
     SerialArray_Descriptor_Type *Return_Descriptor = NULL;
...
SerialArray_Descriptor_Type *SerialArray_Descriptor_Type::Get_Descriptor_From_Cache ( int i, int j, int k, int l )
   {
     SerialArray_Descriptor_Type *Return_Descriptor = NULL;

#if COMPILE_DEBUG_STATEMENTS
     if (APP_DEBUG > 1)
          printf ("Inside of SerialArray_Descriptor_Type::Get_Descriptor_From_Cache(%d,%d,%d,%d) \n",i,j,k,l);
#endif
...
#if COMPILE_DEBUG_STATEMENTS
          if (APP_DEBUG > 1)
               printf ("NOT FOUND in CACHE -- Call new SerialArray_Descriptor_Type (i,j,k,l) \n");
#endif
          Return_Descriptor = new SerialArray_Descriptor_Type (i,j,k,l);
        }
...
SerialArray_Descriptor_Type *SerialArray_Descriptor_Type::Get_Descriptor_From_Cache ( 
          const SerialArray_Descriptor_Type & X )
   {
     SerialArray_Descriptor_Type *Return_Descriptor = NULL;
     ...
     if (Return_Descriptor == NULL)
          Return_Descriptor = new SerialArray_Descriptor_Type (X);
