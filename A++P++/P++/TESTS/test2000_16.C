...
test_3D ( int maxIndexRadius, int size )
   {
     ...
     printf ("################ 1 Parameter Test ###################### \n");
     TEST_MACRO_1_PARAMETER(
          parallelX(Ix[0]+i[0],Ix[1]+i[1],Ix[2]+i[2]) = 1,
          serialX  (Ix[0]+i[0],Ix[1]+i[1],Ix[2]+i[2]) = 1,
          "Passed 1 parameter test #%-3d of %d X(I + %-2d,I + %-2d,I + %-2d) = 1;")
     testCounter = 0;
     numberOfCases *= (int) pow(double(numberOfCasesPerParameter[2]),double(dimension));
     printf ("################ 2 Parameter Test ###################### \n");
     TEST_MACRO_2_PARAMETER(
          parallelX(Ix[0]+i[0],Ix[1]+i[1],Ix[2]+i[2]) = parallelY(Iy[0]+j[0],Iy[1]+j[1],Iy[2]+j[2]),
          serialX  (Ix[0]+i[0],Ix[1]+i[1],Ix[2]+i[2]) = serialY  (Iy[0]+j[0],Iy[1]+j[1],Iy[2]+j[2]),
          "Passed 2 parameter test #%-3d of %d X(I + %-2d,I + %-2d,I + %-2d) = Y(I + %-2d,I + %-2d,I + %-2d); ")

     testCounter = 0;
     numberOfCases *= (int) pow(double(numberOfCasesPerParameter[2]),double(dimension));
     TEST_MACRO_3_PARAMETER(
          parallelX(Ix[0]+i[0],Ix[1]+i[1],Ix[2]+i[2]) = parallelY(Iy[0]+j[0],Iy[1]+j[1],Iy[2]+j[2]) + parallelY(Iy[0]+k[0],Iy[1]+k[1],Iy[2]+k[2]),
          serialX  (Ix[0]+i[0],Ix[1]+i[1],Ix[1]+i[1]) = serialY  (Iy[0]+j[0],Iy[1]+j[1],Iy[2]+j[2]) + serialY  (Iy[0]+k[0],Iy[1]+k[1],Iy[2]+k[2]),
...
test_4D ( int maxIndexRadius, int size )
   {
     ...
     printf ("################ 1 Parameter Test ###################### \n");
     TEST_MACRO_1_PARAMETER(
          parallelX(Ix[0]+i[0],Ix[1]+i[1],Ix[2]+i[2],Ix[3]+i[3]) = 1,
          serialX  (Ix[0]+i[0],Ix[1]+i[1],Ix[2]+i[2],Ix[3]+i[3]) = 1,
     ...
     printf ("################ 2 Parameter Test ###################### \n");
     TEST_MACRO_2_PARAMETER(
          parallelX(Ix[0]+i[0],Ix[1]+i[1],Ix[2]+i[2],Ix[3]+i[3]) = parallelY(Iy[0]+j[0],Iy[1]+j[1],Iy[2]+j[2],Iy[3]+j[3]),
          serialX  (Ix[0]+i[0],Ix[1]+i[1],Ix[2]+i[2],Ix[3]+i[3]) = serialY  (Iy[0]+j[0],Iy[1]+j[1],Iy[2]+j[2],Iy[3]+j[3]),
          "Passed 2 parameter test #%-3d of %d X(I + %-2d,I + %-2d,I + %-2d,I + %-2d) = Y(I + %-2d,I + %-2d,I + %-2d,I + %-2d); ")

     testCounter = 0;
     numberOfCases *= (int) pow(double(numberOfCasesPerParameter[3]),double(dimension));
     TEST_MACRO_3_PARAMETER(
          parallelX(Ix[0]+i[0],Ix[1]+i[1],Ix[2]+i[2],Ix[3]+i[3]) = parallelY(Iy[0]+j[0],Iy[1]+j[1],Iy[2]+j[2],Iy[3]+j[3]) + parallelY(Iy[0]+k[0],Iy[1]+k[1],Iy[2]+k[2],Iy[3]+k[3]),
          serialX  (Ix[0]+i[0],Ix[1]+i[1],Ix[1]+i[1],Ix[3]+i[3]) = serialY  (Iy[0]+j[0],Iy[1]+j[1],Iy[2]+j[2],Iy[3]+j[3]) + serialY  (Iy[0]+k[0],Iy[1]+k[1],Iy[2]+k[2],Iy[3]+k[3]),
...
test_5D ( int maxIndexRadius, int size )
   {
     ...
     printf ("################ 1 Parameter Test ###################### \n");
     TEST_MACRO_1_PARAMETER(
          parallelX(Iy[0]+i[0],Iy[1]+i[1],Iy[2]+i[2],Iy[3]+i[3],Iy[4]+i[4]) = 1,
          serialX  (Iy[0]+i[0],Iy[1]+i[1],Iy[2]+i[2],Iy[3]+i[3],Iy[4]+i[4]) = 1,
          "Passed 1 parameter test #%-3d of %d X(I + %-2d,I + %-2d,I + %-2d,I + %-2d) = 1;")
     testCounter = 0;
     numberOfCases *= (int) pow(double(numberOfCasesPerParameter[4]),double(dimension));
     printf ("################ 2 Parameter Test ###################### \n");
     TEST_MACRO_2_PARAMETER(
          parallelX(Iy[0]+i[0],Iy[1]+i[1],Iy[2]+i[2],Iy[3]+i[3],Iy[4]+i[4]) = parallelY(Iy[0]+j[0],Iy[1]+j[1],Iy[2]+j[2],Iy[3]+j[3],Iy[4]+j[4]),
          serialX  (Iy[0]+i[0],Iy[1]+i[1],Iy[2]+i[2],Iy[3]+i[3],Iy[4]+i[4]) = serialY  (Iy[0]+j[0],Iy[1]+j[1],Iy[2]+j[2],Iy[3]+j[3],Iy[4]+j[4]),
          "Passed 2 parameter test #%-3d of %d X(I + %-2d,I + %-2d,I + %-2d,I + %-2d,I + %-2d) = Y(I + %-2d,I + %-2d,I + %-2d,I + %-2d,I + %-2d); ")

     testCounter = 0;
     numberOfCases *= (int) pow(double(numberOfCasesPerParameter[4]),double(dimension));
     TEST_MACRO_3_PARAMETER(
          parallelX(Iy[0]+i[0],Iy[1]+i[1],Iy[2]+i[2],Iy[3]+i[3],Iy[4]+i[4]) = parallelY(Iy[0]+j[0],Iy[1]+j[1],Iy[2]+j[2],Iy[3]+j[3],Iy[4]+j[4]) + parallelY(Iy[0]+k[0],Iy[1]+k[1],Iy[2]+k[2],Iy[3]+k[3],Iy[4]+k[4]),
          serialX  (Iy[0]+i[0],Iy[1]+i[1],Iy[1]+i[1],Iy[3]+i[3],Iy[4]+i[4]) = serialY  (Iy[0]+j[0],Iy[1]+j[1],Iy[2]+j[2],Iy[3]+j[3],Iy[4]+j[4]) + serialY  (Iy[0]+k[0],Iy[1]+k[1],Iy[2]+k[2],Iy[3]+k[3],Iy[4]+k[4]),
...
main(int argc, char** argv)
  ...
  Partitioning_Type::SpecifyDefaultInternalGhostBoundaryWidths(gb);
#endif
