...
// Forward declaration required for IBM xlC compiler
  ...
  // We have to support mixed operations so we need all three types that we support!
     ...
     public:
       ...
       // Note we use a virtual destructor!
          ...
          // *wdh* 100924 static void Catagorize_Operators ( char* String_Var , int Operation_Code_2 );
          static void Catagorize_Operators ( const char* String_Var , int Operation_Code_2 );
