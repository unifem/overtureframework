...
//==============================================================================
   ...
   DOMAIN_SIZE_Type Address_Subscript = 0;
   ...
   // ... need this too ...
   DOMAIN_SIZE_Type *Local_Size          = getSerialDomain().Size;
   DOMAIN_SIZE_Type *Local_Scalar_Offset = getSerialDomain().Scalar_Offset;
