...
\begin{enumerate}
  ...
  \item Install the command line tools in Xcode: 
    ...
    \end{verbatim}
    This command will ask you whether you want to install the command lines tools.
...
\begin{enumerate}
  ...
  \item Install A++ following the normal instructions but,  
    ...
    \end{verbatim}
  \item Install Overture and cg following the regular instructions.
\end{enumerate}

\clearpage
\section{Installing Overture on Mac OS/X -- *OLDER VERSIONS*}  
