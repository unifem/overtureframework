...
int
display( const doubleArray & x, const char *label, const char *format_, const Index *Iv /* =NULL*/ )
// =============================================================================
//   /Description:
...
int
display( const doubleArray & x, const char *label, const DisplayParameters & displayParameters, 
         const Index *Iv /* =NULL*/ )
// =============================================================================
//   /Description:
//      Another version of display -- pass a format but no FILE
...
#define PARALLEL_DISPLAY
  ...
  doubleArray xd;  xd.partition(partition); 
