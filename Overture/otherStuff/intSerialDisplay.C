...
// forward declaration: 
int
display( const intSerialArray & x, 
	 const char *label,
	 FILE *file,
	 const char *format_ ,
...
int
display( const intSerialArray & x, const char *label, const char *format_, const Index *Iv /* =NULL*/ )
// =============================================================================
//   /Description:
...
int
display( const intSerialArray & x, const char *label, const DisplayParameters & displayParameters, 
         const Index *Iv /* =NULL*/ )
// =============================================================================
//   /Description:
//      Another version of display -- pass a format but no FILE
...
int
display( const intSerialArray & x_, 
	 const char *label,
	 FILE *file,
	 const char *format_ ,
...
#undef PARALLEL_DISPLAY
  ...
  intSerialArray xd;  xd.partition(partition); 
  ...
  const intSerialArray & x = xd.getLocalArray(); // WithGhostBoundaries();
...
// dp.iFormat = dp.iFormat or dp.fFormat or dp.dformat
    const char *format = (format_!=NULL && strlen(format_)>0) ? format_ : (const char *)dp.iFormat;
