...
//		Default constructor
 ...
 ListOfMappedGridOperators::ListOfMappedGridOperators(){

#if DEBUGTEMPLATE
  theIDCount++;
  theID = theIDCount;
  cout << "ListOfMappedGridOperators default constructor called.  ";
  cout << "ListOfMappedGridOperators #" << theID << " created." << endl;
#endif
...
//		Copy constructor
 ...
 ListOfMappedGridOperators::ListOfMappedGridOperators(const ListOfMappedGridOperators &X){

#if DEBUGTEMPLATE			// Assign a unique ID from the
  theIDCount++;				// static counter.
  theID =theIDCount;
  cout << "ListOfMappedGridOperators copy constructor called.     ";
  ...
  aList = new MappedGridOperators* [listLength];		// Allocate pointer space.
  memAlloc = listLength;
...
#if DEBUGTEMPLATE
  cout << "ListOfMappedGridOperators destructor called.           ";
  cout << "ListOfMappedGridOperators #" << theID << " destroyed." << endl;
#endif
...
//		Class equal operator
 ...
 ListOfMappedGridOperators& ListOfMappedGridOperators::operator=(const ListOfMappedGridOperators &X){

#if DEBUGTEMPLATE
  cout << "ListOfMappedGridOperators = operator called.           ";
  cout << "ID " << X.theID <<" copied to " << theID << "." << endl;
#endif
  ...
  aList = new MappedGridOperators* [listLength];
  memAlloc = listLength;
...
/*
 void ListOfMappedGridOperators::Iterator(void (MappedGridOperators::*Function)()){
...
//		Add an object element to the list.
 ...
 void ListOfMappedGridOperators::addElement(MappedGridOperators &X){
  ...
  MappedGridOperators **aListTmp;

  aListTmp = new MappedGridOperators* [memAlloc];
 ...
 void ListOfMappedGridOperators::addElement(MappedGridOperators &X, int index){
...
//		Delete an element a location
 ...
 void ListOfMappedGridOperators::deleteElement(int index){
...
//		Delete an element with the same pointer
 ...
 void ListOfMappedGridOperators::deleteElement(MappedGridOperators &X){
...
//		Swap two elements for sorting among other things.
 ...
 void ListOfMappedGridOperators::swapElements(int i, int j){

  checkRange(i);
  checkRange(j);
    
  MappedGridOperators *tmp;
...
//		Set the list element at i to point to X.
 ...
 void ListOfMappedGridOperators::setElementPtr(MappedGridOperators *X, int index){
  checkRange(index);
  aList[index] = X;
}
...
//		Get an object element by reference (the cute way)
 ...
 MappedGridOperators& ListOfMappedGridOperators::operator[](int index) const{
  checkRange(index);  
  return *aList[index];
}
...
//		Get an object element by reference
 ...
 MappedGridOperators& ListOfMappedGridOperators::getElement(int index) const {
  checkRange(index);  
  return *aList[index];
}
...
//		Get an object element pointer
 ...
 MappedGridOperators *ListOfMappedGridOperators::getElementPtr(int index) const{
...
//		Deallocate the list memory and set length to zero.
 ...
 void ListOfMappedGridOperators::clean(){
  listLength = 0;
}

//		Deallocate the list memory and delete the objects.

 void ListOfMappedGridOperators::deepClean(){
  for(int i=0; i<listLength; i++)
    delete aList[i];
...
//		Internal range check routine
 ...
 void ListOfMappedGridOperators::
checkRange(int index) const{
  if(index < 0 || index > listLength - 1){
    cerr << "ListOfMappedGridOperators Index Out of Range!" << endl;
