#ifndef LISTOFFLOATARRAY_H
#define LISTOFFLOATARRAY_H "ListOfFloatArray.h"
// *wdh* for pgi: 110529
#ifdef __PGI
...
//==========================================================================
//	ListOfFloatArray Class Template
//
...
//
//     floatArray a(10),b(5);
//     ListOfFloatArray<floatArray> list,list2;
...
class ListOfFloatArray : public ReferenceCounting
{
  ...
  ListOfFloatArray(const ListOfFloatArray&, 
    const CopyType=DEEP  ); 

  ~ListOfFloatArray();			//   Destructor.
...
//
  virtual ReferenceCounting& operator=(const ReferenceCounting& x)
    { return operator=( (ListOfFloatArray &)x); }
  virtual void reference( const ReferenceCounting& x)
    { reference( (ListOfFloatArray &) x); }
  virtual ReferenceCounting* virtualConstructor( const CopyType ct = DEEP ) const
    { return ::new ListOfFloatArray(*this, ct); }
};
