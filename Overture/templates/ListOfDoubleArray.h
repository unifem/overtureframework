#ifndef LISTOFDOUBLEARRAY_H
#define LISTOFDOUBLEARRAY_H "ListOfDoubleArray.h"
// *wdh* for pgi: 110529
#ifdef __PGI
...
//==========================================================================
//	ListOfDoubleArray Class Template
//
...
//
//     floatArray a(10),b(5);
//     ListOfDoubleArray<floatArray> list,list2;
...
class ListOfDoubleArray : public ReferenceCounting
{
  ...
  ListOfDoubleArray(const ListOfDoubleArray&, 
    const CopyType=DEEP  ); 

  ~ListOfDoubleArray();			//   Destructor.
...
// private:
 public:
  int listLength() const
   ...
   {
     friend class ListOfDoubleArray;
     RCData(){ }     
     ~RCData(){ }
...
//
  virtual ReferenceCounting& operator=(const ReferenceCounting& x)
    { return operator=( (ListOfDoubleArray &)x); }
  virtual void reference( const ReferenceCounting& x)
    { reference( (ListOfDoubleArray &) x); }
  virtual ReferenceCounting* virtualConstructor( const CopyType ct = DEEP ) const
    { return ::new ListOfDoubleArray(*this, ct); }
};
