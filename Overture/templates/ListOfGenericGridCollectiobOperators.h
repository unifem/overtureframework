#ifndef LISTOFGENERICGRIDCOLLECTIOBOPERATORS_H
#define LISTOFGENERICGRIDCOLLECTIOBOPERATORS_H "ListOfGenericGridCollectiobOperators.h"
class GenericGridCollectionOperators;
//
//			ListOfGenericGridCollectiobOperators Class Template
//
...
class ListOfGenericGridCollectiobOperators{
  private:
...
#endif				//   int ListOfGenericGridCollectiobOperators<stuff>::theIDCount = 0;

				// Constructors/Destructors
    ListOfGenericGridCollectiobOperators();			//   Default constructor.
    ListOfGenericGridCollectiobOperators(const ListOfGenericGridCollectiobOperators&);		//   Copy constructor.
   ~ListOfGenericGridCollectiobOperators();			//   Destructor.
    
    ListOfGenericGridCollectiobOperators& operator=(const ListOfGenericGridCollectiobOperators&);	// Equal operator (only pointers of
					// list objects copied).

//  void Iterator( void (GenericGridCollectionOperators::*Function)());  // Function iterator.


			// ListOfGenericGridCollectiobOperators Management Functions
