...
! DEFECT_SUBROUTINE(defect3dOrder4,3,4)
        subroutine defect3dOrder4( nd, nd1a,nd1b,nd2a,nd2b,nd3a,nd3b, 
                ...
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3dSparse4(i1,i2,
     & i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
...
! loops(op3dSparse4l0)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3dSparse4l0(i1,i2,
     & i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
...
! loops(op3dSparse4l1)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3dSparse4l1(i1,i2,
     & i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
...
! loops(op3dSparse4l2)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3dSparse4l2(i1,i2,
     & i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
...
! loops(op3d4)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3d4(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op3d4l0)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3d4l0(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op3d4l1)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3d4l1(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op3d4l2)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3d4l2(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op3dCC4)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3dCC4(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op3dCC4l0)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3dCC4l0(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op3dCC4l1)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3dCC4l1(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op3dCC4l2)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3dCC4l2(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op3dSparseCC4)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3dSparseCC4(i1,i2,
     & i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
...
c  defect for line smooth in direction 0
! loops(op3dSparseCC4l0)
                if( defectOption.eq.0 )then
                  do i3=n3a,n3b,n3c
                  do i2=n2a,n2b,n2c
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3dSparseCC4l0(i1,
     & i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
...
c  defect for line smooth in direction 1
! loops(op3dSparseCC4l1)
                if( defectOption.eq.0 )then
                  do i3=n3a,n3b,n3c
                  do i2=n2a,n2b,n2c
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3dSparseCC4l1(i1,
     & i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
...
c  defect for line smooth in direction 2
! loops(op3dSparseCC4l2)
                if( defectOption.eq.0 )then
                  do i3=n3a,n3b,n3c
                  do i2=n2a,n2b,n2c
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op3dSparseCC4l2(i1,
     & i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
