...
if( defectOption.eq.0 )then
  ...
  do i1=n1a,n1b,n1c
    if( mask(i1,i2,i3).gt.0 )then
      defect(i1,i2,i3)=f(i1,i2,i3)-OP(i1,i2,i3)
    else
      defect(i1,i2,i3)=0.
    end if
  end do
...
#End
  ...
  write(*,*) 'defectOpt::nd=#ND'
  write(*,*) 'defectOpt::lineSmoothOption=',lineSmoothOption
  stop 
end if
#endMacro

c =============================================================
#beginMacro loops2dVC(OP)
do i3=n3a,n3b,n3c
  do i2=n2a,n2b,n2c
    do i1=n1a,n1b,n1c
      if( mask(i1,i2,i3).gt.0 )then
        ...
        ad=-(a1p+a1m+a2p+a2m)
        defect(i1,i2,i3)=f(i1,i2,i3)-OP(i1,i2,i3)
        ! write(*,*) 'defect: ',i1,i2,s(i1,i2,i3),a1p,a1m,a2p,a2m
      else
        defect(i1,i2,i3)=0.
      end if
    end do
...
#beginMacro DEFECT_SUBROUTINE(NAME,DIM,ORDER) 
...
! line smooth direction 1 
 ...
 op2dSparse(i1,i2,i3)= \
     ...
     c(m12,i1,i2,i3)*u(i1-1,i2  ,i3)+ \
     c(m21,i1,i2,i3)*u(i1  ,i2-1,i3)
 op2dSparsel0(i1,i2,i3)= \
     c(m23,i1,i2,i3)*u(i1  ,i2+1,i3)+ \
     c(m21,i1,i2,i3)*u(i1  ,i2-1,i3)
 op2dSparsel1(i1,i2,i3)= \
     c(m32,i1,i2,i3)*u(i1+1,i2  ,i3)+ \
     c(m12,i1,i2,i3)*u(i1-1,i2  ,i3) 
 op2dCC(i1,i2,i3)= \
 ...
 op2dCCl1(i1,i2,i3)= \
     ...
     cc(m13)*u(i1-1,i2+1,i3)+ \
     cc(m33)*u(i1+1,i2+1,i3)
 op2dSparseCC(i1,i2,i3)= \
     cc(m22)*u(i1  ,i2  ,i3)+ \
     cc(m32)*u(i1+1,i2  ,i3)+ \
     cc(m23)*u(i1  ,i2+1,i3)+ \
     cc(m12)*u(i1-1,i2  ,i3)+ \
     cc(m21)*u(i1  ,i2-1,i3)
 op2dSparseCCl0(i1,i2,i3)= \
     cc(m23)*u(i1  ,i2+1,i3)+ \
     cc(m21)*u(i1  ,i2-1,i3)
 op2dSparseCCl1(i1,i2,i3)= \
     cc(m32)*u(i1+1,i2  ,i3)+ \
     cc(m12)*u(i1-1,i2  ,i3) 
...
#If #DIM == "3"
 ...
 op3dSparse(i1,i2,i3)= \
                       ...
                       c(m232,i1,i2,i3)*u(i1  ,i2+1,i3  )+ \
                       c(m223,i1,i2,i3)*u(i1  ,i2  ,i3+1)
 op3dSparsel0(i1,i2,i3)= \
                       c(m221,i1,i2,i3)*u(i1  ,i2  ,i3-1)+ \
                       c(m212,i1,i2,i3)*u(i1  ,i2-1,i3  )+ \
                       c(m232,i1,i2,i3)*u(i1  ,i2+1,i3  )+ \
                       c(m223,i1,i2,i3)*u(i1  ,i2  ,i3+1)
 op3dSparsel1(i1,i2,i3)= \
                       c(m221,i1,i2,i3)*u(i1  ,i2  ,i3-1)+ \
                       c(m122,i1,i2,i3)*u(i1-1,i2  ,i3  )+ \
                       c(m322,i1,i2,i3)*u(i1+1,i2  ,i3  )+ \
                       c(m223,i1,i2,i3)*u(i1  ,i2  ,i3+1)
 op3dSparsel2(i1,i2,i3)= \
                       c(m212,i1,i2,i3)*u(i1  ,i2-1,i3  )+ \
                       c(m122,i1,i2,i3)*u(i1-1,i2  ,i3  )+ \
                       c(m322,i1,i2,i3)*u(i1+1,i2  ,i3  )+ \
                       c(m232,i1,i2,i3)*u(i1  ,i2+1,i3  ) 

 op3dSparseCC(i1,i2,i3) = \
 ...
 op3dSparseCCl0(i1,i2,i3) = \
     cc(m221)*u(i1  ,i2  ,i3-1)+ \
     cc(m212)*u(i1  ,i2-1,i3  )+ \
     cc(m232)*u(i1  ,i2+1,i3  )+ \
     cc(m223)*u(i1  ,i2  ,i3+1)
 op3dSparseCCl1(i1,i2,i3) = \
     cc(m221)*u(i1  ,i2  ,i3-1)+ \
     cc(m122)*u(i1-1,i2  ,i3  )+ \
     cc(m322)*u(i1+1,i2  ,i3  )+ \
     cc(m223)*u(i1  ,i2  ,i3+1)
 op3dSparseCCl2(i1,i2,i3) = \
     cc(m212)*u(i1  ,i2-1,i3  )+ \
     cc(m122)*u(i1-1,i2  ,i3  )+ \
     cc(m322)*u(i1+1,i2  ,i3  )+ \
     cc(m232)*u(i1  ,i2+1,i3  ) 
...
#If #DIM == "2"
 ...
 op2dSparseVCl0(i1,i2,i3)= \
     a2m*u(i1  ,i2-1,i3)+ \
      a2p*u(i1  ,i2+1,i3)

 op2dSparseVCl1(i1,i2,i3)= \
      a1m*u(i1-1,i2  ,i3)+ \
      a1p*u(i1+1,i2  ,i3) 

#End
#If #DIM == "3"
 op3dSparseVC(i1,i2,i3) = \
     a3m*u(i1  ,i2  ,i3-1)+ \
     a2m*u(i1  ,i2-1,i3  )+ \
     a1m*u(i1-1,i2  ,i3  )+ \
     ad*u(i1  ,i2  ,i3  )+ \
 ...
 op3dSparseVCl0(i1,i2,i3) = \
     a3m*u(i1  ,i2  ,i3-1)+ \
     a2m*u(i1  ,i2-1,i3  )+ \
     a2p*u(i1  ,i2+1,i3  )+ \
     a3p*u(i1  ,i2  ,i3+1)

 op3dSparseVCl1(i1,i2,i3) = \
     a3m*u(i1  ,i2  ,i3-1)+ \
     a1m*u(i1-1,i2  ,i3  )+ \
     a1p*u(i1+1,i2  ,i3  )+ \
     a3p*u(i1  ,i2  ,i3+1)

 op3dSparseVCl2(i1,i2,i3) = \
     a2m*u(i1  ,i2-1,i3  )+ \
     a1m*u(i1-1,i2  ,i3  )+ \
     a1p*u(i1+1,i2  ,i3  )+ \
     a2p*u(i1  ,i2+1,i3  ) 
...
#If #DIM == "2"
 ...
 op2dSparse4l0(i1,i2,i3)= \
     c(m31,i1,i2,i3)*u(i1  ,i2-2,i3)+ \
     c(m32,i1,i2,i3)*u(i1  ,i2-1,i3)+ \
     c(m34,i1,i2,i3)*u(i1  ,i2+1,i3)+ \
     c(m35,i1,i2,i3)*u(i1  ,i2+2,i3)
 op2dSparse4l1(i1,i2,i3)= \
     c(m13,i1,i2,i3)*u(i1-2,i2  ,i3)+ \
     c(m23,i1,i2,i3)*u(i1-1,i2  ,i3)+ \
     c(m43,i1,i2,i3)*u(i1+1,i2  ,i3)+ \
     c(m53,i1,i2,i3)*u(i1+2,i2  ,i3) 
...
#If #DIM == "2"
 ...
 op2dSparseCC4l0(i1,i2,i3)= \
     cc(m31)*u(i1  ,i2-2,i3)+ \
     cc(m32)*u(i1  ,i2-1,i3)+ \
     cc(m34)*u(i1  ,i2+1,i3)+ \
     cc(m35)*u(i1  ,i2+2,i3)

 op2dSparseCC4l1(i1,i2,i3)= \
     cc(m13)*u(i1-2,i2  ,i3)+ \
     cc(m23)*u(i1-1,i2  ,i3)+ \
     cc(m43)*u(i1+1,i2  ,i3)+ \
     cc(m53)*u(i1+2,i2  ,i3)
...
#If #DIM == "3"
 ...
 op3dCC4l1(i1,i2,i3)= \
        ...
        +op3dCC4a(i1,i2,i3,2, \
           ...
           m155,m255,m355,m455,m555)
 op3dCC4l2(i1,i2,i3)= \
         op3dCC4al2(i1,i2,i3,-2, \
           m111,m211,m311,m411,m511, \
           m121,m221,m321,m421,m521, \
           m131,m231,m331,m431,m531, \
           m141,m241,m341,m441,m541, \
           m151,m251,m351,m451,m551) \
        +op3dCC4al2(i1,i2,i3,-1, \
           m112,m212,m312,m412,m512, \
           m122,m222,m322,m422,m522, \
           m132,m232,m332,m432,m532, \
           m142,m242,m342,m442,m542, \
           m152,m252,m352,m452,m552) \
        +op3dCC4al2(i1,i2,i3,0, \
           m113,m213,m313,m413,m513, \
           m123,m223,m323,m423,m523, \
           m133,m233,m333,m433,m533, \
           m143,m243,m343,m443,m543, \
...
#beginFile NAME.f
 DEFECT_SUBROUTINE(NAME,DIM,ORDER)
#endFile
#endMacro
