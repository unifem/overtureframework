...
! SMOOTH_JACOBI_SUBROUTINE(smoothJAC2dOrder2,2,2)
        subroutine smoothJAC2dOrder2( nd, nd1a,nd1b,nd2a,nd2b,nd3a,
...
c write(*,*) 'n1a..',n1a,n1b,n1c,n1d,n2a,n2b,n2c
             if( option.eq.0 )then
               ...
               do i1=n1a,n1b,n1c
                 if( mask(i1,i2,i3).gt.0 )then
                   u(i1,i2,i3)=update2dSparse(i1,i2,i3) ! update2dSparse points R1 or B1
                 end if
               end do
               end do
               end do
             else if( option.eq.2 .or. option.eq.3 )then
! updateBoundaryLoops(v,u,update2dSparse)
c write(*,*) 'n1a..',n1a,n1b,n1c,n1d,n2a,n2b,n2c
                 if( bc(0,0).gt.0 )then
! boundaryLoop(v,u,update2dSparse,n1a,n1a+nb,n2a,n2b,n3a,n3b)
                   if( option.eq.2 )then
                     do i3=n3a,n3b
                     do i2=n2a,n2b
                     do i1=n1a,n1a+nb
                       if( mask(i1,i2,i3).gt.0 )then
                         v(i1,i2,i3)=update2dSparse(i1,i2,i3)
                       end if
                     end do
                     end do
                     end do
                     ...
                     do i1=n1a,n1a+nb
                       if( mask(i1,i2,i3).gt.0 )then
                         u(i1,i2,i3)=update2dSparse(i1,i2,i3)
                 ...
                 if( bc(1,0).gt.0 )then
! boundaryLoop(v,u,update2dSparse,n1b-nb,n1b,n2a,n2b,n3a,n3b)
                   if( option.eq.2 )then
                     do i3=n3a,n3b
                     do i2=n2a,n2b
                     do i1=n1b-nb,n1b
                 ...
                 if( bc(0,1).gt.0 )then
! boundaryLoop(v,u,update2dSparse,n1a,n1b,n2a,n2a+nb,n3a,n3b)
                   if( option.eq.2 )then
                     do i3=n3a,n3b
                     do i2=n2a,n2a+nb
                     do i1=n1a,n1b
                 ...
                 if( bc(1,1).gt.0 )then
! boundaryLoop(v,u,update2dSparse,n1a,n1b,n2b-nb,n2b,n3a,n3b)
                   if( option.eq.2 )then
                     do i3=n3a,n3b
                     do i2=n2b-nb,n2b
                     do i1=n1a,n1b
...
! boundaryLoop(v,u,update2dSparse,n1a,n1b,n2a,n2b,n3a,n3a+nb)
                   if( option.eq.2 )then
                     do i3=n3a,n3a+nb
                     do i2=n2a,n2b
                     do i1=n1a,n1b
...
! boundaryLoop(v,u,update2dSparse,n1a,n1b,n2a,n2b,n3b-nb,n3b)
                   if( option.eq.2 )then
                     do i3=n3b-nb,n3b
                     do i2=n2a,n2b
                     do i1=n1a,n1b
...
! updateListOfPoints(update2dSparse)
...
! updateListOfPointsJacobi(update2dSparse)
...
c write(*,*) 'n1a..',n1a,n1b,n1c,n1d,n2a,n2b,n2c
              if( option.eq.0 )then
                ...
                do i1=n1a,n1b,n1c
                  if( mask(i1,i2,i3).gt.0 )then
                    u(i1,i2,i3)=update2dSparseCC(i1,i2,i3) ! update2dSparseCC points R1 or B1
                  end if
                end do
                end do
                end do
              else if( option.eq.2 .or. option.eq.3 )then
! updateBoundaryLoops(v,u,update2dSparseCC)
c write(*,*) 'n1a..',n1a,n1b,n1c,n1d,n2a,n2b,n2c
                  if( bc(0,0).gt.0 )then
! boundaryLoop(v,u,update2dSparseCC,n1a,n1a+nb,n2a,n2b,n3a,n3b)
                    if( option.eq.2 )then
                      do i3=n3a,n3b
                      do i2=n2a,n2b
                      do i1=n1a,n1a+nb
                        if( mask(i1,i2,i3).gt.0 )then
                          v(i1,i2,i3)=update2dSparseCC(i1,i2,i3)
                        end if
                      end do
                      end do
                      end do
                      ...
                      do i1=n1a,n1a+nb
                        if( mask(i1,i2,i3).gt.0 )then
                          u(i1,i2,i3)=update2dSparseCC(i1,i2,i3)
                          ! write(*,*) 'u,f=',u(i1,i2,i3),f(i1,i2,i3)
                        end if
                      end do
                      end do
                  ...
                  if( bc(1,0).gt.0 )then
! boundaryLoop(v,u,update2dSparseCC,n1b-nb,n1b,n2a,n2b,n3a,n3b)
                    if( option.eq.2 )then
                      do i3=n3a,n3b
                      do i2=n2a,n2b
                      do i1=n1b-nb,n1b
                  ...
                  if( bc(0,1).gt.0 )then
! boundaryLoop(v,u,update2dSparseCC,n1a,n1b,n2a,n2a+nb,n3a,n3b)
                    if( option.eq.2 )then
                      do i3=n3a,n3b
                      do i2=n2a,n2a+nb
                      do i1=n1a,n1b
                  ...
                  if( bc(1,1).gt.0 )then
! boundaryLoop(v,u,update2dSparseCC,n1a,n1b,n2b-nb,n2b,n3a,n3b)
                    if( option.eq.2 )then
                      do i3=n3a,n3b
                      do i2=n2b-nb,n2b
                      do i1=n1a,n1b
                  ...
                  if( nd.eq.3 .and. bc(0,2).gt.0 )then
! boundaryLoop(v,u,update2dSparseCC,n1a,n1b,n2a,n2b,n3a,n3a+nb)
                    if( option.eq.2 )then
                      do i3=n3a,n3a+nb
                      do i2=n2a,n2b
                      do i1=n1a,n1b
                  ...
                  if( nd.eq.3 .and. bc(1,2).gt.0 )then
! boundaryLoop(v,u,update2dSparseCC,n1a,n1b,n2a,n2b,n3b-nb,n3b)
                    if( option.eq.2 )then
                      do i3=n3b-nb,n3b
                      do i2=n2a,n2b
                      do i1=n1a,n1b
...
! updateListOfPoints(update2dSparseCC)
                 ! write(*,*) 'updateListOfPoints...'
                 if( nd.eq.2 )then
                  i3=0
                  do i=1,np
...
! updateListOfPointsJacobi(update2dSparseCC)
                 ! write(*,*) 'updateListOfPointsJacobi...'
                 if( nd.eq.2 )then
                  i3=0
                  do i=1,np
...
c write(*,*) 'n1a..',n1a,n1b,n1c,n1d,n2a,n2b,n2c
              if( option.eq.0 )then
                ...
                do i1=n1a,n1b,n1c
                  if( mask(i1,i2,i3).gt.0 )then
                    u(i1,i2,i3)=update2d(i1,i2,i3) ! update2d points R1 or B1
                  end if
                end do
                end do
                end do
              else if( option.eq.2 .or. option.eq.3 )then
! updateBoundaryLoops(v,u,update2d)
c write(*,*) 'n1a..',n1a,n1b,n1c,n1d,n2a,n2b,n2c
                  if( bc(0,0).gt.0 )then
! boundaryLoop(v,u,update2d,n1a,n1a+nb,n2a,n2b,n3a,n3b)
                    if( option.eq.2 )then
                      do i3=n3a,n3b
                      do i2=n2a,n2b
                      do i1=n1a,n1a+nb
                        if( mask(i1,i2,i3).gt.0 )then
                          v(i1,i2,i3)=update2d(i1,i2,i3)
                        end if
                      end do
                      end do
                      end do
                  ...
                  if( bc(1,0).gt.0 )then
! boundaryLoop(v,u,update2d,n1b-nb,n1b,n2a,n2b,n3a,n3b)
                    if( option.eq.2 )then
                      do i3=n3a,n3b
                      do i2=n2a,n2b
                      do i1=n1b-nb,n1b
                  ...
                  if( bc(0,1).gt.0 )then
! boundaryLoop(v,u,update2d,n1a,n1b,n2a,n2a+nb,n3a,n3b)
                    if( option.eq.2 )then
                      do i3=n3a,n3b
                      do i2=n2a,n2a+nb
                      do i1=n1a,n1b
                  ...
                  if( bc(1,1).gt.0 )then
! boundaryLoop(v,u,update2d,n1a,n1b,n2b-nb,n2b,n3a,n3b)
                    if( option.eq.2 )then
                      do i3=n3a,n3b
                      do i2=n2b-nb,n2b
                      do i1=n1a,n1b
                  ...
                  if( nd.eq.3 .and. bc(0,2).gt.0 )then
! boundaryLoop(v,u,update2d,n1a,n1b,n2a,n2b,n3a,n3a+nb)
                    if( option.eq.2 )then
                      do i3=n3a,n3a+nb
                      do i2=n2a,n2b
                      do i1=n1a,n1b
                  ...
                  if( nd.eq.3 .and. bc(1,2).gt.0 )then
! boundaryLoop(v,u,update2d,n1a,n1b,n2a,n2b,n3b-nb,n3b)
                    if( option.eq.2 )then
                      do i3=n3b-nb,n3b
                      do i2=n2a,n2b
                      do i1=n1a,n1b
...
! updateListOfPointsJacobi(update2d)
                 ! write(*,*) 'updateListOfPointsJacobi...'
                 if( nd.eq.2 )then
                  i3=0
                  do i=1,np
...
c write(*,*) 'n1a..',n1a,n1b,n1c,n1d,n2a,n2b,n2c
              if( option.eq.0 )then
                ...
                do i1=n1a,n1b,n1c
                  if( mask(i1,i2,i3).gt.0 )then
                    u(i1,i2,i3)=update2dCC(i1,i2,i3) ! update2dCC points R1 or B1
                  end if
                end do
                end do
                end do
              else if( option.eq.2 .or. option.eq.3 )then
! updateBoundaryLoops(v,u,update2dCC)
c write(*,*) 'n1a..',n1a,n1b,n1c,n1d,n2a,n2b,n2c
                  if( bc(0,0).gt.0 )then
! boundaryLoop(v,u,update2dCC,n1a,n1a+nb,n2a,n2b,n3a,n3b)
                    if( option.eq.2 )then
                      do i3=n3a,n3b
                      do i2=n2a,n2b
                      do i1=n1a,n1a+nb
                        if( mask(i1,i2,i3).gt.0 )then
                          v(i1,i2,i3)=update2dCC(i1,i2,i3)
                        end if
                      end do
                      end do
                      end do
                      ...
                      do i1=n1a,n1a+nb
                        if( mask(i1,i2,i3).gt.0 )then
                          u(i1,i2,i3)=update2dCC(i1,i2,i3)
                          ! write(*,*) 'u,f=',u(i1,i2,i3),f(i1,i2,i3)
                        end if
                      end do
                      end do
                  ...
                  if( bc(1,0).gt.0 )then
! boundaryLoop(v,u,update2dCC,n1b-nb,n1b,n2a,n2b,n3a,n3b)
                    if( option.eq.2 )then
                      do i3=n3a,n3b
                      do i2=n2a,n2b
                      do i1=n1b-nb,n1b
                  ...
                  if( bc(0,1).gt.0 )then
! boundaryLoop(v,u,update2dCC,n1a,n1b,n2a,n2a+nb,n3a,n3b)
                    if( option.eq.2 )then
                      do i3=n3a,n3b
                      do i2=n2a,n2a+nb
                      do i1=n1a,n1b
                  ...
                  if( bc(1,1).gt.0 )then
! boundaryLoop(v,u,update2dCC,n1a,n1b,n2b-nb,n2b,n3a,n3b)
                    if( option.eq.2 )then
                      do i3=n3a,n3b
                      do i2=n2b-nb,n2b
                      do i1=n1a,n1b
                  ...
                  if( nd.eq.3 .and. bc(0,2).gt.0 )then
! boundaryLoop(v,u,update2dCC,n1a,n1b,n2a,n2b,n3a,n3a+nb)
                    if( option.eq.2 )then
                      do i3=n3a,n3a+nb
                      do i2=n2a,n2b
                      do i1=n1a,n1b
                  ...
                  if( nd.eq.3 .and. bc(1,2).gt.0 )then
! boundaryLoop(v,u,update2dCC,n1a,n1b,n2a,n2b,n3b-nb,n3b)
                    if( option.eq.2 )then
                      do i3=n3b-nb,n3b
                      do i2=n2a,n2b
                      do i1=n1a,n1b
...
! updateListOfPointsJacobi(update2dCC)
                 ! write(*,*) 'updateListOfPointsJacobi...'
                 if( nd.eq.2 )then
                  i3=0
                  do i=1,np
