...
! DEFECT_SUBROUTINE(defect2dOrder2,2,2)
        subroutine defect2dOrder2( nd, nd1a,nd1b,nd2a,nd2b,nd3a,nd3b, 
                ...
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op2dSparse(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op2dSparsel0)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op2dSparsel0(i1,i2,
     & i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
...
! loops(op2dSparsel1)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op2dSparsel1(i1,i2,
     & i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
...
! loops(op2d)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op2d(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op2dl0)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op2dl0(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op2dl1)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op2dl1(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op2dCC)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op2dCC(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op2dCCl0)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op2dCCl0(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op2dCCl1)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op2dCCl1(i1,i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  end do
...
! loops(op2dSparseCC)
                if( defectOption.eq.0 )then
                  ...
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op2dSparseCC(i1,i2,
     & i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
...
c  defect for line smooth in direction 0
! loops(op2dSparseCCl0)
                if( defectOption.eq.0 )then
                  do i3=n3a,n3b,n3c
                  do i2=n2a,n2b,n2c
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op2dSparseCCl0(i1,
     & i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
...
c  defect for line smooth in direction 1
! loops(op2dSparseCCl1)
                if( defectOption.eq.0 )then
                  do i3=n3a,n3b,n3c
                  do i2=n2a,n2b,n2c
                  do i1=n1a,n1b,n1c
                    if( mask(i1,i2,i3).gt.0 )then
                      defect(i1,i2,i3)=f(i1,i2,i3)-op2dSparseCCl1(i1,
     & i2,i3)
                    else
                      defect(i1,i2,i3)=0.
                    end if
                  ...
                  do i2=n2a,n2b,n2c
                    do i1=n1a,n1b,n1c
                      if( mask(i1,i2,i3).gt.0 )then
                        ...
                        ad=-(a1p+a1m+a2p+a2m)
                        defect(i1,i2,i3)=f(i1,i2,i3)-op2dSparseVC(i1,
     & i2,i3)
                  ...
                  do i2=n2a,n2b,n2c
                    do i1=n1a,n1b,n1c
                      if( mask(i1,i2,i3).gt.0 )then
                        ...
                        a2m=(s(i1,i2,i3)+s(i1,i2-1,i3))*dy2i
                        ad=-(a1p+a1m+a2p+a2m)
                        defect(i1,i2,i3)=f(i1,i2,i3)-op2dSparseVCl0(i1,
     & i2,i3)
                        ! write(*,*) 'defect: ',i1,i2,s(i1,i2,i3),a1p,a1m,a2p,a2m
                      else
                        defect(i1,i2,i3)=0.
                  ...
                  do i2=n2a,n2b,n2c
                    do i1=n1a,n1b,n1c
                      if( mask(i1,i2,i3).gt.0 )then
                        ...
                        a2m=(s(i1,i2,i3)+s(i1,i2-1,i3))*dy2i
                        ad=-(a1p+a1m+a2p+a2m)
                        defect(i1,i2,i3)=f(i1,i2,i3)-op2dSparseVCl1(i1,
     & i2,i3)
                        ! write(*,*) 'defect: ',i1,i2,s(i1,i2,i3),a1p,a1m,a2p,a2m
                      else
                        defect(i1,i2,i3)=0.
