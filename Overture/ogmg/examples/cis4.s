...
../cgmgt << EOF
../../cguser/cis2.dat
 &inp itest=0,iord=4,eps=1.e-2,zratio=9.,fratio=20. &end
EOF
...
../cgmgt << EOF
../../cguser/cis2.dat
 &inp itest=1,intbc=1,iord=4,zratio=12.,fratio=30.,ipcm=1 &end
EOF
...
../cgmgt << EOF
../../cguser/cis2.dat
 &inp itest=17,intbc=1,iord=4,zratio=12.,fratio=40.,ipcm=1,
