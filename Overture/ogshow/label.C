...
//    }
  ...
  if( parameters.topLabel!="" && parameters.topLabel!=" ")
  {
    ...
    label(parameters.topLabel,.0,yb,size,0,0.,parameters);
    glEndList();
  ...
  if( parameters.topLabel1!="" && parameters.topLabel1!=" " )
  {
    ...
    setColour(textColour); //  label colour 
    label(parameters.topLabel1,.0,yb-size*1.25,subSize,0,0.,parameters);
    glEndList();
    labelsPlotted[win_number]=TRUE;
  }
  if( parameters.topLabel2!="" && parameters.topLabel2!=" " )
  {
    ...
    setColour(textColour); //  label colour 
    label(parameters.topLabel2,.0,yb-(size+subSize)*1.25,subSize,0,0.,parameters);
    glEndList();
    labelsPlotted[win_number]=TRUE;
  }
  if( parameters.topLabel3!="" && parameters.topLabel3!=" " )
  {
    ...
    setColour(textColour); //  label colour 
    label(parameters.topLabel3,.0,yb-(size+2*subSize)*1.25,subSize,0,0.,parameters);
    glEndList();
    labelsPlotted[win_number]=TRUE;
  }
  ...
  if( parameters.bottomLabel1!="" )
  {
    ...
    setColour(textColour); //  label colour 
    label(parameters.bottomLabel1,.0,ya+size*1.25,subSize,0,0.,parameters);
    glEndList();
    labelsPlotted[win_number]=TRUE;
  }
  if( parameters.bottomLabel2!="" )
  {
    ...
    setColour(textColour); //  label colour 
    label(parameters.bottomLabel2,.0,ya+(size+subSize)*1.25,subSize,0,0.,parameters);
    glEndList();
    labelsPlotted[win_number]=TRUE;
  }
  if( parameters.bottomLabel3!="" )
  {
    ...
    setColour(textColour); //  label colour 
    label(parameters.bottomLabel3,.0,ya+(size+2*subSize)*1.25,subSize,0,0.,parameters);
    glEndList();
    labelsPlotted[win_number]=TRUE;
  }
