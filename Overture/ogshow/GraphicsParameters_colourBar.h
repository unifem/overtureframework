//
//  FOR PORTING COLOURBAR to current overture -- July 18, 2001 -- PF
//   GraphicsParameters_colourBar.C & .h are not used anywhere
//   they may be erased once not needed. Currently just to to show
//   which variables are needed for the new ColourBar classes
...
enum GraphicsOptions // if you edit this, remember to update PlotStuff.tex \tablecaption{Graphics Parameter Options} **pf
{
  GI_AXES_ORIGIN,  
  ...
  GI_COLOURBAR_POSITION,
  GI_COLOURBAR_WIDTH,
  GI_COLOURBAR_LENGTH,
  GI_COLOURBAR_CENTER,
  GI_COLOURBAR_ANGLE,
  GI_COLOURBAR_CURVATURE,
  GI_COLOURBAR_OFFSET_FROM_PLOT,
  GI_COLOURBAR_LABEL_OPTION,
  GI_COLOURBAR_LABEL_ON_RIGHT,
  GI_COLOURBAR_LABEL_ANGLE,
  GI_COLOURBAR_RELATIVE_ANGLE,
  GI_COLOURBAR_LABEL_NORMAL_OFFSET,
  GI_COLOURBAR_LABEL_TANGENTIAL_OFFSET,
  GI_COLOURBAR_MAXIMUM_NUMBER_OF_LABELS,
  GI_COLOURBAR_NUMBER_OF_INTERVALS,
  GI_COLOURBAR_LABEL_SCALING,
  GI_COLOURBAR_THICK_LINE_INTERVAL,
  GI_COLOUR_TABLE,
...
enum ColourBarPosition //for `ColourBar's **pf
{
  leftColourBar  = 0,
  rightColourBar,
  topColourBar,
...
// These are for 'ColourBar's **pf
ColourBarPosition colourBarPosition;        //..colour bars
real              colourBarWidth;         
real              colourBarLength;
RealArray         colourBarCenter;
real              colourBarAngle;
real              colourBarCurvature;
real              colourBarOffsetFromPlot;

ColourBarLabelOption colourBarLabelOption;  //..colourbar labels
bool                 colourBarLabelOnRight;
real                 colourBarLabelAngle;
bool                 colourBarRelativeAngle;
real                 colourBarLabelNormalOffset;
real                 colourBarLabelTangentialOffset;

int                  colourBarNumberOfIntervals; 
int                  colourBarMaximumNumberOfLabels;
real                 colourBarLabelScaling;
int                  colourBarThickLineInterval; //not a good name. maybe colourBarTickLineInterval? **pf
