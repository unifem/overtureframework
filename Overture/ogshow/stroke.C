...
//================================================================================
//  Define a roman stroke font for OpenGL labels
//================================================================================
...
static StrokeFontPtr font = &glutStrokeRoman;   // *** use this font ***


void
strokeCharacter(int c)
{
  StrokeCharPtr ch;
  StrokePtr stroke;
  CoordPtr coord;
  ...
  if (ch) {
    for (i = ch->num_strokes, stroke = ch->stroke;
      ...
      for (j = stroke->num_coords, coord = stroke->coord;
        j > 0; j--, coord++) {
//        glVertex2(coord->x, coord->y);
        glVertex3(coord->x, coord->y, 0.0); // AP: Necessary to get the z-buffering to work on SUN's native OpenGL
      }
      glEnd();
    }
    glTranslatef(ch->right+10., 0.0, 0.0);  // shift to a position to start the next char
  }
}


// --- here is a roman stroke font ----
