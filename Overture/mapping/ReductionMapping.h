...
//-------------------------------------------------------------
/// \brief  Define a new Mapping for the face or edge of another Mapping, thus  reducing the domain dimension.
//-------------------------------------------------------------
...
public:
  ...
  void basicInverse(const realArray & x, 
		    realArray & r,
  ...
  const Mapping * getOriginalMapping() const { return originalMap; }

  int getActiveAxis(int a) const { return activeAxis[a]; }
  int getInActiveAxis(int a) const { return inActiveAxis[a]; }
  real getInActiveAxisValue(int a) const { return inActiveAxisValue[a]; }
