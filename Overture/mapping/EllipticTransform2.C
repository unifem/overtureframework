...
#include "Square.h"
 ...
 multigrid2 mulgrid;
//\begin{>EllipticTransform2Include.tex}{\subsubsection{Constructor}}
EllipticTransform2::
EllipticTransform2() 
...
// 
//\end{EllipticTransform2Include.tex}
//===========================================================================
{ 
  EllipticTransform2::className="EllipticTransform2";
  setName( Mapping::mappingName,"EllipticTransform2");
  userMap=NULL;
  compose=FALSE;
  dpm=NULL;
...
EllipticTransform2::
EllipticTransform2( const EllipticTransform2& map, const CopyType copyType )
{
  EllipticTransform2::className="EllipticTransform2";
  if( copyType==DEEP )
  {
  ...
  {
    cout << "EllipticTransform2:: sorry no shallow copy constructor, doing a deep! \n";
    *this=map;
  }
}
...
{ 
  if( debug & 4 )
    cout << " EllipticTransform2::Destructor called" << endl;
}

EllipticTransform2 & EllipticTransform2::
operator=( const EllipticTransform2 & X )
{
  if( EllipticTransform2::className != X.getClassName() )
  {
    cout << "EllipticTransform2::operator= ERROR trying to set a EllipticTransform2= to a" 
...
//\begin{>>EllipticTransform2Include.tex}{\subsubsection{get}}
int EllipticTransform2::
...
//===========================================================================
{
  ...
  if( debug & 4 )
    cout << "Entering EllipticTransform2::get" << endl;

  subDir.get( EllipticTransform2::className,"className" ); 
  if( EllipticTransform2::className != "EllipticTransform2" )
  {
    cout << "EllipticTransform2::get ERROR in className!" << endl;
  }
  ...
  else
  {
    ...
    if( userMap==NULL )
    {
      cout << "EllipticTransform2::get:ERROR: reading in the userMap with className=" << userMapClassName << endl;
      return 1;
    }
...
//\begin{>>EllipticTransform2Include.tex}{\subsubsection{put}}
int EllipticTransform2::
...
{  
  ...
  subDir.put( EllipticTransform2::className,"className" );
...
Mapping *EllipticTransform2::
make( const aString & mappingClassName )
{ // Make a new mapping if the mappingClassName is the name of this Class
  Mapping *retval=0;
  if( mappingClassName==EllipticTransform2::className )
    retval = new EllipticTransform2();
  return retval;
}


void EllipticTransform2::
    ...
    MappingParameters & params /* =Overture::nullMappingParameters() */ )
{
  ...
  {
    cout << "EllipticTransform2::map:ERROR: no mapping defined yet! \n";
  }
}
	   ...
	   MappingParameters & params /* =Overture::nullMappingParameters() */ )
{
  ...
  {
    cout << "EllipticTransform2::inverseMap:ERROR: no mapping defined yet! \n";
  }
...
//\begin{>>EllipticTransform2Include.tex}{\subsubsection{generateGrid}}
void EllipticTransform2::
...
//This section is the part dealing with menu choices.
  gi.appendToTheDefaultPrompt("EllipticTransform2>"); // set the default prompt
  ...
  for( int it=0;; it++ )
  {
	...
	{
	  cout << "EllipticTransform2::ERROR: you cannot transform this mapping, "
