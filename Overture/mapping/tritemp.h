/* $Id: tritemp.h,v 1.3 1999/11/18 21:54:44 henshaw Exp $ */
...
/*
 * $Log: tritemp.h,v $
 * Revision 1.3  1999/11/18 21:54:44  henshaw
 * wdh
 *
 * Revision 1.1  1999/08/25 21:35:04  henshaw
	 ...
	 dbdy = oneOverArea * (eMaj.dx * eBot_db - eMaj_db * eBot.dx);
...

      {
	    ...
	    dvInner = dvOuter + dvdx;
	      ...
	      if( right-left == 2 )
	      {
		printf("draw a small one! %i %i %i %i \n",left,right,iy);
	      }
