       ...
       Index I33, int i, int isweep, int ichangePQ)
{
  ...
  for (axis=0;axis<=1;axis++)
	...
	if (axis==1)
	{
	  Xc(I111,I222,I333,Rtmp)=
	    (u[i](I111+icdif[0],I222,I333,Rtmp)-
	     u[i](I111-icdif[0],I222,I333,Rtmp))/(2.*dx(0,i));
	  ...
	  Xcc(I111,I222,I333,Rtmp)=
	    (u[i](I111+icdif[0],I222,I333,Rtmp)-
	     ...
	     u[i](I111-icdif[0],I222,I333,Rtmp))/(dx(0,i)*dx(0,i));
	  ...
	  Xee(I111,I222,I333,Rtmp)=(-7.*u[i](I111,I222,I333,Rtmp)+ 
				    ...
				    6.0*real(is[1])*dx(1,i)*Xe(I111,I222,I333,Rtmp))/
	    (2.*dx(1,i)*dx(1,i));
	  XEE[side]=Xee;
	  if (ichangePQ==1)
	  {
	...
	else if (axis==0)
	{
	  Xe(I111,I222,I333,Rtmp)=
	    (u[i](I111,I222+icdif[1],I333,Rtmp)-
	     u[i](I111,I222-icdif[1],I333,Rtmp))/(2.*dx(1,i));
	  ...
	  Xee(I111,I222,I333,Rtmp)=
	    (u[i](I111,I222+icdif[1],I333,Rtmp)-
	     2.0*u[i](I111,I222,I333,Rtmp)+
	     u[i](I111,I222-icdif[1],I333,Rtmp))/(dx(1,i)*dx(1,i));
	  ...
	  Xcc(I111,I222,I333,Rtmp)=(-7.*u[i](I111,I222,I333,Rtmp)+ 
				    ...
				    6.0*real(is[0])*dx(0,i)*Xc(I111,I222,I333,Rtmp))/
	    (2.*dx(0,i)*dx(0,i));
	  XCC[side]=Xcc;
	  if (ichangePQ==1)
	  {
	...
	P[i0][i] /= (2.*dx(0,i)), Q[i0][i] /= (2*dx(1,i));
		 ...
		 int i, realArray &u1, int isweep, realArray *up)
{
   ...
   if (isweep==0){
     ...
     b1(0,0,I11,I22,I33)=-2.0*coeff1(0,0,I11,I22,I33)/(dx(0,i)*dx(0,i))-
	                2.0*coeff2(0,0,I11,I22,I33)/(dx(1,i)*dx(1,i));
     b1(1,1,I11,I22,I33)=b1(0,0,I11,I22,I33);
     a1(0,0,I11,I22,I33)=coeff1(0,0,I11,I22,I33)*(1.0/(dx(0,i)*dx(0,i))-
	                 Source[i](0,0,I11,I22,I33,0)/(2*dx(0,i)))+
     ...
     c1(0,0,I11,I22,I33)=coeff1(0,0,I11,I22,I33)*(1.0/(dx(0,i)*dx(0,i))+
			 Source[i](0,0,I11,I22,I33,0)/(2*dx(0,i)))-
			 (P[0][i](0,0,I11,I22,I33)+P[1][i](0,0,I11,I22,I33)+
			  P[2][i](0,0,I11,I22,I33)+P[3][i](0,0,I11,I22,I33));
...
//ADJUST THE COEFFICIENTS
         ...
         if (axis==1){
           b1(0,0,I111,I222+is[1],I333) -= 
              8.*(P1[i0](0,0,I111,I222+is[1],I333,0)+
                  Q1[i0](0,0,I111,I222+is[1],I333,0))/(2*dx(1,i)*dx(1,i));
           b1(0,1,I111,I222+is[1],I333) -= 
              8.*(P2[i0](0,0,I111,I222+is[1],I333,0)+
                  Q2[i0](0,0,I111,I222+is[1],I333,0))/(2*dx(1,i)*dx(1,i));
           b1(1,0,I111,I222+is[1],I333) -= 
              8.*(P1[i0](0,0,I111,I222+is[1],I333,1)+
                  Q1[i0](0,0,I111,I222+is[1],I333,1))/(2*dx(1,i)*dx(1,i));
           b1(1,1,I111,I222+is[1],I333) -= 
              8.*(P2[i0](0,0,I111,I222+is[1],I333,1)+
                  Q2[i0](0,0,I111,I222+is[1],I333,1))/(2*dx(1,i)*dx(1,i));
         }
         if (axis==0){
		  ...
		  Q1[i0](0,0,I111+is[0],I222,I333,0))/(2.*dx(0,i)*dx(0,i));
          a11(0,1,I111+is[0],I222,I333)+=
              7.*(P2[i0](0,0,I111+is[0],I222,I333,0)+
		  Q2[i0](0,0,I111+is[0],I222,I333,0))/(2.*dx(0,i)*dx(0,i));
          a11(1,0,I111+is[0],I222,I333)+=
              7.*(P1[i0](0,0,I111+is[0],I222,I333,1)+
		  Q1[i0](0,0,I111+is[0],I222,I333,1))/(2.*dx(0,i)*dx(0,i));
          a11(1,1,I111+is[0],I222,I333)+=
              7.*(P2[i0](0,0,I111+is[0],I222,I333,1)+
		  Q2[i0](0,0,I111+is[0],I222,I333,1))/(2.*dx(0,i)*dx(0,i));
     ...
     d1(1,I11,I22,I33)=RHS[i](0,I11,I22,I33,1)+coeff3(0,I11,I22,I33)*
		    ...
		    u1(0,I11,I22-1,I33,1))/(dx(1,i)*dx(1,i))+
		    (Q[0][i](0,I11,I22,I33)+Q[1][i](0,I11,I22,I33)+
                     Q[2][i](0,I11,I22,I33)+Q[3][i](0,I11,I22,I33)-
                     coeff2(0,I11,I22,I33)*
		     Source[i](0,I11,I22,I33,1)/(2*dx(1,i)))*
             ...
             (P1[i0](0,I111,I222+is[1],I333,0)+
              Q1[i0](0,I111,I222+is[1],I333,0))*
                  ((7.*u1(0,I111,I222,I333,0)+
                       u1(0,I111,I222+2*is[1],I333,0))/(2.*dx(1,i)*dx(1,i))+
                    real(is[1])*3.*X_E(0,I111,I222,I333,0)/dx(1,i))+
             (P2[i0](0,I111,I222+is[1],I333,0)+
              Q2[i0](0,I111,I222+is[1],I333,0))*
                  ((7.*u1(0,I111,I222,I333,1)+
                       u1(0,I111,I222+2*is[1],I333,1))/(2.*dx(1,i)*dx(1,i))+
                    real(is[1])*3.*X_E(0,I111,I222,I333,1)/dx(1,i))+
             (P1[i0](0,I111,I222+is[1],I333,0)+
	...
	//printf("j=%i\t X0=%g::%g\t Y0=%g::%g\t Xf=%g::%g\t Yf=%g::%g\n",j1,u1(istart,j1,0,0),d1(0,istart,j1,0),
     ...
     b1(0,0,I11,I22,I33)=-2.0*coeff1(0,0,I11,I22,I33)/(dx(0,i)*dx(0,i))-
	                2.0*coeff2(0,0,I11,I22,I33)/(dx(1,i)*dx(1,i));
     b1(1,1,I11,I22,I33)=b1(0,0,I11,I22,I33);
     a1(0,0,I11,I22,I33)=coeff2(0,0,I11,I22,I33)*(1.0/(dx(1,i)*dx(1,i))-
	                 Source[i](0,0,I11,I22,I33,1)/(2*dx(1,i)))+
			 (Q[0][i](0,0,I11,I22,I33)+Q[1][i](0,0,I11,I22,I33)+
			  Q[2][i](0,0,I11,I22,I33)+Q[3][i](0,0,I11,I22,I33));
     a1(1,1,I11,I22,I33)=a1(0,0,I11,I22,I33);
     c1(0,0,I11,I22,I33)=coeff2(0,0,I11,I22,I33)*(1.0/(dx(1,i)*dx(1,i))+
			 Source[i](0,0,I11,I22,I33,1)/(2*dx(1,i)))-
			 (Q[0][i](0,0,I11,I22,I33)+Q[1][i](0,0,I11,I22,I33)+
			  Q[2][i](0,0,I11,I22,I33)+Q[3][i](0,0,I11,I22,I33));
     c1(1,1,I11,I22,I33)=c1(0,0,I11,I22,I33);
         ...
         d1(0,I111+is[0],I222,I333) -= 
            (P1[i0](0,I111+is[0],I222,I333,0)+
             Q1[i0](0,I111+is[0],I222,I333,0))*
                ((7.*u1(0,I111,I222,I333,0)+
                     u1(0,I111+2*is[0],I222,I333,0))/(2.*dx(0,i)*dx(0,i))+
                  real(is[0])*3.*X_C(0,I111,I222,I333,0)/dx(0,i))+
            (P2[i0](0,I111+is[0],I222,I333,0)+
             Q2[i0](0,I111+is[0],I222,I333,0))*
                ((7.*u1(0,I111,I222,I333,1)+
                     u1(0,I111+2*is[0],I222,I333,1))/(2.*dx(0,i)*dx(0,i))+
                  real(is[0])*3.*X_C(0,I111,I222,I333,1)/dx(0,i))+
	    (P1[i0](0,I111+is[0],I222,I333,0)+
