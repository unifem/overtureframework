...
mapScalar(const realArray & r_, realArray & x, realArray & xr, MappingParameters & params, const Index & I)
// =========================================================================================================
...
// =========================================================================================================
{
  ...
  intArray i12,i22,i32; 

  
  if( orderOfInterpolation==2 )
  {
    i12.redim(I);      i22.redim(I);      i32.redim(I);
  }
  ...
  //  i11(I)=delta(axis1)*r(I,axis1)-shift;
  ...
  i11=min(dimension(End,axis1)-rShift,max(dimension(Start,axis1)+lShift,i11+gridIndexRange(Start,axis1)) );

  // ::display(i11(I),"i11(I) after");
  // dr(I)=delta[axis1]*r(I,axis1)-(i11-dimension(Start,axis1));
  for( i=base; i<=bound; i++ )  // do this because no mixed A++ operations
    dr(i)=delta[axis1]*r(i,axis1)-(i11(i)-gridIndexRange(Start,axis1));

  if( domainDimension > 1 )
  {
    //  i21=delta[axis2]*r(I,axis2)+gridIndexRange(Start,axis2)-shift;
    for( i=base; i<=bound; i++ )  // do this because no mixed A++ operations
      i21(i)=int( floor(delta[axis2]*r(i,axis2))-shift );
    i21=min(dimension(End,axis2)-rShift,max(dimension(Start,axis2)+lShift,i21+gridIndexRange(Start,axis2)) );

    // ds(I)=delta[axis2]*r(I,axis2)-(i21-dimension(Start,axis2));
    for( i=base; i<=bound; i++ )  // do this because no mixed A++ operations
      ds(i)=delta[axis2]*r(i,axis2)-(i21(i)-gridIndexRange(Start,axis2));
  }
  if( domainDimension>2 )
  {
//    i31(I)=dimension(Start,axis3);
//    dt(I)=0.;
    ...
    // dt(I)=delta[axis3]*r(i,axis3)-(i31(I)-dimension(Start,axis3));
    for( i=base; i<=bound; i++ ) 
  ...
  if( orderOfInterpolation==2 )  // linear interpolation
  {
        ...
        if( domainDimension==2 )
	{
	  for( i=base; i<=bound; i++ )
	  {
	    x(i,axis)=INT_2D_ORDER_2(dr(i),ds(i)
				     ,xy(i11(i),i21(i),i30,axis),xy(i12(i),i21(i),i30,axis)
				     ,xy(i11(i),i22(i),i30,axis),xy(i12(i),i22(i),i30,axis));
	...
	{
/* ----
	    xr(i,axis,0)=INT_2D_ORDER_2_R(dr(i),ds(i)
					  ,xy(i11(i),i21(i),i30,axis),xy(i12(i),i21(i),i30,axis)
					  ,xy(i11(i),i22(i),i30,axis),xy(i12(i),i22(i),i30,axis));
	    xr(i,axis,1)=INT_2D_ORDER_2_S(dr(i),ds(i)
					  ,xy(i11(i),i21(i),i30,axis),xy(i12(i),i21(i),i30,axis)
					  ,xy(i11(i),i22(i),i30,axis),xy(i12(i),i22(i),i30,axis));
  ----- */
          ...
          for( int dir=0; dir<domainDimension; dir++ )
	  {
	    ...
	    real d12=.5*delta[dir];
            ...
            // ******************************************************** one-sided here is wrong ******
            int iStart=base;
            if( (dir==0 &&  i11(base)==dimension(Start,dir)) || (dir==1 &&  i21(base)==dimension(Start,dir)) )
              iStart++;
	    int iEnd  = bound;
            if( (dir==0 &&  i12(bound)==dimension(End,dir)) || (dir==1 &&  i22(bound)==dimension(End,dir)) )
              iEnd--;
		  
	    for( i=iStart; i<=iEnd; i++ )
	    { // approximate dx/dr by a centred difference
	      xr11(i)=(xy(i11(i)+is1,i21(i)+is2,i30,axis)-xy(i11(i)-is1,i21(i)-is2,i30,axis))*d12;
	      xr21(i)=(xy(i12(i)+is1,i21(i)+is2,i30,axis)-xy(i12(i)-is1,i21(i)-is2,i30,axis))*d12;
	      xr12(i)=(xy(i11(i)+is1,i22(i)+is2,i30,axis)-xy(i11(i)-is1,i22(i)-is2,i30,axis))*d12;
	      xr22(i)=(xy(i12(i)+is1,i22(i)+is2,i30,axis)-xy(i12(i)-is1,i22(i)-is2,i30,axis))*d12;
	    }
	    if( iStart>base )
	    { // use a one side approximation at the end ***This is wrong *** need to check all points
              i=base;
	      xr11(i)=(xy(i11(i)+is1,i21(i)+is2,i30,axis)-xy(i11(i),i21(i),i30,axis))*d12*2.;
	      xr21(i)=(xy(i12(i)+is1,i21(i)+is2,i30,axis)-xy(i12(i),i21(i),i30,axis))*d12*2.;
	      xr12(i)=(xy(i11(i)+is1,i22(i)+is2,i30,axis)-xy(i11(i),i22(i),i30,axis))*d12*2.;
	      xr22(i)=(xy(i12(i)+is1,i22(i)+is2,i30,axis)-xy(i12(i),i22(i),i30,axis))*d12*2.;
	    }
	    if( iEnd<bound )
	    {
	      i=bound;
	      xr11(i)=(xy(i11(i),i21(i),i30,axis)-xy(i11(i)-is1,i21(i)-is2,i30,axis))*d12*2.;
	      xr21(i)=(xy(i12(i),i21(i),i30,axis)-xy(i12(i)-is1,i21(i)-is2,i30,axis))*d12*2.;
	      xr12(i)=(xy(i11(i),i22(i),i30,axis)-xy(i11(i)-is1,i22(i)-is2,i30,axis))*d12*2.;
	      xr22(i)=(xy(i12(i),i22(i),i30,axis)-xy(i12(i)-is1,i22(i)-is2,i30,axis))*d12*2.;
	    }
...
/* --------
	  for( i=base; i<= bound; i++ )
	  {	
	    xr(i,axis,0)=INT_3D_ORDER_2_R(dr(i),ds(i),dt(i)
					  ,xy(i11(i),i21(i),i31(i),axis),xy(i12(i),i21(i),i31(i),axis)
					  ,xy(i11(i),i22(i),i31(i),axis),xy(i12(i),i22(i),i31(i),axis)
					  ,xy(i11(i),i21(i),i32(i),axis),xy(i12(i),i21(i),i32(i),axis)
					  ,xy(i11(i),i22(i),i32(i),axis),xy(i12(i),i22(i),i32(i),axis));
	    xr(i,axis,1)=INT_3D_ORDER_2_S(dr(i),ds(i),dt(i)
					  ,xy(i11(i),i21(i),i31(i),axis),xy(i12(i),i21(i),i31(i),axis)
					  ,xy(i11(i),i22(i),i31(i),axis),xy(i12(i),i22(i),i31(i),axis)
					  ,xy(i11(i),i21(i),i32(i),axis),xy(i12(i),i21(i),i32(i),axis)
					  ,xy(i11(i),i22(i),i32(i),axis),xy(i12(i),i22(i),i32(i),axis));

	    xr(i,axis,2)=INT_3D_ORDER_2_T(dr(i),ds(i),dt(i)
					  ,xy(i11(i),i21(i),i31(i),axis),xy(i12(i),i21(i),i31(i),axis)
					  ,xy(i11(i),i22(i),i31(i),axis),xy(i12(i),i22(i),i31(i),axis)
					  ,xy(i11(i),i21(i),i32(i),axis),xy(i12(i),i21(i),i32(i),axis)
					  ,xy(i11(i),i22(i),i32(i),axis),xy(i12(i),i22(i),i32(i),axis));
...
------------ */
          ...
          for( int dir=0; dir<domainDimension; dir++ )
	  {
	    ...
	    real d12=.5*delta[dir];
            ...
            int iStart=base;
            if( (dir==0 &&  i11(base)==dimension(Start,dir)) || 
                (dir==1 &&  i21(base)==dimension(Start,dir)) ||
                (dir==2 &&  i31(base)==dimension(Start,dir)) )
              iStart++;
	    int iEnd  = bound;
            if( (dir==0 &&  i12(bound)==dimension(End,dir)) ||
                (dir==1 &&  i22(bound)==dimension(End,dir)) ||
                (dir==2 &&  i32(bound)==dimension(End,dir)) )
              iEnd--;
		  
	    for( i=iStart; i<=iEnd; i++ )
	    { // approximate dx/dr by a centred difference
	      xr111(i)=(xy(i11(i)+is1,i21(i)+is2,i31(i)+is3,axis)-xy(i11(i)-is1,i21(i)-is2,i31(i)-is3,axis))*d12;
	      xr211(i)=(xy(i12(i)+is1,i21(i)+is2,i31(i)+is3,axis)-xy(i12(i)-is1,i21(i)-is2,i31(i)-is3,axis))*d12;
	      xr121(i)=(xy(i11(i)+is1,i22(i)+is2,i31(i)+is3,axis)-xy(i11(i)-is1,i22(i)-is2,i31(i)-is3,axis))*d12;
	      xr221(i)=(xy(i12(i)+is1,i22(i)+is2,i31(i)+is3,axis)-xy(i12(i)-is1,i22(i)-is2,i31(i)-is3,axis))*d12;

	      xr112(i)=(xy(i11(i)+is1,i21(i)+is2,i32(i)+is3,axis)-xy(i11(i)-is1,i21(i)-is2,i32(i)-is3,axis))*d12;
	      xr212(i)=(xy(i12(i)+is1,i21(i)+is2,i32(i)+is3,axis)-xy(i12(i)-is1,i21(i)-is2,i32(i)-is3,axis))*d12;
	      xr122(i)=(xy(i11(i)+is1,i22(i)+is2,i32(i)+is3,axis)-xy(i11(i)-is1,i22(i)-is2,i32(i)-is3,axis))*d12;
	      xr222(i)=(xy(i12(i)+is1,i22(i)+is2,i32(i)+is3,axis)-xy(i12(i)-is1,i22(i)-is2,i32(i)-is3,axis))*d12;
	    }
	    if( iStart>base )
	    { // use a one side approximation at the end
              i=base;
	      xr111(i)=(xy(i11(i)+is1,i21(i)+is2,i31(i)+is3,axis)-xy(i11(i),i21(i),i31(i),axis))*d12*2.;
	      xr211(i)=(xy(i12(i)+is1,i21(i)+is2,i31(i)+is3,axis)-xy(i12(i),i21(i),i31(i),axis))*d12*2.;
	      xr121(i)=(xy(i11(i)+is1,i22(i)+is2,i31(i)+is3,axis)-xy(i11(i),i22(i),i31(i),axis))*d12*2.;
	      xr221(i)=(xy(i12(i)+is1,i22(i)+is2,i31(i)+is3,axis)-xy(i12(i),i22(i),i31(i),axis))*d12*2.;

	      xr112(i)=(xy(i11(i)+is1,i21(i)+is2,i32(i)+is3,axis)-xy(i11(i),i21(i),i32(i),axis))*d12*2.;
	      xr212(i)=(xy(i12(i)+is1,i21(i)+is2,i32(i)+is3,axis)-xy(i12(i),i21(i),i32(i),axis))*d12*2.;
	      xr122(i)=(xy(i11(i)+is1,i22(i)+is2,i32(i)+is3,axis)-xy(i11(i),i22(i),i32(i),axis))*d12*2.;
	      xr222(i)=(xy(i12(i)+is1,i22(i)+is2,i32(i)+is3,axis)-xy(i12(i),i22(i),i32(i),axis))*d12*2.;
	    }
	    if( iEnd<bound )
	    {
	      i=bound;
	      xr111(i)=(xy(i11(i),i21(i),i31(i),axis)-xy(i11(i)-is1,i21(i)-is2,i31(i)-is3,axis))*d12*2.;
	      xr211(i)=(xy(i12(i),i21(i),i31(i),axis)-xy(i12(i)-is1,i21(i)-is2,i31(i)-is3,axis))*d12*2.;
	      xr121(i)=(xy(i11(i),i22(i),i31(i),axis)-xy(i11(i)-is1,i22(i)-is2,i31(i)-is3,axis))*d12*2.;
	      xr221(i)=(xy(i12(i),i22(i),i31(i),axis)-xy(i12(i)-is1,i22(i)-is2,i31(i)-is3,axis))*d12*2.;
					       
	      xr112(i)=(xy(i11(i),i21(i),i32(i),axis)-xy(i11(i)-is1,i21(i)-is2,i32(i)-is3,axis))*d12*2.;
	      xr212(i)=(xy(i12(i),i21(i),i32(i),axis)-xy(i12(i)-is1,i21(i)-is2,i32(i)-is3,axis))*d12*2.;
	      xr122(i)=(xy(i11(i),i22(i),i32(i),axis)-xy(i11(i)-is1,i22(i)-is2,i32(i)-is3,axis))*d12*2.;
	      xr222(i)=(xy(i12(i),i22(i),i32(i),axis)-xy(i12(i)-is1,i22(i)-is2,i32(i)-is3,axis))*d12*2.;
	    }
          ...
          for( int dir=0; dir<domainDimension; dir++ )
	  {
	    ...
	    real d12=.5*delta[0];
            ...
            if( i11(base)==dimension(Start,dir) )
              iStart++;
	    int iEnd  = bound;
            if( i12(bound)==dimension(End,dir) )
              iEnd--;
		  
	    for( i=iStart; i<=iEnd; i++ )
	    { // approximate dx/dr by a centred difference
	      xr1(i)=(xy(i11(i)+is1,i20,i30,axis)-xy(i11(i)-is1,i20,i30,axis))*d12;
	      xr2(i)=(xy(i12(i)+is1,i20,i30,axis)-xy(i12(i)-is1,i20,i30,axis))*d12; // *wdh* 991019
	    }
	    if( iStart>base )
	    { // use a one side approximation at the end
              i=base;
	      xr1(i)=(xy(i11(i)+is1,i20,i30,axis)-xy(i11(i),i20,i30,axis))*d12*2.;
	      xr2(i)=(xy(i12(i)+is1,i20,i30,axis)-xy(i12(i),i20,i30,axis))*d12*2.;
	    }
	    if( iEnd<bound )
	    {
	      i=bound;
	      xr1(i)=(xy(i11(i),i20,i30,axis)-xy(i11(i)-is1,i20,i30,axis))*d12*2.;
	      xr2(i)=(xy(i12(i),i20,i30,axis)-xy(i12(i)-is1,i20,i30,axis))*d12*2.;
	    }

	    xr(I,axis,dir)=INT_1D_ORDER_2(dr(I),xr1,xr2);
	  }
	}
        else
          {throw "error";}
