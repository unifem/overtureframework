...
Modifications for Overture: Petri Fast, 2001

*The original code (ply-1.1) is used by Stanford Graphics
  codes Zipper & Vrip. See http://graphics.stanford.edu
