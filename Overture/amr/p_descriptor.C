...
#ifdef GNU
#pragma implementation "p_descriptor.h"
#endif
...
intArray_Descriptor_Type ( const Internal_Index & I )
   : Array_Domain(I)
   {
  // printf ("At TOP of constructor for intArray_Descriptor_Type \n");
     setDataPointer(NULL);
     Preinitialize_Descriptor();
  // printf ("At BASE of constructor for intArray_Descriptor_Type \n");
   }
...
Build_Temporary_By_Example ( const intArray_Descriptor_Type & X )
  ...
  // *wdh* 060504 -- In the case of P++ the above statement will allocate a new internalArrayID 
  //  We should return this ID to avoid a leak of ID's
     #if defined(PPP)
       assert( Array_ID()!=Original_Array_ID );
       SerialArray_Domain_Type::Push_Array_ID(Array_ID());
     #endif
               ...
               if (Data_Pointer->getReferenceCount() < getReferenceCountBase())
                 ...
                 // about this by setting the SerialArray_Domain_Type::PppIsAvailableToCallGlobalMemoryRelease = TRUE
                    ...
                    if ( (APP_DEBUG > 1) && (SerialArray_Domain_Type::letPppCallGlobalMemoryRelease == TRUE) )
                       {
                         printf ("In intArray::Delete_Array_Data(): P++ Defering call to GlobalMemoryRelease() until P++ can call it ... \n");
                       }
#endif
                  }
               Data_Pointer = NULL;
...
doubleArray_Descriptor_Type ( const Internal_Index & I )
   : Array_Domain(I)
   {
  // printf ("At TOP of constructor for doubleArray_Descriptor_Type \n");
     setDataPointer(NULL);
     Preinitialize_Descriptor();
  // printf ("At BASE of constructor for doubleArray_Descriptor_Type \n");
   }
            ...
            // The destructor we decrement the referenceCount in the SerialArray
               ...
               if (Data_Pointer->getReferenceCount() < getReferenceCountBase())
                 ...
                 // about this by setting the SerialArray_Domain_Type::PppIsAvailableToCallGlobalMemoryRelease = TRUE
                    ...
                    if ( (APP_DEBUG > 1) && (SerialArray_Domain_Type::letPppCallGlobalMemoryRelease == TRUE) )
                       {
                         printf ("In doubleArray::Delete_Array_Data(): P++ Defering call to GlobalMemoryRelease() until P++ can call it ... \n");
                       }
#endif
                  }
               Data_Pointer = NULL;
...
floatArray_Descriptor_Type ( const Internal_Index & I )
   : Array_Domain(I)
   {
  // printf ("At TOP of constructor for floatArray_Descriptor_Type \n");
     setDataPointer(NULL);
     Preinitialize_Descriptor();
  // printf ("At BASE of constructor for floatArray_Descriptor_Type \n");
   }
            ...
            // The destructor we decrement the referenceCount in the SerialArray
               ...
               if (Data_Pointer->getReferenceCount() < getReferenceCountBase())
                 ...
                 // about this by setting the SerialArray_Domain_Type::PppIsAvailableToCallGlobalMemoryRelease = TRUE
                    ...
                    if ( (APP_DEBUG > 1) && (SerialArray_Domain_Type::letPppCallGlobalMemoryRelease == TRUE) )
                       {
                         printf ("In floatArray::Delete_Array_Data(): P++ Defering call to GlobalMemoryRelease() until P++ can call it ... \n");
                       }
#endif
                  }
               Data_Pointer = NULL;
