...
// TEST 5:  tests children on periodic grids
// create a base periodic grid (one direction)
// and create two children who align on
// branch cut. vary distance between siblings for
// cases a)-f)
...
bool passedCase( GridCollection &gc, int i, int j, int caseNo)
{
  ...
  switch( caseNo ){
  case 1:  // periodic siblings that align on grid boundaries
    // ranges for first patch
    rangeA(0,0) = 0; rangeA(1,0) = 5;
    rangeA(0,1) = 0; rangeA(1,1) = 10;
    rangeA(0,2) = 0; rangeA(1,2) =  0;
    // ranges for second patch
    rangeB(0,0) = 15; rangeB(1,0) = 20;
    rangeB(0,1) = 0; rangeB(1,1) = 10;
    rangeB(0,2) = 0; rangeB(1,2) =  0;
    break;
  case 2:  // periodic siblings that touch parent grid boundaries
           // but don't align exactly with each other
    // ranges for first patch
    rangeA(0,0) = 0; rangeA(1,0) = 5;
    rangeA(0,1) = 0; rangeA(1,1) = 8;
    rangeA(0,2) = 0; rangeA(1,2) =  0;
    // ranges for second patch
    rangeB(0,0) = 15; rangeB(1,0) = 20;
    ...
    rangeB(0,2) = 0; rangeB(1,2) =  0;
    break;
  case 3:  // seperation between periodic grids is greater than GBW
    // ranges for first patch
    ...
    rangeB(0,2) = 0; rangeB(1,2) =  0;
    break;
  case 4:  // seperation between periodic grids is exactly GBW
    // ranges for first patch
    rangeA(0,0) = 1; rangeA(1,0) = 5;
    rangeA(0,1) = 0; rangeA(1,1) = 10;
    rangeA(0,2) = 0; rangeA(1,2) =  0;
    // ranges for second patch
    rangeB(0,0) = 15; rangeB(1,0) = 20;
    ...
    rangeB(0,2) = 0; rangeB(1,2) =  0;    
    break;
  case 5:  // periodic grids touch at a point
    // ranges for first patch
    rangeA(0,0) = 0; rangeA(1,0) = 5;
    rangeA(0,1) = 0; rangeA(1,1) = 5;
    rangeA(0,2) = 0; rangeA(1,2) =  0;
    // ranges for second patch
    rangeB(0,0) = 15; rangeB(1,0) = 20;
    rangeB(0,1) = 5; rangeB(1,1) = 10;
    rangeB(0,2) = 0; rangeB(1,2) =  0;
    break;
  case 6:    // periodic grids meet at a corner seperated by GBW
    // ranges for first patch
    rangeA(0,0) = 0; rangeA(1,0) = 5;
    rangeA(0,1) = 0; rangeA(1,1) = 5;
    rangeA(0,2) = 0; rangeA(1,2) =  0;
...
int main( int argc, char **argv)
{
  ...
  cout << "The mapped grid is periodic in the following directions" << endl;
  mg.isPeriodic().display("Periodicity array");
  ...
  if(retVal)
    cout << "TEST 5: successfully passed all cases" << endl;
