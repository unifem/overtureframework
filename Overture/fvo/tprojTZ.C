...
main (int args, char **argv)
{
  ...
  printf ("\n========================================\n");
  printf ("  TPROJTZ: test Projection \n");
  printf ("    Class TwilightZone features  \n");
  printf ("========================================\n\n");
  ...
  if (args < 2)
    {
      cerr << "Usage: tprojTZ.x CMPGRD_datafile:" << endl;
      ierr = -1;
      return (ierr);
    }
	// ========================================
  ...
  if (PLOT_ON) ps.createWindow("tprojTZ: Projection class test code");  
  ...
  Projection projection (cg, &operatorForU);

  // ========================================
  // Test projection elliptic solver options
  // ========================================

//  setProjectionEllipticSolverParameters (projection);
