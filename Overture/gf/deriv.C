...
xDerivative43(const derivativeTypes & derivativeType0,
...
void MappedGridOperators::
yDerivative43(const derivativeTypes & derivativeType0,
		    const realMappedGridFunction & u,
		    const realMappedGridFunction & inverseVertexDerivative,
		    RealArray & derivative,
		    const Index & I1,
...
void MappedGridOperators::
zDerivative43(const derivativeTypes & derivativeType0,
		    const realMappedGridFunction & u,
		    const realMappedGridFunction & inverseVertexDerivative,
		    RealArray & derivative,
		    const Index & I1,
...
void MappedGridOperators::
xxDerivative43(const derivativeTypes & derivativeType0,
		    const realMappedGridFunction & u,
		    const realMappedGridFunction & inverseVertexDerivative,
		    RealArray & derivative,
		    const Index & I1,
...
void MappedGridOperators::
yyDerivative43(const derivativeTypes & derivativeType0,
		    const realMappedGridFunction & u,
		    const realMappedGridFunction & inverseVertexDerivative,
		    RealArray & derivative,
		    const Index & I1,
...
void MappedGridOperators::
zzDerivative43(const derivativeTypes & derivativeType0,
		    const realMappedGridFunction & u,
		    const realMappedGridFunction & inverseVertexDerivative,
		    RealArray & derivative,
		    const Index & I1,
