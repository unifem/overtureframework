#defineMacro ajac2d(i1,i2,i3) (rvol/max(1.e-30,abs(rx(i1,i2,i3)*sy(i1,i2,i3)-ry(i1,i2,i3)*sx(i1,i2,i3))))
#defineMacro ajac3d(i1,i2,i3) (rvol/max(1.e-30,abs(\
                               (rx(i1,i2,i3)*sy(i1,i2,i3)-ry(i1,i2,i3)*sx(i1,i2,i3))*tz(i1,i2,i3)+\
                               (ry(i1,i2,i3)*sz(i1,i2,i3)-rz(i1,i2,i3)*sy(i1,i2,i3))*tx(i1,i2,i3)+\
                               (rz(i1,i2,i3)*sx(i1,i2,i3)-rx(i1,i2,i3)*sz(i1,i2,i3))*ty(i1,i2,i3))))

! ===================================================================================
! ===================================================================================
#beginMacro innerLoops(DIM,GRID_TYPE,MASK_OPTION)

  do i3=n3a,n3b
  do i2=n2a,n2b
  do i1=n1a,n1b
   ! do NOT include points that are hidden by refinement 
   #If #MASK_OPTION eq "NE"
    if( mask(i1,i2,i3).ne.0  .and. .not.btest(mask(i1,i2,i3),hiddenByRefinementBit) )then
   #Elif #MASK_OPTION eq "GT"
    if( mask(i1,i2,i3).gt.0  .and. .not.btest(mask(i1,i2,i3),hiddenByRefinementBit) )then
   #Else
     stop 90502
   #End
      #If #GRID_TYPE eq "rectangular"
        up=up+abs(u(i1,i2,i3))**p
      #Elif  #GRID_TYPE eq "curvilinear"
        #If #DIM eq "2"
          vol = ajac2d(i1,i2,i3)
        #Else
          vol = ajac3d(i1,i2,i3)
...
! ===================================================================================
! ===================================================================================
#beginMacro innerLoopsByMask(DIM,GRID_TYPE)

 if( maskOption.eq.0 )then
  innerLoops(DIM,GRID_TYPE,NE)
 else if( maskOption.eq.1 )then
  innerLoops(DIM,GRID_TYPE,GT)
 else
   stop 90302 
 end if
#endMacro
...
! ===================================================================================
! ===================================================================================
#beginMacro innerLoopsByGridType(DIM)

 if( gridType.eq.rectangular )then
  innerLoopsByMask(DIM,rectangular)
 else if( gridType.eq.curvilinear )then
  innerLoopsByMask(DIM,curvilinear)
 else
  stop 90202
 end if
...
! ===================================================================================
! ===================================================================================
#beginMacro innerLoopsByDim()

 if( nd.eq.2 )then
  innerLoopsByGridType(2)
 else if( nd.eq.3 )then
  innerLoopsByGridType(3)
 else
   stop 90102
 end if
...
! ===================================================================================
#beginMacro getAreaNorm(NAME)

 subroutine NAME( nd, nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,\
       n1a,n1b,n2a,n2b,n3a,n3b, u, mask, rsxy,  ipar, rpar )
c ===================================================================================
...
c ===================================================================================
  ...
  implicit none
  integer nd,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,n1a,n1b,n2a,n2b,n3a,n3b,maskOption,p
...
c     --- end statement functions
  ...
  return
      ...
      getAreaNorm(getAreaWeightedLpNorm)
