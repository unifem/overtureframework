...
#ifndef FLOAT_MAPPED_GRID_FUNCTION_H
...
//
//  Notes:
//   o a floatMappedGridFunction is derived from an A++ array
//   o a floatMappedGridFunction contains a pointer to a MappedGrid
//
...
//----------------------------------------------------------------------------
class floatMappedGridFunctionRCData : public ReferenceCounting 
{
  friend class floatMappedGridFunction;
  ...
  floatMappedGridFunctionRCData & operator=( const floatMappedGridFunctionRCData & rcData );  // deep copy

private:
  
  // These are used by list's of ReferenceCounting objects
  virtual void reference( const ReferenceCounting & mgf )
  { floatMappedGridFunctionRCData::reference( (floatMappedGridFunctionRCData&) mgf ); }
  virtual ReferenceCounting & operator=( const ReferenceCounting & mgf )
  { return floatMappedGridFunctionRCData::operator=( (floatMappedGridFunctionRCData&) mgf ); }
  virtual ReferenceCounting* virtualConstructor( const CopyType ) const
  { return ::new floatMappedGridFunctionRCData(); }  
};
...
//
//==================================================================
class floatMappedGridFunction : public floatDistributedArray, public floatGenericGridFunction
{
 public:
  
  enum
  {
    maximumNumberOfIndicies=floatMappedGridFunctionRCData::maximumNumberOfIndicies,  // we support this many Indicies
    numberOfIndicies=floatMappedGridFunctionRCData::numberOfIndicies,             // A++ supports this many Indicies
 ...
 public:
  ...
  float & operator()(const int & i0, const int & i1 ) const
    { return floatDistributedArray::operator()(i0,i1); }
  float & operator()(const int   & i0, const int   & i1, const int   i2 ) const
    { return floatDistributedArray::operator()(i0,i1,i2); }
  ...
  float & operator()(const int & i0, const int & i1, const int & i2, const int & i3, const int & i4) const
    { return floatDistributedArray::operator()(i0,i1,i2,i3+rcData->R[3].length()*(i4-rcData->R[4].getBase())); }
  float & operator()(const int & i0, const int & i1, const int & i2, const int & i3, const int & i4,
                      const int & i5) const
    { return floatDistributedArray::operator()(i0,i1,i2,i3+rcData->R[3].length()*(
  ...
  float & sa(const int & i0, const int & i1, const int & i2, 
  ...
  void link(const floatMappedGridFunction & mgf, 
...
//   int zeroUnusedPoints(floatMappedGridFunction & coeff, 
//                        float value = 0,
// 		       const Index & component0=nullIndex,
// 		       const Index & component1=nullIndex,
// 		       const Index & component2=nullIndex,
...
// 			      const int & grid=0 );
 ...
 private:
  ...
  // These are used by list's of ReferenceCounting objects
  virtual void reference( const ReferenceCounting & mgf )
  { floatMappedGridFunction::reference( (floatMappedGridFunction&) mgf ); }
  virtual ReferenceCounting & operator=( const ReferenceCounting & mgf )
  { return floatMappedGridFunction::operator=( (floatMappedGridFunction&) mgf ); }
  virtual ReferenceCounting* virtualConstructor( const CopyType ct = DEEP ) const
  { return ::new floatMappedGridFunction(*this,ct); }  
  ...
  aString className;
  floatMappedGridFunctionRCData *rcData;
...
floatMappedGridFunction &
multiply( const floatMappedGridFunction & a, const floatMappedGridFunction & coeff );

floatMappedGridFunction &
multiply( const floatDistributedArray & a, const floatMappedGridFunction & coeff );
...
#endif // floatMappedGridFunction.h
