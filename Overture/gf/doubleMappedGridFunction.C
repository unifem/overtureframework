...
//  positionOfCoordinate.redim(maximumNumberOfIndicies);
  ...
  stencilType            =doubleMappedGridFunction::generalStencil;
//  stencilOffset.redim(1);
  stencilWidth           =3;
  updateToMatchGridOption=doubleMappedGridFunction::updateSize | doubleMappedGridFunction::updateCoefficientMatrix;
  numberOfNames          =0;
  name                   =NULL;
}
doubleMappedGridFunctionRCData::
...
doubleMappedGridFunctionRCData & doubleMappedGridFunctionRCData::
operator=( const doubleMappedGridFunctionRCData & rcData )  // deep copy
{
  if( this == &rcData )
    return *this;
...
// ================ member functions for doubleMappedGridFunction ========
...
//\begin{>>MappedGridFunctionInclude.tex}{\subsubsection{Constructors}} 
doubleMappedGridFunction::
doubleMappedGridFunction(MappedGrid & grid0)
//-----------------------------------------------------------------------------------------
// /Description:
...
//     Range all;
//     MappedGrid mg(...);
//     doubleMappedGridFunction u(mg,all,all,all);
//   \end{verbatim}  
...
//---------------------------------------------------------------------------------------------
doubleMappedGridFunction::
doubleMappedGridFunction(MappedGridData & grid0)
{
  initialize();
  grid=&grid0;
			   ...
			   const Range & R7=nullRange ) 
{
  ...
  for( int i=0; i<doubleMappedGridFunction::maximumNumberOfIndicies; i++ )
    if( Ru[i].length() > 0 )
      count++;
  return count;
}
...
//
//        doubleMappedGridFunction u(mg);                           //  --> u(R1,R2,R3);
//
//        doubleMappedGridFunction u(mg,all,all,all,1);             //  --> u(R1,R2,R3,0:1);
//        doubleMappedGridFunction u(mg,all,all,Range(1,1));        //  --> u(R1,R2,1:1,R3);
//
//        doubleMappedGridFunction u(mg,2,all);                     //  --> u(0:2,R1,R2,R3);
//        doubleMappedGridFunction u(mg,Range(0,2),all,all,all);    //  --> u(0:2,R1,R2,R3);
//        doubleMappedGridFunction u(mg,all,Range(3,3),all,all);    //  --> u(R1,3:3,R2,R3);
//    
//    \end{verbatim}
//    }   
//    
...
//-----------------------------------------------------------------------------------------
{
  ...
  case GridFunctionParameters::faceCenteredAll:
    ...
    default:
      cout << "doubleMappedGridFunction::constructor:ERROR too many components, only 4 allowed \n";
      Overture::abort("doubleMappedGridFunction::constructor:ERROR too many components, only 4 allowed" );
    }
    break;
...
//\begin{>>MappedGridFunctionInclude.tex}{} 
doubleMappedGridFunction::
doubleMappedGridFunction(const doubleMappedGridFunction & cgf, 
...
//-----------------------------------------------------------------------------------------
{
//   printf("Inside doubleMappedGridFunction copy constructor. cgf.name=%s\n",(const char*)cgf.getName());
...
//-----------------------------------------------------------------------------------------
void doubleMappedGridFunction::
initialize()  
{
  rcData = ::new doubleMappedGridFunctionRCData;  //    new : don't call A++ new
...
//==================================================================================
{
  if( operators==NULL )
  {
    cout << "doubleMappedGridFunction: ERROR: trying to applyBoundaryCondition without defining an operator\n";
    Overture::abort("doubleMappedGridFunction: ERROR: trying to applyBoundaryCondition without defining an operator");
  }
  // boundaryConditionError(); 
  #ifdef OV_USE_DOUBLE
    //  boundaryConditionError(); 
     ...
     const Range & C0 /* =nullRange */)
{
  if( operators==NULL )
  {
    cout << "doubleMappedGridFunction: ERROR: trying to finishBoundaryConditions without defining an operator\n";
    Overture::abort("doubleMappedGridFunction: ERROR: trying to finishBoundaryConditions without defining an operator");
  }
  // boundaryConditionError(); 
  #ifdef OV_USE_DOUBLE
    //  boundaryConditionError(); 
		                   ...
		                   const int & grid_ /* =0  */  )
{
  if( operators==NULL )
  {
    cout << "doubleMappedGridFunction: ERROR: trying to applyBoundaryConditionCoefficients without defining an operator\n";
    Overture::abort("doubleMappedGridFunction: ERROR: trying to applyBoundaryConditionCoefficients without defining an operator");
  }
  // boundaryConditionError(); 
  #ifdef OV_USE_DOUBLE
    //  boundaryConditionError(); 
...
{
  cout << "doubleMappedGridFunction: ERROR: do not know how to apply boundary conditions to this grid function\n";
}
...
//-----------------------------------------------------------------------------------------
{
  ...
  {
    doubleMappedGridFunction cgf = *this;  // makes a deep copy
...
int doubleMappedGridFunction::
dataCopy( const doubleMappedGridFunction & mgf )
//==================================================================================
// /Description:
...
// extern doubleMappedGridFunction nullDoubleMappedGridFunction;
...
{
  cout << "doubleMappedGridFunction: ERROR: do not know how to differentiate this grid function\n"
...
//==================================================================================
{
//  *this=nullDoubleMappedGridFunction;
...
//==================================================================================
{
  ...
  dir.find(subDir,name,"doubleMappedGridFunction");
...
aString doubleMappedGridFunction::
getClassName() const 
//==================================================================================
// /Description:
...
doubleSerialArray & doubleMappedGridFunction::
getSerialArray()
//==================================================================================
// /Description:
...
const doubleSerialArray & doubleMappedGridFunction::
...
//==================================================================================
{
  ...
  {
    cout << "doubleMappedGridFunction::getComponentBase:ERROR invalid argument, component = " 
         << component << endl;
    Overture::abort("doubleMappedGridFunction::getComponentBase:ERROR invalid argument");
  }
...
//==================================================================================
{
  if( component<0 || component>=maximumNumberOfComponents )
  {
    cout << "doubleMappedGridFunction::getComponentBound:ERROR invalid argument, component = " 
         << component << endl;
    Overture::abort("doubleMappedGridFunction::getComponentBound:ERROR invalid argument");
  }
...
//==================================================================================
{
  if( component<0 || component>=maximumNumberOfComponents )
  {
    cout << "doubleMappedGridFunction::getComponentDimension:ERROR invalid argument, component = " 
         << component << endl;
    Overture::abort("doubleMappedGridFunction::getComponentDimension:ERROR invalid argument");
  }
  return rcData->R[positionOfComponent(component)].getBound()
...
//==================================================================================
{
  ...
  {
    cout << "doubleMappedGridFunction::getCoordinateBase:ERROR invalid argument, coordinate = " 
         << coordinate << endl;
    Overture::abort("doubleMappedGridFunction::getCoordinateBase:ERROR invalid argument");
  }
...
//==================================================================================
{
  if( coordinate<0 || coordinate>=3 )
  {
    cout << "doubleMappedGridFunction::getCoordinateBound:ERROR invalid argument, coordinate = " 
         << coordinate << endl;
    Overture::abort("doubleMappedGridFunction::getCoordinateBound:ERROR invalid argument");
  }
...
//==================================================================================
{
  if( coordinate<0 || coordinate>=3 )
  {
    cout << "doubleMappedGridFunction::getCoordinateDimension:ERROR invalid argument, coordinate = " 
         << coordinate << endl;
    Overture::abort("doubleMappedGridFunction::getCoordinateDimension:ERROR invalid argument");
  }
  return rcData->R[positionOfCoordinate(coordinate)].getBound()
...
//==================================================================================
{
  ...
  {
    cout << "doubleMappedGridFunction: ERROR: trying to take a derivative without defining operators\n";
  }
}


//\begin{>>MappedGridFunctionInclude.tex}{\subsubsection{getFaceCentering}}
GridFunctionParameters::faceCenteringType doubleMappedGridFunction::
...
GridFunctionParameters::GridFunctionType doubleMappedGridFunction::
...
//-----------------------------------------------------------------------------------------
{
  ...
  else 
  {
	...
	cout << "doubleMappedGridFunction::getGridFunctionType:ERROR: cannot handle more than 3 components\n";
...
GridFunctionParameters::GridFunctionTypeWithComponents doubleMappedGridFunction::
...
//-----------------------------------------------------------------------------------------
{
  ...
  default:
    cerr << "doubleMappedGridFunction::getGridFunctionTypeWithComponents:ERROR unknown grid function type!! \n";
  ...
  if( this )
  {
    cerr << "doubleMappedGridFunction::getGridFunctionTypeWithComponents:ERROR: numberOfLocalComponents=="
...
//     A {\ff doubleMappedGridFunction} can be used for finite
//   difference and finite volume codes. Finite volume
//   codes often require that the grid function be cell-centered.
//   By default a {\ff doubleMappedGridFunction} will be cell-centered
...
// ====================================================================================================
{
  ...
  if( Rc[3].length()!=1 || Rc[4].length()!=1 )
    cout << "doubleMappedGridFunction::getIsCellCentered:ERROR: cannot handle more than 3 components\n";
  Index Axes;
...
//==================================================================================
{
  ...
  if( Rc[3].length()!=1 || Rc[4].length()!=1 )
    cout << "doubleMappedGridFunction::getIsFaceCentered:ERROR: cannot handle more than 3 components\n";
...
MappedGrid* doubleMappedGridFunction::
...
//==================================================================================
{
  ...
  {
    cout << "doubleMappedGridFunction:getMappedGrid:ERROR: The pointer to the MappedGrid is NULL \n";
    Overture::abort("error");
  }
  return mappedGrid;
}
...
MappedGridOperators*  doubleMappedGridFunction::
getOperators() const
//==================================================================================
// /Description:
...
doubleMappedGridFunction::stencilTypes doubleMappedGridFunction:: 
...
void doubleMappedGridFunction::
link(const doubleMappedGridFunction & mgf, 
...
//======================================================================================================
{
  ...
  if( grid==NULL )
  {
    cerr << "doubleMappedGridFunction:ERROR in link, trying to link to a doubleMappedGridFunction \n"
...
// stencilOffset          =mgf.stencilOffset;
  ...
  if( link<0 )
  {
    cout << "doubleMappedGridFunction::link:ERROR nothing to link to!\n";
  ...
  { // if linking to more than one component then Ranges before the link must be full size
    for( i=0; i<link; i++ )
    {
      ...
      {
	cout << "doubleMappedGridFunction::link:ERROR trying to link to invalid components\n";
  ...
  { // we can link to sets of components of the form  (all,...,all,partial,1,...1)
	...
	{
          cout << "doubleMappedGridFunction::link:ERROR trying to link to an invalid component\n";
          cout << "The name of the grid function is " << mgf.getName() << endl;
...
//-----------------------------------------------------------------------------
void doubleMappedGridFunction::
link(const doubleMappedGridFunction & mgf, const int componentToLinkTo, const int numberOfComponents0 )
{
...
doubleMappedGridFunction &
multiply( const doubleMappedGridFunction & a_, const doubleMappedGridFunction & coeff_ )
//==================================================================================
// /Description:
...
//==================================================================================
{
  doubleMappedGridFunction & a = (doubleMappedGridFunction&)a_;  // cast away const
  doubleMappedGridFunction & coeff = (doubleMappedGridFunction &) coeff_;
  
  
  Index I1,I2,I3;
  if( a.getLength(3)!=1 )
  {
    cout << "doubleMappedGridFunction: multiply(a,coeff):ERROR: `a' should be a scalar grid function\n";
...
//\begin{>>MappedGridFunctionInclude.tex}{\subsubsection{multiply(a,coeff)}}
doubleMappedGridFunction &
multiply( const doubleDistributedArray & a_, const doubleMappedGridFunction & coeff_ )
//==================================================================================
// /Description:
...
//==================================================================================
{
  ...
  doubleMappedGridFunction & coeff = (doubleMappedGridFunction &) coeff_;  // cast away const

  Index I1,I2,I3;
  if( a.getLength(3)!=1 )
  {
    cout << "doubleMappedGridFunction: multiply(a,coeff):ERROR: `a' should not be a scalar grid function\n";
    Overture::abort("multiply(a,coeff):ERROR");
  }
  a.reshape(1,Range(a.getBase(0),a.getBound(0)),
		  Range(a.getBase(1),a.getBound(1)),
...
//---------------------------------------------------------------------------------------------------
doubleDistributedArray  doubleMappedGridFunction::  
...
{
  cout << "doubleMappedGridFunction::ERROR: The operator (Index,Index,Index,Index,Index) is not implemented!\n";
  if( &I0 ) // if( TRUE ) to fool kcc compiler
    Overture::abort("doubleMappedGridFunction::ERROR");
...
{
  cout << "doubleMappedGridFunction::ERROR: The operator (Index,Index,Index,Index,Index,Index) is not implemented!\n";
  if( &I0 )
    Overture::abort("doubleMappedGridFunction::ERROR");
  return doubleDistributedArray::operator()(I0);
}
...
{
  cout << "doubleMappedGridFunction::ERROR: The operator (Index,Index,Index,Index,Index,Index,Index) is not implemented!\n";
  if( &I0 )
    Overture::abort("doubleMappedGridFunction::ERROR");
  return doubleDistributedArray::operator()(I0);
}
...
{
  cout << "doubleMappedGridFunction::ERROR: The operator (Index,Index,Index,Index,Index,Index,Index,Index) is not implemented!\n";
  if( &I0 )
    Overture::abort("doubleMappedGridFunction::ERROR");
  return doubleDistributedArray::operator()(I0);
}
...
//-----------------------------------------------------------------------------------------
//\begin{>>MappedGridFunctionInclude.tex}{\subsubsection{operator = doubleMappedGridFunction}}  
doubleMappedGridFunction & doubleMappedGridFunction::
operator= ( const doubleMappedGridFunction & cgf )
//==================================================================================
// /Description:
...
//==================================================================================
{
  ...
  if( grid!=0 && cgf.grid!=0 )
  {
    ...
    if( !isConformable(cgf) )
      printf("doubleMappedGridFunction:operator= ERROR: Try to assign two grid functions that are not conformable\n");
  ...
  else if( cgf.grid!=0 )
  {
    ...
    *rcData                =*cgf.rcData;  // deep copy
    ...
    if( grid==NULL )
    {
      ...
      {
	cerr << "doubleMappedGridFunction:ERROR in operator=, grid is NULL and array is not null!" << endl;
	if( getName()!=" " ) cout << "GridFunctionName = " << getName() << endl;
	exit(1);
      }
      else
...
//==================================================================================
{
  if( grid==NULL )
  {
    printf("doubleMappedGridFunction::operator=:ERROR: trying to assign a mappedGridFunction=value but the grid is NULL!\n");
    Overture::abort("error");
  }
  #ifndef USE_PPP
...
//==================================================================================
{
  if( grid==NULL )
  {
    printf("doubleMappedGridFunction::operator=:ERROR: trying to assign a mappedGridFunction=array but the grid is NULL!\n");
    Overture::abort("error");
  }
  if( isNull() )
  {
...
// only use opt version in serial -- need to write an opt parallel periodic update
  ...
  //   
  doubleMappedGridFunction & u = *this;
...
//   updateComponentsChanged = 4 : component dimensions may have changed (but grid was not resized or reshaped)
//-----------------------------------------------------------------------------------------
doubleMappedGridFunction::updateReturnValue doubleMappedGridFunction::
privateUpdateToMatchGrid()
{
  int returnValue=0;
...
// **      Ra[positionOfCoordinate(axis)]=Range(grid->dimension(Start,axis),grid->dimension(End,axis));
  ...
  {
    cout << "doubleMappedGridFunction:updateToMatchGrid:ERROR: grid is NULL but array is not! " << endl;
  }
...
//==================================================================================
{
  ...
  dir.create(subDir,name,"doubleMappedGridFunction");                      // create a sub-directory 
...
void doubleMappedGridFunction::
reference(const doubleMappedGridFunction & cgf)
//-----------------------------------------------------------------------------------------
// /Description:
//   Use this function to reference one doubleMappedGridFunction to another.
...
double & doubleMappedGridFunction::
sa(const int & i0, 
   const int & i1, 
   const int & i2, 
   const int & c0, /* =0 */
...
//---------------------------------------------------------------------------------------------
{
  ...
  {
    cout << "doubleMappedGridFunction::setFaceCentering:ERROR cannot face center this grid function\n"
         << " since getFaceCentering()==none \n";
    Overture::abort("doubleMappedGridFunction::setFaceCentering:ERROR");
  }
  else if( getFaceCentering()==GridFunctionParameters::all )
  {
    ...
    if( faceCentre== -1 )
    {
      cout << "doubleMappedGridFunction::setFaceCentering::ERROR: unable to find the component for the `face'\n";
...
//   used when the doubleMappedGridFunction is really part of a CompositeGRidFunction. 
// 
//  /Author: WDH
//\end{MappedGridFunctionInclude.tex} 
//---------------------------------------------------------------------------------------------
...
//==================================================================================
{
  ...
  if( Rc[3].length()!=1 || Rc[4].length()!=1 )
    cout << "doubleMappedGridFunction::setIsCellCentered:ERROR: cannot handle more than 3 components\n";
...
//======================================================================================================
{
  ...
  if( Rc[3].length()!=1 || Rc[4].length()!=1 )
    cout << "doubleMappedGridFunction::setIsFaceCentered:ERROR: cannot handle more than 3 components\n";
    ...
    for( int i=0; i<maximumNumberOfComponents; i++ )
    {
      if( c[i]==defaultValue )
        c[i]=R[positionOfComponent(i)].getBase();
 	      ...
 	      c[i] > R[positionOfComponent(i)].getBound() )
      {
	printf("doubleMappedGridFunction::setName:ERROR component%i=%i is invalid ! \n",i,c[i]);
             ...
             const GridFunctionParameters::GridFunctionType & type /* =defaultCentering */ )
{
  ...
  {
    cout << "doubleMappedGridFunction:ERROR: there is no grid associated with this grid function!\n";
    Overture::abort("error");
  }
  Range *R = rcData->R;  // make a reference to the array in rcData
  Range *Ra= rcData->Ra; // make a reference to the array in rcData
  ...
  for( i=0, axis=0, component=0; i<maximumNumberOfIndicies; i++ )
  {
        ...
        if( R[i].getBase() > bigNegativeNumber )
	{
	  ...
	  else
	  {
	    ...
	    {
	      printf("doubleMappedGridFunction::updateRanges::ERROR: unknown grid function type for an unstructured grid\n");
	      Overture::abort("error");
	    }
	  }
	}
  ...
  {
    cout << "doubleMappedGridFunction::ERROR:When you declare a grid function there must be room for " <<
...
// assign default positions for unused coordinates
  ...
  else 
  {
    ...
    {
      cout << "doubleMappedGridFunction::updateRanges:ERROR invalid component Ranges!\n";
      cout << "I am unable to merge these components\n";
      Overture::abort("doubleMappedGridFunction::updateRanges:ERROR");
    }
  }
...
doubleMappedGridFunction::updateReturnValue doubleMappedGridFunction::
updateToMatchGridFunction(const doubleMappedGridFunction & cgf)
//==================================================================================
//\end{MappedGridFunctionInclude.tex} 
//==================================================================================
{
...
// int doubleMappedGridFunction::
// zeroUnusedPoints(doubleMappedGridFunction & coeff, 
//                  double value /* = 0 */,
// 		 const Index & component0 /* =nullIndex */,
// 		 const Index & component1 /* =nullIndex */,
// 		 const Index & component2 /* =nullIndex */,
...
{                                                                                                            \
  ...
  {                                                                                                          \
    cout << "doubleMappedGridFunction: ERROR: trying to take a derivative without defining a derivative routine\n";\
    if( this )  \
      Overture::abort("doubleMappedGridFunction: ERROR");                                                                       \
    return *this;                                                                                            \
  }                                                                                                          \
...
#undef  ARGS1
#undef  ARGS2
#define ARGS1 const doubleMappedGridFunction &w, \
              const Index & I1, \
              const Index & I2, \
              const Index & I3
...
#undef  ARGS1
#define ARGS1 const doubleMappedGridFunction &s, \
              const Index & I1, \
              const Index & I2, \
              const Index & I3, \
              const Index & I4, \
