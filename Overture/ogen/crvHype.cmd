...
#
# usage: ogen [noplot] crvHype -factor=<num> -interp=[e/i] -dw=<num> -iw=<> 
#  -dw : discretization width : for 2 layers of interpolation points set the dw to 5 
#  -iw : interpolation width 
# examples:
#     ogen noplot crvHype -factor=2 
#     ogen noplot crvHype -factor=2 -dw=5 -iw=5 -interp=e -name="crvHypee2.order4.hdf"
#     ogen noplot crvHype -factor=3 -dw=5 -iw=5 -interp=e -name="crvHypee3.order4.hdf"
#     ogen noplot crvHype -factor=4 -dw=5 -iw=5 -interp=e -name="crvHypee4.order4.hdf"
#     ogen noplot crvHype -factor=2 -dw=7 -iw=5 -interp=e -name="crvHypee2.dw7iw5.hdf"
#
#  srun -N8 -n32 -ppdebug $ogenp noplot crvHype -factor=16 -dw=5 -iw=5 -interp=e -name="crvHypee16.order4.hdf"
#
# srun -N1 -n2 -ppdebug $ogenp noplot crvHype
# 
...
$exponent=10.; $stretchFactor=1.75;
# 
...
# 
$suffix = ".order$order"; 
if( $name eq "" ){$name = "crvHype" . "$interp$factor" . $suffix . ".hdf";}
# 
...
#-     exit
#
#  Use the hyperbolic mapping instead of the normal mapping 
#
  hyperbolic
