#
# loftedHalfBox: make grids for the exterior of a quarter-box with rounded corners
#
# Usage:
#    ogen [-noplot] loftedQuarterBoxGrid.cmd -factor=<> -interp=[e|i] -order=<> -ml=<> -widthX=<> -widthY=<> -widthZ=<> ...
...
# Examples:
#
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -factor=2 
# 
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -order=4 -factor=2 
#
# -- multigrid:
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -factor=2 -ml=1
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -factor=4 -ml=1
#
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -order=4 -factor=2 -ml=1
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -order=4 -factor=4 -ml=1
#
#
# ******************** from loftedHalfBox:
#  ogen -noplot loftedQuarterBoxGrid.cmd -factor=2 
#  ogen -noplot loftedQuarterBoxGrid.cmd -factor=2 -widthX=2.
#  ogen -noplot loftedQuarterBoxGrid.cmd -factor=2 -widthZ=2.
# 
# -- multigrid:
#  ogen -noplot loftedQuarterBoxGrid.cmd -factor=2 -ml=1
# 
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -xa=-1. -xb=2.5 -factor=2 -ml=1
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -xa=-1. -xb=2.5 -xbc=5. -order=2 -factor=8 -ml=2
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -xa=-1. -xb=2.5 -xbc=5. -order=2 -factor=8 -ml=3
# -- fourth-order
#  ogen -noplot loftedQuarterBoxGrid.cmd -order=4 -interp=e -ml=1 -factor=2
#
#
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=i -xa=-1. -xb=2.5 -xbc=5. -order=4 -factor=2 -ml=1 
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -xa=-1. -xb=2.5 -xbc=5. -order=4 -factor=3 -ml=1 
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -xa=-1. -xb=2.5 -xbc=5. -order=4 -factor=3 -ml=2
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -xa=-1. -xb=2.5 -xbc=5. -order=4 -factor=4 -ml=2 
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -xa=-1. -xb=2.5 -xbc=5. -order=4 -factor=4 -ml=3
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -xa=-1. -xb=2.5 -xbc=5. -order=4 -factor=8 -ml=2
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -xa=-1. -xb=2.5 -xbc=5. -order=4 -factor=8 -ml=3
#
# TEST for valid grid:
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -refinementBox=0 -xa=-1. -xb=1.5 -xbc=1.5 -order=4 -factor=3 -ml=1 
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -refinementBox=0 -xa=-1. -xb=1.5 -xbc=1.5 -order=4 -factor=3 -ml=2
#  ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -refinementBox=0 -xa=-1. -xb=1.5 -xac=-1.5 -yac=-1.5 -ybc=1.5 -xbc=1.5 -zac=-1.5 zbc=1.5 -order=4 -factor=3 -ml=2
# TESTS for Ogmg:
#   ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -xac=-1.5 -xbc=1.5 -yac=-1.5 -ybc=1.5 -zac=-1.5 -zbc=1.5 -factor=2 -ml=2
# 
#  -- no refinement box:
#   ogen -noplot loftedQuarterBoxGrid.cmd -interp=e -refinementBox=0 -xac=-1.5 -xbc=1.5 -yac=-1.5 -ybc=1.5 -zac=-1.5 -zbc=1.5 -factor=2 -ml=2
#
# - sharper corners:
#  ogen loftedQuarterBoxGrid -factor=4 -sharpnessLB=120. 
#  
# Options:
...
#
#
$prefix="loftedQuarterBoxGrid";     # prefix for grid name 
#
...
$xar=0.; $xbr=2.; $yar=0; $ybr=1.; $zar=-1.; $zbr=1.; 
...
if( $name eq "" ){$name = "loftedQuarterBoxGrid" . "$interp$factor" . $suffix . ".hdf";}
# 
#
...
#  the lofted mapping has a singularity
  builder
    create surface grid...
      Start curve:loftedQuarterBoxGridSurface
      plot options...
...
#
      ...
      name loftedQuarterBoxGridFrontSurface
      # open graphics
    exit
  exit
#
...
#
  reparameterize
    ...
    lines 
       $ns $nTheta 
    mappingName
      loftedQuarterBoxGridSurfaceNoEnds
    exit    
#
#  Split the front surface in half
#
#-   reparameterize
#-     transform which mapping?
#-       loftedHalfBoxGridFrontSurface
#-     restrict parameter space
#-       set corners
#-         .0 1. .5 1. 
#-       exit
#-     mappingName
#-       loftedQuarterBoxGridFrontSurface
#-     open graphics
#- 
#-     exit    
#
...
#
  hyperbolic
    Start curve:loftedQuarterBoxGridSurfaceNoEnds
...
#
    ...
    lines 
       ...
       $ns $nTheta $nr 
    name loftedQuarterBoxGridBodyUnstretched
    # open graphics 
 exit
#
...
#
  hyperbolic
    Start curve:loftedQuarterBoxGridFrontSurface
    # target grid spacing .05 .05 (tang,normal, <0 : use default)
    distance to march $nDist
    $linesToMarch = $nr-1; 
    lines to march $linesToMarch
    ...
    share
      0 0 3 0 $wallShare 0
    name loftedQuarterBoxGridFrontUnstretched
    # open graphics
 exit
#
...
#
  stretch coordinates
    transform which mapping?
      loftedQuarterBoxGridBodyUnstretched
    STRT:multigrid levels $ml 
    Stretch r3:exp to linear
    STP:stretch r3 expl: min dx, max dx $dsBL $ds
    STRT:name loftedQuarterBoxGridBody
  exit
#
  stretch coordinates
    transform which mapping?
      loftedQuarterBoxGridFrontUnstretched
    STRT:multigrid levels $ml 
    Stretch r3:exp to linear
    STP:stretch r3 expl: min dx, max dx $dsBL $ds
    STRT:name loftedQuarterBoxGridFront
  exit
#
#
...
convertToNurbs(loftedQuarterBoxGridBody,loftedQuarterBoxGridBodyNurbs,$angle,$rotationAxis,$xShift,$yShift,$zShift);
$cmds
convertToNurbs(loftedQuarterBoxGridFront,loftedQuarterBoxGridFrontNurbs,$angle,$rotationAxis,$xShift,$yShift,$zShift);
$cmds
#
...
generate an overlapping grid
  ...
  $cmd
#  loftedQuarterBoxGridBody
#  loftedQuarterBoxGridFront
# -- use nurbs versions
  loftedQuarterBoxGridBodyNurbs
  loftedQuarterBoxGridFrontNurbs
#
  done
  change parameters
