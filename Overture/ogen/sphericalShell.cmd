...
*  Spherical shell 
*
*   ogen noplot sphericalShell -interp=e -factor=2
* 
*   ogen noplot sphericalShell -interp=e -factor=3
*   ogen noplot sphericalShell -interp=e -factor=4
* 
* 
...
* 
$suffix = ".order$order"; 
if( $name eq "" ){$name = "sphericalShell" . "$interp$factor" . $suffix . ".hdf";}
* 
* 
# $ds=1./50./$factor;
