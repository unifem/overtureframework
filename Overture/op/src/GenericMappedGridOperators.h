...
class AssignInterpNeighbours;  // forward declaration
...
class GenericMappedGridOperators
{
 ...
 public:
  ...
  int getOrderOfAccuracy() const { return orderOfAccuracy; }
  ...
  // set the default width for extrapolation of interpolation neighbours
...
#undef SCALAR_FUNCTION_COEFFICIENTS
  ...
  void setInterpolationPoint( intArray & interpolationPoint );  // used by GenericCompositeGridOperators
 ...
 public:
  ...
  enum boundaryConditionTypes   // get rid of this eventually **** Must match BCTypes ****
  {
    ...
    oddSymmetry=BCTypes::oddSymmetry,
...
// 			      const int & grid=0 );
  ...
  virtual void finishBoundaryConditionsOld
    (realMappedGridFunction & u,
     const BoundaryConditionParameters & bcParameters= Overture::defaultBoundaryConditionParameters(),
     const Range & C0=nullRange);
...
// *wdh* 091123 -- Here is the old way: ------------------------------------------------------
  ...
  int maximumWidthToExtrapolationInterpolationNeighbours; // new *wdh* 060319
  IntegerArray *extrapolateInterpolationNeighbourPoints;
  IntegerArray *extrapolateInterpolationNeighboursDirection;
  IntegerArray *extrapolateInterpolationNeighboursVariableWidth;  // new *wdh* 060319
// *wdh* 091123 -- Here is the new way: ------------------------------------------------------
...
static int defaultMaximumWidthToExtrapolationInterpolationNeighbours;

static real timeForDirichlet;
static real timeForNeumann;
static real timeForExtrapolate;
static real timeForNormalComponent;
static real timeForGeneralMixedDerivative;
static real timeForNormalDerivative;
static real timeForNormalDerivativeOfADotU;
static real timeForADotU;
static real timeForADotGradU;
static real timeForNormalDotScalarGrad;
static real timeForSymmetry;
static real timeForGeneralizedDivergence;
static real timeForExtrapolateInterpolationNeighbours;
static real timeForExtrapolateNormalComponent;
static real timeForExtrapolateRefinementBoundaries;
static real timeForPeriodicUpdate;
static real timeForFixBoundaryCorners;

static real timeToSetupBoundaryConditions;
static real timeForAllBoundaryConditions;
