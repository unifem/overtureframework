// **** THIS FILE WAS AUTOMATICALLY GENERATED BY makeOperators.p from GenericGridCollectionOperators.C ******
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{Constructors}}  
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{}
GenericCompositeGridOperators::
GenericCompositeGridOperators( CompositeGrid & g0 )
//=======================================================================================
// /Description:
//   Construct a GenericCompositeGridOperators
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{}
GenericCompositeGridOperators::
GenericCompositeGridOperators( GenericMappedGridOperators & op )
//=======================================================================================
// /Description:
//   Construct a GenericCompositeGridOperators using a MappedGridOperators
...
//===========================================================================================
GenericCompositeGridOperators::
GenericCompositeGridOperators( CompositeGrid & g0, GenericMappedGridOperators & op)
{
  mappedGridOperatorsPointer=&op;
  updateToMatchGrid( g0 );
  setup();
...
//===========================================================================================
GenericCompositeGridOperators::
GenericCompositeGridOperators( const GenericCompositeGridOperators & gco ) 
{
...
//  to the base classGenericCompositeGridOperators.
//
//  Notes:
//   o This routine is needed if this class has been derived from the base class GenericCompositeGridOperators
...
virtualConstructor()
{
  return new GenericCompositeGridOperators();
}



//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{get}}
...
//-------------------------------------------------------------------
{
  cout << "GenericCompositeGridOperators::get - not implemented yet!\n"; 
  return 1;
...
//================================================================================
GenericMappedGridOperators & GenericCompositeGridOperators::
operator[]( const int grid ) const
{
  if( grid<0 || grid>=mappedGridOperators.getLength() )
  {
    cout << "GenericCompositeGridOperators:ERROR in operator[]  argument grid is invalid" << endl;
    cout << "grid = " << grid << endl;
    cout << "mappedGridOperators.getLength() = " << mappedGridOperators.getLength() << endl;
    cout << "Perhaps you forgot to associate a CompositeGrid with the GenericCompositeGridOperators object\n";
    cout << "Do this in the constructor of GenericCompositeGridOperators or use updateToMatchGrid\n";
    Overture::abort("This is a fatal error");
  }    
  return mappedGridOperators[grid];
}

//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{put}}
int GenericCompositeGridOperators::
...
//==================================================================================
{
  cout << " GenericCompositeGridOperators::put - not implemented yet!\n"; 
  return 0;
}

//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{setOrderOfAccuracy}}
void GenericCompositeGridOperators::
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{getOrderOfAccuracy}}
int GenericCompositeGridOperators::
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{setStencilSize}}
void GenericCompositeGridOperators::
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsection{sizeOf}} 
real GenericCompositeGridOperators::
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{useConservativeApproximations}}
void GenericCompositeGridOperators::
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{setAveragingType}}
void GenericCompositeGridOperators::
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{updateToMatchGrid}}
void GenericCompositeGridOperators::
updateToMatchGrid( CompositeGrid & gc )              // here is a (new) CompositeGrid to use
//========================================================================
// /Description:
//   Use this update function to associate a new CompositeGrid with this object or to
//   update the object when the CompositeGrid changes.
...
//========================================================================
{
  gridCollection.reference(gc);                       // keep a reference to this CompositeGrid
...
#define DERIVATIVE(x)                                                                       \
realCompositeGridFunction GenericCompositeGridOperators::                                 \
x( const realCompositeGridFunction & u, ARGS1 )                                            \
{                                                                                           \
 /* Determine the dimensions of the return type from the dimensions of the derivative of the mappedGridFunction.*/ \
  ...
  realCompositeGridFunction result((CompositeGrid&)(*u.gridCollection),R[0],R[1],R[2],R[3],R[4],R[5],R[6],R[7]);  \
  result[0]=r;  \
  \
...
realCompositeGridFunction GenericCompositeGridOperators::                                 \
x( const realCompositeGridFunction & u, const GridFunctionParameters & gfType, ARGS1 )     \
{                                                                                           \
  realMappedGridFunction r;  \
  int grid=0;  \
...
#undef  ARGS1
#undef  ARGS2
#define ARGS1 const realCompositeGridFunction &w, \
              const Index & C1, \
              const Index & C2, \
              const Index & C3
...
{                                                                                           \
  ...
  realCompositeGridFunction result(gridCollection,stencilDim,all,all,all);                         \
...
#undef  ARGS1
#define ARGS1 const realCompositeGridFunction &s, \
              const Index & C1, \
              const Index & C2, \
              const Index & C3, \
              const Index & C4
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{setTwilightZoneFlow}}  
void GenericCompositeGridOperators::
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{setTwilightZoneFlowFunction}}  
void GenericCompositeGridOperators:: 
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{applyBoundaryConditions}}  
void GenericCompositeGridOperators:: 
applyBoundaryConditions(realCompositeGridFunction & u, 
			const real & time, /* =0. */
...
//=======================================================================================
{
  if( grid0==forAll )
  {
    for( int grid=0; grid<gridCollection.numberOfGrids(); grid++ )
    {
      ...
      {
        printf("GenericCompositeGridOperators::applyBoundaryConditions:ERROR\n"
...
//\begin{>>GenericCompositeGridOperatorsInclude.tex}{\subsubsection{ApplyBoundaryConditions}}  
void GenericCompositeGridOperators:: 
assignBoundaryConditionCoefficients(realCompositeGridFunction & coeff, 
				    const real & time, /* =0. */ 
				    const int & grid0  /* =forAll */ )
//=======================================================================================
// /Description:
...
//\begin{>>CompositeGridOperatorsInclude.tex}{\subsubsection{applyBoundaryCondition}}  
void GenericCompositeGridOperators::
applyBoundaryCondition(realCompositeGridFunction & u, 
...
//\begin{>>CompositeGridOperatorsInclude.tex}{\subsubsection{applyBoundaryConditionCoefficients}}  
void GenericCompositeGridOperators::
applyBoundaryConditionCoefficients(realCompositeGridFunction & coeff, 
...
#include "SparseRep.h"
#endif
//\begin{>>CompositeGridOperatorsInclude.tex}{\subsubsection{finishBoundaryConditions}}  
void GenericCompositeGridOperators::
finishBoundaryConditions(realCompositeGridFunction & u,
