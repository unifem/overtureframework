...
C
C            EZFFTF    A SIMPLIFIED REAL PERIODIC FORWARD TRANSFORM
C            EZFFTB    A SIMPLIFIED REAL PERIODIC BACKWARD TRANSFORM
C
C            SINTI     INITIALIZE SINT
C            SINT      SINE TRANSFORM OF A REAL ODD SEQUENCE
C
C            COSTI     INITIALIZE COST
C            COST      COSINE TRANSFORM OF A REAL EVEN SEQUENCE
C
C            SINQI     INITIALIZE SINQF AND SINQB
C            SINQF     FORWARD SINE TRANSFORM WITH ODD WAVE NUMBERS
C            SINQB     UNNORMALIZED INVERSE OF SINQF
C
C            COSQI     INITIALIZE COSQF AND COSQB
C            COSQF     FORWARD COSINE TRANSFORM WITH ODD WAVE NUMBERS
C            COSQB     UNNORMALIZED INVERSE OF COSQF
C
...
C
C*WDH DIMENSION       R(1)       ,A(1)       ,B(1)       ,WSAVE(1)
...
C     ( CALL EZFFTI(N,WSAVE) ) FROM BOTH EZFFTF AND EZFFTB AND INSERT IT
C     AT THE BEGINNING OF YOUR PROGRAM FOLLOWING THE DEFINITION OF N.
C
  103 CALL EZFFTI (N,WSAVE)
C
      DO 104 I=1,N
         WSAVE(I) = R(I)
  104 CONTINUE
