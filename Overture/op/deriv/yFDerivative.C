...
void 
yFDerivative42(const realMappedGridFunction & ugf,
...
{                                                                        
  ...
  { // these lines also prevent warnings about unused variables.
    printf("yFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
  ...
  for( n=N.getBase(); n<=N.getBound(); n++ )                        
    derivative(I1,I2,I3,n)=UY42(I1,I2,I3,n);                  
}

void 
yFDerivative43(const realMappedGridFunction & ugf,
	     RealDistributedArray & derivative,
	     const Index & I1,
	     const Index & I2,
	     const Index & I3,
...
{                                                                        
  ...
  for( n=N.getBase(); n<=N.getBound(); n++ )                        
      derivative(I1,I2,I3,n)=UY43(I1,I2,I3,n);                  
}

void 
yFDerivative22(const realMappedGridFunction & ugf,
	     RealDistributedArray & derivative,
	     const Index & I1,
	     const Index & I2,
	     const Index & I3,
...
{                                                                        
  ...
  for( n=N.getBase(); n<=N.getBound(); n++ )                        
    derivative(I1,I2,I3,n)=UY22(I1,I2,I3,n);                  
}

void 
yFDerivative23(const realMappedGridFunction & ugf,
	     RealDistributedArray & derivative,
	     const Index & I1,
	     const Index & I2,
	     const Index & I3,
...
{                                                                        
  ...
  for( n=N.getBase(); n<=N.getBound(); n++ )                        
    derivative(I1,I2,I3,n)=UY23(I1,I2,I3,n);                  
}


void 
yFDerivative(const realMappedGridFunction & ugf,
	     RealDistributedArray & derivative,
	     const Index & I1,
	     const Index & I2,
	     const Index & I3,
...
//       const RealArray & h22 = mgop.h22;
      ...
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UY21R(I1,I2,I3,n);                  
      }
      else if(numberOfDimensions==2 )
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UY22R(I1,I2,I3,n);                  
      }
      else if( numberOfDimensions==3 )
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UY23R(I1,I2,I3,n);                  
      }
      else
      {  // these lines also prevent warnings about unused variables.
	printf("yFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
...
#define h42(n) h42c[n]
	...
	h42(axis)=1./(12.*SQR(mgop.dx[axis]));
      ...
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UY41R(I1,I2,I3,n);                  
      }
      else if(numberOfDimensions==2 )
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UY42R(I1,I2,I3,n);                  
      }
      else if( numberOfDimensions==3 )
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UY43R(I1,I2,I3,n);                  
      }
      else
      {  // these lines also prevent warnings about unused variables.
	printf("yFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
  ...
  { // Ths grid is not rectangular
    ...
    if( orderOfAccuracy==2 )
    {
      ...
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UY21(I1,I2,I3,n);                  
      }
      else if(numberOfDimensions==2 )
        yFDerivative22(ugf,derivative,I1,I2,I3,N,mgop );
      else if( numberOfDimensions==3 )
        yFDerivative23(ugf,derivative,I1,I2,I3,N,mgop );
      else
      {  // these lines also prevent warnings about unused variables.
	printf("yFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
    ...
    else   // ====== 4th order =======
    {
      ...
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UY41(I1,I2,I3,n);                  
      }
      else if(numberOfDimensions==2 )
        yFDerivative42(ugf,derivative,I1,I2,I3,N,mgop );
      else if( numberOfDimensions==3 )
        yFDerivative43(ugf,derivative,I1,I2,I3,N,mgop );
      else
      {  // these lines also prevent warnings about unused variables.
	printf("yFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
	u.display("u"); ur.display("ur"); us.display("us"); ut.display("ut"); 
