...
void 
yzFDerivative42(const realMappedGridFunction & ugf,
...
{                                                                        
  ...
  { // these lines also prevent warnings about unused variables.
    printf("yzFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
  ...
  for( n=N.getBase(); n<=N.getBound(); n++ )                        
    derivative(I1,I2,I3,n)=UYZ42(I1,I2,I3,n);                  
}

void 
yzFDerivative43(const realMappedGridFunction & ugf,
	     RealDistributedArray & derivative,
	     const Index & I1,
	     const Index & I2,
	     const Index & I3,
...
{                                                                        
  ...
  for( n=N.getBase(); n<=N.getBound(); n++ )                        
      derivative(I1,I2,I3,n)=UYZ43(I1,I2,I3,n);                  
}

void 
yzFDerivative22(const realMappedGridFunction & ugf,
	     RealDistributedArray & derivative,
	     const Index & I1,
	     const Index & I2,
	     const Index & I3,
...
{                                                                        
  ...
  for( n=N.getBase(); n<=N.getBound(); n++ )                        
    derivative(I1,I2,I3,n)=UYZ22(I1,I2,I3,n);                  
}

void 
yzFDerivative23(const realMappedGridFunction & ugf,
	     RealDistributedArray & derivative,
	     const Index & I1,
	     const Index & I2,
	     const Index & I3,
...
{                                                                        
  ...
  for( n=N.getBase(); n<=N.getBound(); n++ )                        
    derivative(I1,I2,I3,n)=UYZ23(I1,I2,I3,n);                  
}


void 
yzFDerivative(const realMappedGridFunction & ugf,
	     RealDistributedArray & derivative,
	     const Index & I1,
	     const Index & I2,
	     const Index & I3,
...
//       const RealArray & h22 = mgop.h22;
      ...
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYZ21R(I1,I2,I3,n);                  
      }
      else if(numberOfDimensions==2 )
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYZ22R(I1,I2,I3,n);                  
      }
      else if( numberOfDimensions==3 )
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYZ23R(I1,I2,I3,n);                  
      }
      else
      {  // these lines also prevent warnings about unused variables.
	printf("yzFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
...
#define h42(n) h42c[n]
	...
	h42(axis)=1./(12.*SQR(mgop.dx[axis]));
      ...
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYZ41R(I1,I2,I3,n);                  
      }
      else if(numberOfDimensions==2 )
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYZ42R(I1,I2,I3,n);                  
      }
      else if( numberOfDimensions==3 )
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYZ43R(I1,I2,I3,n);                  
      }
      else
      {  // these lines also prevent warnings about unused variables.
	printf("yzFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
  ...
  { // Ths grid is not rectangular
    ...
    if( orderOfAccuracy==2 )
    {
      ...
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYZ21(I1,I2,I3,n);                  
      }
      else if(numberOfDimensions==2 )
        yzFDerivative22(ugf,derivative,I1,I2,I3,N,mgop );
      else if( numberOfDimensions==3 )
        yzFDerivative23(ugf,derivative,I1,I2,I3,N,mgop );
      else
      {  // these lines also prevent warnings about unused variables.
	printf("yzFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
    ...
    else   // ====== 4th order =======
    {
      ...
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYZ41(I1,I2,I3,n);                  
      }
      else if(numberOfDimensions==2 )
        yzFDerivative42(ugf,derivative,I1,I2,I3,N,mgop );
      else if( numberOfDimensions==3 )
        yzFDerivative43(ugf,derivative,I1,I2,I3,N,mgop );
      else
      {  // these lines also prevent warnings about unused variables.
	printf("yzFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
	u.display("u"); ur.display("ur"); us.display("us"); ut.display("ut"); 
