...
void 
rtDerivative(const realMappedGridFunction & ugf,
...
{                                                                        
  ...
  if( orderOfAccuracy==2 )
  {
    ...
    { // these lines also prevent warnings about unused variables.
      printf("rtDerivative:ERROR: numberOfDimensions=%i\n",mgop.mappedGrid.numberOfDimensions());
      Overture::abort("error");
    }
    for( n=N.getBase(); n<=N.getBound(); n++ )
      derivative(I1,I2,I3,n)=URT2(I1,I2,I3,n);
  }
  else // ====== 4th order =======
  {
    ...
    for( n=N.getBase(); n<=N.getBound(); n++ )
      derivative(I1,I2,I3,n)=URT4(I1,I2,I3,n);
  }
}
