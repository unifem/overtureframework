...
void 
yyFDerivative42(const realMappedGridFunction & ugf,
...
{                                                                        
  ...
  { // these lines also prevent warnings about unused variables.
    printf("yyFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
  ...
  for( n=N.getBase(); n<=N.getBound(); n++ )                        
    derivative(I1,I2,I3,n)=UYY42(I1,I2,I3,n);                  
}

void 
yyFDerivative43(const realMappedGridFunction & ugf,
	     RealDistributedArray & derivative,
	     const Index & I1,
	     const Index & I2,
	     const Index & I3,
...
{                                                                        
  ...
  for( n=N.getBase(); n<=N.getBound(); n++ )                        
      derivative(I1,I2,I3,n)=UYY43(I1,I2,I3,n);                  
}

void 
yyFDerivative22(const realMappedGridFunction & ugf,
	     RealDistributedArray & derivative,
	     const Index & I1,
	     const Index & I2,
	     const Index & I3,
...
{                                                                        
  ...
  for( n=N.getBase(); n<=N.getBound(); n++ )                        
    derivative(I1,I2,I3,n)=UYY22(I1,I2,I3,n);                  
}

void 
yyFDerivative23(const realMappedGridFunction & ugf,
	     RealDistributedArray & derivative,
	     const Index & I1,
	     const Index & I2,
	     const Index & I3,
...
{                                                                        
  ...
  for( n=N.getBase(); n<=N.getBound(); n++ )                        
    derivative(I1,I2,I3,n)=UYY23(I1,I2,I3,n);                  
}


void 
yyFDerivative(const realMappedGridFunction & ugf,
	     RealDistributedArray & derivative,
	     const Index & I1,
	     const Index & I2,
	     const Index & I3,
...
//       const RealArray & h22 = mgop.h22;
      ...
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYY21R(I1,I2,I3,n);                  
      }
      else if(numberOfDimensions==2 )
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYY22R(I1,I2,I3,n);                  
      }
      else if( numberOfDimensions==3 )
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYY23R(I1,I2,I3,n);                  
      }
      else
      {  // these lines also prevent warnings about unused variables.
	printf("yyFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
...
#define h42(n) h42c[n]
	...
	h42(axis)=1./(12.*SQR(mgop.dx[axis]));
      ...
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYY41R(I1,I2,I3,n);                  
      }
      else if(numberOfDimensions==2 )
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYY42R(I1,I2,I3,n);                  
      }
      else if( numberOfDimensions==3 )
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYY43R(I1,I2,I3,n);                  
      }
      else
      {  // these lines also prevent warnings about unused variables.
	printf("yyFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
  ...
  { // Ths grid is not rectangular
    ...
    if( orderOfAccuracy==2 )
    {
      ...
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYY21(I1,I2,I3,n);                  
      }
      else if(numberOfDimensions==2 )
        yyFDerivative22(ugf,derivative,I1,I2,I3,N,mgop );
      else if( numberOfDimensions==3 )
        yyFDerivative23(ugf,derivative,I1,I2,I3,N,mgop );
      else
      {  // these lines also prevent warnings about unused variables.
	printf("yyFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
    ...
    else   // ====== 4th order =======
    {
      ...
      {
        for( n=N.getBase(); n<=N.getBound(); n++ )                        
          derivative(I1,I2,I3,n)=UYY41(I1,I2,I3,n);                  
      }
      else if(numberOfDimensions==2 )
        yyFDerivative42(ugf,derivative,I1,I2,I3,N,mgop );
      else if( numberOfDimensions==3 )
        yyFDerivative43(ugf,derivative,I1,I2,I3,N,mgop );
      else
      {  // these lines also prevent warnings about unused variables.
	printf("yyFDerivative:ERROR: numberOfDimensions=%i, orderOfAccuracy=%i\n",numberOfDimensions,orderOfAccuracy);
	u.display("u"); ur.display("ur"); us.display("us"); ut.display("ut"); 
