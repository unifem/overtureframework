...
! coeffOperator2ndOrder(rs)
       subroutine rsCoeff2ndOrder( nd, nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,
...
c
c  nc1a,nd1b : subset for evaluating rs, axis 1
c  nc2a,nd2b : subset for evaluating rs, axis 2
c  nc3a,nd3b : subset for evaluating rs, axis 3
c
...
! rs2ndOrder3dRectangular(x,x,1,2)
             ...
             d8=d*8.
             d64=d*64.
! loopBody2ndOrder3dSwitchxx(0.,0.,0., 0.,0.,0., 0.,0.,0., d,0.,-d, 0.,0.,0., -d,0.,d, 0.,0.,0., 0.,0.,0., 0.,0.,0.)
