...
! coeffOperator2ndOrder(st)
       subroutine stCoeff2ndOrder( nd, nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,
...
c
c  nc1a,nd1b : subset for evaluating st, axis 1
c  nc2a,nd2b : subset for evaluating st, axis 2
c  nc3a,nd3b : subset for evaluating st, axis 3
c
