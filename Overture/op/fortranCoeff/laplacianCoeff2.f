...
! coeffOperator2ndOrder(laplacian)
       subroutine laplacianCoeff2ndOrder( nd, nd1a,nd1b,nd2a,nd2b,nd3a,
...
c
c  nc1a,nd1b : subset for evaluating laplacian, axis 1
c  nc2a,nd2b : subset for evaluating laplacian, axis 2
c  nc3a,nd3b : subset for evaluating laplacian, axis 3
c
...
!              #If "laplacian" == "laplacian"
               ...
               rsx =(2.*d12(1)*d12(2))*(rx(i1,i2,i3)*sx(i1,i2,i3)+ry(
     & i1,i2,i3)*sy(i1,i2,i3))
...
c ** it did not affect performance to use an array to index coeff ***
            ...
            do i1=n1a,n1b
!             #If "laplacian" == "laplacian"
! loopBody2ndOrder3d(0.,0.,0.,0.,h22(3),0.,0.,0.,0., 0.,h22(2),0.,h22(1),-2.*(h22(1)+h22(2)+h22(3)),h22(1),0.,h22(2),0., 0.,0.,0.,0.,h22(3),0.,0.,0.,0. )
...
c ** it did not affect performance to use an array to index coeff ***
            ...
            do i1=n1a,n1b
!             #If "laplacian" == "laplacian"
             rxSq = d22(1)*(rx(i1,i2,i3)**2+ry(i1,i2,i3)**2+rz(i1,i2,
     & i3)**2)
             rxx  = d12(1)*(rxx23(i1,i2,i3)+ryy23(i1,i2,i3)+rzz23(i1,
     & i2,i3))
             sxSq = d22(2)*(sx(i1,i2,i3)**2+sy(i1,i2,i3)**2+sz(i1,i2,
     & i3)**2)
             sxx  = d12(2)*(sxx23(i1,i2,i3)+syy23(i1,i2,i3)+szz23(i1,
     & i2,i3))
             txSq = d22(3)*(tx(i1,i2,i3)**2+ty(i1,i2,i3)**2+tz(i1,i2,
     & i3)**2)
             txx  = d12(3)*(txx23(i1,i2,i3)+tyy23(i1,i2,i3)+tzz23(i1,
     & i2,i3))
             rsx  = (2.*d12(1)*d12(2))*(rx(i1,i2,i3)*sx(i1,i2,i3)+ry(
     & i1,i2,i3)*sy(i1,i2,i3)+rz(i1,i2,i3)*sz(i1,i2,i3))
             rtx  = (2.*d12(1)*d12(3))*(rx(i1,i2,i3)*tx(i1,i2,i3)+ry(
     & i1,i2,i3)*ty(i1,i2,i3)+rz(i1,i2,i3)*tz(i1,i2,i3))
             stx  = (2.*d12(2)*d12(3))*(sx(i1,i2,i3)*tx(i1,i2,i3)+sy(
