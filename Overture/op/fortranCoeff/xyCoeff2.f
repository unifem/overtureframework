...
! coeffOperator2ndOrder(xy)
     ...
     & a32 )
       ...
       !
       !  nc1a,nd1b : subset for evaluating xy, axis 1
       !  nc2a,nd2b : subset for evaluating xy, axis 2
       !  nc3a,nd3b : subset for evaluating xy, axis 3
       !
...
!       #Elif "xy" == "xy"
             ...
             rxx  = d12(1)*(rxy2(i1,i2,i3))
               ...
               rsx = (d12(1)*d12(2))*(rx(i1,i2,i3)*sy(i1,i2,i3)+ry(i1,
     & i2,i3)*sx(i1,i2,i3))
