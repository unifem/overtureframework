...
c      implicit none
     ...
     &  gridType, order
      ...
      real UYZ21R, UYZ21, UYZ41R, UYZ41
      real UYZ22R, UYZ22, UYZ42R, UYZ42
      real UYZ23R, UYZ23, UYZ43R, UYZ43
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UYZ22R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UYZ42R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UYZ22(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UYZ42(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UYZ23R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UYZ43R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UYZ23(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UYZ43(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UYZ21R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UYZ41R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UYZ21(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UYZ41(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
