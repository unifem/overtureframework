...
#beginMacro limitedExtrapolation3()
 ue3 = 3.*u(i1+  (is1),i2+  (is2),i3+  (is3),c)  \
     - 3.*u(i1+2*(is1),i2+2*(is2),i3+2*(is3),c)  \
     +    u(i1+3*(is1),i2+3*(is2),i3+3*(is3),c)

 ue1 =    u(i1+is1,i2+is2,i3+is3,c)
 ue2 = 2.*u(i1+is1,i2+is2,i3+is3,c)-u(i1+2*is1,i2+2*is2,i3+2*is3,c) 

 denom =abs(ue3)+abs(u(i1+is1,i2+is2,i3+is3,c))+abs(u(i1+2*is1,i2+2*is2,i3+2*is3,c))+uEps
...
#beginMacro limitedExtrapolation2()
 ue1 =    u(i1+is1,i2+is2,i3+is3,c)
 ue2 = 2.*u(i1+is1,i2+is2,i3+is3,c)-u(i1+2*is1,i2+2*is2,i3+2*is3,c) 

 denom =abs(ue2)+abs(u(i1+is1,i2+is2,i3+is3,c))+abs(u(i1+2*is1,i2+2*is2,i3+2*is3,c))+uEps
...
c======================================================================
     ...
     & ndu1a,ndu1b,ndu2a,ndu2b,ndu3a,ndu3b,ndu4a,ndu4b
      ...
      integer ia(nda1a:nda1b,0:*), id(ndd1a:ndd1b,0:*), vew(ndd1a:ndd1b,0:*)
...
c     --- local variables 
      ...
      if( .false. .and. nd.eq.2 ) then
        ...
        do i=n1a,n1b
          ...
          if( i1.lt.ndu1a .or. i1.gt.ndu1b .or. i1+width*id(i,0).lt.ndu1a .or. i1+width*id(i,0).gt.ndu1b .or.\
              i2.lt.ndu2a .or. i2.gt.ndu2b .or. i2+width*id(i,1).lt.ndu2a .or. i2+width*id(i,1).gt.ndu2b )then
            write(*,'("extrapInterpNeighboursOpt:ERROR: i=",2i4," id=",2i4," ndu1a,...=",4i4)') \
              i1,i2,id(i,0),id(i,1),ndu1a,ndu1b,ndu2a,ndu2b
            ! '
          end if
        end do
      end if
 	...
 	if( nd.eq.2 ) then 
 	  ...
 	  loops(u(ia(i,0),i2,i3,c)=u(ia(i,0)+id(i,0),i2,i3,c))
        ...
        if( nd.eq.2 ) then 
           loops(u(ia(i,0),ia(i,1),i3,c)=(4.*u(ia(i,0)+  id(i,0),ia(i,1)+  id(i,1),i3,c)- \
 				          6.*u(ia(i,0)+2*id(i,0),ia(i,1)+2*id(i,1),i3,c)+ \
 				          4.*u(ia(i,0)+3*id(i,0),ia(i,1)+3*id(i,1),i3,c)- \
 				             u(ia(i,0)+4*id(i,0),ia(i,1)+4*id(i,1),i3,c)) )
        else if( nd.eq.3 ) then
           loops(u(ia(i,0),ia(i,1),ia(i,2),c)=(4.*u(ia(i,0)+  id(i,0),ia(i,1)+  id(i,1),ia(i,2)+  id(i,2),c)-\
 					       6.*u(ia(i,0)+2*id(i,0),ia(i,1)+2*id(i,1),ia(i,2)+2*id(i,2),c)+\
 					       4.*u(ia(i,0)+3*id(i,0),ia(i,1)+3*id(i,1),ia(i,2)+3*id(i,2),c)-\
 					          u(ia(i,0)+4*id(i,0),ia(i,1)+4*id(i,1),ia(i,2)+4*id(i,2),c)))
        else
 	  loops(u(ia(i,0),i2,i3,c)=(4.*u(ia(i,0)+  id(i,0),i2,i3,c)-\
 				    6.*u(ia(i,0)+2*id(i,0),i2,i3,c)+\
 				    4.*u(ia(i,0)+3*id(i,0),i2,i3,c)-\
        ...
        if( nd.eq.2 ) then 
           loops(u(ia(i,0),ia(i,1),i3,c)=(5.*u(ia(i,0)+  id(i,0),ia(i,1)+  id(i,1),i3,c)- \
 				         10.*u(ia(i,0)+2*id(i,0),ia(i,1)+2*id(i,1),i3,c)+ \
 				         10.*u(ia(i,0)+3*id(i,0),ia(i,1)+3*id(i,1),i3,c)- \
 				          5.*u(ia(i,0)+4*id(i,0),ia(i,1)+4*id(i,1),i3,c)+ \
 				             u(ia(i,0)+5*id(i,0),ia(i,1)+5*id(i,1),i3,c)) )
        else if( nd.eq.3 ) then
           loops(u(ia(i,0),ia(i,1),ia(i,2),c)=(5.*u(ia(i,0)+  id(i,0),ia(i,1)+  id(i,1),ia(i,2)+  id(i,2),c)-\
 					      10.*u(ia(i,0)+2*id(i,0),ia(i,1)+2*id(i,1),ia(i,2)+2*id(i,2),c)+\
 					      10.*u(ia(i,0)+3*id(i,0),ia(i,1)+3*id(i,1),ia(i,2)+3*id(i,2),c)-\
 					       5.*u(ia(i,0)+4*id(i,0),ia(i,1)+4*id(i,1),ia(i,2)+4*id(i,2),c)+\
 					          u(ia(i,0)+5*id(i,0),ia(i,1)+5*id(i,1),ia(i,2)+5*id(i,2),c)))
        else
 	  loops(u(ia(i,0),i2,i3,c)=(5.*u(ia(i,0)+  id(i,0),i2,i3,c)-\
 				   10.*u(ia(i,0)+2*id(i,0),i2,i3,c)+\
 				   10.*u(ia(i,0)+3*id(i,0),i2,i3,c)-\
 				    5.*u(ia(i,0)+4*id(i,0),i2,i3,c)+\
 				       u(ia(i,0)+5*id(i,0),i2,i3,c)))
        end if

       else if( orderOfExtrapolation.eq.6 )then 

        if( nd.eq.2 ) then 
           loops(u(ia(i,0),ia(i,1),i3,c)=(6.*u(ia(i,0)+  id(i,0),ia(i,1)+  id(i,1),i3,c)- \
 				         15.*u(ia(i,0)+2*id(i,0),ia(i,1)+2*id(i,1),i3,c)+ \
 				         20.*u(ia(i,0)+3*id(i,0),ia(i,1)+3*id(i,1),i3,c)- \
 				         15.*u(ia(i,0)+4*id(i,0),ia(i,1)+4*id(i,1),i3,c)+ \
 				          6.*u(ia(i,0)+5*id(i,0),ia(i,1)+5*id(i,1),i3,c)- \
 				             u(ia(i,0)+6*id(i,0),ia(i,1)+6*id(i,1),i3,c)) )
        else if( nd.eq.3 ) then
           loops(u(ia(i,0),ia(i,1),ia(i,2),c)=(6.*u(ia(i,0)+  id(i,0),ia(i,1)+  id(i,1),ia(i,2)+  id(i,2),c)-\
 					      15.*u(ia(i,0)+2*id(i,0),ia(i,1)+2*id(i,1),ia(i,2)+2*id(i,2),c)+\
 					      20.*u(ia(i,0)+3*id(i,0),ia(i,1)+3*id(i,1),ia(i,2)+3*id(i,2),c)-\
 					      15.*u(ia(i,0)+4*id(i,0),ia(i,1)+4*id(i,1),ia(i,2)+4*id(i,2),c)+\
 					       6.*u(ia(i,0)+5*id(i,0),ia(i,1)+5*id(i,1),ia(i,2)+5*id(i,2),c)-\
 					          u(ia(i,0)+6*id(i,0),ia(i,1)+6*id(i,1),ia(i,2)+6*id(i,2),c)))
        else
 	  loops(u(ia(i,0),i2,i3,c)=(6.*u(ia(i,0)+  id(i,0),i2,i3,c)-\
 				   15.*u(ia(i,0)+2*id(i,0),i2,i3,c)+\
 				   20.*u(ia(i,0)+3*id(i,0),i2,i3,c)-\
 				   15.*u(ia(i,0)+4*id(i,0),i2,i3,c)+\
 				    6.*u(ia(i,0)+5*id(i,0),i2,i3,c)-\
 				       u(ia(i,0)+6*id(i,0),i2,i3,c)))
        end if

       else if( orderOfExtrapolation.eq.7 )then 

        if( nd.eq.2 ) then 
           loops(u(ia(i,0),ia(i,1),i3,c)=(7.*u(ia(i,0)+  id(i,0),ia(i,1)+  id(i,1),i3,c)- \
 				         21.*u(ia(i,0)+2*id(i,0),ia(i,1)+2*id(i,1),i3,c)+ \
 				         35.*u(ia(i,0)+3*id(i,0),ia(i,1)+3*id(i,1),i3,c)- \
 				         35.*u(ia(i,0)+4*id(i,0),ia(i,1)+4*id(i,1),i3,c)+ \
 				         21.*u(ia(i,0)+5*id(i,0),ia(i,1)+5*id(i,1),i3,c)- \
 				          7.*u(ia(i,0)+6*id(i,0),ia(i,1)+6*id(i,1),i3,c)+ \
 				             u(ia(i,0)+7*id(i,0),ia(i,1)+7*id(i,1),i3,c)) )
        else if( nd.eq.3 ) then
           loops(u(ia(i,0),ia(i,1),ia(i,2),c)=(7.*u(ia(i,0)+  id(i,0),ia(i,1)+  id(i,1),ia(i,2)+  id(i,2),c)-\
 					      21.*u(ia(i,0)+2*id(i,0),ia(i,1)+2*id(i,1),ia(i,2)+2*id(i,2),c)+\
 					      35.*u(ia(i,0)+3*id(i,0),ia(i,1)+3*id(i,1),ia(i,2)+3*id(i,2),c)-\
 					      35.*u(ia(i,0)+4*id(i,0),ia(i,1)+4*id(i,1),ia(i,2)+4*id(i,2),c)+\
 					      21.*u(ia(i,0)+5*id(i,0),ia(i,1)+5*id(i,1),ia(i,2)+5*id(i,2),c)-\
 					       7.*u(ia(i,0)+6*id(i,0),ia(i,1)+6*id(i,1),ia(i,2)+6*id(i,2),c)+\
 					          u(ia(i,0)+7*id(i,0),ia(i,1)+7*id(i,1),ia(i,2)+7*id(i,2),c)))
        else
 	  loops(u(ia(i,0),i2,i3,c)=(7.*u(ia(i,0)+  id(i,0),i2,i3,c)-\
 				   21.*u(ia(i,0)+2*id(i,0),i2,i3,c)+\
 				   35.*u(ia(i,0)+3*id(i,0),i2,i3,c)-\
 				   35.*u(ia(i,0)+4*id(i,0),i2,i3,c)+\
 				   21.*u(ia(i,0)+5*id(i,0),i2,i3,c)-\
 				    7.*u(ia(i,0)+6*id(i,0),i2,i3,c)+\
 				       u(ia(i,0)+7*id(i,0),i2,i3,c)))
        end if

       else if( orderOfExtrapolation.eq.8 )then 

        if( nd.eq.2 ) then 
           loops(u(ia(i,0),ia(i,1),i3,c)=(8.*u(ia(i,0)+  id(i,0),ia(i,1)+  id(i,1),i3,c)- \
 				         28.*u(ia(i,0)+2*id(i,0),ia(i,1)+2*id(i,1),i3,c)+ \
 				         56.*u(ia(i,0)+3*id(i,0),ia(i,1)+3*id(i,1),i3,c)- \
 				         70.*u(ia(i,0)+4*id(i,0),ia(i,1)+4*id(i,1),i3,c)+ \
 				         56.*u(ia(i,0)+5*id(i,0),ia(i,1)+5*id(i,1),i3,c)- \
 				         28.*u(ia(i,0)+6*id(i,0),ia(i,1)+6*id(i,1),i3,c)+ \
 				          8.*u(ia(i,0)+7*id(i,0),ia(i,1)+7*id(i,1),i3,c)- \
 				             u(ia(i,0)+8*id(i,0),ia(i,1)+8*id(i,1),i3,c)) )
        else if( nd.eq.3 ) then
           loops(u(ia(i,0),ia(i,1),ia(i,2),c)=(8.*u(ia(i,0)+  id(i,0),ia(i,1)+  id(i,1),ia(i,2)+  id(i,2),c)-\
 					      28.*u(ia(i,0)+2*id(i,0),ia(i,1)+2*id(i,1),ia(i,2)+2*id(i,2),c)+\
 					      56.*u(ia(i,0)+3*id(i,0),ia(i,1)+3*id(i,1),ia(i,2)+3*id(i,2),c)-\
 					      70.*u(ia(i,0)+4*id(i,0),ia(i,1)+4*id(i,1),ia(i,2)+4*id(i,2),c)+\
 					      56.*u(ia(i,0)+5*id(i,0),ia(i,1)+5*id(i,1),ia(i,2)+5*id(i,2),c)-\
 					      28.*u(ia(i,0)+6*id(i,0),ia(i,1)+6*id(i,1),ia(i,2)+6*id(i,2),c)+\
 					       8.*u(ia(i,0)+7*id(i,0),ia(i,1)+7*id(i,1),ia(i,2)+7*id(i,2),c)-\
 					          u(ia(i,0)+8*id(i,0),ia(i,1)+8*id(i,1),ia(i,2)+8*id(i,2),c)))
        else
 	  loops(u(ia(i,0),i2,i3,c)=(8.*u(ia(i,0)+  id(i,0),i2,i3,c)-\
 				   28.*u(ia(i,0)+2*id(i,0),i2,i3,c)+\
 				   56.*u(ia(i,0)+3*id(i,0),i2,i3,c)-\
 				   70.*u(ia(i,0)+4*id(i,0),i2,i3,c)+\
 				   56.*u(ia(i,0)+5*id(i,0),i2,i3,c)-\
 				   28.*u(ia(i,0)+6*id(i,0),i2,i3,c)+\
 				    8.*u(ia(i,0)+7*id(i,0),i2,i3,c)-\
 				       u(ia(i,0)+8*id(i,0),i2,i3,c)))
        end if

       else if( orderOfExtrapolation.eq.9 )then 

        if( nd.eq.2 ) then 
           loops(u(ia(i,0),ia(i,1),i3,c)=(9.*u(ia(i,0)+  id(i,0),ia(i,1)+  id(i,1),i3,c)- \
 				         36.*u(ia(i,0)+2*id(i,0),ia(i,1)+2*id(i,1),i3,c)+ \
 				         84.*u(ia(i,0)+3*id(i,0),ia(i,1)+3*id(i,1),i3,c)- \
 				        126.*u(ia(i,0)+4*id(i,0),ia(i,1)+4*id(i,1),i3,c)+ \
 				        126.*u(ia(i,0)+5*id(i,0),ia(i,1)+5*id(i,1),i3,c)- \
 				         84.*u(ia(i,0)+6*id(i,0),ia(i,1)+6*id(i,1),i3,c)+ \
 				         36.*u(ia(i,0)+7*id(i,0),ia(i,1)+7*id(i,1),i3,c)- \
 				          9.*u(ia(i,0)+8*id(i,0),ia(i,1)+8*id(i,1),i3,c)+ \
 				             u(ia(i,0)+9*id(i,0),ia(i,1)+9*id(i,1),i3,c)) )
        else if( nd.eq.3 ) then
           loops(u(ia(i,0),ia(i,1),ia(i,2),c)=(9.*u(ia(i,0)+  id(i,0),ia(i,1)+  id(i,1),ia(i,2)+  id(i,2),c)-\
 					      36.*u(ia(i,0)+2*id(i,0),ia(i,1)+2*id(i,1),ia(i,2)+2*id(i,2),c)+\
 					      84.*u(ia(i,0)+3*id(i,0),ia(i,1)+3*id(i,1),ia(i,2)+3*id(i,2),c)-\
 					     126.*u(ia(i,0)+4*id(i,0),ia(i,1)+4*id(i,1),ia(i,2)+4*id(i,2),c)+\
 					     126.*u(ia(i,0)+5*id(i,0),ia(i,1)+5*id(i,1),ia(i,2)+5*id(i,2),c)-\
 					      84.*u(ia(i,0)+6*id(i,0),ia(i,1)+6*id(i,1),ia(i,2)+6*id(i,2),c)+\
 					      36.*u(ia(i,0)+7*id(i,0),ia(i,1)+7*id(i,1),ia(i,2)+7*id(i,2),c)-\
 					       9.*u(ia(i,0)+8*id(i,0),ia(i,1)+8*id(i,1),ia(i,2)+8*id(i,2),c)+\
 					          u(ia(i,0)+9*id(i,0),ia(i,1)+9*id(i,1),ia(i,2)+9*id(i,2),c)))
        else
 	  loops(u(ia(i,0),i2,i3,c)=(9.*u(ia(i,0)+  id(i,0),i2,i3,c)-\
 				   36.*u(ia(i,0)+2*id(i,0),i2,i3,c)+\
 				   84.*u(ia(i,0)+3*id(i,0),i2,i3,c)-\
 				  126.*u(ia(i,0)+4*id(i,0),i2,i3,c)+\
 				  126.*u(ia(i,0)+5*id(i,0),i2,i3,c)-\
 				   84.*u(ia(i,0)+6*id(i,0),i2,i3,c)+\
 				   36.*u(ia(i,0)+7*id(i,0),i2,i3,c)-\
 				    9.*u(ia(i,0)+8*id(i,0),i2,i3,c)+\
 	...
 	write(*,*) 'extrapInterpNeighboursOpt:ERROR:Not implemented: '
       ...
       ! write(*,'("extrapInterpNeighbours: use limiter, order=",i2," limiterPar0=",e9.2)')\
       !    orderOfExtrapolation,limiterPar0
       ! '
 	...
 	write(*,*) 'extrapInterpNeighboursOpt:ERROR: '
      ...
      if( .false. .and. nd.eq.3 ) then
        do i=n1a,n1b
          write(*,'(" EIN: i=",i4," ia=",3i4," u=",e12.6)') i,ia(i,0),ia(i,1),ia(i,2),u(ia(i,0),ia(i,1),ia(i,2),0)
        end do
      end if
...
c     --- local variables 
     ...
     & is1,is2,is3,useWhereMask
      ...
      if( bcType.eq.extrapolate .and. extrapolationOption.eq.polynomialExtrapolation )then
      ...
      else if( bcType.eq.extrapolate .and. extrapolationOption.eq.extrapolateWithLimiter )then
