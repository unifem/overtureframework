          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UX22R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UX42R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UX22(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UX42(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UX23R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UX43R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UX23(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UX43(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UX21R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UX41R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UX21(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UX41(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
