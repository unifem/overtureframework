...
c      implicit none
     ...
     &  gridType, order
      ...
      real UXX21R, UXX21, UXX41R, UXX41
      real UXX22R, UXX22, UXX42R, UXX42
      real UXX23R, UXX23, UXX43R, UXX43
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UXX22R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UXX42R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UXX22(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UXX42(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UXX23R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UXX43R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UXX23(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UXX43(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UXX21R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UXX41R(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
          ...
          if( order.eq.2 )then
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UXX21(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
            ...
            do c=ca,cb
              do i3=n3a,n3b
                do i2=n2a,n2b
                  do i1=n1a,n1b
                    deriv(i1,i2,i3,c)=UXX41(i1,i2,i3,c)
                  end do
                end do
              end do
            end do
