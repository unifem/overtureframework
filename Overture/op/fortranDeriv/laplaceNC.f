...
! nonConservative(laplaceNC)
       subroutine laplaceNC( nd,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,ndu1a,
     & ndu1b,ndu2a,ndu2b,ndu3a,ndu3b,ndu4a,ndu4b, ndd1a,ndd1b,ndd2a,
     & ndd2b,ndd3a,ndd3b,ndd4a,ndd4b, n1a,n1b,n2a,n2b,n3a,n3b, ca,cb, 
     & h21,d22,d12,h22,d14,d24,h41,h42,rsxy,u,s,deriv,derivOption,
...
c......end statement function
       kd3=nd
! #If "laplaceNC" == "divScalarGradNC"
! #Elif "laplaceNC" == "laplaceNC"
c       ****** laplace ******
       if( nd .eq. 2 )then
c         ******* 2D *************      
...
! nonConservativeNew(laplaceNC)
       subroutine laplaceNCNew( nd,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,ndu1a,
     & ndu1b,ndu2a,ndu2b,ndu3a,ndu3b,ndu4a,ndu4b, ndd1a,ndd1b,ndd2a,
     & ndd2b,ndd3a,ndd3b,ndd4a,ndd4b, n1a,n1b,n2a,n2b,n3a,n3b, ca,cb, 
     & dr,dx,rsxy,u,sc,deriv,derivOption,gridType,order,averagingType,
     & dir1,dir2 )
c ===============================================================
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN22R(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN22R(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN42R(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN42R(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN62R(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN62R(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN82R(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN82R(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN22(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN22(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN42(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN42(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN62(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN62(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN82(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN82(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN23R(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN23R(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN43R(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN43R(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN63R(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN63R(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN83R(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN83R(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN23(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN23(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN43(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN43(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN63(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN63(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN83(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN83(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN21R(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN21R(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN41R(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN41R(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN61R(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN61R(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN81R(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN81R(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN21(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN21(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN41(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN41(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN61(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN61(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
...
! loopsDSG(deriv(i1,i2,i3,c)=ULAPLACIAN81(i1,i2,i3,c))
             do c=ca,cb
               do i3=n3a,n3b
                 do i2=n2a,n2b
                   do i1=n1a,n1b
                     deriv(i1,i2,i3,c)=ULAPLACIAN81(i1,i2,i3,c)
                   end do
                 end do
               end do
             end do
