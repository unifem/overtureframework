! ********** *wdh* 091123 : This is the old version -- new version is findInterpNeighbours.bf  ************
...
c     const intArray & mask = mg.mask()
     ...
     & ndm1a,ndm1b,ndm2a,ndm2b,ndm3a,ndm3b,
     & ndi,ndin, indexRange, dim, ni, nin, mask,m, ip,id,ia,vew, ipar, ierr )
!======================================================================
!  Optimised findInterpolationNeighbours
!         
! nd : number of space dimensions
...
!     --- local variables -----
      integer n1a,n1b,n2a,n2b,n3a,n3b,i1,i2,i3,i,n0,n1,n2,mm,j1,j2,j3,myid
