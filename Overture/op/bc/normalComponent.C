...
applyBCnormalComponent(realMappedGridFunction & u, 
		       const int side,
		       const int axis,
		       ...
		       const int & grid  )
{
  ...
  //       u <- u + (g-(n.u)) n
  //
  getVelocityComponents( n1,n2,n3,m1,m2,m3, u,bcParameters,"normalComponent",uC,fC );
...
//       }
  ...
  if( numberOfDimensions==2 )
  {
    uDotN(I1,I2,I3)=uA(I1,I2,I3,n1)*normal(I1,I2,I3,0)+uA(I1,I2,I3,n2)*normal(I1,I2,I3,1);
  }
  else if( numberOfDimensions==3 )
  {
    uDotN(I1,I2,I3)=uA(I1,I2,I3,n1)*normal(I1,I2,I3,0)
      +uA(I1,I2,I3,n2)*normal(I1,I2,I3,1) 
      +uA(I1,I2,I3,n3)*normal(I1,I2,I3,2);
  }
  else
  ...
  { // In this case we want to specify the value for n.u
    if( numberOfDimensions==2 )
      uDotN(I1,I2,I3)-=(*e)(c,I1,I2,I3,m1,t)*normal(I1,I2,I3,0)
	+(*e)(c,I1,I2,I3,m2,t)*normal(I1,I2,I3,1);
    else if( numberOfDimensions==3 ) 
      uDotN(I1,I2,I3)-=(*e)(c,I1,I2,I3,m1,t)*normal(I1,I2,I3,0)
	+(*e)(c,I1,I2,I3,m2,t)*normal(I1,I2,I3,1) 
	+(*e)(c,I1,I2,I3,m3,t)*normal(I1,I2,I3,2);
    else
  ...
  else if( bcOption==arrayForcing )
  {
    ...
    {
      #ifdef USE_PPP
	Overture::abort("MappedGridOperators::applyBCnormalComponent:ERROR finish me Bill!");
      #else    
      if( numberOfDimensions==2 ) 
	uDotN(I1,I2,I3)-=(arrayDataD(I1,I2,I3,m1)*normal(I1,I2,I3,0)+
			  arrayDataD(I1,I2,I3,m2)*normal(I1,I2,I3,1));
      else if( numberOfDimensions==3 )
	uDotN(I1,I2,I3)-=(arrayDataD(I1,I2,I3,m1)*normal(I1,I2,I3,0)+
			  arrayDataD(I1,I2,I3,m2)*normal(I1,I2,I3,1)+
			  arrayDataD(I1,I2,I3,m3)*normal(I1,I2,I3,2));
      else
	uDotN(I1,I2,I3)-=arrayDataD(I1,I2,I3,m1)*(2*side-1);  // outward normal in 1D
      #endif
    }
    else if( side<=arrayData.getBound(1) && axis<=arrayData.getBound(2) && grid<=arrayData.getBound(3) )
    {
      if( numberOfDimensions==2 ) 
	uDotN(I1,I2,I3)-=arrayData(m1,side,axis,grid)*normal(I1,I2,I3,0)
	  +arrayData(m2,side,axis,grid)*normal(I1,I2,I3,1);
      else if( numberOfDimensions==3 )
	uDotN(I1,I2,I3)-=arrayData(m1,side,axis,grid)*normal(I1,I2,I3,0)
	  +arrayData(m2,side,axis,grid)*normal(I1,I2,I3,1) 
	  +arrayData(m3,side,axis,grid)*normal(I1,I2,I3,2);
      else
	uDotN(I1,I2,I3)-=arrayData(m1,side,axis,grid)*(2*side-1);  // outward normal in 1D
    }
    else
    {
      if( numberOfDimensions==2 ) 
	uDotN(I1,I2,I3)-=arrayData(m1)*normal(I1,I2,I3,0)
	  +arrayData(m2)*normal(I1,I2,I3,1);
      else if( numberOfDimensions==3 )
	uDotN(I1,I2,I3)-=arrayData(m1)*normal(I1,I2,I3,0)
	  +arrayData(m2)*normal(I1,I2,I3,1) 
	  +arrayData(m3)*normal(I1,I2,I3,2);
      else
	uDotN(I1,I2,I3)-=arrayData(m1,side,axis,grid)*(2*side-1);  // outward normal in 1D
    }
  }
  ...
  {  // use user supplied variable values
    if( gfData.getComponentDimension(0) < numberOfDimensions )   
      ...
      uDotN(I1,I2,I3)-=gfData(I1,I2,I3,m1)*normal(I1,I2,I3,0)
	+gfData(I1,I2,I3,m2)*normal(I1,I2,I3,1);
    else if( numberOfDimensions==3 )
      uDotN(I1,I2,I3)-=gfData(I1,I2,I3,m1)*normal(I1,I2,I3,0)
	+gfData(I1,I2,I3,m2)*normal(I1,I2,I3,1) 
	+gfData(I1,I2,I3,m3)*normal(I1,I2,I3,2);
    else
      uDotN(I1,I2,I3)-=gfData(I1,I2,I3,m1)*(2*side-1);  // outward normal in 1D
  }
  else
  {
    {throw "Invalid value for bcOption! (normalComponent)";}
