//================================================================================
//   Define the coefficient matrix for the x derivative
//================================================================================
...
void 
xFDerivCoefficients(RealDistributedArray & derivative,
		     const Index & I1,
		     const Index & I2,
		     const Index & I3,
		     const Index & E,
...
/* ---    
	...
	ForStencil(m1,m2,m3)                                            
	{                                                               
	  UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UX21(I1,I2,I3,c0); 
	}
      }
	...
	ForStencil(m1,m2,m3)                                            
	{                                                               
	  UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UX22(I1,I2,I3,c0);    
	}
      }
      else // ======= 3D ================
      {
	ForStencil(m1,m2,m3)                                            
	{                                                               
	  UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UX23(I1,I2,I3,c0);
	}
      }
    }
    else   // ====== 4th order =======
	...
	ForStencil(m1,m2,m3)                                            
	{                                                               
	  UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UX41(I1,I2,I3,c0);  
	}
      }
      else if( numberOfDimensions==2 )
      {
	ForStencil(m1,m2,m3)                                            
	{                                                               
	  UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UX42(I1,I2,I3,c0);  
	}
      }
      else  // ======= 3D ================
      {
	ForStencil(m1,m2,m3)                                            
	{                                                               
	  UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UX43(I1,I2,I3,c0);  
	}
      }
    }
-- */
...
#define h21(n) h21c[n]
	...
	derivative(M+CE(c0,e0),I1,I2,I3)=0.;
      ...
      derivative(MCE(-1, 0, 0),I1,I2,I3)=-h21(axis1);
      derivative(MCE(+1, 0, 0),I1,I2,I3)= h21(axis1);
    }
    else   // ====== 4th order =======
    {
...
#define h41(n) h41c[n]
      ...
      derivative(MCE(-2, 0, 0),I1,I2,I3)=    +h41(axis1);
      derivative(MCE(-1, 0, 0),I1,I2,I3)= -8.*h41(axis1);
      derivative(MCE(+1, 0, 0),I1,I2,I3)=  8.*h41(axis1);
      derivative(MCE(+2, 0, 0),I1,I2,I3)=    -h41(axis1);
    }
  }
  else
  {
    ...
    if( orderOfAccuracy==2 )
    {
      ...
      if( numberOfDimensions==1 )
      { // get coefficients for the first component
        realArray rx; rx = d12(axis1)*RX(I1,I2,I3); 
      ...
      {
        realArray rx; rx = d12(axis1)*RX(I1,I2,I3); 
        realArray sx; sx = d12(axis2)*SX(I1,I2,I3); 
        rx.reshape(1,I1,I2,I3);
      ...
      else // ======= 3D ================
      {
        realArray rx; rx = d12(axis1)*RX(I1,I2,I3); 
        realArray sx; sx = d12(axis2)*SX(I1,I2,I3); 
        realArray tx; tx = d12(axis3)*TX(I1,I2,I3); 
        rx.reshape(1,I1,I2,I3);
        sx.reshape(1,I1,I2,I3);
    ...
    else   // ====== 4th order =======
    {
      ...
      if( numberOfDimensions==1 )
      {
        realArray rx; rx = d14(axis1)*RX(I1,I2,I3);
        rx .reshape(1,I1,I2,I3);
	...
	derivative(MCE( 0, 0, 0),I1,I2,I3)=     0.;
      ...
      {
        realArray rx; rx = d14(axis1)*(RX(I1,I2,I3));
        realArray sx; sx = d14(axis2)*(SX(I1,I2,I3));
	...
	derivative(M+CE(c0,e0),I1,I2,I3)=     0.;
      ...
      else  // ======= 3D ================
      {
        realArray rx; rx = d14(axis1)*(RX(I1,I2,I3));
        realArray sx; sx = d14(axis2)*(SX(I1,I2,I3));
        realArray tx; tx = d14(axis3)*(TX(I1,I2,I3));
  ...
  // time=getCPU()-time;
  // printf("xFDerivCoefficients: time = %e \n",time);
