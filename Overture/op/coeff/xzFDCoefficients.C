//================================================================================
//   Define the coefficient matrix for the xz derivative
//================================================================================
...
void 
xzFDerivCoefficients4(RealDistributedArray & derivative,
		     const Index & I1,
		     const Index & I2,
		     const Index & I3,
		     const Index & E,
...
{                                                                        
  ...
  realArray rxSq; rxSq = d24(axis1)*(RX(I1,I2,I3)*RZ(I1,I2,I3));
  realArray rxx; rxx = d14(axis1)*(RXZ43(I1,I2,I3));

  realArray sxSq; sxSq = d24(axis2)*(SX(I1,I2,I3)*SZ(I1,I2,I3));
  realArray sxx; sxx = d14(axis2)*(SXZ43(I1,I2,I3));

  realArray txSq; txSq = d24(axis3)*(TX(I1,I2,I3)*TZ(I1,I2,I3));
  realArray txx; txx = d14(axis3)*(TXZ43(I1,I2,I3));

  realArray rsx; rsx = (d14(axis1)*d14(axis2))*(RX(I1,I2,I3)*SZ(I1,I2,I3)+RZ(I1,I2,I3)*SX(I1,I2,I3));
  realArray rtx; rtx = (d14(axis1)*d14(axis3))*(RX(I1,I2,I3)*TZ(I1,I2,I3)+RZ(I1,I2,I3)*TX(I1,I2,I3));
  realArray stx; stx = (d14(axis2)*d14(axis3))*(SX(I1,I2,I3)*TZ(I1,I2,I3)+SZ(I1,I2,I3)*TX(I1,I2,I3));
...
void 
xzFDerivCoefficients(RealDistributedArray & derivative,
		     const Index & I1,
		     const Index & I2,
		     const Index & I3,
		     const Index & E,
...
/* ----    
    ...
    if( orderOfAccuracy==2 )
    {
      ...
      ForStencil(m1,m2,m3)                                            
      {                                                               
	UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UXZ23(I1,I2,I3,c0);
      }
    }
    else   // ====== 4th order =======
    {
      ...
      ForStencil(m1,m2,m3)                                            
      {                                                               
	UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UXZ43(I1,I2,I3,c0);  
      }
    }
---- */
  }
...
#define h21(n) h21c[n]
      ...
      Range M(0,bound);
      derivative(M+CE(c0,e0),I1,I2,I3)=0.;
      real d=h21(axis1)*h21(axis3);
      derivative(MCE(-1, 0,-1),I1,I2,I3)= d;
      derivative(MCE(+1, 0,-1),I1,I2,I3)=-d;
      derivative(MCE(-1, 0,+1),I1,I2,I3)=-d;
      derivative(MCE(+1, 0,+1),I1,I2,I3)= d;
    }
...
#define h41(n) h41c[n]
      ...
      Range M(0,bound);
      derivative(M+CE(c0,e0),I1,I2,I3)=0.;
      real d=h41(axis1)*h41(axis3);
      derivative(MCE(-2, 0,-2),I1,I2,I3)=     d;
      derivative(MCE(-1, 0,-2),I1,I2,I3)= -8.*d;
      derivative(MCE( 1, 0,-2),I1,I2,I3)=  8.*d;
      derivative(MCE( 2, 0,-2),I1,I2,I3)=    -d;
      derivative(MCE(-2, 0,-1),I1,I2,I3)= -8.*d;
      derivative(MCE(-1, 0,-1),I1,I2,I3)= 64.*d;
      derivative(MCE( 1, 0,-1),I1,I2,I3)=-64.*d;
      derivative(MCE( 2, 0,-1),I1,I2,I3)=  8.*d;
      derivative(MCE(-2, 0, 1),I1,I2,I3)=  8.*d;
      derivative(MCE(-1, 0, 1),I1,I2,I3)=-64.*d;
...
//      +TXY23(I1,I2,I3)*UT2(I1,I2,I3,KD) )                  
      realArray rxSq; rxSq = d22(axis1)*(RX(I1,I2,I3)*RZ(I1,I2,I3));
      realArray rxx; rxx = d12(axis1)*(RXZ23(I1,I2,I3));

      realArray sxSq; sxSq = d22(axis2)*(SX(I1,I2,I3)*SZ(I1,I2,I3));
      realArray sxx; sxx = d12(axis2)*(SXZ23(I1,I2,I3));

      realArray txSq; txSq = d22(axis3)*(TX(I1,I2,I3)*TZ(I1,I2,I3));
      realArray txx; txx = d12(axis3)*(TXZ23(I1,I2,I3));

      realArray rsx; rsx = (d12(axis1)*d12(axis2))*(RX(I1,I2,I3)*SZ(I1,I2,I3)+RZ(I1,I2,I3)*SX(I1,I2,I3));
      realArray rtx; rtx = (d12(axis1)*d12(axis3))*(RX(I1,I2,I3)*TZ(I1,I2,I3)+RZ(I1,I2,I3)*TX(I1,I2,I3));
      realArray stx; stx = (d12(axis2)*d12(axis3))*(SX(I1,I2,I3)*TZ(I1,I2,I3)+SZ(I1,I2,I3)*TX(I1,I2,I3));
    ...
    {
      xzFDerivCoefficients4(derivative,I1,I2,I3,E,C,mgop );
