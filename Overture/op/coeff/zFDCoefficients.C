//================================================================================
//   Define the coefficient matrix for the z derivative
//================================================================================
...
void 
zFDerivCoefficients(RealDistributedArray & derivative,
		     const Index & I1,
		     const Index & I2,
		     const Index & I3,
		     const Index & E,
...
/* ----    
    ...
    if( orderOfAccuracy==2 )
    {
      ...
      ForStencil(m1,m2,m3)                                            
      {                                                               
	UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UZ23(I1,I2,I3,c0);
      }
    ...
    else   // ====== 4th order =======
    {
      ...
      ForStencil(m1,m2,m3)                                            
      {                                                               
	UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UZ43(I1,I2,I3,c0);  
      }
...
#define h21(n) h21c[n]
	...
	int bound= numberOfDimensions==2 ? 8 : 26;
      ...
      derivative(MCE( 0, 0,-1),I1,I2,I3)=-h21(axis3);
      derivative(MCE( 0, 0,+1),I1,I2,I3)= h21(axis3);
    }
    else   // ====== 4th order =======
    {
...
#define h41(n) h41c[n]
      ...
      derivative(MCE( 0, 0,-2),I1,I2,I3)=    +h41(axis3);
      derivative(MCE( 0, 0,-1),I1,I2,I3)= -8.*h41(axis3);
      derivative(MCE( 0, 0,+1),I1,I2,I3)=  8.*h41(axis3);
      derivative(MCE( 0, 0,+2),I1,I2,I3)=    -h41(axis3);
    }
  }
  else
  {
    ...
    if( orderOfAccuracy==2 )
    {
      ...
      realArray rx; rx = d12(axis1)*RZ(I1,I2,I3); 
      realArray sx; sx = d12(axis2)*SZ(I1,I2,I3); 
      realArray tx; tx = d12(axis3)*TZ(I1,I2,I3); 
    ...
    else   // ====== 4th order =======
    {
      ...
      realArray rx; rx = d14(axis1)*(RZ(I1,I2,I3));
      realArray sx; sx = d14(axis2)*(SZ(I1,I2,I3));
      realArray tx; tx = d14(axis3)*(TZ(I1,I2,I3));
  ...
  // time=getCPU()-time;
  // printf("zFDerivCoefficients: time = %e \n",time);
