...
void 
rtDerivCoefficients(RealDistributedArray & derivative,
		    const Index & I1,
		    const Index & I2,
		    const Index & I3,
		    const Index & E,
...
/* ---  
  ...
  { 
    ...
    ForStencil(m1,m2,m3)                                            
    {                                                               
      UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=URT2(I1,I2,I3,c0);  
    }                                                               
  }
  else // ====== 4th order =======
  {
    ...
    ForStencil(m1,m2,m3)                                            
    {                                                               
      UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=URT4(I1,I2,I3,c0);  
    }                                                               
  }
