//================================================================================
//   Define the coefficient matrix for the yy derivative
//================================================================================
...
void 
yyFDerivCoefficients(RealDistributedArray & derivative,
		     const Index & I1,
		     const Index & I2,
		     const Index & I3,
		     const Index & E,
...
/* ----    
	...
	ForStencil(m1,m2,m3)                                            
	{                                                               
	  UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UYY22(I1,I2,I3,c0);    
	}
      }
      else // ======= 3D ================
      {
	ForStencil(m1,m2,m3)                                            
	{                                                               
	  UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UYY23(I1,I2,I3,c0);
	}
      }
    }
    else   // ====== 4th order =======
	...
	ForStencil(m1,m2,m3)                                            
	{                                                               
	  UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UYY42(I1,I2,I3,c0);  
	}
      }
      else  // ======= 3D ================
      {
	ForStencil(m1,m2,m3)                                            
	{                                                               
	  UX_MERGED(m1,m2,m3,c0,e0,I1,I2,I3)=UYY43(I1,I2,I3,c0);  
	}
      }
    }
--- */
...
#define h22(n) h22c[n]
	...
	h22(axis)=1./SQR(mgop.dx[axis]);
      ...
      derivative(MCE( 0, 0, 0),I1,I2,I3)=-2.*h22(axis2);
      derivative(MCE( 0,+1, 0),I1,I2,I3)=    h22(axis2);
    }
    else   // ====== 4th order =======
    {
...
#define h42(n) h42c[n]
	...
	h42(axis)=1./(12.*SQR(mgop.dx[axis]));
      ...
      derivative(MCE( 0, 0, 0),I1,I2,I3)=-30.*h42(axis2);
      derivative(MCE( 0,+1, 0),I1,I2,I3)= 16.*h42(axis2);
      derivative(MCE( 0,+2, 0),I1,I2,I3)=    -h42(axis2);
    }
  }
  else
  {
    ...
    if( orderOfAccuracy==2 )
    {
      ...
      if( numberOfDimensions==2 )
      {
        realArray rxSq; rxSq = d22(axis1)*(RY(I1,I2,I3)*RY(I1,I2,I3));
	realArray rxx; rxx = d12(axis1)*RYY2(I1,I2,I3);

        realArray sxSq; sxSq = d22(axis2)*(SY(I1,I2,I3)*SY(I1,I2,I3));
	realArray sxx; sxx = d12(axis2)*SYY2(I1,I2,I3);
	realArray rsx; rsx = (2.*d12(axis1)*d12(axis2))*(RY(I1,I2,I3)*SY(I1,I2,I3));
      ...
      {
        realArray rxSq; rxSq = d22(axis1)*(RY(I1,I2,I3)*RY(I1,I2,I3));
	realArray rxx; rxx = d12(axis1)*(RYY23(I1,I2,I3));

        realArray sxSq; sxSq = d22(axis2)*(SY(I1,I2,I3)*SY(I1,I2,I3));
	realArray sxx; sxx = d12(axis2)*(SYY23(I1,I2,I3));

        realArray txSq; txSq = d22(axis3)*(TY(I1,I2,I3)*TY(I1,I2,I3));
	realArray txx; txx = d12(axis3)*(TYY23(I1,I2,I3));

	realArray rsx; rsx = (2.*d12(axis1)*d12(axis2))*(RY(I1,I2,I3)*SY(I1,I2,I3));
	realArray rtx; rtx = (2.*d12(axis1)*d12(axis3))*(RY(I1,I2,I3)*TY(I1,I2,I3));
	realArray stx; stx = (2.*d12(axis2)*d12(axis3))*(SY(I1,I2,I3)*TY(I1,I2,I3));
    ...
    else   // ====== 4th order =======
    {
      ...
      if( numberOfDimensions==2 )
      {
        realArray rxSq; rxSq = d24(axis1)*(RY(I1,I2,I3)*RY(I1,I2,I3));
	realArray rxx; rxx = d14(axis1)*(RYY4(I1,I2,I3));

        realArray sxSq; sxSq = d24(axis2)*(SY(I1,I2,I3)*SY(I1,I2,I3));
	realArray sxx; sxx = d14(axis2)*(SYY4(I1,I2,I3));
	realArray rsx; rsx = (2.*d14(axis1)*d14(axis2))*(RY(I1,I2,I3)*SY(I1,I2,I3));
	...
	derivative(MCE( 0, 0, 0),I1,I2,I3)=-30.*(rxSq           +sxSq);
      ...
      {
        realArray rxSq; rxSq = d24(axis1)*(RY(I1,I2,I3)*RY(I1,I2,I3));
	realArray rxx; rxx = d14(axis1)*(RYY43(I1,I2,I3));

        realArray sxSq; sxSq = d24(axis2)*(SY(I1,I2,I3)*SY(I1,I2,I3));
	realArray sxx; sxx = d14(axis2)*(SYY43(I1,I2,I3));

        realArray txSq; txSq = d24(axis3)*(TY(I1,I2,I3)*TY(I1,I2,I3));
	realArray txx; txx = d14(axis3)*(TYY43(I1,I2,I3));

	realArray rsx; rsx = (2.*d14(axis1)*d14(axis2))*(RY(I1,I2,I3)*SY(I1,I2,I3));
	realArray rtx; rtx = (2.*d14(axis1)*d14(axis3))*(RY(I1,I2,I3)*TY(I1,I2,I3));
	realArray stx; stx = (2.*d14(axis2)*d14(axis3))*(SY(I1,I2,I3)*TY(I1,I2,I3));
