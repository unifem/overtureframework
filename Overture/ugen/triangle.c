...
/* wdh: this global variable is set to true when an error occurs */
int triangleErrorDetected=0;
/* wdh change these names to avoid conflicts with prediates */
#define exactinit exactinit_triangle
#define fast_expansion_sum_zeroelim fast_expansion_sum_zeroelim_triangle
#define scale_expansion_zeroelim scale_expansion_zeroelim_triangle
#define estimate estimate_triangle
#define incircleadapt incircleadapt_triangle
#define incircle incircle_triangle
#define orient3dadapt orient3dadapt_triangle
#define orient3d orient3d_triangle
/* end changes to names wdh */
...

{
  ...
  /* wdh : set the global variable that detects errors */
  triangleErrorDetected=0;

  triangleinit(&m);

  GTS_FPU_ROUND_DOUBLE; /* kkc Overture */
