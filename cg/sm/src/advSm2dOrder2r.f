! This file automatically generated from advOptSm.bf with bpp.
        subroutine advSm2dOrder2r(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c add forcing to the first 2 equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm22ru(i1,i2,i3)+dtsq*f(i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm22rv(i1,i2,i3)+dtsq*f(i1,i2,i3,vc)
...
c add dissipation to the first 3 equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm22ru(i1,i2,i3)+dis(i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm22rv(i1,i2,i3)+dis(i1,i2,i3,vc)
...
c add forcing to the first 2 equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm22rut(i1,i2,i3)+f(i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm22rvt(i1,i2,i3)+f(i1,i2,i3,vc)
...
c add dissipation to the first 3 equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm22rut(i1,i2,i3)+dis(i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm22rvt(i1,i2,i3)+dis(i1,i2,i3,vc)
...
c  add forcing and dissipation
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm22rut(i1,i2,i3)+f(i1,i2,i3,uc)+dis(
     & i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm22rvt(i1,i2,i3)+f(i1,i2,i3,vc)+dis(
     & i1,i2,i3,vc)
