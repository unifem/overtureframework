// This file automatically generated from assignParabolicInitialConditions.bC with bpp.
#include "Cgsm.h"
...
// ===========================================================================================
/// \brief Assign "parabolic" initial conditions.
...
#define PARABOLIC(x,y,z,c,t) (alpha[c]*(x)*(1.-x))
// #define PARABOLIC(x,y,z,c,t) (alpha[c]*sin(Pi*(x))*sin(Pi*(x)))
        ...
        if( mg.numberOfDimensions()==2 )
        {
      	...
      	U(i1,i2,i3,uc) =PARABOLIC(x0,y0,0.,uc,t);
      	U(i1,i2,i3,vc) =PARABOLIC(x0,y0,0.,vc,t);
            }
        }
        else
        { // ***** 3D  ****
      	...
      	U(i1,i2,i3,uc) =PARABOLIC(x0,y0,z0,uc,t);
      	U(i1,i2,i3,vc) =PARABOLIC(x0,y0,z0,vc,t);
      	U(i1,i2,i3,wc) =PARABOLIC(x0,y0,z0,wc,t);
            }
        }
#undef PARABOLIC
