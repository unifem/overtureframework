! This file automatically generated from advOptSm.bf with bpp.
        subroutine advSm3dOrder2c(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c add forcing to the equations
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   un(i1,i2,i3,uc)=sm23u(i1,i2,i3)+dtsq*f(i1,i2,i3,uc)
                   un(i1,i2,i3,vc)=sm23v(i1,i2,i3)+dtsq*f(i1,i2,i3,vc)
                   un(i1,i2,i3,wc)=sm23w(i1,i2,i3)+dtsq*f(i1,i2,i3,wc)
...
c add dissipation to the equations
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   un(i1,i2,i3,uc)=sm23u(i1,i2,i3)+dis(i1,i2,i3,uc)
                   un(i1,i2,i3,vc)=sm23v(i1,i2,i3)+dis(i1,i2,i3,vc)
                   un(i1,i2,i3,wc)=sm23w(i1,i2,i3)+dis(i1,i2,i3,wc)
...
c add forcing to the equations
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   un(i1,i2,i3,uc)=sm23ut(i1,i2,i3)+f(i1,i2,i3,uc)
                   un(i1,i2,i3,vc)=sm23vt(i1,i2,i3)+f(i1,i2,i3,vc)
                   un(i1,i2,i3,wc)=sm23wt(i1,i2,i3)+f(i1,i2,i3,wc)
...
c add dissipation to the equations
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   un(i1,i2,i3,uc)=sm23ut(i1,i2,i3)+dis(i1,i2,i3,uc)
                   un(i1,i2,i3,vc)=sm23vt(i1,i2,i3)+dis(i1,i2,i3,vc)
                   un(i1,i2,i3,wc)=sm23wt(i1,i2,i3)+dis(i1,i2,i3,wc)
...
c add dissipation and forcing to the equations
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   un(i1,i2,i3,uc)=sm23ut(i1,i2,i3)+f(i1,i2,i3,uc)+dis(
     & i1,i2,i3,uc)
                   un(i1,i2,i3,vc)=sm23vt(i1,i2,i3)+f(i1,i2,i3,vc)+dis(
     & i1,i2,i3,vc)
                   un(i1,i2,i3,wc)=sm23wt(i1,i2,i3)+f(i1,i2,i3,wc)+dis(
     & i1,i2,i3,wc)
