! This file automatically generated from advOptSm.bf with bpp.
        subroutine advSm3dOrder4r(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c add forcing to the equations
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   dis(i1,i2,i3,uc)=adcdt*fd63d(i1,i2,i3,uc)+0
                   dis(i1,i2,i3,vc)=adcdt*fd63d(i1,i2,i3,vc)+0
                   dis(i1,i2,i3,wc)=adcdt*fd63d(i1,i2,i3,wc)+0
...
c add forcing to the equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm43ru(i1,i2,i3)+dtsq*f(i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm43rv(i1,i2,i3)+dtsq*f(i1,i2,i3,vc)
                 un(i1,i2,i3,wc)=sm43rw(i1,i2,i3)+dtsq*f(i1,i2,i3,wc)
...
c add dissipation to the equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm43ru(i1,i2,i3)+dis(i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm43rv(i1,i2,i3)+dis(i1,i2,i3,vc)
                 un(i1,i2,i3,wc)=sm43rw(i1,i2,i3)+dis(i1,i2,i3,wc)
