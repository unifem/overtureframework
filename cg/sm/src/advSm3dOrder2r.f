! This file automatically generated from advOptSm.bf with bpp.
        subroutine advSm3dOrder2r(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c add forcing to the equations
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   dis(i1,i2,i3,uc)=adcdt*fd43d(i1,i2,i3,uc)+0
                   dis(i1,i2,i3,vc)=adcdt*fd43d(i1,i2,i3,vc)+0
                   dis(i1,i2,i3,wc)=adcdt*fd43d(i1,i2,i3,wc)+0
     ...
     & .gt.0 )then
                     dis(i1,i2,i3,uc)=adcdt*varDis(i1,i2,i3)*fd43d(i1,
     & i2,i3,uc)
                     dis(i1,i2,i3,vc)=adcdt*varDis(i1,i2,i3)*fd43d(i1,
     & i2,i3,vc)
                     dis(i1,i2,i3,wc)=adcdt*varDis(i1,i2,i3)*fd43d(i1,
     & i2,i3,wc)
...
c add forcing to the equations
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   dis(i1,i2,i3,uc)=adcdt*fd23d(i1,i2,i3,uc)+0
                   dis(i1,i2,i3,vc)=adcdt*fd23d(i1,i2,i3,vc)+0
                   dis(i1,i2,i3,wc)=adcdt*fd23d(i1,i2,i3,wc)+0
...
c add forcing to the equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm23ru(i1,i2,i3)+dtsq*f(i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm23rv(i1,i2,i3)+dtsq*f(i1,i2,i3,vc)
                 un(i1,i2,i3,wc)=sm23rw(i1,i2,i3)+dtsq*f(i1,i2,i3,wc)
...
c add dissipation to the equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm23ru(i1,i2,i3)+dis(i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm23rv(i1,i2,i3)+dis(i1,i2,i3,vc)
                 un(i1,i2,i3,wc)=sm23rw(i1,i2,i3)+dis(i1,i2,i3,wc)
...
c add forcing to the equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm23rut(i1,i2,i3)+f(i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm23rvt(i1,i2,i3)+f(i1,i2,i3,vc)
                 un(i1,i2,i3,wc)=sm23rwt(i1,i2,i3)+f(i1,i2,i3,wc)
...
c add dissipation to the equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm23rut(i1,i2,i3)+dis(i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm23rvt(i1,i2,i3)+dis(i1,i2,i3,vc)
                 un(i1,i2,i3,wc)=sm23rwt(i1,i2,i3)+dis(i1,i2,i3,wc)
...
c add dissipation and forcing to the equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm23rut(i1,i2,i3)+f(i1,i2,i3,uc)+dis(
     & i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm23rvt(i1,i2,i3)+f(i1,i2,i3,vc)+dis(
     & i1,i2,i3,vc)
                 un(i1,i2,i3,wc)=sm23rwt(i1,i2,i3)+f(i1,i2,i3,wc)+dis(
     & i1,i2,i3,wc)
