! This file automatically generated from advOptSm.bf with bpp.
        subroutine advSm2dOrder4r(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c     write(*,'(" i=",3i3," varDis=",e10.2," diss=",3e10.2)') i1,i2,i3,varDis(i1,i2,i3),dis(i1,i2,i3,uc),c         dis(i1,i2,i3,vc),dis(i1,i2,i3,wc)
     ...
     & i2,i3,vc)
              ...
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 dis(i1,i2,i3,uc)=adcdt*fd62d(i1,i2,i3,uc)
...
c add forcing to the first 2 equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm42ru(i1,i2,i3)+dtsq*f(i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm42rv(i1,i2,i3)+dtsq*f(i1,i2,i3,vc)
...
c add dissipation to the first 3 equations
              if( useWhereMask.ne.0 )then
               ...
               do i1=n1a,n1b
                if( mask(i1,i2,i3).gt.0 )then
                 un(i1,i2,i3,uc)=sm42ru(i1,i2,i3)+dis(i1,i2,i3,uc)
                 un(i1,i2,i3,vc)=sm42rv(i1,i2,i3)+dis(i1,i2,i3,vc)
