#
#  cgsm: rotating disk example -- use the full FSI exact solution
#
# Usage: (not all options implemented yet)
#   
#  cgsm [-noplot] rotatingDiskInFluid -g=<name> -omega=<> -ra=<> -rb=<> -godunovType=[0|1|2] ...
...
$rotationRate=$omega;
rho0=1.4; $pOffset=1.; 
$omega0=$rotationRate; $r0=0.; $r1=1.; $r2=5.; $gridRatio=5.; 
$lambdaSolid=$lambda; $muSolid=$mu; $rho0 $pOffset $gamma 
# 
