...
//* 
//* // ===================================================================================================================
//* /// \brief Assign some standard initial conditions.
//* // ===================================================================================================================
//* void DomainSolver::
//* assignStandardInitialConditions( GridFunction & cgf )
//* //=====================================================================
//* //  /Description:  
//* //   Assign Initial conditions such as
//* // \begin{description}
//* //   \item[twilightZone] : analytically defined solution.
//* //   \item[uniform] : uniform state.
//* //   \item[piecewise] : piecewise uniform state.
//* //   \item[shockCircle] : special case, should not be here.
//* //   \item[spinDown] : special case, should not be here.
//* // \end{description}
//* //
//* //=====================================================================
//* {
...
//*     option=twilightZone;
//*   else if( initialConditions(0)!=(int)Parameters::defaultValue )
//*   {
//*     printF("assignStandardInitialConditions: assign values from parameters.initialConditions \n");
//*     for( grid=0; grid<cg.numberOfComponentGrids(); grid++ )
//*     {
//*       MappedGrid & c = cg[grid];
//*       getIndex( c.dimension(),I1,I2,I3 );
...
//*   {
//*     printF( 
//*            "    >>>>Specify a Standard Initial Condition<<<< \n"
//*            " uniform      : Specify a uniform state              \n"   
//*            " piecewise    : Specify a piecewise constant state   \n"   
//*            " shockCircle  : Shock approaching circular hole(s)    \n"   
//*            " spinDown     : spin down on the unit square          \n"   
//* 	   " >>>Enter the option \n");
//* 
//*     aString answer;
...
//*     if( answer=="uniform" )
//*       option=uniform;
//*     else if( answer=="piecewise" )
//*       option=piecewise;
//*     else if( answer=="shockCircle" )
//*       option=shockCircle;
//*     else if( answer=="spinDown" )
//*       option=spinDown;
//*     else
//*     {
...
//*     }
//*   }
//*   if( option==twilightZone )
//*   {
//*     cout << ">>>>>>>>>>>>assignStandardInitialConditions: assign twilightZone\n" << endl;
//*   
//*     parameters.dbase.get<OGFunction* >("exactSolution")->assignGridFunction( u,t );   //  Twilight-zone flow
//*   }
//*   else if( option==uniform )
//*   {
//*     realArray uv0(numberOfComponents);
//*     cout << "assignStandardInitialConditions: Enter the uniform state uv0(n),n=1,..," << numberOfComponents << endl;
//*     ForAllComponents( n )
//*       cin >> uv0(n);               // ****     read(infile,*) (uv0(n),n=1,nv)
//*     cout << "assignStandardInitialConditions: ";
//*     ForAllComponents( n )
//*       printF("uv0(%i)=%6.2e, ",n,uv0(n));
//*     cout << endl;    
//*     for( grid=0; grid<cg.numberOfComponentGrids(); grid++ )
//*     {
//*       MappedGrid & c = cg[grid];
//*       getIndex( c.dimension(),I1,I2,I3 );
//*       ForAllComponents( n )
//*         u[grid](I1,I2,I3,n)=uv0(n);
//*     }
//*   }
//*   else if( option==piecewise || option==shockCircle )
//*   {
//*     cg.update(MappedGrid::THEcenter);
//* 
//*     real xjump,sbeta;
//*     int njump;
//*     realArray uLeft(numberOfComponents);    
//*     realArray uRight(numberOfComponents);    
//*     cout << " Layer: Enter xjump,sbeta,kdjump" << endl;
//*     cout << " layer : ul+(ur-ul)*(1+tanh(sbeta*(x-xjump))/2" << endl;
//*     cout << " njump=0,1,2 : jump in x,y, or z direction" << endl;
//*     cin >> xjump >> sbeta >> njump;    // infile
//* 
//*     printF(" xjump = %e, sbeta=%e, njump=%i \n",xjump,sbeta,njump);
//*     assert( njump>=0 && njump<cg.numberOfDimensions() );
//* 
//*     cout << " Enter state 1, uLeft(n), n=1,..," << numberOfComponents << endl;
//*     ForAllComponents( n )
//*       cin >> uLeft(n) ;
//*     cout << " Enter state 2, uRight(n), n=1,..," << numberOfComponents << endl;
//*     ForAllComponents( n )
//*       cin >> uRight(n);
//* 
//*     uLeft.display("Here is uLeft");
...
//*       getIndex( c.dimension(),I1,I2,I3 );
//*       ForAllComponents( n )
//*         u[grid](I1,I2,I3,n)=uLeft(n)+(uRight(n)-uLeft(n))*
//* 	  (.5+.5*tanh(sbeta*(center(I1,I2,I3,njump)-xjump)));
//*       if( debug() & 64 )
//*         u[grid].display("Here is the initial conditions, u[grid]");
//*     }
//*     
//*   }
//*   else if( option==spinDown )
//*   {
//*     cg.update(MappedGrid::THEcenter);
//* 
//*     const int & pc = parameters.dbase.get<int >("pc");
