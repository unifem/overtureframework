...
!
c$$$      subroutine evalOscillatingBubbleVelocity(r,Rb,n,mu,lr,li, 
c$$$     +     cr,ci,p0r,p0i,vrr,vri,vtr,vti)
c$$$      
c$$$
c$$$      double precision r,Rb,mu,lr,li,cr,ci,p0r,p0i,vrr,vri,vtr,vti
c$$$      integer n
c$$$c$$$      complex*16 vr, vt, p
c$$$      
c$$$      vrr = r
c$$$      vri = r
c$$$      vtr = r
...
c$$$      end
c$$$
c$$$      subroutine evalOscillatingBubblePressure( r, Rb, n, mu, lr,li, 
c$$$     +     cr,ci, p0r,p0i, pr,pi)
c$$$
c$$$      double precision r, Rb, mu, lr, li, cr, ci, p0r, p0i,
c$$$     +     pr, pi
c$$$      integer n
c$$$c$$$      complex*16 vr, vt, p
c$$$      
