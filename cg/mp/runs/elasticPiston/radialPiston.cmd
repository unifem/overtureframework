...
# 
# Usage:
#    cgmp [-noplot] radialPiston -g=<name> -method=[ins|cns] -nu=<> -mu=<> -kappa=<num> -tf=<tFinal> -tp=<tPlot> ...
...
$diss=.1;   # 2nd-order linear dissipation for cgsm
$smVariation = "g"; 
...
# -- RAMP PRESSURE BC: 
$bc = "bcNumber100=noSlipWall uniform(u=.0,T=$T0)\n bcNumber100=tractionInterface";
    #
    # **** ramp the pressure on the outer boundary  ****
    $cmdRamp="bcNumber4=outflow, pressure(1.*p+0.*p.n=$p0), userDefinedBoundaryData\n" . \
    " time function option\n" . \
    "   ramp function\n" .\
    "   ramp end values: 0,$ap (start,end)\n" .\
