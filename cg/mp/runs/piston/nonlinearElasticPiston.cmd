...
* 
* Usage:
*    cgmp [-noplot] nonlinearElasticPiston -g=<name> -method=[ins|cns] -nu=<> -mu=<> -rhog=<num> -tf=<tFinal> -tp=<tPlot> ...
...
*
* TZ testing (linear)
* cgmp nonlinearElasticPiston -method=cns -cnsVariation=godunov -g="elasticPistonGrid4" -tp=.05 -tf=.05 -smVariation=g -godunovType=0 -problem=0 -tz=poly -debug=3 -go=halt -piGhostOption=0 -pi=0 
*
* TZ testing (SVK)
* cgmp nonlinearElasticPiston -method=cns -cnsVariation=godunov -g="elasticPistonGrid4" -tp=.05 -tf=.05 -smVariation=g -godunovType=2 -problem=0 -tz=poly -debug=3 -go=halt -piGhostOption=0 -pi=0 
* 
* cgmp nonlinearElasticPiston -method=cns -cnsVariation=godunov -g="elasticPistonGrid8" -tp=.05 -tf=1. -smVariation=g -debug=0 
* 
* cgmp nonlinearElasticPiston -method=cns -cnsVariation=godunov -g="planeInterfacenp16" -tp=.05 -tf=.5 -nc=1 -smVariation=g -debug=0 
*
* -- non-conservative: 
* cgmp nonlinearElasticPiston -method=cns -cnsVariation=godunov -g="planeInterfacenp16" -tp=.05 -tf=.5 -nc=1 -smVariation=nc -debug=0 
* 
* --- set default values for parameters ---
* 
$grid="twoSquaresInterfacee1.order2.hdf"; $domain1="rightDomain"; $domain2="leftDomain";
$problem=1; $godunovType=0; 
$method="ins"; $probeFile=""; $multiDomainAlgorithm=1; $useExactInterface=0; $useExactVelocity=0; $pi=0; $piOption=0; 
