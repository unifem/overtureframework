#
# 2D circular disk inside a larger disk
#
#
# usage: ogen [-noplot] diskInDiskGrid.cmd -factor=<num> -order=[2/4/6/8] -interp=[e/i] -blf=<num> -ml=<>  -rgd=[fixed|var] ...
...
# 
# examples:
#     ogen -noplot diskInDiskGrid -order=2 -interp=e -factor=1
#     ogen -noplot diskInDiskGrid -order=2 -interp=e -factor=2
...
# ********************* INNER ANNULUS *************************
#
if( $blf>1 ){ $annulusName="diskUnStretched"; $stretchdiskName="innerDisk"; }else{ $annulusName="innerDisk"; $stretchdiskName="diskStretched"; }
Annulus
...
# 
 stretch coordinates 
  ...
  #stretch grid
  STRT:name $stretchdiskName
 exit
 $innerDisk=$annulusName;
#
#
# ********************* OUTER ANNULUS *************************
#
