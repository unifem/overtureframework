...
# 
$grid="multiBeamsInAChannelGride2.order2.hdf"; $ts="adams PC"; $noplot=""; $backGround="square"; $uIn=1.; $v0=0.; $T0=0.; $p0=0.; $cfl=.9; $useNewImp=1;
...
#probe beams
$saveProbe=1;
$beamProbeFileName1="probeBeam1"; 
$beamProbeFileName2="probeBeam2"; 
$beamProbeFileName3="probeBeam3";
$beamProbeFileName4="probeBeam4"; 
...
GetOptions( "g=s"=>\$grid,"tf=f"=>\$tFinal,"implicitFactor=f"=>\$implicitFactor, "model=s"=>\$model,\
 ...
 "ts=s"=>\$ts,"nu=f"=>\$nu,"cfl=f"=>\$cfl,"noplot=s"=>\$noplot,"uIn=f"=>\$uIn,\
 ...
 "rhoBeam1=f"=>\$rhoBeam1,"rhoBeam2=f"=>\$rhoBeam2,"rhoBeam3=f"=>\$rhoBeam3,"rhoBeam4=f"=>\$rhoBeam4,\
...
if($BM2 eq "FEM") {$beamModel2 = "FEMBeamModel";}
if($BM2 eq "FD")  {$beamModel2 = "FDBeamModel";}
if($BM3 eq "FEM") {$beamModel3 = "FEMBeamModel";}
if($BM3 eq "FD")  {$beamModel3 = "FDBeamModel";}
if($BM4 eq "FEM") {$beamModel4 = "FEMBeamModel";}
if($BM4 eq "FD")  {$beamModel4 = "FDBeamModel";}
if($E ge 0.){$E1=$E;$E2=$E;$E3=$E;$E4=$E;}# same E for all beams
if($rhoBeam ge 0.){$rhoBeam1=$rhoBeam;$rhoBeam2=$rhoBeam;$rhoBeam3=$rhoBeam;$rhoBeam4=$rhoBeam;}# same rhoBeam for all beams
#
#generate probe file name
if($addedMass){$method="AMP";}else{$method="TP";}
$probeFileFormat="text";
$beamProbeFileName1="$beamProbeFileName1\_$method\_$BM1.$probeFileFormat"; 
$beamProbeFileName2="$beamProbeFileName2\_$method\_$BM2.$probeFileFormat"; 
$beamProbeFileName3="$beamProbeFileName3\_$method\_$BM3.$probeFileFormat"; 
$beamProbeFileName4="$beamProbeFileName4\_$method\_$BM4.$probeFileFormat"; 
#print "$beamProbeFileName1\n$beamProbeFileName2\n$beamProbeFileName3\n$beamProbeFileName4\n";
#
#
$kThermal=$nu/$Prandtl;
$Pi=4.*atan2(1.,1.);
