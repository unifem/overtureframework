...
#
# Usage:
#         ogen [-noplot] verticalBeamInAChannelGrid [options]
# where options are
...
# Examples:
#
#      ogen -noplot verticalBeamInAChannelGrid -interp=e -factor=1
#      ogen -noplot verticalBeamInAChannelGrid -interp=e -factor=2 
#      ogen -noplot verticalBeamInAChannelGrid -interp=e -factor=4 
#
#  -- non-centered beam:
#  ogen -noplot verticalBeamInAChannelGrid -interp=e -yb=.75 -prefix=verticalBeamInAnOffsetChannelGrid -factor=1
#
...
$ya=0.; $yb=2.; $xa=-.5; $xb=.5; $nExtra=0; 
$refineInner=0; $refineOuter=0; $fixedRadius=-1; 
$prefix = "verticalBeamInAChannelGrid"; 
# 
