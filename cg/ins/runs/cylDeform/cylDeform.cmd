...
# Usage:
#     cgins cylDeform -g=<grid> -nu=<> -ts=<> -move=[0|1] -moveOnly=[0|1|2] -freq=<> -amp=<> -rotationFreq=<>
...
#
#  -- non-moving:
#  cgins cylDeform -g=deformingCylinderInAChannelGride1.order2.hdf -nu=.05 -tp=.01 -tf=10. -move=0 -cfl=.9 -psolver=best -ts=im -ad2=1 -ad4=0 -debug=3 -go=halt 
#  -- moving:
# 
#===============================================================
#
$grid="deformingCylinderInAChannelGride1.order2.hdf"; $show = " "; $tFinal=5.; $tPlot=.1; $nu=.1; $cfl=.9;
