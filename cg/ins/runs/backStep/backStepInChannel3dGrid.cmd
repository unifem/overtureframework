#
# Grid for a 3D back step in a channel
# ------------------------------------
#
#   yb  ---------------------------------------------
#       |                                           |
...
#
# usage: ogen [noplot] backStepInChannel3dGrid -factor=<num> -order=[2/4/6/8] -interp=[e/i] -name=[] -ml=<i> -blSpacingFactor=<f>
# 
# examples:
# 
#     ogen -noplot backStepInChannel3dGrid -interp=e -factor=1
#     ogen -noplot backStepInChannel3dGrid -interp=e -factor=2
#     ogen -noplot backStepInChannel3dGrid -interp=e -factor=4
# 
#     ogen -noplot backStepInChannel3dGrid -interp=e -order=4 -factor=2
#     ogen -noplot backStepInChannel3dGrid -interp=e -order=4 -factor=4
#     ogen -noplot backStepInChannel3dGrid -interp=e -order=4 -factor=8
# 
# -- multigrid ( Don't make too many levels on coarse grids for cgins -- ghost points? )
#     ogen -noplot backStepInChannel3dGrid -interp=e -order=4 -ml=1 -factor=4 
#     ogen -noplot backStepInChannel3dGrid -interp=e -order=4 -ml=2 -factor=8
#     ogen -noplot backStepInChannel3dGrid -interp=e -order=4 -cornerSharpness=60. -ml=3 -factor=16
#     ogen -noplot backStepInChannel3dGrid -interp=e -order=4 -cornerSharpness=60. -ml=3 -factor=32
#     ogen -noplot backStepInChannel3dGrid -interp=e -order=4 -cornerSharpness=60. -ml=4 -factor=64
#
#  -- wider channel 
#    ogen -noplot backStepInChannel3dGrid -interp=e -order=4 -za=-1. -zb=1. -prefix=backStepInChannel3dWidth2Grid -ml=1 -factor=2
#    ogen -noplot backStepInChannel3dGrid -interp=e -order=4 -za=-1. -zb=1. -prefix=backStepInChannel3dWidth2Grid -ml=1 -factor=4 
#
$order=2; $factor=1; $interp="i";  $ml=0; # default values
$orderOfAccuracy = "second order"; $ng=2; 
$name=""; $prefix="backStepInChannel3dGrid";
...
GetOptions( "order=i"=>\$order,"factor=f"=> \$factor,"xa=f"=>\$xa,"xb=f"=>\$xb,"ya=f"=> \$ya,"yb=f"=> \$yb,"za=f"=>\$za,"zb=f"=>\$zb,\
            ...
            "cornerSharpness=f"=>\$cornerSharpness,"prefix=s"=>\$prefix );
# 
