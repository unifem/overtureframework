#===============================================================
# cgins: flow past a rounded blade
#
# Usage:
#     cgins roundedBlade -g=<grid> -nu=<> -ts=<> -move=[0|1] -moveOnly=[0|1|2] -freq=<> -amp=<> -rotationFreq=<>
...
#
#  -- non-moving:
#  cgins -noplot roundedBlade -g=roundedBladeGride2.order2.ml1 -nu=2.e-3 -tp=.01 -tf=10. -move=0 -cfl=4. -psolver=mg -ts=afs -ad2=1 -ad4=0 -freqFullUpdate=1 -debug=3 -go=og
#
# 
#===============================================================
#
...
GetOptions( "g=s"=>\$grid,"tf=f"=>\$tFinal,"degreex=i"=>\$degreex, "degreet=i"=>\$degreet, "model=s"=>\$model,\
 ...
 "rtol=f"=>\$rtol,"atol=f"=>\$atol,"rtolp=f"=>\$rtolp,"atolp=f"=>\$atolp,"restart=s"=>\$restart,"ad2=i"=>\$ad2,\
  ...
  "freqZ=f"=>\$freqZ,"ogmgAutoChoose=s"=>\$ogmgAutoChoose, "ogmgSsr=s"=>\$ogmgSsr );
# -------------------------------------------------------------------------------------------------
...
#
  boundary conditions
    all=slipWall
    bcNumber8=noSlipWall
    bcNumber3=inflowWithVelocityGiven, uniform(v=1.)
    bcNumber4=outflow
   done
#
  debug $debug
...
#
  continue
#
# -- redefine the home viewpoint --
## set view:0 0.0181269 -0.00906344 0 1.03762 0.642788 -0.383022 0.663414 0.766044 0.321394 -0.55667 -1.0631e-16 0.866025 0.5
set view:0 0.0210385 -0.0177983 0 1.1151 0.642788 -0.133022 0.754406 0.766044 0.111619 -0.633022 -1.0631e-16 0.984807 0.173648
 set home
#
 plot:v
 contour
