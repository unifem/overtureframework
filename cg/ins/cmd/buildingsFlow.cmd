#===============================================================
# cgins: flow past buildings
# Usage:
#     cgins buildingsFlow -g=<grid> -nu=<> -ts=<> -move=[0|1] -moveOnly=[0|1|2] -freq=<> -amp=<> -rotationFreq=<>
...
# Examples: 
#
#  cgins buildingsFlow -g=buildingsGridi2.order2 -nu=1.e-4 -tp=.1 -tf=10. -cfl=4. -psolver=best -ts=afs -ad2=1 -ad4=0 -debug=3 -go=halt 
#
#===============================================================
#
$grid="buildingsGridi2.order2"; $show = " "; $tFinal=5.; $tPlot=.1; $nu=.1; $cfl=.9;
...
$order = 2; $fullSystem=0; $go="halt"; $move=0;  $moveOnly=0; 
...
#
  boundary conditions
    ...
    $d=.5; 
    bcNumber3=inflowWithVelocityGiven, parabolic(d=$d,p=1.,u=1.)
