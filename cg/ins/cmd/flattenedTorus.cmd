#===============================================================
# cgins: flow past a moving flattened torus
# Usage:
#     cgins flattenedTorus -g=<grid> -nu=<> -ts=<> -move=[0|1] -moveOnly=[0|1|2] -freq=<> -amp=<> -rotationFreq=<>
...
#
#  -- non-moving:
#  cgins flattenedTorus -g=flattenedTorusGride2.order2.ml1 -nu=1.e-2 -tp=.1 -tf=10. -move=0 -cfl=5. -psolver=mg -ts=afs -ad2=1 -ad4=0 -debug=3 -go=halt 
#  -- moving:
#  cgins flattenedTorus -g=flattenedTorusGride2.order2.ml1 -nu=1.e-2 -tp=.1 -tf=10. -move=1 -cfl=5. -psolver=mg -ts=afs -ad2=1 -ad4=0 -debug=3 -go=halt
# 
#===============================================================
#
$grid="flattenedTorusGride2.order2.ml1"; $show = " "; $tFinal=5.; $tPlot=.1; $nu=.1; $cfl=.9;
$pGrad=0.; $wing="wing"; $newts=0; $uInflow=1.; $motion="translate"; 
...
$freq=.25; $amp=.5; # amplitude (speed of translation)
