! This file automatically generated from inscr4.bf with bpp.
c ************* NEW version *****************

      subroutine inscr4( kd1,ks1,kd2,ks2,nd,gridIndexRange,bc,
     & ndra,ndrb,ndsa,ndsb,ndta,ndtb,ipar,rpar, u,t,d14,d24,ajs,xy,
     & rsxy,gridType )
c======================================================================
...
c Define the rectangular and curvilinear versions
            ...
            subroutine insbv4c( i1,i2,i3,kd1,kd2,kdn,is1,is2,is3,t,vr,
     & vrr,d14,d24,drs,nd,ndra,ndrb,ndsa,ndsb,ndta,ndtb, xy,rsxy,u,
     & gridType )
c======================================================================
c        Return Tangential and Mixed Derivatives
c          at a Corner in 2D or and edge in 3D
...
c======================================================================
       implicit none
       integer ndra,ndrb,ndsa,ndsb,ndta,ndtb,nd
       real t,vr(3,3),vrr(3,3,3),d14(3),d24(3),drs(3),u(ndra:ndrb,
     & ndsa:ndsb,ndta:ndtb,0:*),xy(ndra:ndrb,ndsa:ndsb,ndta:ndtb,nd),
     & rsxy(ndra:ndrb,ndsa:ndsb,ndta:ndtb,nd,nd)
       integer i1,i2,i3,kd1,kd2,kdn,is1,is2,is3,gridType
c.......local
       ...
       real rx,ry,rz,sx,sy,sz,tx,ty,tz,ubr,ubs,ubt,ubrr,ubss,ubtt,ubrs,
     & ubrt,ubst,rx3,rxr3,rxs3,rxt3,divr0,divs0,divt0,uc31,uc32,uc33,
     & ux6m,rsxyr,rsxys,rsxyt,trsi
       real rxr,rxs,rxt, ryr,rys,ryt, rzr,rzs,rzt,sxr,sxs,sxt, syr,sys,
     & syt, szr,szs,szt,txr,txs,txt, tyr,tys,tyt, tzr,tzs,tzt
       real taylor3d3e1,taylor3d3e2,taylor3d2e1,taylor3d2e2,
...
c.......
       ubr(i1,i2,i3,kd)=(8.*(u(i1+1,i2,i3,kd)-u(i1-1,i2,i3,kd)) -(u(i1+
     & 2,i2,i3,kd)-u(i1-2,i2,i3,kd)))*d14(1)
       ubs(i1,i2,i3,kd)=(8.*(u(i1,i2+1,i3,kd)-u(i1,i2-1,i3,kd)) -(u(i1,
     & i2+2,i3,kd)-u(i1,i2-2,i3,kd)))*d14(2)
       ubt(i1,i2,i3,kd)=(8.*(u(i1,i2,i3+1,kd)-u(i1,i2,i3-1,kd)) -(u(i1,
     & i2,i3+2,kd)-u(i1,i2,i3-2,kd)))*d14(3)
       ubrr(i1,i2,i3,kd)= ( -30.*u(i1,i2,i3,kd) +16.*(u(i1+1,i2,i3,kd)+
     & u(i1-1,i2,i3,kd)) -(u(i1+2,i2,i3,kd)+u(i1-2,i2,i3,kd)) )*d24(1)
       ubss(i1,i2,i3,kd)= +( -30.*u(i1,i2,i3,kd) +16.*(u(i1,i2+1,i3,kd)
     & +u(i1,i2-1,i3,kd)) -(u(i1,i2+2,i3,kd)+u(i1,i2-2,i3,kd)) )*d24(
     & 2)
       ubtt(i1,i2,i3,kd)= +( -30.*u(i1,i2,i3,kd) +16.*(u(i1,i2,i3+1,kd)
     & +u(i1,i2,i3-1,kd)) -(u(i1,i2,i3+2,kd)+u(i1,i2,i3-2,kd)) )*d24(
     & 3)
       ubrs(i1,i2,i3,kd)= (8.*(ubs(i1+1,i2,i3,kd)-ubs(i1-1,i2,i3,kd)) -
     & (ubs(i1+2,i2,i3,kd)-ubs(i1-2,i2,i3,kd)))*d14(1)
       ubrt(i1,i2,i3,kd)= (8.*(ubt(i1+1,i2,i3,kd)-ubt(i1-1,i2,i3,kd)) -
     & (ubt(i1+2,i2,i3,kd)-ubt(i1-2,i2,i3,kd)))*d14(1)
       ubst(i1,i2,i3,kd)= (8.*(ubt(i1,i2+1,i3,kd)-ubt(i1,i2-1,i3,kd)) -
     & (ubt(i1,i2+2,i3,kd)-ubt(i1,i2-2,i3,kd)))*d14(2)
c     ...short forms for jacobian entries and derivatives
       rsxyr(i1,i2,i3,m1,m2)=(8.*(rsxy(i1+1,i2,i3,m1,m2)-rsxy(i1-1,i2,
     & i3,m1,m2)) -(rsxy(i1+2,i2,i3,m1,m2)-rsxy(i1-2,i2,i3,m1,m2)))*
     & d14(1)
       rsxys(i1,i2,i3,m1,m2)=(8.*(rsxy(i1,i2+1,i3,m1,m2)-rsxy(i1,i2-1,
     & i3,m1,m2)) -(rsxy(i1,i2+2,i3,m1,m2)-rsxy(i1,i2-2,i3,m1,m2)))*
     & d14(2)
       rsxyt(i1,i2,i3,m1,m2)=(8.*(rsxy(i1,i2,i3+1,m1,m2)-rsxy(i1,i2,i3-
     & 1,m1,m2)) -(rsxy(i1,i2,i3+2,m1,m2)-rsxy(i1,i2,i3-2,m1,m2)))*
     & d14(3)
...
c       rhs for div.r=0, div.s=0 and div.t=0
       divr0(m1,m2,m3)= rxr3(m1,1)*vr(1,m1)+rxr3(m1,2)*vr(2,m1)+rxr3(
     & m1,3)*vr(3,m1) + rxr3(m2,1)*vr(1,m2)+rxr3(m2,2)*vr(2,m2)+rxr3(
     & m2,3)*vr(3,m2) + rxr3(m3,1)*vr(1,m3)+rxr3(m3,2)*vr(2,m3)+rxr3(
     & m3,3)*vr(3,m3) + rx3(m1,1)*vrr(1,m1,m1)+rx3(m1,2)*vrr(2,m1,m1) 
     & +rx3(m1,3)*vrr(3,m1,m1) + rx3(m3,1)*vrr(1,m1,m3)+rx3(m3,2)*vrr(
     & 2,m1,m3) +rx3(m3,3)*vrr(3,m1,m3)
       divs0(m1,m2,m3)= rxs3(m1,1)*vr(1,m1)+rxs3(m1,2)*vr(2,m1)+rxs3(
     & m1,3)*vr(3,m1) + rxs3(m2,1)*vr(1,m2)+rxs3(m2,2)*vr(2,m2)+rxs3(
     & m2,3)*vr(3,m2) + rxs3(m3,1)*vr(1,m3)+rxs3(m3,2)*vr(2,m3)+rxs3(
     & m3,3)*vr(3,m3) + rx3(m1,1)*vrr(1,m1,m1)+rx3(m1,2)*vrr(2,m1,m1) 
     & +rx3(m1,3)*vrr(3,m1,m1) + rx3(m3,1)*vrr(1,m1,m3)+rx3(m3,2)*vrr(
     & 2,m1,m3) +rx3(m3,3)*vrr(3,m1,m3)
       divt0(m1,m2,m3)= rxt3(m1,1)*vr(1,m1)+rxt3(m1,2)*vr(2,m1)+rxt3(
     & m1,3)*vr(3,m1) + rxt3(m2,1)*vr(1,m2)+rxt3(m2,2)*vr(2,m2)+rxt3(
     & m2,3)*vr(3,m2) + rxt3(m3,1)*vr(1,m3)+rxt3(m3,2)*vr(2,m3)+rxt3(
     & m3,3)*vr(3,m3) + rx3(m1,1)*vrr(1,m1,m1)+rx3(m1,2)*vrr(2,m1,m1) 
     & +rx3(m1,3)*vrr(3,m1,m1) + rx3(m3,1)*vrr(1,m1,m3)+rx3(m3,2)*vrr(
     & 2,m1,m3) +rx3(m3,3)*vrr(3,m1,m3)
       uc33(is1,is2,i1,i2,i3,kd)= 2.*u(i1,i2,i3,kd)-u(i1+is1,i2+is2,i3,
     & kd) +(is1*drs(1))**2*vrr(kd,1,1) +(is2*drs(2))**2*vrr(kd,2,2)
       uc32(is1,is3,i1,i2,i3,kd)= 2.*u(i1,i2,i3,kd)-u(i1+is1,i2,i3+is3,
     & kd) +(is1*drs(1))**2*vrr(kd,1,1) +(is3*drs(3))**2*vrr(kd,3,3)
       uc31(is2,is3,i1,i2,i3,kd)= 2.*u(i1,i2,i3,kd)-u(i1,i2+is2,i3+is3,
     & kd) +(is2*drs(2))**2*vrr(kd,2,2) +(is3*drs(3))**2*vrr(kd,3,3)
c  Here are more accurate expressions for 3D -- exact for 4th order polynomials
       ! 3d, edge along direction 3, 1st derivative term in Taylor series
       taylor3d3e1(is1,is2,i1,i2,i3,kd)= (is1*drs(1))*vr(kd,1) +(is2*
     & drs(2))*vr(kd,2)
       ! 3d, edge along direction 3, 2nd derivative term in Taylor series
       taylor3d3e2(is1,is2,i1,i2,i3,kd)=    .5*(is1*drs(1))**2*vrr(kd,
     & 1,1) +.5*(is2*drs(2))**2*vrr(kd,2,2)
       ! 3d, edge along direction 2, 1st derivative term in Taylor series
       taylor3d2e1(is1,is3,i1,i2,i3,kd)= (is1*drs(1))*vr(kd,1) +(is3*
     & drs(3))*vr(kd,3)
       ! 3d, edge along direction 2, 2nd derivative term in Taylor series
       taylor3d2e2(is1,is3,i1,i2,i3,kd)= .5*(is1*drs(1))**2*vrr(kd,1,1)
     &  +.5*(is3*drs(3))**2*vrr(kd,3,3)
       ! 3d, edge along direction 1, 1st derivative term in Taylor series
       taylor3d1e1(is2,is3,i1,i2,i3,kd)= (is2*drs(2))*vr(kd,2) +(is3*
     & drs(3))*vr(kd,3)
       ! 3d, edge along direction 1, 2nd derivative term in Taylor series
       taylor3d1e2(is2,is3,i1,i2,i3,kd)=   .5*(is2*drs(2))**2*vrr(kd,2,
     & 2) +.5*(is3*drs(3))**2*vrr(kd,3,3)
       !  3d, edge along direction 3,for u(-1,-1,*) 
       uc3d3e11(is1,is2,i1,i2,i3,kd)= 3.75*u(i1,i2,i3,kd)   -3.*u(i1+
     & is1,i2+is2,i3,kd) +.25*u(i1+2*is1,i2+2*is2,i3,kd) +1.5*
     & taylor3d3e1(is1,is2,i1,i2,i3,kd) + 3.*taylor3d3e2(is1,is2,i1,
     & i2,i3,kd)
       !  3d, edge along direction 2,for u(-1,*,-1) 
       uc3d2e11(is1,is3,i1,i2,i3,kd)= 3.75*u(i1,i2,i3,kd)   -3.*u(i1+
     & is1,i2,i3+is3,kd) +.25*u(i1+2*is1,i2,i3+2*is3,kd) +1.5*
     & taylor3d2e1(is1,is3,i1,i2,i3,kd) + 3.*taylor3d2e2(is1,is3,i1,
     & i2,i3,kd)
       !  3d, edge along direction 1,for u(*,-1,-1) 
       uc3d1e11(is2,is3,i1,i2,i3,kd)= 3.75*u(i1,i2,i3,kd)   -3.*u(i1,
     & i2+is2,i3+is3,kd) +.25*u(i1,i2+2*is2,i3+2*is3,kd) +1.5*
     & taylor3d1e1(is2,is3,i1,i2,i3,kd) + 3.*taylor3d1e2(is2,is3,i1,
     & i2,i3,kd)
       ! ...extrapolate velocity in 3D (extrap u(i1-n1,i2-n2,i3-n3)
       ux6m(n1,n2,n3,kd)= + 6.*u(i1     ,i2     ,i3     ,kd) -15.*u(i1+
     &   n1,i2+  n2,i3+  n3,kd) +20.*u(i1+2*n1,i2+2*n2,i3+2*n3,kd) -
     & 15.*u(i1+3*n1,i2+3*n2,i3+3*n3,kd) + 6.*u(i1+4*n1,i2+4*n2,i3+4*
     & n3,kd) -    u(i1+5*n1,i2+5*n2,i3+5*n3,kd)
c.......end statement functions
       oldway=.false. ! .true.
       debug=.false.
       kd3=min(nd,3)
...
c     ...get mixed derivatives at corners
        if( gridType.eq.curvilinear )then
         ...
         a1=rxr(i1,i2,i3)*vr(1,1)+sxr(i1,i2,i3)*vr(1,2) +ryr(i1,i2,i3)*
     & vr(2,1)+syr(i1,i2,i3)*vr(2,2)
         a2=rxs(i1,i2,i3)*vr(1,1)+sxs(i1,i2,i3)*vr(1,2) +rys(i1,i2,i3)*
     & vr(2,1)+sys(i1,i2,i3)*vr(2,2)
         vrr(1,1,2)=(+ry(i1,i2,i3)*rx(i1,i2,i3)*vrr(1,1,1) -sy(i1,i2,
     & i3)*sx(i1,i2,i3)*vrr(1,2,2) +ry(i1,i2,i3)*ry(i1,i2,i3)*vrr(2,1,
     & 1) -sy(i1,i2,i3)*sy(i1,i2,i3)*vrr(2,2,2) +ry(i1,i2,i3)*a1-sy(
     & i1,i2,i3)*a2)/ajac
         vrr(2,1,2)=(-rx(i1,i2,i3)*rx(i1,i2,i3)*vrr(1,1,1) +sx(i1,i2,
     & i3)*sx(i1,i2,i3)*vrr(1,2,2) -rx(i1,i2,i3)*ry(i1,i2,i3)*vrr(2,1,
     & 1) +sx(i1,i2,i3)*sy(i1,i2,i3)*vrr(2,2,2) -rx(i1,i2,i3)*a1+sx(
     & i1,i2,i3)*a2)/ajac
        else ! rectangular
...
c   write(1,9100) i1,i2,i3,is1,is2,is3,kd1,kd2,kdn,tn, c  (vrr(kdd,1,1),kdd=1,nd),(vrr(kdd,2,2),kdd=1,nd), c  (vrr(kdd,3,3),kdd=1,nd)
c end if
c 9100 format(' INSBV4: i1,i2,i3 =',3i3,' is1,is2,is3=',3i3, c      ' kd1,kd2,kdn=',3i3,/,' tn =',3e10.2,' u.rr=',3e10.2,/, c      ' v.ss=',3e10.2,' v.tt=',3e10.2)
         if( kdn.eq.3 )then
...
c         ...determine the rhs from the extrapolation condition
           ...
           b(3)= tn(1)*(ux6m(is1,is2,0,1)-uc33(is1,is2,i1,i2,i3,1))*
     & trsi +tn(2)*(ux6m(is1,is2,0,2)-uc33(is1,is2,i1,i2,i3,2))*trsi +
     & tn(3)*(ux6m(is1,is2,0,3)-uc33(is1,is2,i1,i2,i3,3))*trsi
           else
           trsi=1./(3.*(is1*drs(kd1)*is2*drs(kd2)))
           b(3)= tn(1)*(ux6m(is1,is2,0,1)-uc3d3e11(is1,is2,i1,i2,i3,1))
     & *trsi +tn(2)*(ux6m(is1,is2,0,2)-uc3d3e11(is1,is2,i1,i2,i3,2))*
     & trsi +tn(3)*(ux6m(is1,is2,0,3)-uc3d3e11(is1,is2,i1,i2,i3,3))*
     & trsi
           end if
         elseif( kdn.eq.2 )then
           do kd=1,nd
...
c         ...determine the rhs from the extrapolation condition
           ...
           b(3)= tn(1)*(ux6m(is1,0,is3,1)-uc32(is1,is3,i1,i2,i3,1))*
     & trsi +tn(2)*(ux6m(is1,0,is3,2)-uc32(is1,is3,i1,i2,i3,2))*trsi +
     & tn(3)*(ux6m(is1,0,is3,3)-uc32(is1,is3,i1,i2,i3,3))*trsi
           else
           trsi=1./(3.*(is1*drs(kd1)*is3*drs(kd2)))
           b(3)= tn(1)*(ux6m(is1,0,is3,1)-uc3d2e11(is1,is3,i1,i2,i3,1))
     & *trsi +tn(2)*(ux6m(is1,0,is3,2)-uc3d2e11(is1,is3,i1,i2,i3,2))*
     & trsi +tn(3)*(ux6m(is1,0,is3,3)-uc3d2e11(is1,is3,i1,i2,i3,3))*
     & trsi
           end if
...
c         ...determine the rhs from the extrapolation condition
           ...
           b(3)= tn(1)*(ux6m(0,is2,is3,1)-uc31(is2,is3,i1,i2,i3,1))*
     & trsi +tn(2)*(ux6m(0,is2,is3,2)-uc31(is2,is3,i1,i2,i3,2))*trsi +
     & tn(3)*(ux6m(0,is2,is3,3)-uc31(is2,is3,i1,i2,i3,3))*trsi
           else
           trsi=1./(3.*(is2*drs(kd1)*is3*drs(kd2)))
           b(3)= tn(1)*(ux6m(0,is2,is3,1)-uc3d1e11(is2,is3,i1,i2,i3,1))
     & *trsi +tn(2)*(ux6m(0,is2,is3,2)-uc3d1e11(is2,is3,i1,i2,i3,2))*
     & trsi +tn(3)*(ux6m(0,is2,is3,3)-uc3d1e11(is2,is3,i1,i2,i3,3))*
     & trsi
           end if
c      if( debug )then
c        j2=i2-is2
...
c 9700 format(' ux6m(0,is2,is3,1)=',e12.4,' uc31 =',e12.4,' u0=',e12.4)
         ...
         a(3,2)=tn(2)
         a(3,3)=tn(3)
         det=a(1,1)*(a(2,2)*a(3,3)-a(3,2)*a(2,3)) +a(2,1)*(a(3,2)*a(1,
     & 3)-a(1,2)*a(3,3)) +a(3,1)*(a(1,2)*a(2,3)-a(2,2)*a(1,3))
         if( det.eq.0. )then
           stop 'INSBV4: det=0'
         end if
         deti=1./det
         do kd=1,nd
           kdp1=mod(kd  ,nd)+1
           kdp2=mod(kd+1,nd)+1
           vrr(kd,kd1,kd2)= deti* (  b(1)*(a(2,kdp1)*a(3,kdp2)-a(3,
     & kdp1)*a(2,kdp2)) +b(2)*(a(3,kdp1)*a(1,kdp2)-a(1,kdp1)*a(3,kdp2)
     & ) +b(3)*(a(1,kdp1)*a(2,kdp2)-a(2,kdp1)*a(1,kdp2)) )
           vrr(kd,kd2,kd1)=vrr(kd,kd1,kd2)
         end do
c if( debug .and.kdn.eq.1 )then
c   write(1,9200) a,b, c   kd1,kd2, (vrr(kd,kd1,kd2),kd=1,nd),(ubst(i1,i2,i3,kd),kd=1,nd)
c end if
c 9200 format(' a=',9e9.1,/,' b=',3e12.4,/, c             ' kd1,kd2=',2i2,' vrr(kd1,kd2)=',3e12.4,/, c             '             ubrr=',3e12.4)
c **   end if ! curvilinear
       end if
       return
       end
            subroutine insbv4r( i1,i2,i3,kd1,kd2,kdn,is1,is2,is3,t,vr,
     & vrr,d14,d24,drs,nd,ndra,ndrb,ndsa,ndsb,ndta,ndtb, xy,rsxy,u,
     & gridType )
c======================================================================
c        Return Tangential and Mixed Derivatives
