...
c     *********************************      
     ...
     & ulaplacian42r(i1,i2,i3,vc)
            ...
            do i1=n1a,n1b
              ! INS, no AD
               ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*ux42r(i1,i2,i3,uc)-uu(
     & i1,i2,i3,vc)*uy42r(i1,i2,i3,uc)-ux42r(i1,i2,i3,pc)+nu*
     & ulaplacian42r(i1,i2,i3,uc)
               ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*ux42r(i1,i2,i3,vc)-uu(
     & i1,i2,i3,vc)*uy42r(i1,i2,i3,vc)-uy42r(i1,i2,i3,pc)+nu*
     & ulaplacian42r(i1,i2,i3,vc)
            end do
            end do
            end do
     ...
     & uc)*ri )
                  ut(i1,i2,i3,vc)=ut(i1,i2,i3,vc)+nu*( (uy42r(i1,i2,i3,
     & vc)-uu(i1,i2,i3,vc)*ri)*ri )
                else
                  ut(i1,i2,i3,uc)=ut(i1,i2,i3,uc)+nu*( uyy42r(i1,i2,i3,
     & uc) )
                  ut(i1,i2,i3,vc)=ut(i1,i2,i3,vc)+nu*( .5*uyy42r(i1,i2,
     & i3,vc) )
                end if
             end if
            end do
     ...
     & uu(i1,i2,i3,vc)*uy42r(i1,i2,i3,vc)-uy42r(i1,i2,i3,pc)
                 ! include implicit terms - diffusion
                  ...
                  ri=radiusInverse(i1,i2,i3)
                  if( ri.ne.0. )then
                    uti(i1,i2,i3,uc)=uti(i1,i2,i3,uc)+nu*( uy42r(i1,i2,
     & i3,uc)*ri )
     ...
     & uu(i1,i2,i3,vc)*uy42r(i1,i2,i3,vc)-uy42r(i1,i2,i3,pc)
                ! include implicit terms - diffusion
                 ...
                 if( ri.ne.0. )then
                   uti(i1,i2,i3,uc)=uti(i1,i2,i3,uc)+nu*( uy42r(i1,i2,
     & i3,uc)*ri )
                   uti(i1,i2,i3,vc)=uti(i1,i2,i3,vc)+nu*( (uy42r(i1,i2,
     & i3,vc)-uu(i1,i2,i3,vc)*ri)*ri )
                 else
                   uti(i1,i2,i3,uc)=uti(i1,i2,i3,uc)+nu*( uyy42r(i1,i2,
     & i3,uc) )
                   uti(i1,i2,i3,vc)=uti(i1,i2,i3,vc)+nu*( .5*uyy42r(i1,
     & i2,i3,vc) )
                 end if
              end do
              end do
          ...
          if( gridIsImplicit.eq.0 )then
           ...
           if( useWhereMask.ne.0 )then
            ...
            do i1=n1a,n1b
             if( mask(i1,i2,i3).gt.0 )then
               ! INS, no AD
                ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)-uu(
     & i1,i2,i3,vc)*uy42(i1,i2,i3,uc)-ux42(i1,i2,i3,pc)+nu*
     & ulaplacian42(i1,i2,i3,uc)
                ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*ux42(i1,i2,i3,vc)-uu(
     & i1,i2,i3,vc)*uy42(i1,i2,i3,vc)-uy42(i1,i2,i3,pc)+nu*
     ...
     & ulaplacian42(i1,i2,i3,vc)
               ...
               ri=radiusInverse(i1,i2,i3)
               if( ri.ne.0. )then
                 ut(i1,i2,i3,uc)=ut(i1,i2,i3,uc)+nu*( uy42(i1,i2,i3,uc)
     & *ri )
                 ut(i1,i2,i3,vc)=ut(i1,i2,i3,vc)+nu*( (uy42(i1,i2,i3,
     & vc)-uu(i1,i2,i3,vc)*ri)*ri )
               else
     ...
     & i3,uc)*ri )
                    uti(i1,i2,i3,vc)=uti(i1,i2,i3,vc)+nu*( (uy42(i1,i2,
     & i3,vc)-uu(i1,i2,i3,vc)*ri)*ri )
                  else
                    uti(i1,i2,i3,uc)=uti(i1,i2,i3,uc)+nu*( uyy42(i1,i2,
     & i3,uc) )
                    uti(i1,i2,i3,vc)=uti(i1,i2,i3,vc)+nu*( .5*uyy42(i1,
     & i2,i3,vc) )
                  end if
               end if
              end do
