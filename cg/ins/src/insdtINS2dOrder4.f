...
c============================================================================================
     ...
     & upwindOrder
                    ...
                    ut(i1,i2,i3,uc)= -(agu(uc,uc)+agu(vc,uc))-ux42r(i1,
     & i2,i3,pc)+nu*ulaplacian42r(i1,i2,i3,uc)
                    ut(i1,i2,i3,vc)= -(agu(uc,vc)+agu(vc,vc))-uy42r(i1,
     & i2,i3,pc)+nu*ulaplacian42r(i1,i2,i3,vc)
               end do
               end do
               end do
              end if
                ...
                if( mask(i1,i2,i3).gt.0 )then
                  ! INS, no AD
                    ! --- upwind approximations ---
                      ...
                      !  end if
                        agu(uc,uc)=uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)
                        agu(vc,uc)=uu(i1,i2,i3,vc)*uy42(i1,i2,i3,uc)
                        agu(uc,vc)=uu(i1,i2,i3,uc)*ux42(i1,i2,i3,vc)
                        agu(vc,vc)=uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)
                     ut(i1,i2,i3,uc)= -(agu(uc,uc)+agu(vc,uc))-ux42(i1,
     & i2,i3,pc)+nu*ulaplacian42(i1,i2,i3,uc)
                     ut(i1,i2,i3,vc)= -(agu(uc,vc)+agu(vc,vc))-uy42(i1,
     & i2,i3,pc)+nu*ulaplacian42(i1,i2,i3,vc)
                end if
               end do
               end do
               end do
