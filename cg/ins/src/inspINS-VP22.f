...
c     ---- local variables -----
     ...
     & cw3e6, cv1e3, cd0, cr0
         ...
         real eDotNorm,exp0,eDotNormSqx,eDotNormSqy,eDotNormSqxx,
     & eDotNormSqxy,eDotNormSqyy
           ...
           if( useWhereMask.ne.0 )then
             ...
             do i1=n1a,n1b
               if( mask(i1,i2,i3).ne.0 )then
                    ...
                    u0xx = uxx22r(i1,i2,i3,uc)
                    u0xy = uxy22r(i1,i2,i3,uc)
                    u0yy = uyy22r(i1,i2,i3,uc)
                    v0xx = uxx22r(i1,i2,i3,vc)
                    v0xy = uxy22r(i1,i2,i3,vc)
                    v0yy = uyy22r(i1,i2,i3,vc)
                    u0Lap=u0xx+u0yy
                    v0Lap=v0xx+v0yy
                    ! still need to define 3d 3rd derivatives   
                    u0xxx=uxxx22r(i1,i2,i3,uc)
                    u0xxy=uxxy22r(i1,i2,i3,uc)
                    u0xyy=uxyy22r(i1,i2,i3,uc)
                    u0yyy=uyyy22r(i1,i2,i3,uc)
                    v0xxx=uxxx22r(i1,i2,i3,vc)
                    v0xxy=uxxy22r(i1,i2,i3,vc)
                    v0xyy=uxyy22r(i1,i2,i3,vc)
                    v0yyy=uyyy22r(i1,i2,i3,vc)
                    ! eDotNorm = sqrt( u0x**2 + u0y**2 + v0x**2 + v0y**2 ) + epsVP
                    eDotNorm = (sqrt((2./3.)*(u0x**2+v0y**2+.5*(u0y+
     & v0x)**2))+epsVP)
                      exp0 = exp(-exponentVP*eDotNorm)
                      nuT = (etaVP + (yieldStressVP/eDotNorm)*(1.-exp0)
     & )*(2./3.)
                      nuTd = ( (-1./eDotNorm)*(1.-exp0) + exponentVP*
     & exp0  )*(yieldStressVP/eDotNorm**2)*(1./3.)
                      nuTdd=( 3./(eDotNorm**2)*(1.-exp0) -2./(eDotNorm)
     & *exponentVP*exp0 + exponentVP**2*exp0 )*(
     & yieldStressVP/eDotNorm**2)*(1./6.)
                      ! fake viscosity for tesing:
                      ! nuT=nu + nuVP*eDotNorm**2
                      ! nuTd = nuVP
                      ! nuTdd = 0.
                    ! nuT=nu + nuVP*eDotNorm**2
                    ! eDotNormSqx = 2.*( u0x*u0xx + u0y*u0xy + v0x*v0xx + v0y*v0xy )
                    ! eDotNormSqy = 2.*( u0x*u0xy + u0y*u0yy + v0x*v0xy + v0y*v0yy )
                    ! eDotNormSqxx = 2.*( u0x*u0xxx + u0y*u0xxy + v0x*v0xxx + v0y*v0xxy + u0xx**2   + u0xy**2   + v0xx**2   + v0xy**2 )
                    ! eDotNormSqxy = 2.*( u0x*u0xxy + u0y*u0xyy + v0x*v0xxy + v0y*v0xyy + u0xy*u0xx + u0yy*u0xy + v0xy*v0xx + v0yy*v0xy )
                    ! eDotNormSqyy = 2.*( u0x*u0xyy + u0y*u0yyy + v0x*v0xyy + v0y*v0yyy + u0xy**2   + u0yy**2   + v0xy**2   + v0yy**2 )
                    eDotNormSqx =((2./3.)**2*(2.*u0x*u0xx+2.*v0y*v0xy+(
     & u0y+v0x)*(u0xy+v0xx)))
                    eDotNormSqy =((2./3.)**2*(2.*u0x*u0xy+2.*v0y*v0yy+(
     & u0y+v0x)*(u0yy+v0xy)))
                    eDotNormSqxx=((2./3.)**2*(2.*(u0xx*u0xx+u0x*u0xxx)+
     & 2.*(v0xy*v0xy+v0y*v0xxy)+(u0xy+v0xx)*(u0xy+v0xx)+(u0y+v0x)*(
     & u0xxy+v0xxx)))
                    eDotNormSqxy=((2./3.)**2*(2.*(u0xy*u0xx+u0x*u0xxy)+
     & 2.*(v0yy*v0xy+v0y*v0xyy)+(u0yy+v0xy)*(u0xy+v0xx)+(u0y+v0x)*(
     & u0xyy+v0xxy)))
                    eDotNormSqyy=((2./3.)**2*(2.*(u0xy*u0xy+u0x*u0xyy)+
     & 2.*(v0yy*v0yy+v0y*v0yyy)+(u0yy+v0xy)*(u0yy+v0xy)+(u0y+v0x)*(
     & u0yyy+v0xyy)))
                    nuTx=nuTd*eDotNormSqx
                    nuTy=nuTd*eDotNormSqy
                    nuTxx=nuTd*eDotNormSqxx + nuTdd*eDotNormSqx**2
                    nuTxy=nuTd*eDotNormSqxy + nuTdd*eDotNormSqx*
     & eDotNormSqy
           ...
           if( useWhereMask.ne.0 )then
             ...
             do i1=n1a,n1b
               if( mask(i1,i2,i3).ne.0 )then
                    ...
                    u0xx = uxx22(i1,i2,i3,uc)
                    u0xy = uxy22(i1,i2,i3,uc)
                    u0yy = uyy22(i1,i2,i3,uc)
                    v0xx = uxx22(i1,i2,i3,vc)
                    v0xy = uxy22(i1,i2,i3,vc)
                    v0yy = uyy22(i1,i2,i3,vc)
                    u0Lap=u0xx+u0yy
                    v0Lap=v0xx+v0yy
                    ! still need to define 3d 3rd derivatives   
                    u0xxx=uxxx22(i1,i2,i3,uc)
                    u0xxy=uxxy22(i1,i2,i3,uc)
                    u0xyy=uxyy22(i1,i2,i3,uc)
                    u0yyy=uyyy22(i1,i2,i3,uc)
                    v0xxx=uxxx22(i1,i2,i3,vc)
                    v0xxy=uxxy22(i1,i2,i3,vc)
                    v0xyy=uxyy22(i1,i2,i3,vc)
                    v0yyy=uyyy22(i1,i2,i3,vc)
                    ! eDotNorm = sqrt( u0x**2 + u0y**2 + v0x**2 + v0y**2 ) + epsVP
                    eDotNorm = (sqrt((2./3.)*(u0x**2+v0y**2+.5*(u0y+
     & v0x)**2))+epsVP)
                      exp0 = exp(-exponentVP*eDotNorm)
...
c if( (includeADinPressure.eq.0) .or. (use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.0 ) )then
                         ...
                         do i1=n1a,n1b
                          ...
                          ! By default there is no AD:
                            ! get nuT,nuTx,nuTy,nuTz
                                 ...
                                 v0yy = uyy22r(i1,i2,i3,vc)
                                 ! eDotNorm = sqrt( u0x**2 + u0y**2 + v0x**2 + v0y**2 ) + epsVP
                                 eDotNorm = (sqrt((2./3.)*(u0x**2+v0y**
     & 2+.5*(u0y+v0x)**2))+epsVP)
                                 ! nuT = etaPlasticVP + sigmaYieldVP*( 1 - exp(-exponentVP*eDotNorm ) )/( eDotNorm )
                                   exp0 = exp(-exponentVP*eDotNorm)
                                   nuT = (etaVP + (
     & yieldStressVP/eDotNorm)*(1.-exp0))*(2./3.)
                                   nuTd = ( (-1./eDotNorm)*(1.-exp0) + 
     & exponentVP*exp0  )*(yieldStressVP/eDotNorm**2)*(1./3.)
                                   ! fake viscosity for tesing:
                                   ! nuT=nu + nuVP*eDotNorm**2
                                   ! nuTd = nuVP
                                 !*   nuTd = (-(yieldStressVP/(eDotNorm**2))*(1.-exp0) + (yieldStressVP/eDotNorm)*exponentVP*exp0   )*(2./3.)
                               !   nuT=nu + nuVP*eDotNorm**2
                                 ! nuTx=nuTd*2.*( u0x*u0xx + u0y*u0xy + v0x*v0xx + v0y*v0xy )
                                 ! nuTy=nuTd*2.*( u0x*u0xy + u0y*u0yy + v0x*v0xy + v0y*v0yy )
                                 nuTx = nuTd*((2./3.)**2*(2.*u0x*u0xx+
     & 2.*v0y*v0xy+(u0y+v0x)*(u0xy+v0xx)))
                                 nuTy = nuTd*((2./3.)**2*(2.*u0x*u0xy+
     & 2.*v0y*v0yy+(u0y+v0x)*(u0yy+v0xy)))
     ...
     & advectionCoefficient*(uu(i1,i2,i3,uc)*ux22r(i1,i2,i3,uc)+uu(i1,
     & i2,i3,vc)*uy22r(i1,i2,i3,uc))  )
                           end if
                         end do
                         end do
                         end do
                             ...
                             do i1=n1a,n1b
                              ...
                              ! By default there is no AD:
                                ! get nuT,nuTx,nuTy,nuTz
                                     ...
                                     v0yy = uyy22r(i1,i2,i3,vc)
                                     ! eDotNorm = sqrt( u0x**2 + u0y**2 + v0x**2 + v0y**2 ) + epsVP
                                     eDotNorm = (sqrt((2./3.)*(u0x**2+
     & v0y**2+.5*(u0y+v0x)**2))+epsVP)
                                     ! nuT = etaPlasticVP + sigmaYieldVP*( 1 - exp(-exponentVP*eDotNorm ) )/( eDotNorm )
                                       exp0 = exp(-exponentVP*eDotNorm)
                                       nuT = (etaVP + (
     & yieldStressVP/eDotNorm)*(1.-exp0))*(2./3.)
                                       nuTd = ( (-1./eDotNorm)*(1.-
     & exp0) + exponentVP*exp0  )*(yieldStressVP/eDotNorm**2)*(1./3.)
                                       ! fake viscosity for tesing:
                                       ! nuT=nu + nuVP*eDotNorm**2
                                       ! nuTd = nuVP
                                     !*   nuTd = (-(yieldStressVP/(eDotNorm**2))*(1.-exp0) + (yieldStressVP/eDotNorm)*exponentVP*exp0   )*(2./3.)
                                   !   nuT=nu + nuVP*eDotNorm**2
                                     ! nuTx=nuTd*2.*( u0x*u0xx + u0y*u0xy + v0x*v0xx + v0y*v0xy )
                                     ! nuTy=nuTd*2.*( u0x*u0xy + u0y*u0yy + v0x*v0xy + v0y*v0yy )
                                     nuTx = nuTd*((2./3.)**2*(2.*u0x*
     & u0xx+2.*v0y*v0xy+(u0y+v0x)*(u0xy+v0xx)))
                                     nuTy = nuTd*((2./3.)**2*(2.*u0x*
     & u0xy+2.*v0y*v0yy+(u0y+v0x)*(u0yy+v0xy)))
                                    ! normal00-form of the diffusion operator in 2D
                              ! Artficial Dissipation  **todo** implicit-line, self-adjoint versions
                              ! Here now is the statement where the ghost line value in the RHS is assigned.
                                  f(i1+is1,i2,i3)=(2*side-1)*( (nuT*(
     & ulaplacian22r(i1,i2,i3,uc))+2.*nuTx*(ux22r(i1,i2,i3,uc))+nuTy*(
     & uy22r(i1,i2,i3,uc)+ux22r(i1,i2,i3,vc)))-advectionCoefficient*(
     & uu(i1,i2,i3,uc)*ux22r(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy22r(i1,i2,
     & i3,uc))  )
                               end if
                             end do
                             end do
     ...
     & advectionCoefficient*(uu(i1,i2,i3,uc)*ux22r(i1,i2,i3,vc)+uu(i1,
     & i2,i3,vc)*uy22r(i1,i2,i3,vc))  )
                           end if
                         end do
                         end do
                         end do
     ...
     & ux22r(i1,i2,i3,vc)+uy22r(i1,i2,i3,uc)))-advectionCoefficient*(
     & uu(i1,i2,i3,uc)*ux22r(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy22r(i1,i2,
     & i3,vc))  )
                               end if
                             end do
                             end do
     ...
     & advectionCoefficient*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,
     & i2,i3,vc)*uy22(i1,i2,i3,uc))  )+normal00(i1,i2,i3,1)*( (nuT*(
     & uxx22(i1,i2,i3,vc)-uxy22(i1,i2,i3,uc))-2.*nuTy*(ux22(i1,i2,i3,
     & uc))+nuTx*(ux22(i1,i2,i3,vc)+uy22(i1,i2,i3,uc)))-
     & advectionCoefficient*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,
     & i2,i3,vc)*uy22(i1,i2,i3,vc))  )
                           end if
                         end do
                         end do
                         end do
     ...
     & ux22(i1,i2,i3,vc)+uy22(i1,i2,i3,uc)))-advectionCoefficient*(uu(
     ...
     & i1,i2,i3,vc))+nuTy*(uy22(i1,i2,i3,uc)+ux22(i1,i2,i3,vc)))-
     & advectionCoefficient*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,
     & i2,i3,vc)*uy22(i1,i2,i3,uc))  )+normal10(i1,i2,i3,1)*( (nuT*(
     & uxx22(i1,i2,i3,vc)-uxy22(i1,i2,i3,uc))-2.*nuTy*(ux22(i1,i2,i3,
     & uc))+nuTx*(ux22(i1,i2,i3,vc)+uy22(i1,i2,i3,uc)))-
     & advectionCoefficient*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,
     & i2,i3,vc)*uy22(i1,i2,i3,vc))  )
     ...
     & i1,i2,i3,vc))+nuTy*(uy22(i1,i2,i3,uc)+ux22(i1,i2,i3,vc)))-
     & advectionCoefficient*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,
     & i2,i3,vc)*uy22(i1,i2,i3,uc))  )+normal01(i1,i2,i3,1)*( (nuT*(
     & uxx22(i1,i2,i3,vc)-uxy22(i1,i2,i3,uc))-2.*nuTy*(ux22(i1,i2,i3,
     & uc))+nuTx*(ux22(i1,i2,i3,vc)+uy22(i1,i2,i3,uc)))-
     & advectionCoefficient*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,
     & i2,i3,vc)*uy22(i1,i2,i3,vc))  )
     ...
     & i1,i2,i3,vc))+nuTy*(uy22(i1,i2,i3,uc)+ux22(i1,i2,i3,vc)))-
     & advectionCoefficient*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,
     & i2,i3,vc)*uy22(i1,i2,i3,uc))  )+normal11(i1,i2,i3,1)*( (nuT*(
     & uxx22(i1,i2,i3,vc)-uxy22(i1,i2,i3,uc))-2.*nuTy*(ux22(i1,i2,i3,
     & uc))+nuTx*(ux22(i1,i2,i3,vc)+uy22(i1,i2,i3,uc)))-
     & advectionCoefficient*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,
     & i2,i3,vc)*uy22(i1,i2,i3,vc))  )
