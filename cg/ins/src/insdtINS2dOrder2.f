...
c     *********************************      
     ...
     & ulaplacian22r(i1,i2,i3,vc)
            ...
            do i1=n1a,n1b
              ! INS, no AD
               ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*ux22r(i1,i2,i3,uc)-uu(
     & i1,i2,i3,vc)*uy22r(i1,i2,i3,uc)-ux22r(i1,i2,i3,pc)+nu*
     & ulaplacian22r(i1,i2,i3,uc)
               ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*ux22r(i1,i2,i3,vc)-uu(
     & i1,i2,i3,vc)*uy22r(i1,i2,i3,vc)-uy22r(i1,i2,i3,pc)+nu*
     & ulaplacian22r(i1,i2,i3,vc)
            end do
            end do
            end do
          ...
          if( gridIsImplicit.eq.0 )then
           ...
           if( useWhereMask.ne.0 )then
            ...
            do i1=n1a,n1b
             if( mask(i1,i2,i3).gt.0 )then
               ! INS, no AD
                ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)-uu(
     & i1,i2,i3,vc)*uy22(i1,i2,i3,uc)-ux22(i1,i2,i3,pc)+nu*
     & ulaplacian22(i1,i2,i3,uc)
                ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)-uu(
     & i1,i2,i3,vc)*uy22(i1,i2,i3,vc)-uy22(i1,i2,i3,pc)+nu*
     ...
     & ulaplacian22(i1,i2,i3,vc)
               ...
               ri=radiusInverse(i1,i2,i3)
               if( ri.ne.0. )then
                 ut(i1,i2,i3,uc)=ut(i1,i2,i3,uc)+nu*( uy22(i1,i2,i3,uc)
     & *ri )
                 ut(i1,i2,i3,vc)=ut(i1,i2,i3,vc)+nu*( (uy22(i1,i2,i3,
     & vc)-uu(i1,i2,i3,vc)*ri)*ri )
               else
