! This file automatically generated from inspf.bf with bpp.
        subroutine assignPressureRhsINSKE22(nd,  n1a,n1b,n2a,n2b,n3a,
           ...
           if( useWhereMask.ne.0 )then
             ...
             do i1=n1a,n1b
               if( mask(i1,i2,i3).ne.0 )then
                   ...
                   k0xx=uxx22r(i1,i2,i3,kc)
                   k0xy=uxy22r(i1,i2,i3,kc)
                   k0yy=uyy22r(i1,i2,i3,kc)
                   e0xx=uxx22r(i1,i2,i3,ec)
                   e0xy=uxy22r(i1,i2,i3,ec)
                   e0yy=uyy22r(i1,i2,i3,ec)
           ...
           if( useWhereMask.ne.0 )then
             ...
             do i1=n1a,n1b
               if( mask(i1,i2,i3).ne.0 )then
                   ...
                   nuTx=cMu*k0*( 2.*k0x*e0 - k0*e0x )/e0**2
                   nuTy=cMu*k0*( 2.*k0y*e0 - k0*e0y )/e0**2
                   k0xx=uxx22(i1,i2,i3,kc)
                   k0xy=uxy22(i1,i2,i3,kc)
                   k0yy=uyy22(i1,i2,i3,kc)
                   e0xx=uxx22(i1,i2,i3,ec)
                   e0xy=uxy22(i1,i2,i3,ec)
                   e0yy=uyy22(i1,i2,i3,ec)
                   nuTxx=cMu*(2.*k0xx*e0**2-4.*k0*k0x*e0x*e0+2*k0*k0xx*
     & e0**2+2*k0**2.*e0x**2-k0**2.*e0xx*e0)/e0**3
                   nuTxy=cMu*(2*k0y*k0x*e0**2-2*k0*k0x*e0y*e0+2*k0*
     & k0xy*e0**2-2*k0*e0x*k0y*e0+2*k0**2*e0x*e0y-k0**2*e0xy*e0)/e0**3
