...
#beginMacro initializePdeParameters()
 ...
 if( ok.eq.0 )then
   ...
   write(*,'("*** insImpTP:ERROR: PdeParameters/twoPhaseArtDisPsi NOT FOUND")') 
   ! ' 
 else
   if( debug.gt.4 )then
 ...
 if( ok.eq.0 )then
   adPsi=.1 ! default value if not supplied 
   write(*,'("*** insImpTP:ERROR: PdeParameters/twoPhaseArtDisPhi NOT FOUND")') 
   ! ' 
 else
   if( debug.gt.4 )then
...
! =============================================================================================================
#beginMacro getDivTensorGradCoefficientsINSTP(ul,scale)
#If $DIM == 2 
...
beginLoops()
 ...
 getDivTensorGradCoefficientsINSTP(u,-dtImpOverRho)
 ...
 #If $DIM == 2 
  ...
  setCoeff4(cmpq,eqnq,coeff,iCoeff,-adPsiDt*lapCoeff,adt*ugv*xCoeff,adt*vgv*yCoeff)
...
!       )/ajzzz
 ...
 #Else
  ...
  ! q-eqn (psi)
  setCoeff5(cmpq,eqnq,coeff,iCoeff,-adPsiDt*lapCoeff,adt*ugv*xCoeff,adt*vgv*yCoeff,adt*wgv*zCoeff)
  addCoeff1(cmpu,eqnq,coeff, bDt*q0x*iCoeff)  ! u*q0x 
  addCoeff1(cmpv,eqnq,coeff, bDt*q0y*iCoeff)  ! v*q0y 
...
beginLoopsNoMask()
 ...
 getDivTensorGradCoefficientsINSTP(u,1.)
 ...
 ! ---------------- 2D RHS and Residual ---------------------------
 divNuGradu = divNuGradu2d(u)*(rhoi)
 divNuGradv = divNuGradv2d(u)*(rhoi)
 ...
 if( evalRightHandSide.eq.1 )then
  ...
  if( gridIsImplicit.eq.0 )then
   ...
   fe(i1,i2,i3,uc) = -ugv*u0x -vgv*u0y - p0x*rhoi +gravity(0) + divNuGradu + adCoeff*uDiss22(u,uc) 
   fe(i1,i2,i3,vc) = -ugv*v0x -vgv*v0y - p0y*rhoi +gravity(1) + divNuGradv + adCoeff*uDiss22(u,vc) 
   fe(i1,i2,i3,qc) = -ugv*q0x -vgv*q0y + adPsi*(q0xx+q0yy)
    ...
    getDivTensorGradCoefficientsINSTP(ul,1.)
    divNuGradul = divNuGradu2d(u)*rholi
    divNuGradvl = divNuGradv2d(u)*rholi

    fe(i1,i2,i3,uc) = -ugv*u0x -vgv*u0y - p0x*rhoi +gravity(0) + divNuGradu - divNuGradul \
                           + (adCoeff-adCoeffl)*uDiss22(u,uc)
    fe(i1,i2,i3,vc) = -ugv*v0x -vgv*v0y - p0y*rhoi +gravity(1) + divNuGradv - divNuGradvl \
 ...
 if( evalResidual.eq.1 )then
   ...
   fe(i1,i2,i3,uc) = fi(i1,i2,i3,uc) - ugv*u0x -vgv*u0y - p0x*rhoi +gravity(0) + divNuGradu \
                     + adCoeff*uDiss22(u,uc) 
   fe(i1,i2,i3,vc) = fi(i1,i2,i3,vc) - ugv*v0x -vgv*v0y - p0y*rhoi +gravity(1) + divNuGradv \
                     + adCoeff*uDiss22(u,vc) 
   fe(i1,i2,i3,qc) = fi(i1,i2,i3,qc) - ugv*q0x -vgv*q0y  +adPsi*(q0xx+q0yy)
 ...
 divNuGradu = divNuGradu3d(au,av,aw,u)*rhoi
 divNuGradv = divNuGradu3d(bu,bv,bw,u)*rhoi
 divNuGradw = divNuGradu3d(cu,cv,cw,u)*rhoi
  ...
  if( evalRightHandSide.eq.1 )then
   ...
   if( gridIsImplicit.eq.0 )then
     ! explicit
     fe(i1,i2,i3,uc) = -ugv*u0x -vgv*u0y -wgv*u0z - p0x*rhoi +gravity(0)\
              + divNuGradu + adCoeff*uDiss23(u,uc)
     fe(i1,i2,i3,vc) = -ugv*v0x -vgv*v0y -wgv*v0z - p0y*rhoi +gravity(1)\
              + divNuGradv + adCoeff*uDiss23(u,vc)
     fe(i1,i2,i3,wc) = -ugv*w0x -vgv*w0y -wgv*w0z - p0z*rhoi +gravity(2)\
              + divNuGradw + adCoeff*uDiss23(u,wc)
     fe(i1,i2,i3,qc) = -ugv*q0x -vgv*q0y -wgv*q0z + adPsi*(q0xx+q0yy+q0zz)
   else 
    ! implicit method -- compute explicit part
    !     fe = f(u) - L(u,ul)
    ...
    ! evaluate div( nu(ul).grad ) u
    getDivTensorGradCoefficientsINSTP(ul,1.)
    divNuGradul = divNuGradu3d(au,av,aw,u)*rholi
    divNuGradvl = divNuGradu3d(bu,bv,bw,u)*rholi
    divNuGradwl = divNuGradu3d(cu,cv,cw,u)*rholi
  ...
  if( evalResidual.eq.1 )then
    ...
    fe(i1,i2,i3,uc) = fi(i1,i2,i3,uc) -ugv*u0x -vgv*u0y -wgv*u0z - p0x*rhoi +gravity(0) \
                    + divNuGradu + adCoeff*uDiss23(u,uc)
    fe(i1,i2,i3,vc) = fi(i1,i2,i3,vc) -ugv*v0x -vgv*v0y -wgv*v0z - p0y*rhoi +gravity(1) \
                    + divNuGradv + adCoeff*uDiss23(u,vc)
    fe(i1,i2,i3,wc) = fi(i1,i2,i3,wc) -ugv*w0x -vgv*w0y -wgv*w0z - p0z*rhoi +gravity(2) \
                    + divNuGradw + adCoeff*uDiss23(u,wc)
    fe(i1,i2,i3,qc) = fi(i1,i2,i3,qc) -ugv*q0x -vgv*q0y -wgv*q0z +adPsi*(q0xx+q0yy+q0zz)
