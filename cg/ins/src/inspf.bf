...
!     ---- local variables -----
 ...
 integer isAxisymmetric,is1,is2,is3,pressureBC,gridType,initialConditionsAreBeingProjected
...
!  epsVP               =rpar(22)
 ...
 if( debug.gt.3 .and. surfaceTension.ne.0. )then
   write(*,'("inspf: surfaceTension=",e10.2," pAtmosphere=",e10.2)') surfaceTension,pAtmosphere
 end if
  ...
  do i1=n1a,n1b
   if( mask(i1,i2,i3).ne.0 )then
     ...
     if( surfaceTension.ne.0. .and. gridType.ne.rectangular )then
      ...
      write(*,'(" i1,i2=",2i3," meanCurvature=",f12.8)') i1,i2,meanCurvature
      ...
      f(i1,i2,i3)= pAtmosphere - 2.*surfaceTension*meanCurvature 
