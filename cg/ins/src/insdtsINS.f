! This file automatically generated from insdts.bf with bpp.
        subroutine insdtsINS(nd, n1a,n1b,n2a,n2b,n3a,n3b, nd1a,nd1b,
...
c============================================================================================
         ...
         if( useLocalTimeStepping.eq.0 )then
          ! -- Use a single global dt --
           if( gridIsImplicit.eq.0 )then
            ...
            !  getTimeSteppingEigenvaluesByOrder(INS,GLOBAL,EXPLICIT,NONE)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,GLOBAL,EXPLICIT,AD2)
            ! else if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,GLOBAL,EXPLICIT,AD4)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,GLOBAL,EXPLICIT,AD24)
            ! else
            !   stop 123
            ! end if
     ...
     & uu(i1,i2,i3,vc))/dx(1) )
                          if( 
     & materialFormat.eq.constantMaterialProperties )then
     ...
     & materialFormat.eq.piecewiseConstantMaterialProperties )then
                            ...
                            nuk=max( nu, thermalKpc(i1,i2,i3)/( rhopc(
     & i1,i2,i3)*Cppc(i1,i2,i3) ) )
     ...
     & i2,i3)*Cpv(i1,i2,i3) ) )
                          ...
                          if( pdeModel.eq.twoPhaseFlowModel )then
                            nuk=max(adPsi,u(i1,i2,i3,vsc)/u(i1,i2,i3,
     & rc))  ! do this for now
                          end if
                            a1=a1 -nuk*( rxx22(i1,i2,i3) + ryy22(i1,i2,
     & i3) )
                            a2=a2 -nuk*( sxx22(i1,i2,i3) + syy22(i1,i2,
     & i3) )
                            rePart = nuk*( ( rx(i1,i2,i3)**2          +
     &  ry(i1,i2,i3)**2          )*(crr/(dr(0)*dr(0))) +abs( rx(i1,i2,
     & i3)*sx(i1,i2,i3)+ry(i1,i2,i3)*sy(i1,i2,i3) )*( cr/(dr(0)*dr(1))
     & ) +( sx(i1,i2,i3)**2          + sy(i1,i2,i3)**2          )*(
     & crr/(dr(1)*dr(1))) )
     ...
     & materialFormat.eq.variableMaterialProperties )then
                             ! variable material properties
                             nuk=max( nu, thermalKv(i1,i2,i3)/( rhov(
     & i1,i2,i3)*Cpv(i1,i2,i3) ) )
                             ! write(*,'(" (i1,i2)=",i3,",",i3,") Kv = ",e10.2)') i1,i2,thermalKv(i1,i2,i3)/( rhov(i1,i2,i3)*Cpv(i1,i2,i3) )
                           end if
                             rePart= crr*nuk*( 1./dx(0)**2 + 1./dx(1)**
     & 2 )
                             ...
                             if( abs(yy).ge.dx(1) )then
                               imPart=imPart + cr*nuk*( 1./(yy*dx(1)) )
     &   ! u.y/y
                             else
                               rePart=rePart + crr*nuk*( 1./dx(1)**2 ) 
     &   ! u.yy
                             end if
                         if( use2ndOrderAD.eq.1 )then
                               rePart=rePart + 8.*( ad21 + cd22*( abs(
     ...
     & rc))  ! do this for now
                             ...
                             a1=a1 -nuk*( rxx22(i1,i2,i3) + ryy22(i1,
     & i2,i3) )
                             a2=a2 -nuk*( sxx22(i1,i2,i3) + syy22(i1,
     & i2,i3) )
                             rePart = nuk*( ( rx(i1,i2,i3)**2          
     ...
     & rc))  ! do this for now
                            ...
                            a1=a1 -nuk*( rxx23(i1,i2,i3) + ryy23(i1,i2,
     & i3) + rzz23(i1,i2,i3))
                            a2=a2 -nuk*( sxx23(i1,i2,i3) + syy23(i1,i2,
     & i3) + szz23(i1,i2,i3) )
                            a3=a3 -nuk*( txx23(i1,i2,i3) + tyy23(i1,i2,
     & i3) + tzz23(i1,i2,i3) )
                            rePart = nuk*( ( rx(i1,i2,i3)**2          +
     &  ry(i1,i2,i3)**2         + rz(i1,i2,i3)**2 )*(crr/(dr(0)*dr(0))
     & ) +( sx(i1,i2,i3)**2          + sy(i1,i2,i3)**2         + sz(
     & i1,i2,i3)**2 )*(crr/(dr(1)*dr(1)))  +( tx(i1,i2,i3)**2         
     &  + ty(i1,i2,i3)**2         + tz(i1,i2,i3)**2 )*(crr/(dr(2)*dr(
     & 2)))  +abs( rx(i1,i2,i3)*sx(i1,i2,i3)+ry(i1,i2,i3)*sy(i1,i2,i3)
     & +rz(i1,i2,i3)*sz(i1,i2,i3) )*(cr/(dr(0)*dr(1))) +abs( rx(i1,i2,
     & i3)*tx(i1,i2,i3)+ry(i1,i2,i3)*ty(i1,i2,i3)+rz(i1,i2,i3)*tz(i1,
     & i2,i3) )*(cr/(dr(0)*dr(2))) +abs( sx(i1,i2,i3)*tx(i1,i2,i3)+sy(
     & i1,i2,i3)*ty(i1,i2,i3)+sz(i1,i2,i3)*tz(i1,i2,i3) )*(cr/(dr(1)*
     & dr(2))) )
                          imPart = cr*( abs(a1)/dr(0)+abs(a2)/dr(1)+
     & abs(a3)/dr(2) )
                        if( use2ndOrderAD.eq.1 )then
     ...
     & rc))  ! do this for now
                             ...
                             a1=a1 -nuk*( rxx23(i1,i2,i3) + ryy23(i1,
     & i2,i3) + rzz23(i1,i2,i3))
                             a2=a2 -nuk*( sxx23(i1,i2,i3) + syy23(i1,
     & i2,i3) + szz23(i1,i2,i3) )
                             a3=a3 -nuk*( txx23(i1,i2,i3) + tyy23(i1,
     ...
     & materialFormat.eq.piecewiseConstantMaterialProperties )then
                              ! piecewise constant material properties
                              nuk=max( nu, thermalKpc(i1,i2,i3)/( 
     & rhopc(i1,i2,i3)*Cppc(i1,i2,i3) ) )
                              ! write(*,'(" (i1,i2)=",i3,",",i3,") Kpc = ",e10.2)') i1,i2,thermalKpc(i1,i2,i3)/( rhopc(i1,i2,i3)*Cppc(i1,i2,i3) )
                            else if( 
     & materialFormat.eq.variableMaterialProperties )then
                              ! variable material properties
     ...
     & *2 )
                          if( use2ndOrderAD.eq.1 )then
                                rePart=rePart + 8.*( ad21 + cd22*( abs(
     & ux42r(i1,i2,i3,uc))+abs(ux42r(i1,i2,i3,vc))+abs(uy42r(i1,i2,i3,
     & uc))+abs(uy42r(i1,i2,i3,vc)) ) )
                          end if
                          if(  use4thOrderAD.eq.1 )then
                              rePart=rePart + 32.*( ad41 + cd42*(abs(
     & ux42r(i1,i2,i3,uc))+abs(ux42r(i1,i2,i3,vc))+abs(uy42r(i1,i2,i3,
     ...
     & rc))  ! do this for now
                              ...
                              a1=a1 -nuk*( rxx42(i1,i2,i3) + ryy42(i1,
     & i2,i3) )
                              a2=a2 -nuk*( sxx42(i1,i2,i3) + syy42(i1,
     & i2,i3) )
                              rePart = nuk*( ( rx(i1,i2,i3)**2         
     &  + ry(i1,i2,i3)**2          )*(crr/(dr(0)*dr(0))) +abs( rx(i1,
     & i2,i3)*sx(i1,i2,i3)+ry(i1,i2,i3)*sy(i1,i2,i3) )*( cr/(dr(0)*dr(
     ...
     & crr/(dr(1)*dr(1))) )
                          ...
                          if( use2ndOrderAD.eq.1 )then
                                rePart=rePart + 8.*( ad21 + cd22*( abs(
     & ux42(i1,i2,i3,uc))+abs(ux42(i1,i2,i3,vc))+abs(uy42(i1,i2,i3,uc)
     & )+abs(uy42(i1,i2,i3,vc)) ) )
                          end if
                          if(  use4thOrderAD.eq.1 )then
                              rePart=rePart + 32.*( ad41 + cd42*(abs(
     & ux42(i1,i2,i3,uc))+abs(ux42(i1,i2,i3,vc))+abs(uy42(i1,i2,i3,uc)
     ...
     & abs(ux42r(i1,i2,i3,uc))+abs(ux42r(i1,i2,i3,vc))+abs(uy42r(i1,
     & i2,i3,uc))+abs(uy42r(i1,i2,i3,vc)) ) )
                           end if
                           if(  use4thOrderAD.eq.1 )then
                               rePart=rePart + 32.*( ad41 + cd42*(abs(
     & ux42r(i1,i2,i3,uc))+abs(ux42r(i1,i2,i3,vc))+abs(uy42r(i1,i2,i3,
     & uc))+abs(uy42r(i1,i2,i3,vc))) )
                         ...
                         ! write(*,'("BEFORE: i1,i2,i3,imPart,rePart=",3i3,f6.2,2(e11.3,1x))') i1,i2,i3,imPart,rePart
                         !  correct for divergence damping term
                            rePart = rePart + scaleFactor*divDamping(
     & i1,i2,i3)
                          !  write(*,'(" i1,i2,i3,cdv,divDamping,rePart=",3i3,f6.2,2(e11.3,1x))') i1,i2,i3,cdv,divDamping(i1,i2,i3),rePart
                         ! write(*,'("AFTER: i1,i2,i3,imPart,rePart=",3i3,f6.2,2(e11.3,1x))') i1,i2,i3,imPart,rePart
                          reLambda=max(reLambda,rePart)
     ...
     & i1,i2,i3)*Cpv(i1,i2,i3) ) )
                             ...
                             if( pdeModel.eq.twoPhaseFlowModel )then
                               nuk=max(adPsi,u(i1,i2,i3,vsc)/u(i1,i2,
     & i3,rc))  ! do this for now
                             end if
                               a1=a1 -nuk*( rxx42(i1,i2,i3) + ryy42(i1,
     & i2,i3) )
                               a2=a2 -nuk*( sxx42(i1,i2,i3) + syy42(i1,
     ...
     & 2          )*(crr/(dr(1)*dr(1))) )
                           ...
                           if( use2ndOrderAD.eq.1 )then
                                 rePart=rePart + 8.*( ad21 + cd22*( 
     & abs(ux42(i1,i2,i3,uc))+abs(ux42(i1,i2,i3,vc))+abs(uy42(i1,i2,
     & i3,uc))+abs(uy42(i1,i2,i3,vc)) ) )
                           end if
                           if(  use4thOrderAD.eq.1 )then
                               rePart=rePart + 32.*( ad41 + cd42*(abs(
     & ux42(i1,i2,i3,uc))+abs(ux42(i1,i2,i3,vc))+abs(uy42(i1,i2,i3,uc)
     ...
     & abs(ux43r(i1,i2,i3,uc))+abs(ux43r(i1,i2,i3,vc))+abs(ux43r(i1,
     & i2,i3,wc))+abs(uy43r(i1,i2,i3,uc))+abs(uy43r(i1,i2,i3,vc))+abs(
     & uy43r(i1,i2,i3,wc))+abs(uz43r(i1,i2,i3,uc))+abs(uz43r(i1,i2,i3,
     & vc))+abs(uz43r(i1,i2,i3,wc))) )
                          end if
                          if(  use4thOrderAD.eq.1 )then
                              rePart=rePart + 48.*( ad21 + cd22*( abs(
     & ux43r(i1,i2,i3,uc))+abs(ux43r(i1,i2,i3,vc))+abs(ux43r(i1,i2,i3,
     & wc))+abs(uy43r(i1,i2,i3,uc))+abs(uy43r(i1,i2,i3,vc))+abs(uy43r(
     & i1,i2,i3,wc))+abs(uz43r(i1,i2,i3,uc))+abs(uz43r(i1,i2,i3,vc))+
     & abs(uz43r(i1,i2,i3,wc))) )
                          end if
                        ! write(*,'("BEFORE: i1,i2,i3,imPart,rePart=",3i3,f6.2,2(e11.3,1x))') i1,i2,i3,imPart,rePart
                        !  correct for divergence damping term
                           rePart = rePart + scaleFactor*divDamping(i1,
     ...
     & rc))  ! do this for now
                              ...
                              a1=a1 -nuk*( rxx43(i1,i2,i3) + ryy43(i1,
     & i2,i3) + rzz43(i1,i2,i3))
                              a2=a2 -nuk*( sxx43(i1,i2,i3) + syy43(i1,
     & i2,i3) + szz43(i1,i2,i3) )
                              a3=a3 -nuk*( txx43(i1,i2,i3) + tyy43(i1,
     & i2,i3) + tzz43(i1,i2,i3) )
                              rePart = nuk*( ( rx(i1,i2,i3)**2         
     ...
     & abs(a3)/dr(2) )
                          if( use2ndOrderAD.eq.1 )then
                                rePart=rePart + 12.*( ad21 + cd22*( 
     & abs(ux43(i1,i2,i3,uc))+abs(ux43(i1,i2,i3,vc))+abs(ux43(i1,i2,
     & i3,wc))+abs(uy43(i1,i2,i3,uc))+abs(uy43(i1,i2,i3,vc))+abs(uy43(
     & i1,i2,i3,wc))+abs(uz43(i1,i2,i3,uc))+abs(uz43(i1,i2,i3,vc))+
     & abs(uz43(i1,i2,i3,wc))) )
                          end if
                          if(  use4thOrderAD.eq.1 )then
                              rePart=rePart + 48.*( ad21 + cd22*( abs(
     & ux43(i1,i2,i3,uc))+abs(ux43(i1,i2,i3,vc))+abs(ux43(i1,i2,i3,wc)
     & )+abs(uy43(i1,i2,i3,uc))+abs(uy43(i1,i2,i3,vc))+abs(uy43(i1,i2,
     & i3,wc))+abs(uz43(i1,i2,i3,uc))+abs(uz43(i1,i2,i3,vc))+abs(uz43(
     & i1,i2,i3,wc))) )
                          end if
                        ! write(*,'("BEFORE: i1,i2,i3,imPart,rePart=",3i3,f6.2,2(e11.3,1x))') i1,i2,i3,imPart,rePart
                        !  correct for divergence damping term
     ...
     & i1,i2,i3)
            ...
            ! Don't split by ADTYPE since this makes the file too long for no big benefit.
            ! if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,GLOBAL,IMPLICIT,NONE)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,GLOBAL,IMPLICIT,AD2)
            ! else if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,GLOBAL,IMPLICIT,AD4)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,GLOBAL,IMPLICIT,AD24)
            ! else
            !   stop 123
            ! end if
              if( orderOfAccuracy.eq.2 )then
     ...
     & abs(a3)/dr(2) )
          ...
          ! -- Use a local dt --
           if( gridIsImplicit.eq.0 )then
            ...
            ! Don't split by ADTYPE since this makes the file too long for no big benefit.
            ! if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,LOCAL,EXPLICIT,NONE)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,LOCAL,EXPLICIT,AD2)
            ! else if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,LOCAL,EXPLICIT,AD4)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,LOCAL,EXPLICIT,AD24)
            ! else
            !   stop 123
            ! end if
              if( orderOfAccuracy.eq.2 )then
     ...
     & rePart**2 )      ! explicit local time stepping
            ...
            ! Don't split by ADTYPE since this makes the file too long for no big benefit.
            ! if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,LOCAL,IMPLICIT,NONE)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,LOCAL,IMPLICIT,AD2)
            ! else if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,LOCAL,IMPLICIT,AD4)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INS,LOCAL,IMPLICIT,AD24)
            ! else
            !   stop 123
            ! end if
              if( orderOfAccuracy.eq.2 )then
