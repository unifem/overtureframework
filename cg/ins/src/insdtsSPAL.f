! This file automatically generated from insdts.bf with bpp.
        subroutine insdtsSPAL(nd, n1a,n1b,n2a,n2b,n3a,n3b, nd1a,nd1b,
...
c============================================================================================
         ...
         if( useLocalTimeStepping.eq.0 )then
          ! -- Use a single global dt --
           if( gridIsImplicit.eq.0 )then
            ...
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,GLOBAL,EXPLICIT,NONE)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,GLOBAL,EXPLICIT,AD2)
            ! else if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,GLOBAL,EXPLICIT,AD4)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,GLOBAL,EXPLICIT,AD24)
            ! else
            !   stop 123
            ! end if
     ...
     & uu(i1,i2,i3,vc))/dx(1) )
                            imPart= imPart+ cr*(1.+cb2)*sigmai*(abs(
     & nuTx)/dx(0)+abs(nuTy)/dx(1) )
                           ! "
     ...
     & *2 )
                        if( use2ndOrderAD.eq.1 )then
                              adINS = 8.*( ad21 + cd22*( abs(ux22r(i1,
     & i2,i3,uc))+abs(ux22r(i1,i2,i3,vc))+abs(uy22r(i1,i2,i3,uc))+abs(
     & uy22r(i1,i2,i3,vc)) ) )
                              adSPAL= 8.*( ad21n + cd22n*( abs(ux22r(
     & i1,i2,i3,nc))+abs(uy22r(i1,i2,i3,nc)) ) )
     ...
     & i3,vc)*sy(i1,i2,i3)
                            a1=a1 - (1.+cb2)*sigmai*(nuTx*rx(i1,i2,i3)+
     & nuTy*ry(i1,i2,i3))
                            a2=a2 - (1.+cb2)*sigmai*(nuTx*sx(i1,i2,i3)+
     & nuTy*sy(i1,i2,i3))
                           ! "
                             nuMax= max( nu+nuT, sigmai*(nu+n0) )
                            ! **** finish this ****
     ...
     & crr/(dr(1)*dr(1))) )
                        ...
                        if( use2ndOrderAD.eq.1 )then
                              adINS = 8.*( ad21 + cd22*( abs(ux22(i1,
     & i2,i3,uc))+abs(ux22(i1,i2,i3,vc))+abs(uy22(i1,i2,i3,uc))+abs(
     & uy22(i1,i2,i3,vc)) ) )
                              adSPAL= 8.*( ad21n + cd22n*( abs(ux22(i1,
     & i2,i3,nc))+abs(uy22(i1,i2,i3,nc)) ) )
                              rePart=rePart + max( adINS, adSPAL )
                        end if
                        if(  use4thOrderAD.eq.1 )then
                            rePart=rePart + 32.*( ad41 + cd42*(abs(
                      ...
                      ! ...............................................
                       ...
                       do i1=n1a,n1b
                        if( mask(i1,i2,i3).gt.0 )then
                            ...
                            dd = dw(i1,i2,i3)+cd0
                            dKappaSq=(dd*kappa)**2
                             s=n0*fnu2/dKappaSq +sqrt( (u0y-v0x)**2 + (
     & v0z-w0y)**2 + (w0x-u0z)**2 )
                            r= min( n0/( s*dKappaSq ), cr0 )
                            g=r+cw2*(r**6-r)
                            fw=g*( (1.+cw3e6)/(g**6+cw3e6) )**(1./6.)
     ...
     & abs(uu(i1,i2,i3,vc))/dx(1) + abs(uu(i1,i2,i3,wc))/dx(2) )
                            imPart= imPart+ cr*(1.+cb2)*sigmai*( abs(
     & nuTx)/dx(0)+abs(nuTy)/dx(1)+abs(nuTz)/dx(2) )
                           ! "
                             nuMax= max( nu+nuT, sigmai*(nu+n0) )
                            ! **** finish this ****
                            rePart= crr*nuMax*( 1./dx(0)**2 + 1./dx(1)*
     & *2 + 1./dx(2)**2 )
                        if( use2ndOrderAD.eq.1 )then
                              adINS = 12.*( ad21 + cd22*( abs(ux23r(i1,
     & i2,i3,uc))+abs(ux23r(i1,i2,i3,vc))+abs(ux23r(i1,i2,i3,wc))+abs(
     & uy23r(i1,i2,i3,uc))+abs(uy23r(i1,i2,i3,vc))+abs(uy23r(i1,i2,i3,
     & wc))+abs(uz23r(i1,i2,i3,uc))+abs(uz23r(i1,i2,i3,vc))+abs(uz23r(
     & i1,i2,i3,wc))) )
                              adSPAL = 12.*( ad21n + cd22n*( abs(ux23r(
     & i1,i2,i3,nc))+abs(uy23r(i1,i2,i3,nc))+abs(uz23r(i1,i2,i3,nc)) )
     &  )
                              rePart=rePart + max( adINS, adSPAL )
                        end if
                        if(  use4thOrderAD.eq.1 )then
     ...
     & i3,vc)*ty(i1,i2,i3)+uu(i1,i2,i3,wc)*tz(i1,i2,i3)
                            a1=a1 - (1.+cb2)*sigmai*(nuTx*rx(i1,i2,i3)+
     & nuTy*ry(i1,i2,i3)+nuTz*rz(i1,i2,i3))
                            a2=a2 - (1.+cb2)*sigmai*(nuTx*sx(i1,i2,i3)+
     & nuTy*sy(i1,i2,i3)+nuTz*sz(i1,i2,i3))
                            a3=a3 - (1.+cb2)*sigmai*(nuTx*tx(i1,i2,i3)+
     & nuTy*ty(i1,i2,i3)+nuTz*tz(i1,i2,i3))
                           ! "
                             nuMax= max( nu+nuT, sigmai*(nu+n0) )
                            ! **** finish this ****
     ...
     & abs(a3)/dr(2) )
                        if( use2ndOrderAD.eq.1 )then
                              adINS = 12.*( ad21 + cd22*( abs(ux23(i1,
     & i2,i3,uc))+abs(ux23(i1,i2,i3,vc))+abs(ux23(i1,i2,i3,wc))+abs(
     & uy23(i1,i2,i3,uc))+abs(uy23(i1,i2,i3,vc))+abs(uy23(i1,i2,i3,wc)
     & )+abs(uz23(i1,i2,i3,uc))+abs(uz23(i1,i2,i3,vc))+abs(uz23(i1,i2,
     & i3,wc))) )
                              adSPAL = 12.*( ad21n + cd22n*( abs(ux23(
     & i1,i2,i3,nc))+abs(uy23(i1,i2,i3,nc))+abs(uz23(i1,i2,i3,nc)) ) )
                              rePart=rePart + max( adINS, adSPAL )
                        end if
                        if(  use4thOrderAD.eq.1 )then
                            rePart=rePart + 48.*( ad21 + cd22*( abs(
     ...
     & i2,i3)
            ...
            ! Don't split by ADTYPE since this makes the file too long for no big benefit.
            ! if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,GLOBAL,IMPLICIT,NONE)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,GLOBAL,IMPLICIT,AD2)
            ! else if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,GLOBAL,IMPLICIT,AD4)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,GLOBAL,IMPLICIT,AD24)
            ! else
            !   stop 123
            ! end if
              if( orderOfAccuracy.eq.2 )then
     ...
     & nuTx)/dx(0)+abs(nuTy)/dx(1) )
                          ...
                          if( pdeModel.eq.BoussinesqModel )then
                           ...
                           ! #End
                            ...
                            rePart=rePart+ max(0., 2.*cb1*s - .5*cw1*
     & fw*n0/dd**2)
                      ! write(*,'("BEFORE: i1,i2,i3,imPart,rePart=",3i3,f6.2,2(e11.3,1x))') i1,i2,i3,imPart,rePart
                      !  correct for divergence damping term
     ...
     & abs(a3)/dr(2) )
          ...
          ! -- Use a local dt --
           if( gridIsImplicit.eq.0 )then
            ...
            ! Don't split by ADTYPE since this makes the file too long for no big benefit.
            ! if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,LOCAL,EXPLICIT,NONE)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,LOCAL,EXPLICIT,AD2)
            ! else if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,LOCAL,EXPLICIT,AD4)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,LOCAL,EXPLICIT,AD24)
            ! else
            !   stop 123
            ! end if
              if( orderOfAccuracy.eq.2 )then
     ...
     & 2 )      ! explicit local time stepping
            ...
            ! Don't split by ADTYPE since this makes the file too long for no big benefit.
            ! if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,LOCAL,IMPLICIT,NONE)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.0 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,LOCAL,IMPLICIT,AD2)
            ! else if( use2ndOrderAD.eq.0 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,LOCAL,IMPLICIT,AD4)
            ! else if( use2ndOrderAD.eq.1 .and. use4thOrderAD.eq.1 )then 
            !  getTimeSteppingEigenvaluesByOrder(INSSPAL,LOCAL,IMPLICIT,AD24)
            ! else
            !   stop 123
            ! end if
              if( orderOfAccuracy.eq.2 )then
