...
! =============================================================================================================
#beginMacro getDivTensorGradCoefficientsINSBL(ul,scale)
#If $DIM == 2 
...
!  #End
 ...
 getDivTensorGradCoefficientsINSBL(u,-dtImp)
...
! #defineMacro NAME(u)\
!      ( au ## 11ph*(u(i1+1,i2,i3,uc)-u(i1,i2,i3,uc)) - au ## 11mh*(u(i1,i2,i3,uc)-u(i1-1,i2,i3,uc)) )\
!    + ( au ## 22ph*(u(i1,i2+1,i3,uc)-u(i1,i2,i3,uc)) - au ## 22mh*(u(i1,i2,i3,uc)-u(i1,i2-1,i3,uc)) )\
!    + ( au ## 33ph*(u(i1,i2,i3+1,uc)-u(i1,i2,i3,uc)) - au ## 33mh*(u(i1,i2,i3,uc)-u(i1,i2,i3-1,uc)) )\
!    + (au ## 12pzz*(u(i1+1,i2+1,i3,uc)-u(i1+1,i2-1,i3,uc))-au ## 12mzz*(u(i1-1,i2+1,i3,uc)-u(i1-1,i2-1,i3,uc)))\
!    + (au ## 13pzz*(u(i1+1,i2,i3+1,uc)-u(i1+1,i2,i3-1,uc))-au ## 13mzz*(u(i1-1,i2,i3+1,uc)-u(i1-1,i2,i3-1,uc)))\
!    + (au ## 21zpz*(u(i1+1,i2+1,i3,uc)-u(i1-1,i2+1,i3,uc))-au ## 21zmz*(u(i1+1,i2-1,i3,uc)-u(i1-1,i2-1,i3,uc)))\
!    + (au ## 23zpz*(u(i1,i2+1,i3+1,uc)-u(i1,i2+1,i3-1,uc))-au ## 23zmz*(u(i1,i2-1,i3+1,uc)-u(i1,i2-1,i3-1,uc)))\
!    + (au ## 31zzp*(u(i1+1,i2,i3+1,uc)-u(i1-1,i2,i3+1,uc))-au ## 31zzm*(u(i1+1,i2,i3-1,uc)-u(i1-1,i2,i3-1,uc)))\
!    + (au ## 32zzp*(u(i1,i2+1,i3+1,uc)-u(i1,i2-1,i3+1,uc))-au ## 32zzm*(u(i1,i2+1,i3-1,uc)-u(i1,i2-1,i3-1,uc))) 
! #endMacro
...
!   getOp(zz, u,qc,qq,aj,q0zz)       ! q.zz
 ...
 getDivTensorGradCoefficientsINSBL(u,1.)
 ...
 if( evalRightHandSide.eq.1 )then
  ...
  if( gridIsImplicit.eq.0 )then
   ...
   ! fe(i1,i2,i3,qc) = -ugv*q0x -vgv*q0y + kThermal*(q0xx+q0yy)
    ...
    getDivTensorGradCoefficientsINSBL(ul,1.)
