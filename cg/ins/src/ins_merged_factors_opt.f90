! This file automatically generated from ins_merged_factors_opt.bf90 with bpp.
! -*- mode: fortran -*- !
...
!!! subroutine ins_mfactor_opt
      subroutine ins_mfactor_opt(nd,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,     &
...
side)
      ...
      width = 2*half_width
            ...
            if ( debug.ge.4 .and. processid.le.0 ) then
               print '(a20)',"INSIDE ins_mfactor_opt"
               print '("         nd : ",i3)',nd
...
index_range(1,2)
      ...
      call get_op_coeffs(half_width,1,min(order,4),finite_difference,     &
fdop_p,fdop_dx)
      call get_op_coeffs(half_width,2,min(order,4),finite_difference,     &
fdop_p,fdop_dxx)
      ...
      call get_bos_mop_coeffs(half_width,1,0,order,disc_approx,bop_p(-     &
half_width,0),bop_dx(-half_width,0))
      call get_bos_mop_coeffs(half_width,2,0,order,disc_approx,bop_p(-     &
half_width,0),bop_dxx(-half_width,0))

      call get_bos_mop_coeffs(half_width,1,1,order,disc_approx,bop_p(-     &
half_width,1),bop_dx(-half_width,1))
      call get_bos_mop_coeffs(half_width,2,1,order,disc_approx,bop_p(-     &
half_width,1),bop_dxx(-half_width,1))
...
!!         SET_STENCIL_IDX()
         use_os_rxr = .true.
               ...
               if ( .not. is_rect ) then
               do io=-0,0 ! loop over the stencil and fill the small arrays of metrics at adjacent grid points
                        i1o = i1l + (io-off)*is1
                        i2o = i2l + (io-off)*is2
                        i3o = i3l + (io-off)*is3
...
!!         enddo
         ...
         ab_ik(idir,1) = ab_ik(idir,1) + u(i1l,i2l,i3l,uc)*rx(0,dir,0)*     &
advection_coefficient - nu_eq*rxx(0,dir,0) + nu_eq*4d0*rxr(0,     &
dir,0)*rx(0,dir,0)
         ab_ik(idir,2) = ab_ik(idir,2) + rx(0,dir,1)*rx(0,dir,1)
         ab_ik(idir,1) = ab_ik(idir,1) + u(i1l,i2l,i3l,vc)*rx(0,dir,1)*     &
advection_coefficient - nu_eq*rxx(0,dir,1) + nu_eq*4d0*rxr(0,     &
dir,1)*rx(0,dir,1)
         if ( nd.eq.3 ) then
            ab_ik(idir,2) = ab_ik(idir,2) + rx(0,dir,2)*rx(0,dir,2)
            ab_ik(idir,1) = ab_ik(idir,1) + u(i1l,i2l,i3l,wc)*rx(0,dir,     &
2)*advection_coefficient - nu_eq*rxx(0,dir,2) + nu_eq*4d0*rxr(     &
0,dir,2)*rx(0,dir,2)
         endif
         ab_ik(idir,2) = -ab_ik(idir,2)*nu_eq

         if (is_moving) then
            ab_ik(idir,1) = ab_ik(idir,1) - gv(i1l,i2l,i3l,0)*rx(0,dir,     &
0)
            ab_ik(idir,1) = ab_ik(idir,1) - gv(i1l,i2l,i3l,1)*rx(0,dir,     &
1)
            if ( nd.eq.3 ) then
               ab_ik(idir,1) = ab_ik(idir,1) - gv(i1l,i2l,i3l,2)*rx(0,     &
dir,2)
            endif
         endif
         ...
         rownorm(1) = 0d0
         rownorm(2) = 0d0
         if ( (use_ad4 .or. use_ad2) .and. idir.ge.(gir(0,dir)) .and.      &
idir.le.(gir(1,dir)) ) then
            if ( .not. (cc.eq.tc .and. pde_model.eq.BoussinesqModel ))      &
then
               if ( .not. is_rect ) then
                  fd1 = 0d0
!                  do ic=uc,uc+nd-1
                  do ic=0,nd-1
                     do id=0,nd-1
                        if ( .false. ) then
                           fd1 = fd1+rsxy(i1l,i2l,i3l,0,id)*dri(0)*(u(     &
i1l+1,i2l,i3l,ic)-u(i1l-1,i2l,i3l,ic))
                           fd1 = fd1+rsxy(i1l,i2l,i3l,1,id)*dri(1)*(u(     &
i1l,i2l+1,i3l,ic)-u(i1l,i2l-1,i3l,ic))
                           if ( nd.eq.3 ) fd1 = fd1+ rsxy(i1l,i2l,i3l,     &
2,id)*dri(2)*(u(i1l,i2l,i3l+1,ic)-u(i1l,i2l,i3l-1,ic))
                           ...
                           fd1=0d0
                           fd1 = fd1+rsxy(i1l,i2l,i3l,0,id)*dri(0)*(u(     &
i1l+1,i2l,i3l,uc+ic)-u(i1l-1,i2l,i3l,uc+ic))
                           fd1 = fd1+rsxy(i1l,i2l,i3l,1,id)*dri(1)*(u(     &
i1l,i2l+1,i3l,uc+ic)-u(i1l,i2l-1,i3l,uc+ic))
                           if ( nd.eq.3 ) fd1 = fd1+ rsxy(i1l,i2l,i3l,     &
2,id)*dri(2)*(u(i1l,i2l,i3l+1,uc+ic)-u(i1l,i2l,i3l-1,uc+ic))
                           fd1 = fd1+rsxy(i1l,i2l,i3l,0,ic)*dri(0)*(u(     &
i1l+1,i2l,i3l,uc+id)-u(i1l-1,i2l,i3l,uc+id))
                           fd1 = fd1+rsxy(i1l,i2l,i3l,1,ic)*dri(1)*(u(     &
i1l,i2l+1,i3l,uc+id)-u(i1l,i2l-1,i3l,uc+id))
                           if ( nd.eq.3 ) fd1 = fd1+ rsxy(i1l,i2l,i3l,     &
2,ic)*dri(2)*(u(i1l,i2l,i3l+1,uc+id)-u(i1l,i2l,i3l-1,uc+id))
...
!                  do ic=uc,uc+nd-1
                     if ( .false. ) then
                        do ic=0,nd-1
                           fd1 = dabs(u(i1l+1,i2l,i3l,uc+ic)-u(i1l-1,     &
i2l,i3l,uc+ic))*dxi(0) + dabs(u(i1l,i2l+1,i3l,uc+ic)-u(i1l,i2l-     &
1,i3l,uc+ic))*dxi(1)
                           if ( nd.eq.3 ) then
                              fd1 = fd1+dabs(u(i1l,i2l,i3l+1,uc+ic)-u(     &
i1l,i2l,i3l-1,uc+ic))*dxi(2)
                           endif
                           uxnorm = uxnorm + dabs(fd1)
                           fd1 = 0d0
                        enddo
                        ...
                        fd1=0d0
                        rownorm(0) = dabs(u(i1l+1,i2l,i3l,uc)-u(i1l-1,     &
i2l,i3l,uc))*dxi(0) + 0.5d0*dabs((u(i1l+1,i2l,i3l,vc)-u(i1l-1,     &
i2l,i3l,vc))*dxi(0) + (u(i1l,i2l+1,i3l,uc)-u(i1l,i2l-1,i3l,uc))     &
*dxi(1))
                        rownorm(1) = 0.5d0*dabs((u(i1l+1,i2l,i3l,vc)-u(     &
i1l-1,i2l,i3l,vc))*dxi(0) + (u(i1l,i2l+1,i3l,uc)-u(i1l,i2l-1,     &
i3l,uc))*dxi(1))  + dabs(u(i1l,i2l+1,i3l,vc)-u(i1l,i2l-1,i3l,     &
vc))*dxi(1)

                        if ( nd.eq.3 ) then
                           rownorm(0) = rownorm(0) + 0.5d0*dabs((u(i1l+     &
1,i2l,i3l,wc)-u(i1l-1,i2l,i3l,wc))*dxi(0)+(u(i1l,i2l,i3l+1,uc)-     &
u(i1l,i2l,i3l-1,uc))*dxi(2))
                           rownorm(1) = rownorm(1) + 0.5d0*dabs((u(i1l,     &
i2l,i3l+1,vc)-u(i1l,i2l,i3l-1,vc))*dxi(2)+(u(i1l,i2l+1,i3l,wc)-     &
u(i1l,i2l-1,i3l,wc))*dxi(1))
                           rownorm(2) = dabs(u(i1l,i2l,i3l+1,wc)-u(i1l,     &
i2l,i3l-1,wc))*dxi(2)+0.5d0*dabs((u(i1l,i2l,i3l+1,vc)-u(i1l,     &
i2l,i3l-1,vc))*dxi(2)+(u(i1l,i2l+1,i3l,wc)-u(i1l,i2l-1,i3l,wc))     &
*dxi(1)) + 0.5d0*dabs((u(i1l+1,i2l,i3l,wc)-u(i1l-1,i2l,i3l,wc))     &
*dxi(0)+(u(i1l,i2l,i3l+1,uc)-u(i1l,i2l,i3l-1,uc))*dxi(2))
                        endif
                     endif
...
!!      do ic=1,3
      ic = 3
      ab_ik(dims(0,dir),ic) = dabs(2d0*ab_ik(dims(0,dir)+1,ic) - ab_ik(     &
dims(0,dir)+2,ic))
      ab_ik(dims(1,dir),ic) = dabs(2d0*ab_ik(dims(1,dir)-1,ic) - ab_ik(     &
dims(1,dir)-2,ic))
!!      enddo
...
!!      do idir=index_range(0,dir),index_range(1,dir)
      ...
      if ( mask(i1,i2,i3).gt.0 ) then
         ...
         near_interp = mask(i1m,i2m,i3m).lt.0 .or. mask(i1p,i2p,i3p)     &
.lt.0
         if ( (.not.near_interp) .and. (order.gt.2 )) then
            near_interp = near_interp .or. mask(i1mm,i2mm,i3mm).lt.0      &
.or. mask(i1pp,i2pp,i3pp).lt.0
         endif
!!         if ( order.eq.2 ) then
...
!!         endif
         ...
         if ( use_self_adjoint_ad ) then
            ...
            uxnorm = ab_ik(idir-1,3) + 4d0*ab_ik(idir,3)+ ab_ik(idir+1,     &
3)
            ...
            ad_coeff(-2) = (ad41 + uxnorm*ad42)
            ad_coeff(-1) =-(ad41 + uxnorm*ad42)*4d0 - (ad21 + uxnorm*     &
ad22)
            ad_coeff( 0) = (ad41 + uxnorm*ad42)*6d0 + (ad21 + uxnorm*     &
ad22)*2d0
            ad_coeff( 1) =-(ad41 + uxnorm*ad42)*4d0 - (ad21 + uxnorm*     &
ad22)
            ad_coeff( 2) = (ad41 + uxnorm*ad42)
...
!!            call get_bos_mop_coeffs(half_width,2,0,order,disc_approx,pxx_coeff,dxx_coeff)
               ...
               if ( .false. ) then
                  ...
                  if  ( .false. ) then
                     uxnorm = ab_ik(idir,3)
                     ad_coeff( -2) = 0d0
                     ad_coeff(-1) =-((ad41+uxnorm*ad42) + (ad21 +      &
uxnorm*ad22))
                     ad_coeff( 0) = (ad41+uxnorm*ad42)*2d0 + (ad21 +      &
uxnorm*ad22)*2d0
                     ad_coeff( 1) =-((ad41+uxnorm*ad42) + (ad21 +      &
uxnorm*ad22))
                     ad_coeff( 2)  = 0d0
                  elseif ( .true. ) then
                     uxnorm = ab_ik(idir,3)
                     ad_coeff(-2) = (ad41 + uxnorm*ad42)
                     ad_coeff(-1) =-(ad41 + uxnorm*ad42)*4d0 - (ad21 +      &
uxnorm*ad22)
                     ad_coeff( 0) = (ad41 + uxnorm*ad42)*6d0 + (ad21 +      &
uxnorm*ad22)*2d0
                     ad_coeff( 1) =-(ad41 + uxnorm*ad42)*4d0 - (ad21 +      &
uxnorm*ad22)
                     ad_coeff( 2) = (ad41 + uxnorm*ad42)
...
uxnorm*ad22)
               ...
               elseif ( .false. ) then
                  ...
                  uxnorm = 2d0*(ab_ik(idir+1,3) + ab_ik(idir,3))
                  ad_coeff(-1) =-(ad41*4d0 + uxnorm*ad42)
                  uxnorm = ab_ik(idir,3) + 4d0*ab_ik(idir+1,3)+ ab_ik(     &
idir+2,3)
                  ad_coeff( 0) = (ad41*6d0 + uxnorm*ad42)
               ...
               if ( .false. ) then
                  do io=-half_width,half_width
                     ...
                     if ( order.eq.4 ) ad_coeff(io) = ad_coeff(io)*(     &
24d0/15d0)
                  enddo
                  off = -1
               else
...
!!                  uxnorm = 0d0
                  ad_coeff( -2) = 0d0
                  ad_coeff(-1) =-((ad41+uxnorm*ad42) + (ad21 + uxnorm*     &
ad22))
                  ad_coeff( 0) = (ad41+uxnorm*ad42)*2d0 + (ad21 +      &
uxnorm*ad22)*2d0
                  ad_coeff( 1) =-((ad41+uxnorm*ad42) + (ad21 + uxnorm*     &
...
uxnorm*ad22)
                  ...
                  uxnorm = 2d0*(ab_ik(idir-2,3) + ab_ik(idir-1,3))
                  ad_coeff(-1) =-(ad41*4d0 + uxnorm*ad42)
                  uxnorm = ab_ik(idir-2,3) + 4d0*ab_ik(idir-1,3)+      &
ab_ik(idir,3)
                  ad_coeff( 0) = (ad41*6d0 + uxnorm*ad42)
...
!!               rhs(i1,i2,i3) = rhs(i1,i2,i3) + (pxc(io) - dto2*drid*dxc(io)*A_IK(io) - dto2*drid*drid*dxxc(io)*B_IK(io))*ul(i1o,i2o,i3o,cc)
               rhs(i1,i2,i3) = rhs(i1,i2,i3) + (pxc(io) - dto2*drid*     &
dxc(io)*ab_ik(idir+(io-off),1) - dto2*drid*drid*dxxc(io)*ab_ik(     &
idir+(io-off),2) - dto2*ad_coeff(io))*ull(idir+isdir*(io-off))
...
!!               rhs(i1,i2,i3) = rhs(i1,i2,i3) + pxc(io)*ul(i1o,i2o,i3o,cc)
               rhs(i1,i2,i3) = rhs(i1,i2,i3) + pxc(io)*ull(idir+isdir*(     &
io-off))
!!!               rhs(i1,i2,i3) = rhs(i1,i2,i3) + pxc(io)*ull(idir+(io-off))
            ...
            if ( .not. rhs_only ) then
               io = 0 +off
               d(i1,i2,i3)      = d(i1,i2,i3)   + dto2*drid*dxc(io)*     &
ab_ik(idir,1) + dto2*drid*drid*dxxc(io)*ab_ik(idir,2) + dto2*     &
ad_coeff(io)
               io = -1 +off
               dl1(i1,i2,i3)    = dl1(i1,i2,i3) + dto2*drid*dxc(io)*     &
ab_ik(idir-1,1) + dto2*drid*drid*dxxc(io)*ab_ik(idir-1,2) +      &
dto2*ad_coeff(io)
               io = 1 +off
               du1(i1,i2,i3)    = du1(i1,i2,i3) + dto2*drid*dxc(io)*     &
ab_ik(idir+1,1) + dto2*drid*drid*dxxc(io)*ab_ik(idir+1,2) +      &
dto2*ad_coeff(io)
               if ( is_penta ) then
                  io = -2  +off
                  if (off.ne.-1) then
                     dl2(i1,i2,i3) = dl2(i1,i2,i3) + dto2*drid*dxc(io)*     &
ab_ik(idir+(io-off),1) + dto2*drid*drid*dxxc(io)*ab_ik(idir+(     &
io-off),2) + dto2*ad_coeff(io)
                  else
                     io = 2
                     dl2(i1,i2,i3) = dl2(i1,i2,i3) + dto2*drid*dxc(io)*     &
ab_ik(idir+(io-off),1) + dto2*drid*drid*dxxc(io)*ab_ik(idir+(     &
io-off),2) + dto2*ad_coeff(io)
                  ...
                  io =  2 +off
                  if (off.ne.1) then
                     du2(i1,i2,i3) = du2(i1,i2,i3) + dto2*drid*dxc(io)*     &
ab_ik(idir+(io-off),1) + dto2*drid*drid*dxxc(io)*ab_ik(idir+(     &
io-off),2) + dto2*ad_coeff(io)
                  else
                     io = -2
...
io-off),2) + dto2*ad_coeff(io)
            ...
            do io=-half_width,half_width !!!x this loop may need to be changed if the grid does not have ghost points with sufficient width
                     ...
                     i2o = i2l + (io-off)*is2
                     i3o = i3l + (io-off)*is3
               rhs(i1,i2,i3) = rhs(i1,i2,i3) +dxc(io)*u(i1o,i2o,i3o,pc)     &
*drid
...
compact,px_coeff,dx_coeff)
                  ...
                  do io=0,2*half_width
                     ...
                     rhs(i1,i2,i3) = rhs(i1,i2,i3) + u(i1o,i2o,i3o,pc)*     &
dx_coeff(-half_width + side*2*half_width + (1-2*side)*io)*drid
                  enddo
                  enddo
                  enddo
                  enddo
