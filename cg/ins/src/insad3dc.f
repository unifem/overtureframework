! This file automatically generated from insad.bf with bpp.
             subroutine insad3dc(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c============================================================================================
     ...
     & 1,i3,c)  +u(i1,i2,i3+1,c)+u(i1,i2,i3-1,c)) -18.*u(i1,i2,i3,c) )
       !     --- end statement functions
             ...
             if( orderOfAccuracy.ne.2 .and. orderOfAccuracy.ne.4 )then
               write(*,'("insad3dc:ERROR orderOfAccuracy=",i6)') 
     & orderOfAccuracy
               stop 1
             end if
             if( gridType.ne.rectangular .and. gridType.ne.curvilinear 
     & )then
               write(*,'("insad3dc:ERROR gridType=",i6)') gridType
               stop 2
             end if
             if( uc.lt.0 .or. vc.lt.0 .or. (nd.eq.3 .and. wc.lt.0) )
     & then
               write(*,'("insad3dc:ERROR uc,vc,ws=",3i6)') uc,vc,wc
               stop 4
             end if
                       ...
                       if( useWhereMask.ne.0 )then
                         ...
                         do i1=n1a,n1b
                           if( mask(i1,i2,i3).gt.0 )then
                                  adCoeff2 = ad21+cd22*( abs(ux23(i1,
     & i2,i3,uc))+abs(uy23(i1,i2,i3,uc))+abs(uz23(i1,i2,i3,uc))+abs(
     & ux23(i1,i2,i3,vc))+abs(uy23(i1,i2,i3,vc))+abs(uz23(i1,i2,i3,vc)
     ...
     & delta23(vc)
                             ut(i1,i2,i3,wc)=ut(i1,i2,i3,wc)+adCoeff2*
     & delta23(wc)
                           end if
                         end do
                         end do
     ...
     & cd22n*(abs(ux23(i1,i2,i3,nc))+abs(uy23(i1,i2,i3,nc))+abs(uz23(
     & i1,i2,i3,nc))))*delta23(nc)
     ...
     & cd22n*(abs(ux23(i1,i2,i3,kc))+abs(uy23(i1,i2,i3,kc))+abs(uz23(
     & i1,i2,i3,kc))))*delta23(kc)
                             ut(i1,i2,i3,ec)=ut(i1,i2,i3,ec)+(ad21n+
     & cd22n*(abs(ux23(i1,i2,i3,ec))+abs(uy23(i1,i2,i3,ec))+abs(uz23(
     & i1,i2,i3,ec))))*delta23(ec)
                           end if
                         end do
                         end do
                         end do
     ...
     & turbulenceModel.eq.largeEddySimulation )then
                       ...
                       if( useWhereMask.ne.0 )then
                         ...
                         do i1=n1a,n1b
                           if( mask(i1,i2,i3).gt.0 )then
                              ! Artficial Dissipation  **todo** implicit-line, self-adjoint versions
                                  adCoeff4 = ad41+cd42*( abs(ux23(i1,
     & i2,i3,uc))+abs(uy23(i1,i2,i3,uc))+abs(uz23(i1,i2,i3,uc))+abs(
     & ux23(i1,i2,i3,vc))+abs(uy23(i1,i2,i3,vc))+abs(uz23(i1,i2,i3,vc)
     & )+abs(ux23(i1,i2,i3,wc))+abs(uy23(i1,i2,i3,wc))+abs(uz23(i1,i2,
     & i3,wc)))
     ...
     & delta43(vc)
                             ut(i1,i2,i3,wc)=ut(i1,i2,i3,wc)+adCoeff4*
     & delta43(wc)
                           end if
                         end do
                         end do
     ...
     & cd42n*(abs(ux23(i1,i2,i3,nc))+abs(uy23(i1,i2,i3,nc))+abs(uz23(
     & i1,i2,i3,nc))))*delta43(nc)
     ...
     & cd42n*(abs(ux23(i1,i2,i3,nc))+abs(uy23(i1,i2,i3,nc))+abs(uz23(
     & i1,i2,i3,nc))))*delta43(kc)
                             ut(i1,i2,i3,ec)=ut(i1,i2,i3,ec)+(ad41n+
     & cd42n*(abs(ux23(i1,i2,i3,nc))+abs(uy23(i1,i2,i3,nc))+abs(uz23(
     & i1,i2,i3,nc))))*delta43(ec)
                           end if
                         end do
                         end do
                         end do
     ...
     & i3,wc)))
                             ut(i1,i2,i3,uc)=ut(i1,i2,i3,uc)+adCoeff2*
     & delta23(uc)+adCoeff4*delta43(uc)
                             ut(i1,i2,i3,vc)=ut(i1,i2,i3,vc)+adCoeff2*
     & delta23(vc)+adCoeff4*delta43(vc)
                             ut(i1,i2,i3,wc)=ut(i1,i2,i3,wc)+adCoeff2*
     & delta23(wc)+adCoeff4*delta43(wc)
                           end if
                         end do
                         end do
                         end do
     ...
     & delta23(wc)+adCoeff4*delta43(wc)
                             ut(i1,i2,i3,nc)=ut(i1,i2,i3,nc)+(ad21n+
     & cd22n*(abs(ux23(i1,i2,i3,nc))+abs(uy23(i1,i2,i3,nc))+abs(uz23(
     & i1,i2,i3,nc))))*delta23(nc)+(ad41n+cd42n*(abs(ux23(i1,i2,i3,nc)
     & )+abs(uy23(i1,i2,i3,nc))+abs(uz23(i1,i2,i3,nc))))*delta43(nc)
     ...
     & delta23(wc)+adCoeff4*delta43(wc)
                             ut(i1,i2,i3,kc)=ut(i1,i2,i3,kc)+(ad21n+
     & cd22n*(abs(ux23(i1,i2,i3,kc))+abs(uy23(i1,i2,i3,kc))+abs(uz23(
     & i1,i2,i3,kc))))*delta23(kc)+(ad41n+cd42n*(abs(ux23(i1,i2,i3,nc)
     & )+abs(uy23(i1,i2,i3,nc))+abs(uz23(i1,i2,i3,nc))))*delta43(kc)
                             ut(i1,i2,i3,ec)=ut(i1,i2,i3,ec)+(ad21n+
     & cd22n*(abs(ux23(i1,i2,i3,ec))+abs(uy23(i1,i2,i3,ec))+abs(uz23(
     & i1,i2,i3,ec))))*delta23(ec)+(ad41n+cd42n*(abs(ux23(i1,i2,i3,nc)
     & )+abs(uy23(i1,i2,i3,nc))+abs(uz23(i1,i2,i3,nc))))*delta43(ec)
                           end if
                         end do
                         end do
                         end do
