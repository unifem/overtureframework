...
c     *********************************      
     ...
     & i3,wc)-uz43r(i1,i2,i3,pc)+nu*ulaplacian43r(i1,i2,i3,wc)
            ...
            do i1=n1a,n1b
              ! INS, no AD
               ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*ux43r(i1,i2,i3,uc)-uu(
     & i1,i2,i3,vc)*uy43r(i1,i2,i3,uc)-uu(i1,i2,i3,wc)*uz43r(i1,i2,i3,
     & uc)-ux43r(i1,i2,i3,pc)+nu*ulaplacian43r(i1,i2,i3,uc)
               ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*ux43r(i1,i2,i3,vc)-uu(
     & i1,i2,i3,vc)*uy43r(i1,i2,i3,vc)-uu(i1,i2,i3,wc)*uz43r(i1,i2,i3,
     & vc)-uy43r(i1,i2,i3,pc)+nu*ulaplacian43r(i1,i2,i3,vc)
               ut(i1,i2,i3,wc)= -uu(i1,i2,i3,uc)*ux43r(i1,i2,i3,wc)-uu(
     & i1,i2,i3,vc)*uy43r(i1,i2,i3,wc)-uu(i1,i2,i3,wc)*uz43r(i1,i2,i3,
          ...
          if( gridIsImplicit.eq.0 )then
           ...
           if( useWhereMask.ne.0 )then
            ...
            do i1=n1a,n1b
             if( mask(i1,i2,i3).gt.0 )then
               ! INS, no AD
                ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*ux43(i1,i2,i3,uc)-uu(
     & i1,i2,i3,vc)*uy43(i1,i2,i3,uc)-uu(i1,i2,i3,wc)*uz43(i1,i2,i3,
     & uc)-ux43(i1,i2,i3,pc)+nu*ulaplacian43(i1,i2,i3,uc)
                ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*ux43(i1,i2,i3,vc)-uu(
     & i1,i2,i3,vc)*uy43(i1,i2,i3,vc)-uu(i1,i2,i3,wc)*uz43(i1,i2,i3,
     & vc)-uy43(i1,i2,i3,pc)+nu*ulaplacian43(i1,i2,i3,vc)
                ut(i1,i2,i3,wc)= -uu(i1,i2,i3,uc)*ux43(i1,i2,i3,wc)-uu(
     & i1,i2,i3,vc)*uy43(i1,i2,i3,wc)-uu(i1,i2,i3,wc)*uz43(i1,i2,i3,
