                ...
                if( mask(i1,i2,i3).gt.0 )then
                  ! INS, no AD
                    ! --- upwind approximations ---
                      ...
                      !  end if
                        agu(uc,uc)=uu(i1,i2,i3,uc)*ux43(i1,i2,i3,uc)
                        agu(vc,uc)=uu(i1,i2,i3,vc)*uy43(i1,i2,i3,uc)
                        agu(uc,vc)=uu(i1,i2,i3,uc)*ux43(i1,i2,i3,vc)
                        agu(vc,vc)=uu(i1,i2,i3,vc)*uy43(i1,i2,i3,vc)
                     ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*ux43(i1,i2,i3,
     & uc)-uu(i1,i2,i3,vc)*uy43(i1,i2,i3,uc)-uu(i1,i2,i3,wc)*uz43(i1,
     & i2,i3,uc)-ux43(i1,i2,i3,pc)+nu*ulaplacian43(i1,i2,i3,uc)
                     ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*ux43(i1,i2,i3,
     & vc)-uu(i1,i2,i3,vc)*uy43(i1,i2,i3,vc)-uu(i1,i2,i3,wc)*uz43(i1,
     & i2,i3,vc)-uy43(i1,i2,i3,pc)+nu*ulaplacian43(i1,i2,i3,vc)
                     ut(i1,i2,i3,wc)= -uu(i1,i2,i3,uc)*ux43(i1,i2,i3,
     & wc)-uu(i1,i2,i3,vc)*uy43(i1,i2,i3,wc)-uu(i1,i2,i3,wc)*uz43(i1,
     & i2,i3,wc)-uz43(i1,i2,i3,pc)+nu*ulaplacian43(i1,i2,i3,wc)
                end if
               end do
               end do
               end do
