...
c     *********************************      
     ...
     & i3,wc)-uz23r(i1,i2,i3,pc)+nu*ulaplacian23r(i1,i2,i3,wc)
            ...
            do i1=n1a,n1b
              ! INS, no AD
               ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*ux23r(i1,i2,i3,uc)-uu(
     & i1,i2,i3,vc)*uy23r(i1,i2,i3,uc)-uu(i1,i2,i3,wc)*uz23r(i1,i2,i3,
     & uc)-ux23r(i1,i2,i3,pc)+nu*ulaplacian23r(i1,i2,i3,uc)
               ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*ux23r(i1,i2,i3,vc)-uu(
     & i1,i2,i3,vc)*uy23r(i1,i2,i3,vc)-uu(i1,i2,i3,wc)*uz23r(i1,i2,i3,
     & vc)-uy23r(i1,i2,i3,pc)+nu*ulaplacian23r(i1,i2,i3,vc)
               ut(i1,i2,i3,wc)= -uu(i1,i2,i3,uc)*ux23r(i1,i2,i3,wc)-uu(
     & i1,i2,i3,vc)*uy23r(i1,i2,i3,wc)-uu(i1,i2,i3,wc)*uz23r(i1,i2,i3,
     & wc)-uz23r(i1,i2,i3,pc)+nu*ulaplacian23r(i1,i2,i3,wc)
            end do
            end do
            end do
           end if
          ...
          if( gridIsImplicit.eq.0 )then
           ...
           if( useWhereMask.ne.0 )then
            ...
            do i1=n1a,n1b
             if( mask(i1,i2,i3).gt.0 )then
               ! INS, no AD
                ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*ux23(i1,i2,i3,uc)-uu(
     & i1,i2,i3,vc)*uy23(i1,i2,i3,uc)-uu(i1,i2,i3,wc)*uz23(i1,i2,i3,
     & uc)-ux23(i1,i2,i3,pc)+nu*ulaplacian23(i1,i2,i3,uc)
                ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*ux23(i1,i2,i3,vc)-uu(
     & i1,i2,i3,vc)*uy23(i1,i2,i3,vc)-uu(i1,i2,i3,wc)*uz23(i1,i2,i3,
     & vc)-uy23(i1,i2,i3,pc)+nu*ulaplacian23(i1,i2,i3,vc)
                ut(i1,i2,i3,wc)= -uu(i1,i2,i3,uc)*ux23(i1,i2,i3,wc)-uu(
     & i1,i2,i3,vc)*uy23(i1,i2,i3,wc)-uu(i1,i2,i3,wc)*uz23(i1,i2,i3,
     & wc)-uz23(i1,i2,i3,pc)+nu*ulaplacian23(i1,i2,i3,wc)
             end if
            end do
            end do
            end do
