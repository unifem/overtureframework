! This file automatically generated from insad.bf with bpp.
             subroutine insad2dr(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c============================================================================================
     ...
     & 1,i3,c)  +u(i1,i2,i3+1,c)+u(i1,i2,i3-1,c)) -18.*u(i1,i2,i3,c) )
       !     --- end statement functions
             ...
             if( orderOfAccuracy.ne.2 .and. orderOfAccuracy.ne.4 )then
               write(*,'("insad2dr:ERROR orderOfAccuracy=",i6)') 
     & orderOfAccuracy
               stop 1
             end if
             if( gridType.ne.rectangular .and. gridType.ne.curvilinear 
     & )then
               write(*,'("insad2dr:ERROR gridType=",i6)') gridType
               stop 2
             end if
             if( uc.lt.0 .or. vc.lt.0 .or. (nd.eq.3 .and. wc.lt.0) )
     & then
               write(*,'("insad2dr:ERROR uc,vc,ws=",3i6)') uc,vc,wc
               stop 4
             end if
                       ...
                       if( useWhereMask.ne.0 )then
                         ...
                         do i1=n1a,n1b
                           if( mask(i1,i2,i3).gt.0 )then
                                  adCoeff2 = ad21+cd22*( abs(ux22r(i1,
     & i2,i3,uc))+abs(uy22r(i1,i2,i3,uc))+abs(ux22r(i1,i2,i3,vc))+abs(
     & uy22r(i1,i2,i3,vc)) )
     ...
     & cd22n*(abs(ux22r(i1,i2,i3,nc))+abs(uy22r(i1,i2,i3,nc))))*
     & delta22(nc)
                           end if
                         end do
                         end do
     ...
     & cd22n*(abs(ux22r(i1,i2,i3,kc))+abs(uy22r(i1,i2,i3,kc))))*
     & delta22(kc)
                             ut(i1,i2,i3,ec)=ut(i1,i2,i3,ec)+(ad21n+
     & cd22n*(abs(ux22r(i1,i2,i3,ec))+abs(uy22r(i1,i2,i3,ec))))*
     & delta22(ec)
     ...
     & turbulenceModel.eq.largeEddySimulation )then
                       ...
                       if( useWhereMask.ne.0 )then
                         ...
                         do i1=n1a,n1b
                           if( mask(i1,i2,i3).gt.0 )then
                              ! Artficial Dissipation  **todo** implicit-line, self-adjoint versions
                                  adCoeff4 = ad41+cd42*( abs(ux22r(i1,
     & i2,i3,uc))+abs(uy22r(i1,i2,i3,uc))+abs(ux22r(i1,i2,i3,vc))+abs(
     & uy22r(i1,i2,i3,vc)) )
     ...
     & cd42n*(abs(ux22r(i1,i2,i3,nc))+abs(uy22r(i1,i2,i3,nc))))*
     & delta42(nc)
                           end if
                         end do
                         end do
     ...
     & cd42n*(abs(ux22r(i1,i2,i3,kc))+abs(uy22r(i1,i2,i3,kc))))*
     & delta42(kc)
                             ut(i1,i2,i3,ec)=ut(i1,i2,i3,ec)+(ad41n+
     & cd42n*(abs(ux22r(i1,i2,i3,ec))+abs(uy22r(i1,i2,i3,ec))))*
     & delta42(ec)
     ...
     & delta22(vc)+adCoeff4*delta42(vc)
                             ut(i1,i2,i3,nc)=ut(i1,i2,i3,nc)+(ad21n+
     & cd22n*(abs(ux22r(i1,i2,i3,nc))+abs(uy22r(i1,i2,i3,nc))))*
     & delta22(nc)+(ad41n+cd42n*(abs(ux22r(i1,i2,i3,nc))+abs(uy22r(i1,
     & i2,i3,nc))))*delta42(nc)
                           end if
                         end do
                         end do
     ...
     & delta22(vc)+adCoeff4*delta42(vc)
                             ut(i1,i2,i3,kc)=ut(i1,i2,i3,kc)+(ad21n+
     & cd22n*(abs(ux22r(i1,i2,i3,kc))+abs(uy22r(i1,i2,i3,kc))))*
     & delta22(kc)+(ad41n+cd42n*(abs(ux22r(i1,i2,i3,kc))+abs(uy22r(i1,
     & i2,i3,kc))))*delta42(kc)
                             ut(i1,i2,i3,ec)=ut(i1,i2,i3,ec)+(ad21n+
     & cd22n*(abs(ux22r(i1,i2,i3,ec))+abs(uy22r(i1,i2,i3,ec))))*
     & delta22(ec)+(ad41n+cd42n*(abs(ux22r(i1,i2,i3,ec))+abs(uy22r(i1,
     & i2,i3,ec))))*delta42(ec)
