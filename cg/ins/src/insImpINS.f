...
c      write(*,'("insImpINS: turbulenceModel=",2i6)') turbulenceModel
c      write(*,'("insImpINS: nd,uc,vc,wc,kc=",2i6)') nd,uc,vc,wc,kc
...
!   $STENCIL_WIDTH : stencil width of the local coeff-matrix (such as xCoeff, yCoeff, lapCoeff, ...)
     ...
     & .or.bc0.eq.inflowWithVelocityGiven 
     ...
     & equationOffset)
         ...
         if( bc0.eq.dirichletBoundaryCondition 
