! This file automatically generated from insLineSolve.bf with bpp.
        subroutine lineSolveINSSPAL(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,
...
c for interpolation points or unused:
     ...
     & ')
                     stop 11
c$$$    triLoops(2,SA,c$$$             $defineArtificialDiffusionCoefficients(2,0,R,),c$$$             $defineSelfAdjointDiffusionCoefficients(DIM,UV,nuTSA),c$$$             am(i1,i2,i3)= -uu(uc+0)*dxv2i(0) -dsam    -cdm, c$$$             bm(i1,i2,i3)=  dtScale/dt(i1,i2,i3)  +dsaDiag +cdDiag, c$$$             cm(i1,i2,i3)=  uu(uc+0)*dxv2i(0) -dsap    -cdp,,,,,c$$$             f(i1,i2,i3,fcu)=f(i1,i2,i3,fcu)+fusar2d0(uc)-ux2(pc) + dsau() +adE0(i1,i2,i3,uc), c$$$             f(i1,i2,i3,fcv)=f(i1,i2,i3,fcv)+fusar2d0(vc)-uy2(pc) + dsav() +adE0(i1,i2,i3,vc),,)
                   end if
...
c for interpolation points or unused:
     ...
     & ')
                     stop 11
c$$$    triLoops(2,SA,c$$$             $defineArtificialDiffusionCoefficients(2,1,R,),c$$$             $defineSelfAdjointDiffusionCoefficients(DIM,UV,nuTSA),c$$$             am(i1,i2,i3)= -uu(uc+1)*dxv2i(1) -dsam    -cdm, c$$$             bm(i1,i2,i3)=  dtScale/dt(i1,i2,i3)  +dsaDiag +cdDiag, c$$$             cm(i1,i2,i3)=  uu(uc+1)*dxv2i(1) -dsap    -cdp,,,,,c$$$             f(i1,i2,i3,fcu)=f(i1,i2,i3,fcu)+fusar2d1(uc)-ux2(pc) + dsau() +adE1(i1,i2,i3,uc), c$$$             f(i1,i2,i3,fcv)=f(i1,i2,i3,fcv)+fusar2d1(vc)-uy2(pc) + dsav() +adE1(i1,i2,i3,vc),,)
                   end if
                 else if( nd.eq.3 )then
                   ! SA turbulence model (always with AD)
                   if( useSelfAdjointDiffusion.eq.0 )then
...
c for interpolation points or unused:
     ...
     & ')
                     stop 11
c$$$    triLoops(2,SA,c$$$             $defineArtificialDiffusionCoefficients(2,2,R,),c$$$             $defineSelfAdjointDiffusionCoefficients(DIM,UV,nuTSA),c$$$             am(i1,i2,i3)= -uu(uc+2)*dxv2i(2) -dsam    -cdm, c$$$             bm(i1,i2,i3)=  dtScale/dt(i1,i2,i3)  +dsaDiag +cdDiag, c$$$             cm(i1,i2,i3)=  uu(uc+2)*dxv2i(2) -dsap    -cdp,,,,,c$$$             f(i1,i2,i3,fcu)=f(i1,i2,i3,fcu)+fusar2d2(uc)-ux2(pc) + dsau() +adE2(i1,i2,i3,uc), c$$$             f(i1,i2,i3,fcv)=f(i1,i2,i3,fcv)+fusar2d2(vc)-uy2(pc) + dsav() +adE2(i1,i2,i3,vc),,)
                   end if
                 else if( nd.eq.3 )then
                   ! SA turbulence model (always with AD)
                   if( useSelfAdjointDiffusion.eq.0 )then
              ...
              if( nd.eq.2 )then
                if( computeMatrix.eq.1 .and. computeRHS.eq.1 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
c matrix equations:
                       cdmz=admzRSA(i1  ,i2  ,i3)
                       cdpz=admzRSA(i1+1,i2  ,i3)
                       cdzm=adzmRSA(i1  ,i2  ,i3)
                       cdzp=adzmRSA(i1  ,i2+1,i3)
                       ! write(*,'(1x,''insLS:i1,i2,cdmz,cdzm='',2i3,2f9.3)') i1,i2,cdmz,cdzm
                       ! cdmz=0.
                       ! cdpz=0.
                       ! cdzm=0.
                    ...
                    nutb=sigmai*(nu+uu(nc))
                      dndx(0)=ux2(nc)
                      dndx(1)=uy2(nc)
                   t1=-(1.+cb2)*sigmai*dndx(0)
                   am(i1,i2,i3)=-(uu(uc+0)+t1)*dxv2i(0)-nutb*dxvsqi(0)-
     & cdm
                   bm(i1,i2,i3)=dtScale/dt(i1,i2,i3)+2.*nutb*(dxvsqi(0)
     & +dxvsqi(1))+cdDiag+nBydSqLhs-cb1*s
                   cm(i1,i2,i3)=(uu(uc+0)+t1)*dxv2i(0)-nutb*dxvsqi(0)-
     & cdp
...
c rhs equations:
                   f(i1,i2,i3,nc)=f(i1,i2,i3,nc)+fsa2d0(nc)+nSqBydSq+
     & adE0(i1,i2,i3,nc)
...
c for interpolation points or unused:
                ...
                if( computeMatrix.eq.1 .and. computeRHS.eq.1 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
c matrix equations:
                       cdmzz=admzzRSA(i1  ,i2  ,i3  )
                       cdpzz=admzzRSA(i1+1,i2  ,i3  )
                       cdzmz=adzmzRSA(i1  ,i2  ,i3  )
                       cdzpz=adzmzRSA(i1  ,i2+1,i3  )
                       cdzzm=adzzmRSA(i1  ,i2  ,i3  )
                       cdzzp=adzzmRSA(i1  ,i2  ,i3+1)
                       cdDiag=cdmzz+cdpzz+cdzmz+cdzpz+cdzzm+cdzzp
                         cdm=cdmzz
                         cdp=cdpzz
                    chi=uu(nc)/nu
                    ...
                    dd = dw(i1,i2,i3)+cd0
                    dKappaSq=(dd*kappa)**2
                       s=uu(nc)*fnu2/dKappaSq +sqrt( (uy2(uc)-ux2(vc))*
     & *2 + (uz2(vc)-uy2(wc))**2 + (ux2(wc)-uz2(uc))**2 )
                    r= min( uu(nc)/( s*dKappaSq ), cr0 )   !  r= uu(nc)/( max( s*dKappaSq, 1.e-20) )
                    g=r+cw2*(r**6-r)
                    fw=g*( (1.+cw3e6)/(g**6+cw3e6) )**(1./6.)
                    ! We use Newton to linearize the quadratic term: y*y -> 2*y*y0 - y0**2
     ...
     & cdm
                   bm(i1,i2,i3)=dtScale/dt(i1,i2,i3)+2.*nutb*(dxvsqi(0)
     & +dxvsqi(1)+dxvsqi(2))+cdDiag+nBydSqLhs-cb1*s
                   cm(i1,i2,i3)=(uu(uc+0)+t1)*dxv2i(0)-nutb*dxvsqi(0)-
     & cdp
...
c rhs equations:
                   f(i1,i2,i3,nc)=f(i1,i2,i3,nc)+fsa3d0(nc)+nSqBydSq+
     & adE3d0(i1,i2,i3,nc)
...
c matrix equations:
                    ...
                    nutb=sigmai*(nu+uu(nc))
                      dndx(0)=ux2(nc)
                      dndx(1)=uy2(nc)
                   t1=-(1.+cb2)*sigmai*dndx(1)
                   am(i1,i2,i3)=-(uu(uc+1)+t1)*dxv2i(1)-nutb*dxvsqi(1)-
     & cdm
                   bm(i1,i2,i3)=dtScale/dt(i1,i2,i3)+2.*nutb*(dxvsqi(0)
     & +dxvsqi(1))+cdDiag+nBydSqLhs-cb1*s
                   cm(i1,i2,i3)=(uu(uc+1)+t1)*dxv2i(1)-nutb*dxvsqi(1)-
     & cdp
...
c rhs equations:
                   f(i1,i2,i3,nc)=f(i1,i2,i3,nc)+fsa2d1(nc)+nSqBydSq+
     & adE1(i1,i2,i3,nc)
...
c rhs equations:
                   f(i1,i2,i3,nc)=f(i1,i2,i3,nc)+fsa3d1(nc)+nSqBydSq+
     & adE3d1(i1,i2,i3,nc)
...
c matrix equations:
                    ...
                    nutb=sigmai*(nu+uu(nc))
                      dndx(0)=ux2(nc)
                      dndx(1)=uy2(nc)
                   t1=-(1.+cb2)*sigmai*dndx(2)
                   am(i1,i2,i3)=-(uu(uc+2)+t1)*dxv2i(2)-nutb*dxvsqi(2)-
     & cdm
                   bm(i1,i2,i3)=dtScale/dt(i1,i2,i3)+2.*nutb*(dxvsqi(0)
     & +dxvsqi(1))+cdDiag+nBydSqLhs-cb1*s
                   cm(i1,i2,i3)=(uu(uc+2)+t1)*dxv2i(2)-nutb*dxvsqi(2)-
     & cdp
...
c rhs equations:
                   f(i1,i2,i3,nc)=f(i1,i2,i3,nc)+fsa2d2(nc)+nSqBydSq+
     & adE2(i1,i2,i3,nc)
...
c rhs equations:
                   f(i1,i2,i3,nc)=f(i1,i2,i3,nc)+fsa3d2(nc)+nSqBydSq+
     & adE3d2(i1,i2,i3,nc)
              ...
              if( nd.eq.2 )then
                if( computeMatrix.eq.1 .and. computeRHS.eq.1 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
c matrix equations:
                       cdmz=admzCSA(i1  ,i2  ,i3)
                       cdpz=admzCSA(i1+1,i2  ,i3)
                       cdzm=adzmCSA(i1  ,i2  ,i3)
                       cdzp=adzmCSA(i1  ,i2+1,i3)
                       ! write(*,'(1x,''insLS:i1,i2,cdmz,cdzm='',2i3,2f9.3)') i1,i2,cdmz,cdzm
                       ! cdmz=0.
                       ! cdpz=0.
                       ! cdzm=0.
                    ...
                    nutb=sigmai*(nu+uu(nc))
                      dndx(0)=ux2c(nc)
                      dndx(1)=uy2c(nc)
                   t1=(uu(uc)*rxi(0,0)+uu(vc)*rxi(0,1)-nutb*(rxx(0,0)+
     & rxy(0,1))-(1.+cb2)*sigmai*(dndx(0)*rxi(0,0)+dndx(1)*rxi(0,1)))*
     & drv2i(0)
                   t2=nutb*(rxi(0,0)**2+rxi(0,1)**2)*drvsqi(0)
                   am(i1,i2,i3)=-t1-t2-cdm
                   bm(i1,i2,i3)=dtScale/dt(i1,i2,i3)+2.*(t2+nutb*(rxi(
     & dirp1,0)**2+rxi(dirp1,1)**2)*drvsqi(dirp1))+cdDiag+nBydSqLhs-
     & cb1*s
                   cm(i1,i2,i3)=t1-t2-cdp
...
c rhs equations:
                   f(i1,i2,i3,nc)=f(i1,i2,i3,nc)+fsac2d0(nc)+nSqBydSq+
     & adE0(i1,i2,i3,nc)
...
c for interpolation points or unused:
                ...
                if( computeMatrix.eq.1 .and. computeRHS.eq.1 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
c matrix equations:
                       cdmzz=admzzCSA(i1  ,i2  ,i3  )
                       cdpzz=admzzCSA(i1+1,i2  ,i3  )
                       cdzmz=adzmzCSA(i1  ,i2  ,i3  )
                       cdzpz=adzmzCSA(i1  ,i2+1,i3  )
                       cdzzm=adzzmCSA(i1  ,i2  ,i3  )
                       cdzzp=adzzmCSA(i1  ,i2  ,i3+1)
                       cdDiag=cdmzz+cdpzz+cdzmz+cdzpz+cdzzm+cdzzp
                         cdm=cdmzz
                         cdp=cdpzz
                    chi=uu(nc)/nu
     ...
     & )**2 + (uz3c(vc)-uy3c(wc))**2 + (ux3c(wc)-uz3c(uc))**2 )
                    ...
                    nutb=sigmai*(nu+uu(nc))
                      ...
                      dndx(1)=uy3c(nc)
                      dndx(2)=uz3c(nc)
                   t1=(uu(uc)*rxi(0,0)+uu(vc)*rxi(0,1)+uu(wc)*rxi(0,2)-
     & nutb*(rxx3(0,0)+rxy3(0,1)+rxz3(0,2))-(1.+cb2)*sigmai*(dndx(0)*
     & rxi(0,0)+dndx(1)*rxi(0,1)+dndx(2)*rxi(0,2)))*drv2i(0)
                   t2=nutb*(rxi(0,0)**2+rxi(0,1)**2+rxi(0,2)**2)*
     & drvsqi(0)
                   am(i1,i2,i3)=-t1-t2-cdm
                   bm(i1,i2,i3)=dtScale/dt(i1,i2,i3)+2.*(t2+nutb*((rxi(
     & dirp1,0)**2+rxi(dirp1,1)**2+rxi(dirp1,2)**2)*drvsqi(dirp1)+(
     & rxi(dirp2,0)**2+rxi(dirp2,1)**2+rxi(dirp2,2)**2)*drvsqi(dirp2))
...
c rhs equations:
                   f(i1,i2,i3,nc)=f(i1,i2,i3,nc)+fsac3d0(nc)+nSqBydSq+
     & adE3d0(i1,i2,i3,nc)
...
c matrix equations:
                    ...
                    nutb=sigmai*(nu+uu(nc))
                      dndx(0)=ux2c(nc)
                      dndx(1)=uy2c(nc)
                   t1=(uu(uc)*rxi(1,0)+uu(vc)*rxi(1,1)-nutb*(rxx(1,0)+
     & rxy(1,1))-(1.+cb2)*sigmai*(dndx(0)*rxi(1,0)+dndx(1)*rxi(1,1)))*
     & drv2i(1)
                   t2=nutb*(rxi(1,0)**2+rxi(1,1)**2)*drvsqi(1)
                   am(i1,i2,i3)=-t1-t2-cdm
                   bm(i1,i2,i3)=dtScale/dt(i1,i2,i3)+2.*(t2+nutb*(rxi(
     & dirp1,0)**2+rxi(dirp1,1)**2)*drvsqi(dirp1))+cdDiag+nBydSqLhs-
     & cb1*s
...
c rhs equations:
                   f(i1,i2,i3,nc)=f(i1,i2,i3,nc)+fsac2d1(nc)+nSqBydSq+
     & adE1(i1,i2,i3,nc)
...
c matrix equations:
     ...
     & )**2 + (uz3c(vc)-uy3c(wc))**2 + (ux3c(wc)-uz3c(uc))**2 )
                    ...
                    nutb=sigmai*(nu+uu(nc))
                      ...
                      dndx(1)=uy3c(nc)
                      dndx(2)=uz3c(nc)
                   t1=(uu(uc)*rxi(1,0)+uu(vc)*rxi(1,1)+uu(wc)*rxi(1,2)-
     & nutb*(rxx3(1,0)+rxy3(1,1)+rxz3(1,2))-(1.+cb2)*sigmai*(dndx(0)*
     & rxi(1,0)+dndx(1)*rxi(1,1)+dndx(2)*rxi(1,2)))*drv2i(1)
                   t2=nutb*(rxi(1,0)**2+rxi(1,1)**2+rxi(1,2)**2)*
     & drvsqi(1)
                   am(i1,i2,i3)=-t1-t2-cdm
                   bm(i1,i2,i3)=dtScale/dt(i1,i2,i3)+2.*(t2+nutb*((rxi(
     & dirp1,0)**2+rxi(dirp1,1)**2+rxi(dirp1,2)**2)*drvsqi(dirp1)+(
...
c rhs equations:
                   f(i1,i2,i3,nc)=f(i1,i2,i3,nc)+fsac3d1(nc)+nSqBydSq+
     & adE3d1(i1,i2,i3,nc)
...
c matrix equations:
                    ...
                    nutb=sigmai*(nu+uu(nc))
                      dndx(0)=ux2c(nc)
                      dndx(1)=uy2c(nc)
                   t1=(uu(uc)*rxi(2,0)+uu(vc)*rxi(2,1)-nutb*(rxx(2,0)+
     & rxy(2,1))-(1.+cb2)*sigmai*(dndx(0)*rxi(2,0)+dndx(1)*rxi(2,1)))*
     & drv2i(2)
                   t2=nutb*(rxi(2,0)**2+rxi(2,1)**2)*drvsqi(2)
                   am(i1,i2,i3)=-t1-t2-cdm
                   bm(i1,i2,i3)=dtScale/dt(i1,i2,i3)+2.*(t2+nutb*(rxi(
     & dirp1,0)**2+rxi(dirp1,1)**2)*drvsqi(dirp1))+cdDiag+nBydSqLhs-
     & cb1*s
...
c rhs equations:
                   f(i1,i2,i3,nc)=f(i1,i2,i3,nc)+fsac2d2(nc)+nSqBydSq+
     & adE2(i1,i2,i3,nc)
...
c matrix equations:
     ...
     & )**2 + (uz3c(vc)-uy3c(wc))**2 + (ux3c(wc)-uz3c(uc))**2 )
                    ...
                    nutb=sigmai*(nu+uu(nc))
                      ...
                      dndx(1)=uy3c(nc)
                      dndx(2)=uz3c(nc)
                   t1=(uu(uc)*rxi(2,0)+uu(vc)*rxi(2,1)+uu(wc)*rxi(2,2)-
     & nutb*(rxx3(2,0)+rxy3(2,1)+rxz3(2,2))-(1.+cb2)*sigmai*(dndx(0)*
     & rxi(2,0)+dndx(1)*rxi(2,1)+dndx(2)*rxi(2,2)))*drv2i(2)
                   t2=nutb*(rxi(2,0)**2+rxi(2,1)**2+rxi(2,2)**2)*
     & drvsqi(2)
                   am(i1,i2,i3)=-t1-t2-cdm
                   bm(i1,i2,i3)=dtScale/dt(i1,i2,i3)+2.*(t2+nutb*((rxi(
     & dirp1,0)**2+rxi(dirp1,1)**2+rxi(dirp1,2)**2)*drvsqi(dirp1)+(
...
c rhs equations:
                   f(i1,i2,i3,nc)=f(i1,i2,i3,nc)+fsac3d2(nc)+nSqBydSq+
     & adE3d2(i1,i2,i3,nc)
