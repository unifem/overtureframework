...
c============================================================================================
     ...
     & iv)*p0 - a0v(iv)*e0 - a1v(iv)*e0t )
                  ...
                  pv0 = p(i1,i2,i3,m)
                  pvm0=pm(i1,i2,i3,m)
                  rhsE = maxwell2dr(i1,i2,i3,ec) + alphaP*(2.*pv0-pvm0)
     &  + fe
     ...
     & deti
               ...
               if( t.le.3.*dt )then
                 write(*,'("advOPT>>>","FD22r-dispersive-MULTI-PV")')
               end if
               fe=0.
     ...
     & + fpv(iv)
                  ...
                  rhsE = maxwell2dr(i1,i2,i3,ec) + alphaP*( pSum - 
     & rhsP ) + fe
