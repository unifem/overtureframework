...
c     + 33190 fv[6] - 4125 fv[7] - 300227 fv[3] - 117051 fv[5])
     ...
     & vvt2,ut3,vvt4,ut5,ut6,ut7, bc, dis, varDis, ipar, rpar, ierr )
       ...
       !!$
       !!$  #Else
       !!$    write(*,*) 'advMaxwell:ERROR order = 2'
       !!$    stop 5
       !!$  #End
       !!$
       !!$   call ovtime( time1 )
           ...
           if( useDivergenceCleaning.eq.0 )then
            if( addForcing.eq.0 .and. .not.addDissipation )then
              if( solveForE.ne.0 .and. solveForH.ne.0 )then
                ...
                stop 9987
c***    loopse9(un(i1,i2,i3,hx)=maxwell3dr(i1,i2,i3,hx),un(i1,i2,i3,hy)=maxwell3dr(i1,i2,i3,hy),un(i1,i2,i3,hz)=maxwell3dr(i1,i2,i3,hz),,,,,,)
              end if
...
c add forcing to the equations
     ...
     & i3,ez)
                ...
                stop 9987
c***    loopse9(un(i1,i2,i3,hx)=maxwell3dr(i1,i2,i3,hx)+dtsq*f(i1,i2,i3,hx),un(i1,i2,i3,hy)=maxwell3dr(i1,i2,i3,hy)+dtsq*f(i1,i2,i3,hy),un(i1,i2,i3,hz)=maxwell3dr(i1,i2,i3,hz)+dtsq*f(i1,i2,i3,hz),,,,,,)
              end if
...
c add dissipation to the equations
     ...
     & ez)
                ...
                stop 6654
c***    loopse9(un(i1,i2,i3,hx)=maxwell3dr(i1,i2,i3,hx)+dis(i1,i2,i3,hx),un(i1,i2,i3,hy)=maxwell3dr(i1,i2,i3,hy)+dis(i1,i2,i3,hy),un(i1,i2,i3,hz)=maxwell3dr(i1,i2,i3,hz)+dis(i1,i2,i3,hz),,,,,,)
              end if
            else
c add dissipation and forcing to the equations
     ...
     & i3,ez)+dis(i1,i2,i3,ez)
                ...
                stop 6654
c****    loopse9(un(i1,i2,i3,hx)=maxwell3dr(i1,i2,i3,hx)+dtsq*f(i1,i2,i3,hx)+dis(i1,i2,i3,hx),un(i1,i2,i3,hy)=maxwell3dr(i1,i2,i3,hy)+dtsq*f(i1,i2,i3,hy)+dis(i1,i2,i3,hy),un(i1,i2,i3,hz)=maxwell3dr(i1,i2,i3,hz)+dtsq*f(i1,i2,i3,hz)+dis(i1,i2,i3,hz),,,,,,)
              end if
            end if
           else
            ! 3D, 2nd-order, div cleaning:
     ...
     & div cleaning... t=",e10.2)') t
            if( addForcing.eq.0 .and. .not.addDissipation )then
              if( solveForE.ne.0 .and. solveForH.ne.0 )then
                ...
                stop 9987
c***    loopse9(un(i1,i2,i3,hx)=mxdc3d2Hx(i1,i2,i3),un(i1,i2,i3,hy)=mxdc3d2Hy(i1,i2,i3),un(i1,i2,i3,hz)=mxdc3d2Hz(i1,i2,i3),,,,,,)
              end if
            else if( addForcing.ne.0 .and. .not.addDissipation )then
c add forcing to the equations
              if( solveForE.ne.0 .and. solveForH.ne.0 )then
     ...
     & ez)
                ...
                stop 9987
c***    loopse9(un(i1,i2,i3,hx)=mxdc3d2Hx(i1,i2,i3)+dtsq*f(i1,i2,i3,hx),un(i1,i2,i3,hy)=mxdc3d2Hy(i1,i2,i3)+dtsq*f(i1,i2,i3,hy),un(i1,i2,i3,hz)=mxdc3d2Hz(i1,i2,i3)+dtsq*f(i1,i2,i3,hz),,,,,,)
              end if
            else if( addForcing.eq.0 .and. addDissipation )then
c add dissipation to the equations
              if( solveForE.ne.0 .and. solveForH.ne.0 )then
     ...
     & hz)
                ...
                stop 6654
c***    loopse9(un(i1,i2,i3,hx)=mxdc3d2Hx(i1,i2,i3)+dis(i1,i2,i3,hx),un(i1,i2,i3,hy)=mxdc3d2Hy(i1,i2,i3)+dis(i1,i2,i3,hy),un(i1,i2,i3,hz)=mxdc3d2Hz(i1,i2,i3)+dis(i1,i2,i3,hz),,,,,,)
              end if
            else
c add dissipation and forcing to the equations
              if( solveForE.ne.0 .and. solveForH.ne.0 )then
     ...
     & ez)+dis(i1,i2,i3,ez)
                ...
                stop 6654
c****    loopse9(un(i1,i2,i3,hx)=mxdc3d2Hx(i1,i2,i3)+dtsq*f(i1,i2,i3,hx)+dis(i1,i2,i3,hx),un(i1,i2,i3,hy)=mxdc3d2Hy(i1,i2,i3)+dtsq*f(i1,i2,i3,hy)+dis(i1,i2,i3,hy),un(i1,i2,i3,hz)=mxdc3d2Hz(i1,i2,i3)+dtsq*f(i1,i2,i3,hz)+dis(i1,i2,i3,hz),,,,,,)
              end if
            end if
           end if
        else
