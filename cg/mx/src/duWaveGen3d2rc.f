...
c
      ...
      t13 = t9 ** 2
      t14 = 0.1E1 / 0.2E1
      t15 = t14 * dt * (t13 + t11 + t12) * t4
      t4 = dt * t4 / 0.4E1
      t16 = cc * (-cc * t1 + t4 * t12 + t15)
      t5 = dt * t5 / 0.8E1
      t17 = t5 * t12
      t18 = t9 + t2
      t19 = t7 * t12 * t18 / 0.4E1
      t20 = cc * (-cc * t2 + t4 * t11 + t15)
      t21 = t5 * t11
      t22 = t7 * t11 * t10 / 0.4E1
      t4 = cc * (-cc * t9 + t4 * t13 + t15)
      t5 = t5 * t13
      t15 = t7 * t13 * t3 / 0.4E1
      t3 = t8 * t1 * t3 / 0.8E1
      t10 = t7 * t1 * t9 * t10 / 0.8E1
      t8 = t8 * t9 * t18 / 0.8E1
      t7 = t7 / 0.8E1
      t12 = t7 * t1 * t12
      t11 = t7 * t2 * t11
      ...
      cuu(33) = t3
      cuu(37) = t10
      cuu(38) = -t1 * t6 * (t14 * t16 + t17) - t19
      cuu(39) = t10
      cuu(43) = t3
      cuu(53) = t11
      cuu(57) = t8
      cuu(58) = -t2 * t6 * (t14 * t20 + t21) - t22
      cuu(59) = t8
      cuu(61) = t7
      cuu(62) = -t9 * t6 * (t14 * t4 + t5) - t15
      cuu(63) = t14 * (0.2E1 * t1 * t6 * t16 + 0.2E1 * t2 * t6 * t20 + 0
     #.2E1 * t9 * t6 * t4) + 0.1E1
      cuu(64) = t9 * t6 * (-t14 * t4 - t5) - t15
      cuu(65) = t7
      cuu(67) = t8
      cuu(68) = t2 * t6 * (-t14 * t20 - t21) - t22
      cuu(69) = t8
      cuu(73) = t11
      cuu(83) = t3
      cuu(87) = t10
      cuu(88) = t1 * t6 * (-t14 * t16 - t17) - t19
      cuu(89) = t10
      cuu(93) = t3
      cuu(113) = t12
c
...
c      t1 = 0.1E1 / dx
      ...
      t5 = cc / 0.16E2
      t6 = 0.1E1 / dy
      t7 = cc * (-t2 * t6 - 0.3E1 / 0.8E1)
      t8 = 0.1E1 / dz
      t2 = cc * (-t2 * t8 - 0.3E1 / 0.8E1)
      t9 = t5 * t4
      t10 = t9 * t1
      t11 = t9 * t6
      t9 = t9 * t8
      ...
      cuv(53) = -t11
      cuv(58) = t4 * (-t7 / 0.2E1 + t5) * t6
      cuv(61) = -t9
      cuv(62) = t4 * (-t2 / 0.2E1 + t5) * t8
      cuv(63) = t1 * t4 * t3 + t8 * t4 * t2 + t6 * t4 * t7 + dt
      cuv(64) = t4 * (-t2 / 0.2E1 + t5) * t8
      cuv(65) = -t9
      cuv(68) = t4 * (-t7 / 0.2E1 + t5) * t6
      cuv(73) = -t11
...
c
      ...
      t11 = t1 ** 2
      t12 = t2 ** 2
      t13 = dt * (t12 + t11 + t10) * t4 / 0.2E1
      t14 = dt / 0.4E1
      t4 = t14 * t4
      t15 = cc * (-cc * t1 + t4 * t11 + t13)
      t5 = t14 * t5
      t14 = t5 * t11
      t16 = t8 + t2
      t17 = t6 * t11 * t16 / 0.2E1
      t18 = cc * (-cc * t2 + t4 * t12 + t13)
      t19 = t5 * t12
      t20 = t6 * t12 * t9 / 0.2E1
      ...
      cvu(33) = t3
      cvu(37) = t9
      cvu(38) = -t1 * dt * (t14 + t15) - t17
      cvu(39) = t9
      cvu(43) = t3
      cvu(53) = t12
      cvu(57) = t7
      cvu(58) = -t2 * dt * (t19 + t18) - t20
      cvu(59) = t7
      cvu(61) = t6
      cvu(62) = -t8 * dt * (t5 + t4) - t13
      cvu(63) = 0.2E1 * t1 * dt * t15 + 0.2E1 * t2 * dt * t18 + 0.2E1 * 
     #t8 * dt * t4
      cvu(64) = t8 * dt * (-t5 - t4) - t13
      cvu(65) = t6
      cvu(67) = t7
      cvu(68) = t2 * dt * (-t19 - t18) - t20
      cvu(69) = t7
      cvu(73) = t12
      cvu(83) = t3
      cvu(87) = t9
      cvu(88) = t1 * dt * (-t14 - t15) - t17
      cvu(89) = t9
      cvu(93) = t3
      cvu(113) = t11
c
...
c
      ...
      t4 = cc / 0.8E1
      t5 = 0.1E1 / dy
      t6 = cc * (-0.3E1 / 0.8E1 + t2 * t5)
      t7 = 0.1E1 / dz
      t2 = cc * (-0.3E1 / 0.8E1 + t2 * t7)
      t8 = t4 * dt
      t9 = t8 * t7
      t10 = t8 * t1
      t8 = t8 * t5
      ...
      cvv(61) = -t9
      cvv(62) = dt * (-t2 + t4) * t7
      cvv(63) = 0.2E1 * t1 * dt * t3 + 0.2E1 * t7 * dt * t2 + 0.2E1 * t5
     # * dt * t6 + 0.1E1
      cvv(64) = dt * (-t2 + t4) * t7
      cvv(65) = -t9
      cvv(68) = dt * (-t6 + t4) * t5
