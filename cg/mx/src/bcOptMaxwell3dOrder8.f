...
c     **************************************************************************
     ...
     & u(i1+3*is1,i2+3*is2,i3+3*is3,et1)
                    u(i1-3*is1,i2-3*is2,i3-3*is3,et2)=2.*u(i1,i2,i3,
     & et2)-u(i1+3*is1,i2+3*is2,i3+3*is3,et2)
                     call ogf3d(ep,xy(i1-3*is1,i2-3*is2,i3-3*is3,0),xy(
     & i1-3*is1,i2-3*is2,i3-3*is3,1),xy(i1-3*is1,i2-3*is2,i3-3*is3,2),
     & t,uvm(0),uvm(1),uvm(2))
                     call ogf3d(ep,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,
     & i2,i3,2),t,uv0(0),uv0(1),uv0(2))
                     call ogf3d(ep,xy(i1+3*is1,i2+3*is2,i3+3*is3,0),xy(
     ...
     & u(i1+4*is1,i2+4*is2,i3+4*is3,et1)
                    u(i1-4*is1,i2-4*is2,i3-4*is3,et2)=2.*u(i1,i2,i3,
     & et2)-u(i1+4*is1,i2+4*is2,i3+4*is3,et2)
                     call ogf3d(ep,xy(i1-4*is1,i2-4*is2,i3-4*is3,0),xy(
     & i1-4*is1,i2-4*is2,i3-4*is3,1),xy(i1-4*is1,i2-4*is2,i3-4*is3,2),
     & t,uvm(0),uvm(1),uvm(2))
                     call ogf3d(ep,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,
     & i2,i3,2),t,uv0(0),uv0(1),uv0(2))
                     call ogf3d(ep,xy(i1+4*is1,i2+4*is2,i3+4*is3,0),xy(
