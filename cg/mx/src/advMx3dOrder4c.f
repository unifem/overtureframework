...
c       **********************************************
     ...
     & then
              ...
              if( solveForE.ne.0 .and. solveForH.ne.0 )then
                stop 6666
c$$$        loopse9(v(i1,i2,i3,ex)=uLaplacian23(i1,i2,i3,ex),c$$$                v(i1,i2,i3,ey)=uLaplacian23(i1,i2,i3,ey),c$$$                v(i1,i2,i3,ez)=uLaplacian23(i1,i2,i3,ez),c$$$                v(i1,i2,i3,hx)=uLaplacian23(i1,i2,i3,hx),c$$$                v(i1,i2,i3,hy)=uLaplacian23(i1,i2,i3,hy),c$$$                v(i1,i2,i3,hz)=uLaplacian23(i1,i2,i3,hz),,,)
...
c$$$        loopse9(v(i1,i2,i3,hx)=uLaplacian23(i1,i2,i3,hx),c$$$                v(i1,i2,i3,hy)=uLaplacian23(i1,i2,i3,hy),c$$$                v(i1,i2,i3,hz)=uLaplacian23(i1,i2,i3,hz),,,,,,)        
              end if
              ...
              if( useDivergenceCleaning.eq.0 )then
                if( addForcing.eq.0 .and. .not.addDissipation )then
                  if( solveForE.ne.0 .and. solveForH.ne.0 )then
                    ...
                    stop 9987
c***    loopse9(un(i1,i2,i3,hx)=max3dc44me(i1,i2,i3,hx),un(i1,i2,i3,hy)=max3dc44me(i1,i2,i3,hy),un(i1,i2,i3,hz)=max3dc44me(i1,i2,i3,hz),,,,,,)
                  end if
...
c add forcing to the equations
     ...
     & i1,i2,i3,ez)
                    ...
                    stop 9987
c***    loopse9(un(i1,i2,i3,hx)=max3dc44me(i1,i2,i3,hx)+dtsq*f(i1,i2,i3,hx),un(i1,i2,i3,hy)=max3dc44me(i1,i2,i3,hy)+dtsq*f(i1,i2,i3,hy),un(i1,i2,i3,hz)=max3dc44me(i1,i2,i3,hz)+dtsq*f(i1,i2,i3,hz),,,,,,)
                  end if
...
c add dissipation to the equations
     ...
     & i2,i3,ez)
                    ...
                    stop 6654
c***    loopse9(un(i1,i2,i3,hx)=max3dc44me(i1,i2,i3,hx)+dis(i1,i2,i3,hx),un(i1,i2,i3,hy)=max3dc44me(i1,i2,i3,hy)+dis(i1,i2,i3,hy),un(i1,i2,i3,hz)=max3dc44me(i1,i2,i3,hz)+dis(i1,i2,i3,hz),,,,,,)
                  end if
                else
c add dissipation and forcing to the equations
     ...
     & i1,i2,i3,ez)+dis(i1,i2,i3,ez)
                    ...
                    stop 6654
c****    loopse9(un(i1,i2,i3,hx)=max3dc44me(i1,i2,i3,hx)+dtsq*f(i1,i2,i3,hx)+dis(i1,i2,i3,hx),un(i1,i2,i3,hy)=max3dc44me(i1,i2,i3,hy)+dtsq*f(i1,i2,i3,hy)+dis(i1,i2,i3,hy),un(i1,i2,i3,hz)=max3dc44me(i1,i2,i3,hz)+dtsq*f(i1,i2,i3,hz)+dis(i1,i2,i3,hz),,,,,,)
                  end if
                end if
              else
                ! finish me
     ...
     & i2,i3,hz)
                  ...
                  do i2=n2a,n2b
                  do i1=n1a,n1b
                   un(i1,i2,i3,ex)=maxwellc44me(i1,i2,i3,ex)+dis(i1,i2,
     & i3,ex)
                   un(i1,i2,i3,ey)=maxwellc44me(i1,i2,i3,ey)+dis(i1,i2,
     & i3,ey)


                   un(i1,i2,i3,hz)=maxwellc44me(i1,i2,i3,hz)+dis(i1,i2,
     & i3,hz)
