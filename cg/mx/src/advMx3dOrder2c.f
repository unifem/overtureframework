...
c============================================================================================
     ...
     & useNewForcingMethod")')
               ...
               if( .true. .and. numberOfPolarizationVectors.eq.1 )then
                ...
                if( t.le.3.*dt )then
                  write(*,'("advOPT>>>","FD22c-3D-dispersive")')
                end if
                  do i3=n3a,n3b
                  do i2=n2a,n2b
                  do i1=n1a,n1b
     ...
     & iv)*p0 - a0v(iv)*e0 - a1v(iv)*e0t )
                   ...
                   ! pv = u(i1,i2,i3,pc)
                   ! pvm=um(i1,i2,i3,pc)
                   rhsE = maxwellc23(i1,i2,i3,ec) + alphaP*(2.*pv0-
     & pvm0) + fe
     ...
     & deti
                ...
                if( t.le.3.*dt )then
                  write(*,'("advOPT>>>","FD22c-3D-dispersive-MULTI-PV")
     & ')
                end if
                fe=0.
     ...
     & + fpv(iv)
                   ...
                   rhsE = maxwellc23(i1,i2,i3,ec) + alphaP*( pSum - 
     & rhsP ) + fe
