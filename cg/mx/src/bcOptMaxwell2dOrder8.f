...
c write(*,'("initializeBoundaryForcing slowStartInterval=",e10.2)') slowStartInterval
     ...
     & u(i1+4*is1,i2+4*is2,i3+4*is3,et1)
                    u(i1-4*is1,i2-4*is2,i3-4*is3,hz)=2.*u(i1,i2,i3,hz)-
     & u(i1+4*is1,i2+4*is2,i3+4*is3,hz)
                     call ogf2dfo(ep,fieldOption,xy(i1-4*is1,i2-4*is2,
     & i3,0),xy(i1-4*is1,i2-4*is2,i3,1),t,uvm(ex),uvm(ey),uvm(hz))
                     call ogf2dfo(ep,fieldOption,xy(i1,i2,i3,0),xy(i1,
     & i2,i3,1),t,uv0(ex),uv0(ey),uv0(hz))
                     call ogf2dfo(ep,fieldOption,xy(i1+4*is1,i2+4*is2,
     & i3,0),xy(i1+4*is1,i2+4*is2,i3,1),t,uvp(ex),uvp(ey),uvp(hz))
