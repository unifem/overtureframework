...
c$$$ loopsFCD2D($$getLapSq2dOrder2(),c$$$                  dtsq*f(i1,i2,i3,ex),dtsq*f(i1,i2,i3,ey),dtsq*f(i1,i2,i3,hz),c$$$                  un(i1,i2,i3,ex)=max2dc44me(i1,i2,i3,ex),c$$$                  un(i1,i2,i3,ey)=max2dc44me(i1,i2,i3,ey),c$$$                  un(i1,i2,i3,hz)=max2dc44me(i1,i2,i3,hz))
              ! do one at a time -- is this faster ? NO
c$$$ loopsFCD2DA($$evalLapSq2dOrder2(ex),c$$$             dtsq*f(i1,i2,i3,ex),c$$$             un(i1,i2,i3,ex)=max2dc44me(i1,i2,i3,ex))
c$$$
c$$$ loopsFCD2DA($$evalLapSq2dOrder2(ey),c$$$             dtsq*f(i1,i2,i3,ey),c$$$             un(i1,i2,i3,ey)=max2dc44me(i1,i2,i3,ey))
c$$$
c$$$ loopsFCD2DA($$evalLapSq2dOrder2(hz),c$$$             dtsq*f(i1,i2,i3,hz),c$$$             un(i1,i2,i3,hz)=max2dc44me(i1,i2,i3,hz))
...
c add forcing to the first 3 equations
                 if( useWhereMask.ne.0 )then
                  ...
                  do i1=n1a,n1b
                   if( mask(i1,i2,i3).gt.0 )then
                    un(i1,i2,i3,ex)=max2dc44me2(i1,i2,i3,ex)+dtsq*f(i1,
     & i2,i3,ex)
                    un(i1,i2,i3,ey)=max2dc44me2(i1,i2,i3,ey)+dtsq*f(i1,
     & i2,i3,ey)
...
c add dissipation to the first 3 equations
                 if( useWhereMask.ne.0 )then
                  ...
                  do i1=n1a,n1b
                   if( mask(i1,i2,i3).gt.0 )then
                    un(i1,i2,i3,ex)=max2dc44me2(i1,i2,i3,ex)+dis(i1,i2,
     & i3,ex)
                    un(i1,i2,i3,ey)=max2dc44me2(i1,i2,i3,ey)+dis(i1,i2,
     & i3,ey)
