...
c       **********************************************
          if( useCurvilinearOpt.eq.1 .and. useConservative.eq.0 )then
           ! *************** non-conservative *****************    
c$$$     loopsFCD(un(i1,i2,i3,ex)=maxwellc22(i1,i2,i3,ex),c$$$              un(i1,i2,i3,ey)=maxwellc22(i1,i2,i3,ey),c$$$              un(i1,i2,i3,ez)=maxwellc22(i1,i2,i3,ez),c$$$               ,,,c$$$              un(i1,i2,i3,hx)=maxwellc22(i1,i2,i3,hx),c$$$              un(i1,i2,i3,hy)=maxwellc22(i1,i2,i3,hy),c$$$              un(i1,i2,i3,hz)=maxwellc22(i1,i2,i3,hz),c$$$              ,,)
            stop 88044
