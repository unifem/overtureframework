! This file automatically generated from advSOSUP.bf with bpp.
        subroutine advMxSOSUP3dOrder2c(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,
     ...
     & ')
       ...
       ! 3D, second-order, curvilinear
             if( useOld.eq.1 ) then
             call duWaveGen3d2ccOLD( nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,n1a,
     ...
     & useWhereMask,mask )
             ...
             call duWaveGen3d2cc( nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,n1a,
     & n1b,n2a,n2b,n3a,n3b,ndf4a,ndf4b,ex,addForcing,u(nd1a,nd2a,nd3a,
     & ex),u(nd1a,nd2a,nd3a,ext),un(nd1a,nd2a,nd3a,ex),un(nd1a,nd2a,
     & nd3a,ext),rsxy(nd1a,nd2a,nd3a,0,0), f0,dr(0),dr(1),dr(2),dt,cc,
     & useWhereMask,mask )
