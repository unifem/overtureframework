c
c     $Header: /usr/casc/overture/Overture/resCVS/maxwell/linpack.f,v 1.1 2006/05/29 16:26:31 henshaw Exp $
c
c     These subroutines and functions are from linpack via netlib@ornl.gov
c
