...
# Examples:
#
#  ogen -noplot pillInABoxGrid.cmd -interp=e -factor=2 
#
# *OLD*
...
#
# Background grid:
$xa=-1.; $xb=1.; $ya=-1.25; $yb=1.25; $za=-1.; $zb=1.; 
# Refinement patch 
...
#
  body of revolution
    ...
    exit
#
# ------ Make a surface mapping for the pill-box ----
#        so we can grow a grid into the interior 
