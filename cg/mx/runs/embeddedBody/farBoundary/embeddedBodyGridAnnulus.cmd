...
#**************************************************************************
#
$prefix="embeddedBodyGridAnnulus"; 
$xa=-4; $xb=4; $ya=-4; $yb=4; $ym=0;  # inner domain bounds
$xca=-4; $xcb=4; $yca=-4; $ycb=4; $ycm=0;  # outer (coarse grid) domain bounds
$width=1.; $height=.5; $body=1; 
$depth=1./6.; # depth of the body 
$per=0; # per=1 : periodic BC's 
$theta=60; 
#
$sharp=100; $tStretch=5; # sharp = sharpnesst factor for corners
# 
...
#
  annulus
    ...
    $nr = $nr0+$ng;
    $outerRad = $xb;
    $innerRad = $outerRad - $ds*$nr;
    inner and outer radii
      $innerRad $outerRad
    lines
      $nTheta = int( 2.*3.14159*($innerRad+$outerRad)*.5/$dsc+1.5);
      $nTheta $nr 
    boundary conditions
      102 103  0 1
    share
...
#   stretch coordinates 
#   Stretch r2:exp
#   STP:stretch r2 exp: parameters 0 1 1 5 0.5 
# exit 
# ---- Lower half space ----
#
   annulus
...
# stretched-upperHalfAnnulus 
# stretched-lowerHalfAnnulus 
  lowerHalfSpace
  upperHalfSpace 
  upperHalfAnnulus
  lowerHalfAnnulus
