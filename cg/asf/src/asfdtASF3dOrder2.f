! This file automatically generated from asfdt.bf with bpp.
        subroutine asfdtASF3dOrder2(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,
     & nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,  u,uu, ut,uti,
     &  rL, pL,  gv,dw,  bc, ipar, rpar, ierr )
c======================================================================
...
c real dxi,dyi,dzi,dri,dsi,dti,dr2i,ds2i,dt2i
     ...
     & computeAllWithWeightedImplicit=3 )
        ...
        real w0x,w0y,w0z
        real p0x,p0y,p0z
        real rhoi,divu,phi,lapT,gamma,gm1,mu,kThermal,Rg,nuRho,
     & pressureLevel,a43,a13
        real gravity(0:2)
        ! for SPAL TM
        real n0,n0x,n0y,n0z
...
c     --- end statement functions
        ...
        if( orderOfAccuracy.ne.2 .and. orderOfAccuracy.ne.4 )then
          write(*,'("asfdt:ERROR orderOfAccuracy=",i6)') 
     & orderOfAccuracy
          stop 1
        end if
...
c      write(*,'("asfdt: nd,uc,vc,wc,kc=",2i6)') nd,uc,vc,wc,kc
     ...
     & kc.gt.1000) )then
          write(*,'("asfdt:ERROR in kc: nd,uc,vc,wc,kc=",2i6)') nd,uc,
     & vc,wc,kc
          stop 5
        end if
        ...
        clm=0.
        if( explicitMethod.eq.0 .and. linearizeImplicitMethod.eq.1 )
     & then
          clm=1
        endif
...
c write(*,'(" **** asf: mu,kThermal,Rg,gamma,nuRho=",5e9.2," gravity=",3f6.1)') c     mu,kThermal,Rg,gamma,nuRho, gravity(0),gravity(1),gravity(2)
c    ! ' 
...
c   call getSpalartAllmarasParameters(cb1, cb2, cv1, sigma, sigmai, kappa, cw1, cw2, cw3, cw3e6, c      cv1e3, cd0, cr0)
...
c     *********************************      
            ...
            do i1=n1a,n1b
             if( mask(i1,i2,i3).gt.0 )then
                ...
                p0=uu(i1,i2,i3,pc)
                 ...
                 p0x=ux23r(i1,i2,i3,pc)
                 p0y=uy23r(i1,i2,i3,pc)
                 p0z=uz23r(i1,i2,i3,pc)
                 divu=u0x+v0y+w0z
                 ut(i1,i2,i3,rc)= -uu(i1,i2,i3,uc)*ux23r(i1,i2,i3,rc)-
     & uu(i1,i2,i3,vc)*uy23r(i1,i2,i3,rc)-uu(i1,i2,i3,wc)*uz23r(i1,i2,
     & i3,rc) -uu(i1,i2,i3,rc)*divu + nuRho*ulaplacian23r(i1,i2,i3,rc)
                 ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*u0x   -uu(i1,i2,i3,
     & vc)*u0y   -uu(i1,i2,i3,wc)*u0z   -cFast*rhoi*p0x + clm*(rL0i-
     & rhoi)*p0x  +(mu*rhoi)*(a43*uxx23r(i1,i2,i3,uc)+uyy23r(i1,i2,i3,
     & uc)+uzz23r(i1,i2,i3,uc)+a13*(uxy23r(i1,i2,i3,vc)+uxz23r(i1,i2,
     & i3,wc))) + gravity(0)
                 ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*v0x   -uu(i1,i2,i3,
     & vc)*v0y   -uu(i1,i2,i3,wc)*v0z   -cFast*rhoi*p0y + clm*(rL0i-
     & rhoi)*p0y  +(mu*rhoi)*(uxx23r(i1,i2,i3,vc)+a43*uyy23r(i1,i2,i3,
     & vc)+uzz23r(i1,i2,i3,vc)+a13*(uxy23r(i1,i2,i3,uc)+uyz23r(i1,i2,
     & i3,wc))) + gravity(1)
                 ut(i1,i2,i3,wc)= -uu(i1,i2,i3,uc)*w0x   -uu(i1,i2,i3,
     & vc)*w0y   -uu(i1,i2,i3,wc)*w0z   -cFast*rhoi*p0z + clm*(rL0i-
     & rhoi)*p0z  +(mu*rhoi)*(uxx23r(i1,i2,i3,wc)+uyy23r(i1,i2,i3,wc)+
     & a43*uzz23r(i1,i2,i3,wc)+a13*(uxz23r(i1,i2,i3,uc)+uyz23r(i1,i2,
     & i3,vc))) + gravity(2)
                 ut(i1,i2,i3,tc)= -uu(i1,i2,i3,uc)*ux23r(i1,i2,i3,tc)-
     & uu(i1,i2,i3,vc)*uy23r(i1,i2,i3,tc)-uu(i1,i2,i3,wc)*uz23r(i1,i2,
     & i3,tc)-gm1*uu(i1,i2,i3,tc)*divu
                 ut(i1,i2,i3,pc)= -uu(i1,i2,i3,uc)*p0x   -uu(i1,i2,i3,
     & vc)*p0y   -uu(i1,i2,i3,wc)*p0z   -cFast*gamma*(p0+
     & pressureLevel)*divu + clm*gamma*(pL0-p0)*divu
                 phi = a43*( u0x*(u0x-v0y) + v0y*(v0y-w0z)+ (w0z)**2 ) 
     &       +   2.*( u0y*v0x+u0z*w0x + v0z*w0y)       + (u0y)**2 + (
     & u0z)**2 + (v0x)**2 + (v0z)**2 + (w0x)**2 + (w0y)**2
                lapT = (gm1*kThermal)*ulaplacian23r(i1,i2,i3,tc)
                ut(i1,i2,i3,tc)= ut(i1,i2,i3,tc) + rhoi*( lapT + (gm1*
     & mu/Rg)*phi )
                ut(i1,i2,i3,pc)= ut(i1,i2,i3,pc) + Rg*lapT +(gm1*mu)*
     & phi
             end if
            end do
            end do
            ...
            do i1=n1a,n1b
             if( mask(i1,i2,i3).gt.0 )then
                ...
                p0=uu(i1,i2,i3,pc)
                 ...
                 p0x=ux23(i1,i2,i3,pc)
                 p0y=uy23(i1,i2,i3,pc)
                 p0z=uz23(i1,i2,i3,pc)
                 divu=u0x+v0y+w0z
                 ut(i1,i2,i3,rc)= -uu(i1,i2,i3,uc)*ux23(i1,i2,i3,rc)-
     & uu(i1,i2,i3,vc)*uy23(i1,i2,i3,rc)-uu(i1,i2,i3,wc)*uz23(i1,i2,
     & i3,rc) -uu(i1,i2,i3,rc)*divu + nuRho*ulaplacian23(i1,i2,i3,rc)
                 ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*u0x   -uu(i1,i2,i3,
     & vc)*u0y   -uu(i1,i2,i3,wc)*u0z   -cFast*rhoi*p0x + clm*(rL0i-
     & rhoi)*p0x  +(mu*rhoi)*(a43*uxx23(i1,i2,i3,uc)+uyy23(i1,i2,i3,
     & uc)+uzz23(i1,i2,i3,uc)+a13*(uxy23(i1,i2,i3,vc)+uxz23(i1,i2,i3,
     & wc))) + gravity(0)
                 ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*v0x   -uu(i1,i2,i3,
     & vc)*v0y   -uu(i1,i2,i3,wc)*v0z   -cFast*rhoi*p0y + clm*(rL0i-
     & rhoi)*p0y  +(mu*rhoi)*(uxx23(i1,i2,i3,vc)+a43*uyy23(i1,i2,i3,
     & vc)+uzz23(i1,i2,i3,vc)+a13*(uxy23(i1,i2,i3,uc)+uyz23(i1,i2,i3,
     & wc))) + gravity(1)
                 ut(i1,i2,i3,wc)= -uu(i1,i2,i3,uc)*w0x   -uu(i1,i2,i3,
     & vc)*w0y   -uu(i1,i2,i3,wc)*w0z   -cFast*rhoi*p0z + clm*(rL0i-
     & rhoi)*p0z  +(mu*rhoi)*(uxx23(i1,i2,i3,wc)+uyy23(i1,i2,i3,wc)+
     & a43*uzz23(i1,i2,i3,wc)+a13*(uxz23(i1,i2,i3,uc)+uyz23(i1,i2,i3,
     & vc))) + gravity(2)
                 ut(i1,i2,i3,tc)= -uu(i1,i2,i3,uc)*ux23(i1,i2,i3,tc)-
     & uu(i1,i2,i3,vc)*uy23(i1,i2,i3,tc)-uu(i1,i2,i3,wc)*uz23(i1,i2,
     & i3,tc)-gm1*uu(i1,i2,i3,tc)*divu
                 ut(i1,i2,i3,pc)= -uu(i1,i2,i3,uc)*p0x   -uu(i1,i2,i3,
     & vc)*p0y   -uu(i1,i2,i3,wc)*p0z   -cFast*gamma*(p0+
     & pressureLevel)*divu + clm*gamma*(pL0-p0)*divu
     ...
     &       +   2.*( u0y*v0x+u0z*w0x + v0z*w0y)       + (u0y)**2 + (
     & u0z)**2 + (v0x)**2 + (v0z)**2 + (w0x)**2 + (w0y)**2
                lapT = (gm1*kThermal)*ulaplacian23(i1,i2,i3,tc)
                ut(i1,i2,i3,tc)= ut(i1,i2,i3,tc) + rhoi*( lapT + (gm1*
     & mu/Rg)*phi )
                ut(i1,i2,i3,pc)= ut(i1,i2,i3,pc) + Rg*lapT +(gm1*mu)*
     & phi
            ...
            do i1=n1a,n1b
               ...
               p0=uu(i1,i2,i3,pc)
                ...
                p0z=uz23(i1,i2,i3,pc)
                divu=u0x+v0y+w0z
                ut(i1,i2,i3,rc)= -uu(i1,i2,i3,uc)*ux23(i1,i2,i3,rc)-uu(
     & i1,i2,i3,vc)*uy23(i1,i2,i3,rc)-uu(i1,i2,i3,wc)*uz23(i1,i2,i3,
     & rc) -uu(i1,i2,i3,rc)*divu + nuRho*ulaplacian23(i1,i2,i3,rc)
                ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*u0x   -uu(i1,i2,i3,
     & vc)*u0y   -uu(i1,i2,i3,wc)*u0z   -cFast*rhoi*p0x + clm*(rL0i-
     & rhoi)*p0x  +(mu*rhoi)*(a43*uxx23(i1,i2,i3,uc)+uyy23(i1,i2,i3,
     & uc)+uzz23(i1,i2,i3,uc)+a13*(uxy23(i1,i2,i3,vc)+uxz23(i1,i2,i3,
     ...
     & a43*uzz23(i1,i2,i3,wc)+a13*(uxz23(i1,i2,i3,uc)+uyz23(i1,i2,i3,
     & vc))) + gravity(2)
                ut(i1,i2,i3,tc)= -uu(i1,i2,i3,uc)*ux23(i1,i2,i3,tc)-uu(
     & i1,i2,i3,vc)*uy23(i1,i2,i3,tc)-uu(i1,i2,i3,wc)*uz23(i1,i2,i3,
     & tc)-gm1*uu(i1,i2,i3,tc)*divu
                ut(i1,i2,i3,pc)= -uu(i1,i2,i3,uc)*p0x   -uu(i1,i2,i3,
     & vc)*p0y   -uu(i1,i2,i3,wc)*p0z   -cFast*gamma*(p0+
     & pressureLevel)*divu + clm*gamma*(pL0-p0)*divu
                phi = a43*( u0x*(u0x-v0y) + v0y*(v0y-w0z)+ (w0z)**2 )  
