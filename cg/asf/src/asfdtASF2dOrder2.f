! This file automatically generated from asfdt.bf with bpp.
        subroutine asfdtASF2dOrder2(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,
...
c     *********************************      
            ...
            do i1=n1a,n1b
             if( mask(i1,i2,i3).gt.0 )then
                ...
                p0=uu(i1,i2,i3,pc)
                 ...
                 p0x=ux22r(i1,i2,i3,pc)
                 p0y=uy22r(i1,i2,i3,pc)
                 divu=u0x+v0y
                 ut(i1,i2,i3,rc)= -uu(i1,i2,i3,uc)*ux22r(i1,i2,i3,rc)-
     & uu(i1,i2,i3,vc)*uy22r(i1,i2,i3,rc) -uu(i1,i2,i3,rc)*divu + 
     & nuRho*ulaplacian22r(i1,i2,i3,rc)
                 ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*u0x-uu(i1,i2,i3,vc)*
     & u0y -cFast*rhoi*p0x + clm*(rL0i-rhoi)*p0x +(mu*rhoi)*(a43*
     & uxx22r(i1,i2,i3,uc)+uyy22r(i1,i2,i3,uc)+a13*(uxy22r(i1,i2,i3,
     & vc))) + gravity(0)
                 ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*v0x-uu(i1,i2,i3,vc)*
     & v0y -cFast*rhoi*p0y + clm*(rL0i-rhoi)*p0y +(mu*rhoi)*(uxx22r(
     & i1,i2,i3,vc)+a43*uyy22r(i1,i2,i3,vc)+a13*(uxy22r(i1,i2,i3,uc)))
     &  + gravity(1)
                 ut(i1,i2,i3,Tc)= -uu(i1,i2,i3,uc)*ux22r(i1,i2,i3,tc)-
     & uu(i1,i2,i3,vc)*uy22r(i1,i2,i3,tc)-gm1*uu(i1,i2,i3,tc)*divu
                 ut(i1,i2,i3,pc)= -uu(i1,i2,i3,uc)*p0x   -uu(i1,i2,i3,
     & vc)*p0y   -cFast*gamma*(p0+pressureLevel)*divu + clm*gamma*(
     & pL0-p0)*divu
                 phi = a43*( u0x**2 - u0x*v0y +v0y**2 ) +(v0x+u0y)**2
                lapT = (gm1*kThermal)*ulaplacian22r(i1,i2,i3,tc)
     ...
     & mu/Rg)*phi )
               ut(i1,i2,i3,pc)= ut(i1,i2,i3,pc) + Rg*lapT +(gm1*mu)*phi
                ...
                if( abs(yy).gt.yEps )then
                  ut(i1,i2,i3,uc)=ut(i1,i2,i3,uc)+nu*( uy22r(i1,i2,i3,
     & uc)/yy )
                  ut(i1,i2,i3,vc)=ut(i1,i2,i3,vc)+nu*( (uy22r(i1,i2,i3,
     & vc)-uu(i1,i2,i3,vc)/yy)/yy )
                else
                  ut(i1,i2,i3,uc)=ut(i1,i2,i3,uc)+nu*( uyy22r(i1,i2,i3,
     & uc) )
                  ut(i1,i2,i3,vc)=ut(i1,i2,i3,vc)+nu*( .5*uyy22r(i1,i2,
     & i3,vc) )
                end if
            end do
            end do
     ...
     & uu(i1,i2,i3,vc)*uy22r(i1,i2,i3,vc)-uy22r(i1,i2,i3,pc)
                 ! include implicit terms - diffusion
                  ...
                  yy=xy(i1,i2,i3,1)
                  if( abs(yy).gt.yEps )then
                    uti(i1,i2,i3,uc)=uti(i1,i2,i3,uc)+nu*( uy22r(i1,i2,
     & i3,uc)/yy )
                    uti(i1,i2,i3,vc)=uti(i1,i2,i3,vc)+nu*( (uy22r(i1,
     & i2,i3,vc)-uu(i1,i2,i3,vc)/yy)/yy )
                  else
     ...
     & uu(i1,i2,i3,vc)*uy22r(i1,i2,i3,vc)-uy22r(i1,i2,i3,pc)
                ! include implicit terms - diffusion
                 ...
                 if( abs(yy).gt.yEps )then
                   uti(i1,i2,i3,uc)=uti(i1,i2,i3,uc)+nu*( uy22r(i1,i2,
     & i3,uc)/yy )
                   uti(i1,i2,i3,vc)=uti(i1,i2,i3,vc)+nu*( (uy22r(i1,i2,
     & i3,vc)-uu(i1,i2,i3,vc)/yy)/yy )
                 else
                   uti(i1,i2,i3,uc)=uti(i1,i2,i3,uc)+nu*( uyy22r(i1,i2,
     & i3,uc) )
                   uti(i1,i2,i3,vc)=uti(i1,i2,i3,vc)+nu*( .5*uyy22r(i1,
     & i2,i3,vc) )
                 end if
              end do
              end do
            ...
            do i1=n1a,n1b
             if( mask(i1,i2,i3).gt.0 )then
                ...
                p0=uu(i1,i2,i3,pc)
                 ...
                 p0x=ux22(i1,i2,i3,pc)
                 p0y=uy22(i1,i2,i3,pc)
                 divu=u0x+v0y
                 ut(i1,i2,i3,rc)= -uu(i1,i2,i3,uc)*ux22(i1,i2,i3,rc)-
     & uu(i1,i2,i3,vc)*uy22(i1,i2,i3,rc) -uu(i1,i2,i3,rc)*divu + 
     & nuRho*ulaplacian22(i1,i2,i3,rc)
                 ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*u0x-uu(i1,i2,i3,vc)*
     & u0y -cFast*rhoi*p0x + clm*(rL0i-rhoi)*p0x +(mu*rhoi)*(a43*
     & uxx22(i1,i2,i3,uc)+uyy22(i1,i2,i3,uc)+a13*(uxy22(i1,i2,i3,vc)))
     &  + gravity(0)
                 ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*v0x-uu(i1,i2,i3,vc)*
     & v0y -cFast*rhoi*p0y + clm*(rL0i-rhoi)*p0y +(mu*rhoi)*(uxx22(i1,
     & i2,i3,vc)+a43*uyy22(i1,i2,i3,vc)+a13*(uxy22(i1,i2,i3,uc))) + 
     & gravity(1)
                 ut(i1,i2,i3,Tc)= -uu(i1,i2,i3,uc)*ux22(i1,i2,i3,tc)-
     & uu(i1,i2,i3,vc)*uy22(i1,i2,i3,tc)-gm1*uu(i1,i2,i3,tc)*divu
                 ut(i1,i2,i3,pc)= -uu(i1,i2,i3,uc)*p0x   -uu(i1,i2,i3,
     & vc)*p0y   -cFast*gamma*(p0+pressureLevel)*divu + clm*gamma*(
     & pL0-p0)*divu
                 phi = a43*( u0x**2 - u0x*v0y +v0y**2 ) +(v0x+u0y)**2
                lapT = (gm1*kThermal)*ulaplacian22(i1,i2,i3,tc)
                ut(i1,i2,i3,tc)= ut(i1,i2,i3,tc) + rhoi*( lapT + (gm1*
     & mu/Rg)*phi )
                ut(i1,i2,i3,pc)= ut(i1,i2,i3,pc) + Rg*lapT +(gm1*mu)*
     & phi
            ...
            do i1=n1a,n1b
               ...
               p0=uu(i1,i2,i3,pc)
                ...
                p0y=uy22(i1,i2,i3,pc)
                divu=u0x+v0y
                ut(i1,i2,i3,rc)= -uu(i1,i2,i3,uc)*ux22(i1,i2,i3,rc)-uu(
     & i1,i2,i3,vc)*uy22(i1,i2,i3,rc) -uu(i1,i2,i3,rc)*divu + nuRho*
     & ulaplacian22(i1,i2,i3,rc)
                ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*u0x-uu(i1,i2,i3,vc)*
     & u0y -cFast*rhoi*p0x + clm*(rL0i-rhoi)*p0x +(mu*rhoi)*(a43*
     & uxx22(i1,i2,i3,uc)+uyy22(i1,i2,i3,uc)+a13*(uxy22(i1,i2,i3,vc)))
     &  + gravity(0)
     ...
     & i2,i3,vc)+a43*uyy22(i1,i2,i3,vc)+a13*(uxy22(i1,i2,i3,uc))) + 
     & gravity(1)
                ut(i1,i2,i3,Tc)= -uu(i1,i2,i3,uc)*ux22(i1,i2,i3,tc)-uu(
     & i1,i2,i3,vc)*uy22(i1,i2,i3,tc)-gm1*uu(i1,i2,i3,tc)*divu
                ut(i1,i2,i3,pc)= -uu(i1,i2,i3,uc)*p0x   -uu(i1,i2,i3,
     & vc)*p0y   -cFast*gamma*(p0+pressureLevel)*divu + clm*gamma*(
     & pL0-p0)*divu
                phi = a43*( u0x**2 - u0x*v0y +v0y**2 ) +(v0x+u0y)**2
     ...
     & i3,uc)/yy )
                    uti(i1,i2,i3,vc)=uti(i1,i2,i3,vc)+nu*( (uy22(i1,i2,
     & i3,vc)-uu(i1,i2,i3,vc)/yy)/yy )
                  else
                    uti(i1,i2,i3,uc)=uti(i1,i2,i3,uc)+nu*( uyy22(i1,i2,
     & i3,uc) )
                    uti(i1,i2,i3,vc)=uti(i1,i2,i3,vc)+nu*( .5*uyy22(i1,
     & i2,i3,vc) )
                  end if
               end if
              end do
