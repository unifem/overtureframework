...
//=================================================================================
{
  ...
  if( parameters.bcIsTimeDependent(side,axis,grid) )
  {
    ...
    // if( getTimeDerivativeOfBoundaryValues(t0,u,gridVelocity,grid,side,axis) )
	...
	if( parameters.dbase.get<int >("numberOfDimensions")==3 )
	{
      ...
      {
	fLocal(I1g,I2g,I3g)-=(normal(I1,I2,I3,0)*parameters.dbase.get<RealArray>("bcData")(parameters.dbase.get<int >("uc"),side,axis,grid)+
			 normal(I1,I2,I3,1)*parameters.dbase.get<RealArray>("bcData")(parameters.dbase.get<int >("vc"),side,axis,grid));
	if( parameters.dbase.get<int >("numberOfDimensions")==3 )
	{
	  fLocal(I1g,I2g,I3g)-=normal(I1,I2,I3,2)*parameters.dbase.get<RealArray>("bcData")(parameters.dbase.get<int >("wc"),side,axis,grid);
	}
      }
    }
  }
