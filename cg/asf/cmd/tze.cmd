* 
*  test the asf solver -- EXPLICIT method
*
$tFinal=.5; $tPlot=.1; $debug=0; $degreeX=1; $degreeT=2; $cfl=.9; $nuRho=.1; $anu=0.; 
*
* $grid="square20.hdf"; 
* $grid="square5.hdf";  $degreeX=2; $degreeT=2; $tFinal=.5; $tPlot=.01; $debug=1; 
$grid="nonSquare5.hdf";  $degreeX=2; $degreeT=2; $tFinal=.5; $tPlot=.01; $debug=1; 
...
* $grid="cic6.hdf"; $anu=5. 
*
* $grid="box5.hdf";  $degreeX=2; $degreeT=2; $tFinal=.5; $tPlot=.01; $debug=1; 
*
$grid
* 
