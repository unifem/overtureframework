*
*    Solve for a detonation traveling wave profile 
* 
* Test of the Ideal-Gas and Mie-Gruneisen EOS with reactions
* 
*
$cfl=.9;
$mu=0.; $kThermal=0.; $Prandtl=.72;
$levels=3;  $tFinal=1.; $tPlot=.1; 
...
*    $levels=2; $showFile = "detonationMGKappa1p5-Level2.show"; $tFinal=1.; $tPlot=.2;
